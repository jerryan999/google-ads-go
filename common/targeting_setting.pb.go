...
func (TargetRestrictionOperation_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_common_targeting_setting_proto_enumTypes[0].Descriptor()
}

func (TargetRestrictionOperation_Operator) Type() protoreflect.EnumType {
	return &file_common_targeting_setting_proto_enumTypes[0]
}
...
func (TargetRestrictionOperation_Operator) EnumDescriptor() ([]byte, []int) {
	return file_common_targeting_setting_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *TargetingSetting) Reset() {
	*x = TargetingSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_targeting_setting_proto_msgTypes[0]
...
func (*TargetingSetting) Descriptor() ([]byte, []int) {
	return file_common_targeting_setting_proto_rawDescGZIP(), []int{0}
}
...
type TargetRestriction struct {
	...
	TargetingDimension enums.TargetingDimensionEnum_TargetingDimension `protobuf:"varint,1,opt,name=targeting_dimension,json=targetingDimension,proto3,enum=google.ads.googleads.v15.enums.TargetingDimensionEnum_TargetingDimension" json:"targeting_dimension,omitempty"`
...
func (x *TargetRestriction) Reset() {
	*x = TargetRestriction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_targeting_setting_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TargetRestriction) Descriptor() ([]byte, []int) {
	return file_common_targeting_setting_proto_rawDescGZIP(), []int{1}
}
...
type TargetRestrictionOperation struct {
	...
	Operator TargetRestrictionOperation_Operator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v15.common.TargetRestrictionOperation_Operator" json:"operator,omitempty"`
...
func (x *TargetRestrictionOperation) Reset() {
	*x = TargetRestrictionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_targeting_setting_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TargetRestrictionOperation) Descriptor() ([]byte, []int) {
	return file_common_targeting_setting_proto_rawDescGZIP(), []int{2}
}
...
var File_common_targeting_setting_proto protoreflect.FileDescriptor

var file_common_targeting_setting_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x38, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x74, 0x61, 0x72, 0x67, 0x65,
...
var (
	file_common_targeting_setting_proto_rawDescOnce sync.Once
	file_common_targeting_setting_proto_rawDescData = file_common_targeting_setting_proto_rawDesc
)

func file_common_targeting_setting_proto_rawDescGZIP() []byte {
	file_common_targeting_setting_proto_rawDescOnce.Do(func() {
		file_common_targeting_setting_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_targeting_setting_proto_rawDescData)
	})
	return file_common_targeting_setting_proto_rawDescData
}

var file_common_targeting_setting_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_common_targeting_setting_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_common_targeting_setting_proto_goTypes = []interface{}{
	(TargetRestrictionOperation_Operator)(0),             // 0: google.ads.googleads.v15.common.TargetRestrictionOperation.Operator
	(*TargetingSetting)(nil),                             // 1: google.ads.googleads.v15.common.TargetingSetting
	(*TargetRestriction)(nil),                            // 2: google.ads.googleads.v15.common.TargetRestriction
	(*TargetRestrictionOperation)(nil),                   // 3: google.ads.googleads.v15.common.TargetRestrictionOperation
	(enums.TargetingDimensionEnum_TargetingDimension)(0), // 4: google.ads.googleads.v15.enums.TargetingDimensionEnum.TargetingDimension
}
var file_common_targeting_setting_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v15.common.TargetingSetting.target_restrictions:type_name -> google.ads.googleads.v15.common.TargetRestriction
	3, // 1: google.ads.googleads.v15.common.TargetingSetting.target_restriction_operations:type_name -> google.ads.googleads.v15.common.TargetRestrictionOperation
	4, // 2: google.ads.googleads.v15.common.TargetRestriction.targeting_dimension:type_name -> google.ads.googleads.v15.enums.TargetingDimensionEnum.TargetingDimension
	0, // 3: google.ads.googleads.v15.common.TargetRestrictionOperation.operator:type_name -> google.ads.googleads.v15.common.TargetRestrictionOperation.Operator
	2, // 4: google.ads.googleads.v15.common.TargetRestrictionOperation.value:type_name -> google.ads.googleads.v15.common.TargetRestriction
...
func init() { file_common_targeting_setting_proto_init() }
func file_common_targeting_setting_proto_init() {
	if File_common_targeting_setting_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_targeting_setting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_targeting_setting_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_targeting_setting_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_targeting_setting_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_common_targeting_setting_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_targeting_setting_proto_goTypes,
		DependencyIndexes: file_common_targeting_setting_proto_depIdxs,
		EnumInfos:         file_common_targeting_setting_proto_enumTypes,
		MessageInfos:      file_common_targeting_setting_proto_msgTypes,
	}.Build()
	File_common_targeting_setting_proto = out.File
	file_common_targeting_setting_proto_rawDesc = nil
	file_common_targeting_setting_proto_goTypes = nil
	file_common_targeting_setting_proto_depIdxs = nil
}
