...
type MetricGoal struct {
	...
	// conversions, etc.
	Metric enums.ExperimentMetricEnum_ExperimentMetric `protobuf:"varint,1,opt,name=metric,proto3,enum=google.ads.googleads.v15.enums.ExperimentMetricEnum_ExperimentMetric" json:"metric,omitempty"`
	// The metric direction of the goal. For example, increase, decrease, no
	// change.
	Direction enums.ExperimentMetricDirectionEnum_ExperimentMetricDirection `protobuf:"varint,2,opt,name=direction,proto3,enum=google.ads.googleads.v15.enums.ExperimentMetricDirectionEnum_ExperimentMetricDirection" json:"direction,omitempty"`
}

func (x *MetricGoal) Reset() {
	*x = MetricGoal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_metric_goal_proto_msgTypes[0]
...
func (*MetricGoal) Descriptor() ([]byte, []int) {
	return file_common_metric_goal_proto_rawDescGZIP(), []int{0}
}
...
var File_common_metric_goal_proto protoreflect.FileDescriptor

var file_common_metric_goal_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2f, 0x76, 0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x65, 0x78, 0x70,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x45,
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0f, 0x4d, 0x65, 0x74,
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x35, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63,
	...
	0x64, 0x73, 0x2e, 0x56, 0x31, 0x35, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xca, 0x02, 0x1f,
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x31, 0x35, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea,
	0x02, 0x23, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x35, 0x3a, 0x3a, 0x43,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_common_metric_goal_proto_rawDescOnce sync.Once
	file_common_metric_goal_proto_rawDescData = file_common_metric_goal_proto_rawDesc
)

func file_common_metric_goal_proto_rawDescGZIP() []byte {
	file_common_metric_goal_proto_rawDescOnce.Do(func() {
		file_common_metric_goal_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_metric_goal_proto_rawDescData)
	})
	return file_common_metric_goal_proto_rawDescData
}

var file_common_metric_goal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_metric_goal_proto_goTypes = []interface{}{
	(*MetricGoal)(nil), // 0: google.ads.googleads.v15.common.MetricGoal
	(enums.ExperimentMetricEnum_ExperimentMetric)(0),                   // 1: google.ads.googleads.v15.enums.ExperimentMetricEnum.ExperimentMetric
	(enums.ExperimentMetricDirectionEnum_ExperimentMetricDirection)(0), // 2: google.ads.googleads.v15.enums.ExperimentMetricDirectionEnum.ExperimentMetricDirection
}
var file_common_metric_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.common.MetricGoal.metric:type_name -> google.ads.googleads.v15.enums.ExperimentMetricEnum.ExperimentMetric
	2, // 1: google.ads.googleads.v15.common.MetricGoal.direction:type_name -> google.ads.googleads.v15.enums.ExperimentMetricDirectionEnum.ExperimentMetricDirection
...
func init() { file_common_metric_goal_proto_init() }
func file_common_metric_goal_proto_init() {
	if File_common_metric_goal_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_metric_goal_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_common_metric_goal_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_metric_goal_proto_goTypes,
		DependencyIndexes: file_common_metric_goal_proto_depIdxs,
		MessageInfos:      file_common_metric_goal_proto_msgTypes,
	}.Build()
	File_common_metric_goal_proto = out.File
	file_common_metric_goal_proto_rawDesc = nil
	file_common_metric_goal_proto_goTypes = nil
	file_common_metric_goal_proto_depIdxs = nil
}
