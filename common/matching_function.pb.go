...
type MatchingFunction struct {
	...
	Operator enums.MatchingFunctionOperatorEnum_MatchingFunctionOperator `protobuf:"varint,4,opt,name=operator,proto3,enum=google.ads.googleads.v15.enums.MatchingFunctionOperatorEnum_MatchingFunctionOperator" json:"operator,omitempty"`
...
func (x *MatchingFunction) Reset() {
	*x = MatchingFunction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_matching_function_proto_msgTypes[0]
...
func (*MatchingFunction) Descriptor() ([]byte, []int) {
	return file_common_matching_function_proto_rawDescGZIP(), []int{0}
}
...
func (x *Operand) Reset() {
	*x = Operand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_matching_function_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Operand) Descriptor() ([]byte, []int) {
	return file_common_matching_function_proto_rawDescGZIP(), []int{1}
}
...
func (x *Operand_ConstantOperand) Reset() {
	*x = Operand_ConstantOperand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_matching_function_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Operand_ConstantOperand) Descriptor() ([]byte, []int) {
	return file_common_matching_function_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *Operand_FeedAttributeOperand) Reset() {
	*x = Operand_FeedAttributeOperand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_matching_function_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Operand_FeedAttributeOperand) Descriptor() ([]byte, []int) {
	return file_common_matching_function_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *Operand_FunctionOperand) Reset() {
	*x = Operand_FunctionOperand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_matching_function_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Operand_FunctionOperand) Descriptor() ([]byte, []int) {
	return file_common_matching_function_proto_rawDescGZIP(), []int{1, 2}
}
...
type Operand_RequestContextOperand struct {
	...
	ContextType enums.MatchingFunctionContextTypeEnum_MatchingFunctionContextType `protobuf:"varint,1,opt,name=context_type,json=contextType,proto3,enum=google.ads.googleads.v15.enums.MatchingFunctionContextTypeEnum_MatchingFunctionContextType" json:"context_type,omitempty"`
}

func (x *Operand_RequestContextOperand) Reset() {
	*x = Operand_RequestContextOperand{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_matching_function_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Operand_RequestContextOperand) Descriptor() ([]byte, []int) {
	return file_common_matching_function_proto_rawDescGZIP(), []int{1, 3}
}
...
var File_common_matching_function_proto protoreflect.FileDescriptor

var file_common_matching_function_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x43, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6d, 0x61, 0x74, 0x63, 0x68,
	...
	0x76, 0x31, 0x35, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x31, 0x35, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xca, 0x02, 0x1f, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73,
	0x5c, 0x56, 0x31, 0x35, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02, 0x23, 0x47, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x35, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_common_matching_function_proto_rawDescOnce sync.Once
	file_common_matching_function_proto_rawDescData = file_common_matching_function_proto_rawDesc
)

func file_common_matching_function_proto_rawDescGZIP() []byte {
	file_common_matching_function_proto_rawDescOnce.Do(func() {
		file_common_matching_function_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_matching_function_proto_rawDescData)
	})
	return file_common_matching_function_proto_rawDescData
}

var file_common_matching_function_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_common_matching_function_proto_goTypes = []interface{}{
	(*MatchingFunction)(nil),                                               // 0: google.ads.googleads.v15.common.MatchingFunction
	(*Operand)(nil),                                                        // 1: google.ads.googleads.v15.common.Operand
	(*Operand_ConstantOperand)(nil),                                        // 2: google.ads.googleads.v15.common.Operand.ConstantOperand
	(*Operand_FeedAttributeOperand)(nil),                                   // 3: google.ads.googleads.v15.common.Operand.FeedAttributeOperand
	(*Operand_FunctionOperand)(nil),                                        // 4: google.ads.googleads.v15.common.Operand.FunctionOperand
	(*Operand_RequestContextOperand)(nil),                                  // 5: google.ads.googleads.v15.common.Operand.RequestContextOperand
	(enums.MatchingFunctionOperatorEnum_MatchingFunctionOperator)(0),       // 6: google.ads.googleads.v15.enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator
	(enums.MatchingFunctionContextTypeEnum_MatchingFunctionContextType)(0), // 7: google.ads.googleads.v15.enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType
}
var file_common_matching_function_proto_depIdxs = []int32{
	6, // 0: google.ads.googleads.v15.common.MatchingFunction.operator:type_name -> google.ads.googleads.v15.enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator
	1, // 1: google.ads.googleads.v15.common.MatchingFunction.left_operands:type_name -> google.ads.googleads.v15.common.Operand
	1, // 2: google.ads.googleads.v15.common.MatchingFunction.right_operands:type_name -> google.ads.googleads.v15.common.Operand
	2, // 3: google.ads.googleads.v15.common.Operand.constant_operand:type_name -> google.ads.googleads.v15.common.Operand.ConstantOperand
	3, // 4: google.ads.googleads.v15.common.Operand.feed_attribute_operand:type_name -> google.ads.googleads.v15.common.Operand.FeedAttributeOperand
	4, // 5: google.ads.googleads.v15.common.Operand.function_operand:type_name -> google.ads.googleads.v15.common.Operand.FunctionOperand
	5, // 6: google.ads.googleads.v15.common.Operand.request_context_operand:type_name -> google.ads.googleads.v15.common.Operand.RequestContextOperand
	0, // 7: google.ads.googleads.v15.common.Operand.FunctionOperand.matching_function:type_name -> google.ads.googleads.v15.common.MatchingFunction
	7, // 8: google.ads.googleads.v15.common.Operand.RequestContextOperand.context_type:type_name -> google.ads.googleads.v15.enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType
...
func init() { file_common_matching_function_proto_init() }
func file_common_matching_function_proto_init() {
	if File_common_matching_function_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_matching_function_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_matching_function_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_matching_function_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_matching_function_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_matching_function_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_matching_function_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_matching_function_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_common_matching_function_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	file_common_matching_function_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	file_common_matching_function_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_common_matching_function_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_matching_function_proto_goTypes,
		DependencyIndexes: file_common_matching_function_proto_depIdxs,
		MessageInfos:      file_common_matching_function_proto_msgTypes,
	}.Build()
	File_common_matching_function_proto = out.File
	file_common_matching_function_proto_rawDesc = nil
	file_common_matching_function_proto_goTypes = nil
	file_common_matching_function_proto_depIdxs = nil
}
