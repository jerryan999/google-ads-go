...
var file_common_policy_proto_goTypes = []any{
...
func file_common_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_policy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_common_policy_proto_msgTypes[12].Exporter = func(v any, i int) any {
	...
	file_common_policy_proto_msgTypes[0].OneofWrappers = []any{}
	file_common_policy_proto_msgTypes[2].OneofWrappers = []any{}
	file_common_policy_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_common_policy_proto_msgTypes[4].OneofWrappers = []any{
	...
	file_common_policy_proto_msgTypes[9].OneofWrappers = []any{
		(*PolicyTopicEvidence_DestinationNotWorking_DnsErrorType)(nil),
		(*PolicyTopicEvidence_DestinationNotWorking_HttpErrorCode)(nil),
	}
	file_common_policy_proto_msgTypes[10].OneofWrappers = []any{}
	file_common_policy_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
