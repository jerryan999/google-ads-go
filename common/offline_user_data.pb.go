...
var file_common_offline_user_data_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
...
func file_common_offline_user_data_proto_init() {
	...
	file_common_offline_user_data_proto_msgTypes[7].OneofWrappers = []interface{}{}
	file_common_offline_user_data_proto_msgTypes[8].OneofWrappers = []interface{}{}
