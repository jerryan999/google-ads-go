...
func (x *AssetLinkPrimaryStatusDetails) Reset() {
	*x = AssetLinkPrimaryStatusDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_asset_policy_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetLinkPrimaryStatusDetails) Descriptor() ([]byte, []int) {
	return file_common_asset_policy_proto_rawDescGZIP(), []int{1}
}
...
func (x *AssetDisapproved) Reset() {
	*x = AssetDisapproved{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_asset_policy_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetDisapproved) Descriptor() ([]byte, []int) {
	return file_common_asset_policy_proto_rawDescGZIP(), []int{2}
}
...
var file_common_asset_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
func file_common_asset_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_common_asset_policy_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_asset_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_asset_policy_proto_msgTypes[1].OneofWrappers = []interface{}{
