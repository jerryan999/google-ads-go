...
var file_common_asset_types_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
func file_common_asset_types_proto_init() {
	...
	file_common_asset_types_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*LeadFormDeliveryMethod_Webhook)(nil),
	}
	file_common_asset_types_proto_msgTypes[9].OneofWrappers = []interface{}{}
	file_common_asset_types_proto_msgTypes[11].OneofWrappers = []interface{}{
