...
var file_common_real_time_bidding_setting_proto_goTypes = []any{
...
func file_common_real_time_bidding_setting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_real_time_bidding_setting_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_common_real_time_bidding_setting_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
