...
func (x *FrequencyCapEntry) Reset() {
	*x = FrequencyCapEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_frequency_cap_proto_msgTypes[0]
...
func (*FrequencyCapEntry) Descriptor() ([]byte, []int) {
	return file_common_frequency_cap_proto_rawDescGZIP(), []int{0}
}
...
type FrequencyCapKey struct {
	...
	Level enums.FrequencyCapLevelEnum_FrequencyCapLevel `protobuf:"varint,1,opt,name=level,proto3,enum=google.ads.googleads.v9.enums.FrequencyCapLevelEnum_FrequencyCapLevel" json:"level,omitempty"`
	// The type of event that the cap applies to (e.g. impression).
	EventType enums.FrequencyCapEventTypeEnum_FrequencyCapEventType `protobuf:"varint,3,opt,name=event_type,json=eventType,proto3,enum=google.ads.googleads.v9.enums.FrequencyCapEventTypeEnum_FrequencyCapEventType" json:"event_type,omitempty"`
...
func (x *FrequencyCapKey) Reset() {
	*x = FrequencyCapKey{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_frequency_cap_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FrequencyCapKey) Descriptor() ([]byte, []int) {
	return file_common_frequency_cap_proto_rawDescGZIP(), []int{1}
}
...
var File_common_frequency_cap_proto protoreflect.FileDescriptor

var file_common_frequency_cap_proto_rawDesc = []byte{
	...
	0x73, 0x2f, 0x76, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x72, 0x65, 0x71, 0x75,
	...
	0x76, 0x39, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65,
	...
	0x2f, 0x76, 0x39, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	0x39, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xca, 0x02, 0x1e, 0x47, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c,
	0x56, 0x39, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02, 0x22, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41,
	0x64, 0x73, 0x3a, 0x3a, 0x56, 0x39, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_common_frequency_cap_proto_rawDescOnce sync.Once
	file_common_frequency_cap_proto_rawDescData = file_common_frequency_cap_proto_rawDesc
)

func file_common_frequency_cap_proto_rawDescGZIP() []byte {
	file_common_frequency_cap_proto_rawDescOnce.Do(func() {
		file_common_frequency_cap_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_frequency_cap_proto_rawDescData)
	})
	return file_common_frequency_cap_proto_rawDescData
}

var file_common_frequency_cap_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_common_frequency_cap_proto_goTypes = []interface{}{
	(*FrequencyCapEntry)(nil),                                  // 0: google.ads.googleads.v9.common.FrequencyCapEntry
	(*FrequencyCapKey)(nil),                                    // 1: google.ads.googleads.v9.common.FrequencyCapKey
	(enums.FrequencyCapLevelEnum_FrequencyCapLevel)(0),         // 2: google.ads.googleads.v9.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	(enums.FrequencyCapEventTypeEnum_FrequencyCapEventType)(0), // 3: google.ads.googleads.v9.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	(enums.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit)(0),   // 4: google.ads.googleads.v9.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
}
var file_common_frequency_cap_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.common.FrequencyCapEntry.key:type_name -> google.ads.googleads.v9.common.FrequencyCapKey
	2, // 1: google.ads.googleads.v9.common.FrequencyCapKey.level:type_name -> google.ads.googleads.v9.enums.FrequencyCapLevelEnum.FrequencyCapLevel
	3, // 2: google.ads.googleads.v9.common.FrequencyCapKey.event_type:type_name -> google.ads.googleads.v9.enums.FrequencyCapEventTypeEnum.FrequencyCapEventType
	4, // 3: google.ads.googleads.v9.common.FrequencyCapKey.time_unit:type_name -> google.ads.googleads.v9.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
...
func init() { file_common_frequency_cap_proto_init() }
func file_common_frequency_cap_proto_init() {
	if File_common_frequency_cap_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_frequency_cap_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_common_frequency_cap_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_frequency_cap_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_common_frequency_cap_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_common_frequency_cap_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_frequency_cap_proto_goTypes,
		DependencyIndexes: file_common_frequency_cap_proto_depIdxs,
		MessageInfos:      file_common_frequency_cap_proto_msgTypes,
	}.Build()
	File_common_frequency_cap_proto = out.File
	file_common_frequency_cap_proto_rawDesc = nil
	file_common_frequency_cap_proto_goTypes = nil
	file_common_frequency_cap_proto_depIdxs = nil
}
