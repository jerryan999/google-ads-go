...
// 	protoc        v4.23.4
// source: google/ads/googleads/v15/common/text_label.proto
...
func (x *TextLabel) Reset() {
	*x = TextLabel{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_text_label_proto_msgTypes[0]
...
func (*TextLabel) Descriptor() ([]byte, []int) {
	return file_common_text_label_proto_rawDescGZIP(), []int{0}
}
...
var File_common_text_label_proto protoreflect.FileDescriptor

var file_common_text_label_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x13, 0x0a, 0x11, 0x5f, 0x62, 0x61, 0x63,
...
var (
	file_common_text_label_proto_rawDescOnce sync.Once
	file_common_text_label_proto_rawDescData = file_common_text_label_proto_rawDesc
)

func file_common_text_label_proto_rawDescGZIP() []byte {
	file_common_text_label_proto_rawDescOnce.Do(func() {
		file_common_text_label_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_text_label_proto_rawDescData)
	})
	return file_common_text_label_proto_rawDescData
}

var file_common_text_label_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_text_label_proto_goTypes = []interface{}{
	(*TextLabel)(nil), // 0: google.ads.googleads.v15.common.TextLabel
}
var file_common_text_label_proto_depIdxs = []int32{
...
func init() { file_common_text_label_proto_init() }
func file_common_text_label_proto_init() {
	if File_common_text_label_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_text_label_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_text_label_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_common_text_label_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_text_label_proto_goTypes,
		DependencyIndexes: file_common_text_label_proto_depIdxs,
		MessageInfos:      file_common_text_label_proto_msgTypes,
	}.Build()
	File_common_text_label_proto = out.File
	file_common_text_label_proto_rawDesc = nil
	file_common_text_label_proto_goTypes = nil
	file_common_text_label_proto_depIdxs = nil
}
