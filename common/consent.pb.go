...
type Consent struct {
	...
	AdUserData enums.ConsentStatusEnum_ConsentStatus `protobuf:"varint,1,opt,name=ad_user_data,json=adUserData,proto3,enum=google.ads.googleads.v15.enums.ConsentStatusEnum_ConsentStatus" json:"ad_user_data,omitempty"`
	// This represents consent for ad personalization.
	// This can only be set for OfflineUserDataJobService and UserDataService.
	AdPersonalization enums.ConsentStatusEnum_ConsentStatus `protobuf:"varint,2,opt,name=ad_personalization,json=adPersonalization,proto3,enum=google.ads.googleads.v15.enums.ConsentStatusEnum_ConsentStatus" json:"ad_personalization,omitempty"`
}

func (x *Consent) Reset() {
	*x = Consent{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_consent_proto_msgTypes[0]
...
func (*Consent) Descriptor() ([]byte, []int) {
	return file_common_consent_proto_rawDescGZIP(), []int{0}
}
...
func (x *Consent) GetAdPersonalization() enums.ConsentStatusEnum_ConsentStatus {
	if x != nil {
...
var File_common_consent_proto protoreflect.FileDescriptor

var file_common_consent_proto_rawDesc = []byte{
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x74,
	...
	0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0c, 0x43, 0x6f,
...
var (
	file_common_consent_proto_rawDescOnce sync.Once
	file_common_consent_proto_rawDescData = file_common_consent_proto_rawDesc
)

func file_common_consent_proto_rawDescGZIP() []byte {
	file_common_consent_proto_rawDescOnce.Do(func() {
		file_common_consent_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_consent_proto_rawDescData)
	})
	return file_common_consent_proto_rawDescData
}

var file_common_consent_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_consent_proto_goTypes = []interface{}{
	(*Consent)(nil), // 0: google.ads.googleads.v15.common.Consent
	(enums.ConsentStatusEnum_ConsentStatus)(0), // 1: google.ads.googleads.v15.enums.ConsentStatusEnum.ConsentStatus
}
var file_common_consent_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.common.Consent.ad_user_data:type_name -> google.ads.googleads.v15.enums.ConsentStatusEnum.ConsentStatus
	1, // 1: google.ads.googleads.v15.common.Consent.ad_personalization:type_name -> google.ads.googleads.v15.enums.ConsentStatusEnum.ConsentStatus
...
func init() { file_common_consent_proto_init() }
func file_common_consent_proto_init() {
	if File_common_consent_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_consent_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_common_consent_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_consent_proto_goTypes,
		DependencyIndexes: file_common_consent_proto_depIdxs,
		MessageInfos:      file_common_consent_proto_msgTypes,
	}.Build()
	File_common_consent_proto = out.File
	file_common_consent_proto_rawDesc = nil
	file_common_consent_proto_goTypes = nil
	file_common_consent_proto_depIdxs = nil
}
