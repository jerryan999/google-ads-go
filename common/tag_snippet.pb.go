...
type TagSnippet struct {
	...
	Type enums.TrackingCodeTypeEnum_TrackingCodeType `protobuf:"varint,1,opt,name=type,proto3,enum=google.ads.googleads.v9.enums.TrackingCodeTypeEnum_TrackingCodeType" json:"type,omitempty"`
	// The format of the web page where the tracking tag and snippet will be
	// installed, e.g. HTML.
	PageFormat enums.TrackingCodePageFormatEnum_TrackingCodePageFormat `protobuf:"varint,2,opt,name=page_format,json=pageFormat,proto3,enum=google.ads.googleads.v9.enums.TrackingCodePageFormatEnum_TrackingCodePageFormat" json:"page_format,omitempty"`
...
var file_common_tag_snippet_proto_goTypes = []interface{}{
	(*TagSnippet)(nil), // 0: google.ads.googleads.v9.common.TagSnippet
	(enums.TrackingCodeTypeEnum_TrackingCodeType)(0),             // 1: google.ads.googleads.v9.enums.TrackingCodeTypeEnum.TrackingCodeType
	(enums.TrackingCodePageFormatEnum_TrackingCodePageFormat)(0), // 2: google.ads.googleads.v9.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
}
var file_common_tag_snippet_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.common.TagSnippet.type:type_name -> google.ads.googleads.v9.enums.TrackingCodeTypeEnum.TrackingCodeType
	2, // 1: google.ads.googleads.v9.common.TagSnippet.page_format:type_name -> google.ads.googleads.v9.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
