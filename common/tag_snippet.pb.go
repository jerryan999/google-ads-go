...
type TagSnippet struct {
	...
	Type enums.TrackingCodeTypeEnum_TrackingCodeType `protobuf:"varint,1,opt,name=type,proto3,enum=google.ads.googleads.v15.enums.TrackingCodeTypeEnum_TrackingCodeType" json:"type,omitempty"`
	// The format of the web page where the tracking tag and snippet will be
	// installed, for example, HTML.
	PageFormat enums.TrackingCodePageFormatEnum_TrackingCodePageFormat `protobuf:"varint,2,opt,name=page_format,json=pageFormat,proto3,enum=google.ads.googleads.v15.enums.TrackingCodePageFormatEnum_TrackingCodePageFormat" json:"page_format,omitempty"`
...
func (x *TagSnippet) Reset() {
	*x = TagSnippet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_tag_snippet_proto_msgTypes[0]
...
func (*TagSnippet) Descriptor() ([]byte, []int) {
	return file_common_tag_snippet_proto_rawDescGZIP(), []int{0}
}
...
var File_common_tag_snippet_proto protoreflect.FileDescriptor

var file_common_tag_snippet_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x72, 0x61, 0x63,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x72,
	...
	0x0a, 0x70, 0x61, 0x67, 0x65, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x12, 0x2b, 0x0a, 0x0f, 0x67,
	0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x5f, 0x73, 0x69, 0x74, 0x65, 0x5f, 0x74, 0x61, 0x67, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0d, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x53, 0x69,
	0x74, 0x65, 0x54, 0x61, 0x67, 0x88, 0x01, 0x01, 0x12, 0x28, 0x0a, 0x0d, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x5f, 0x73, 0x6e, 0x69, 0x70, 0x70, 0x65, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x01, 0x52, 0x0c, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x6e, 0x69, 0x70, 0x70, 0x65, 0x74, 0x88,
	0x01, 0x01, 0x42, 0x12, 0x0a, 0x10, 0x5f, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x5f, 0x73, 0x69,
...
var (
	file_common_tag_snippet_proto_rawDescOnce sync.Once
	file_common_tag_snippet_proto_rawDescData = file_common_tag_snippet_proto_rawDesc
)

func file_common_tag_snippet_proto_rawDescGZIP() []byte {
	file_common_tag_snippet_proto_rawDescOnce.Do(func() {
		file_common_tag_snippet_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_tag_snippet_proto_rawDescData)
	})
	return file_common_tag_snippet_proto_rawDescData
}

var file_common_tag_snippet_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_tag_snippet_proto_goTypes = []interface{}{
	(*TagSnippet)(nil), // 0: google.ads.googleads.v15.common.TagSnippet
	(enums.TrackingCodeTypeEnum_TrackingCodeType)(0),             // 1: google.ads.googleads.v15.enums.TrackingCodeTypeEnum.TrackingCodeType
	(enums.TrackingCodePageFormatEnum_TrackingCodePageFormat)(0), // 2: google.ads.googleads.v15.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
}
var file_common_tag_snippet_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.common.TagSnippet.type:type_name -> google.ads.googleads.v15.enums.TrackingCodeTypeEnum.TrackingCodeType
	2, // 1: google.ads.googleads.v15.common.TagSnippet.page_format:type_name -> google.ads.googleads.v15.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
...
func init() { file_common_tag_snippet_proto_init() }
func file_common_tag_snippet_proto_init() {
	if File_common_tag_snippet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_tag_snippet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_common_tag_snippet_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_common_tag_snippet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_tag_snippet_proto_goTypes,
		DependencyIndexes: file_common_tag_snippet_proto_depIdxs,
		MessageInfos:      file_common_tag_snippet_proto_msgTypes,
	}.Build()
	File_common_tag_snippet_proto = out.File
	file_common_tag_snippet_proto_rawDesc = nil
	file_common_tag_snippet_proto_goTypes = nil
	file_common_tag_snippet_proto_depIdxs = nil
}
