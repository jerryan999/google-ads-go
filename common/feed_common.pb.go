...
var file_common_feed_common_proto_goTypes = []any{
...
func file_common_feed_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_feed_common_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Money); i {
			case 0:
				return &v.state
			case 1:
	...
	file_common_feed_common_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
