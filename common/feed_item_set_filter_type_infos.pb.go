...
var file_common_feed_item_set_filter_type_infos_proto_goTypes = []any{
...
func file_common_feed_item_set_filter_type_infos_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_feed_item_set_filter_type_infos_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_common_feed_item_set_filter_type_infos_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_common_feed_item_set_filter_type_infos_proto_msgTypes[2].Exporter = func(v any, i int) any {
