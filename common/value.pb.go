...
func (x *Value) Reset() {
	*x = Value{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_value_proto_msgTypes[0]
...
func (*Value) Descriptor() ([]byte, []int) {
	return file_common_value_proto_rawDescGZIP(), []int{0}
}
...
var File_common_value_proto protoreflect.FileDescriptor

var file_common_value_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22, 0xc7,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x48, 0x00, 0x52, 0x0a, 0x66, 0x6c, 0x6f, 0x61, 0x74,
...
var (
	file_common_value_proto_rawDescOnce sync.Once
	file_common_value_proto_rawDescData = file_common_value_proto_rawDesc
)

func file_common_value_proto_rawDescGZIP() []byte {
	file_common_value_proto_rawDescOnce.Do(func() {
		file_common_value_proto_rawDescData = protoimpl.X.CompressGZIP(file_common_value_proto_rawDescData)
	})
	return file_common_value_proto_rawDescData
}

var file_common_value_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_common_value_proto_goTypes = []interface{}{
	(*Value)(nil), // 0: google.ads.googleads.v15.common.Value
}
var file_common_value_proto_depIdxs = []int32{
...
func init() { file_common_value_proto_init() }
func file_common_value_proto_init() {
	if File_common_value_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_common_value_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Value); i {
			case 0:
				return &v.state
			case 1:
	...
	file_common_value_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_common_value_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_common_value_proto_goTypes,
		DependencyIndexes: file_common_value_proto_depIdxs,
		MessageInfos:      file_common_value_proto_msgTypes,
	}.Build()
	File_common_value_proto = out.File
	file_common_value_proto_rawDesc = nil
	file_common_value_proto_goTypes = nil
	file_common_value_proto_depIdxs = nil
}
