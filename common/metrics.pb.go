...
func file_common_metrics_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_metrics_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_common_metrics_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_common_metrics_proto_msgTypes[0].OneofWrappers = []any{}
	file_common_metrics_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
