...
var file_common_local_services_proto_goTypes = []any{
...
func file_common_local_services_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_local_services_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_common_local_services_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
