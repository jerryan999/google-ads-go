...
var file_enums_asset_link_primary_status_reason_proto_goTypes = []any{
...
func file_enums_asset_link_primary_status_reason_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_asset_link_primary_status_reason_proto_msgTypes[0].Exporter = func(v any, i int) any {
