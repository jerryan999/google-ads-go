...
func (SkAdNetworkAttributionCreditEnum_SkAdNetworkAttributionCredit) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_sk_ad_network_attribution_credit_proto_enumTypes[0].Descriptor()
}

func (SkAdNetworkAttributionCreditEnum_SkAdNetworkAttributionCredit) Type() protoreflect.EnumType {
	return &file_enums_sk_ad_network_attribution_credit_proto_enumTypes[0]
}
...
func (SkAdNetworkAttributionCreditEnum_SkAdNetworkAttributionCredit) EnumDescriptor() ([]byte, []int) {
	return file_enums_sk_ad_network_attribution_credit_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SkAdNetworkAttributionCreditEnum) Reset() {
	*x = SkAdNetworkAttributionCreditEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_sk_ad_network_attribution_credit_proto_msgTypes[0]
...
func (*SkAdNetworkAttributionCreditEnum) Descriptor() ([]byte, []int) {
	return file_enums_sk_ad_network_attribution_credit_proto_rawDescGZIP(), []int{0}
}

var File_enums_sk_ad_network_attribution_credit_proto protoreflect.FileDescriptor

var file_enums_sk_ad_network_attribution_credit_proto_rawDesc = []byte{
	...
	0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x8b, 0x01, 0x0a, 0x20, 0x53, 0x6b, 0x41, 0x64,
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x21, 0x53, 0x6b,
...
var (
	file_enums_sk_ad_network_attribution_credit_proto_rawDescOnce sync.Once
	file_enums_sk_ad_network_attribution_credit_proto_rawDescData = file_enums_sk_ad_network_attribution_credit_proto_rawDesc
)

func file_enums_sk_ad_network_attribution_credit_proto_rawDescGZIP() []byte {
	file_enums_sk_ad_network_attribution_credit_proto_rawDescOnce.Do(func() {
		file_enums_sk_ad_network_attribution_credit_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_sk_ad_network_attribution_credit_proto_rawDescData)
	})
	return file_enums_sk_ad_network_attribution_credit_proto_rawDescData
}

var file_enums_sk_ad_network_attribution_credit_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_sk_ad_network_attribution_credit_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_sk_ad_network_attribution_credit_proto_goTypes = []interface{}{
	(SkAdNetworkAttributionCreditEnum_SkAdNetworkAttributionCredit)(0), // 0: google.ads.googleads.v15.enums.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit
	(*SkAdNetworkAttributionCreditEnum)(nil),                           // 1: google.ads.googleads.v15.enums.SkAdNetworkAttributionCreditEnum
}
var file_enums_sk_ad_network_attribution_credit_proto_depIdxs = []int32{
...
func init() { file_enums_sk_ad_network_attribution_credit_proto_init() }
func file_enums_sk_ad_network_attribution_credit_proto_init() {
	if File_enums_sk_ad_network_attribution_credit_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_sk_ad_network_attribution_credit_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_sk_ad_network_attribution_credit_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_sk_ad_network_attribution_credit_proto_goTypes,
		DependencyIndexes: file_enums_sk_ad_network_attribution_credit_proto_depIdxs,
		EnumInfos:         file_enums_sk_ad_network_attribution_credit_proto_enumTypes,
		MessageInfos:      file_enums_sk_ad_network_attribution_credit_proto_msgTypes,
	}.Build()
	File_enums_sk_ad_network_attribution_credit_proto = out.File
	file_enums_sk_ad_network_attribution_credit_proto_rawDesc = nil
	file_enums_sk_ad_network_attribution_credit_proto_goTypes = nil
	file_enums_sk_ad_network_attribution_credit_proto_depIdxs = nil
}
