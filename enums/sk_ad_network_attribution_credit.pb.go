...
var file_enums_sk_ad_network_attribution_credit_proto_goTypes = []any{
...
func file_enums_sk_ad_network_attribution_credit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_sk_ad_network_attribution_credit_proto_msgTypes[0].Exporter = func(v any, i int) any {
