...
type LocalServicesCreditStateEnum_CreditState int32

const (
	// Not specified.
	LocalServicesCreditStateEnum_UNSPECIFIED LocalServicesCreditStateEnum_CreditState = 0
	// Used for return value only. Represents value unknown in this version.
	LocalServicesCreditStateEnum_UNKNOWN LocalServicesCreditStateEnum_CreditState = 1
	// Credit is pending.
	LocalServicesCreditStateEnum_PENDING LocalServicesCreditStateEnum_CreditState = 2
	// Credit request is complete.
	LocalServicesCreditStateEnum_CREDITED LocalServicesCreditStateEnum_CreditState = 3
)

// Enum value maps for LocalServicesCreditStateEnum_CreditState.
var (
	LocalServicesCreditStateEnum_CreditState_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "UNKNOWN",
		2: "PENDING",
		3: "CREDITED",
	}
	LocalServicesCreditStateEnum_CreditState_value = map[string]int32{
		"UNSPECIFIED": 0,
		"UNKNOWN":     1,
		"PENDING":     2,
		"CREDITED":    3,
...
func (x LocalServicesCreditStateEnum_CreditState) Enum() *LocalServicesCreditStateEnum_CreditState {
	p := new(LocalServicesCreditStateEnum_CreditState)
	*p = x
	return p
}

func (x LocalServicesCreditStateEnum_CreditState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LocalServicesCreditStateEnum_CreditState) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_local_services_lead_credit_state_proto_enumTypes[0].Descriptor()
}

func (LocalServicesCreditStateEnum_CreditState) Type() protoreflect.EnumType {
	return &file_enums_local_services_lead_credit_state_proto_enumTypes[0]
}
...
func (LocalServicesCreditStateEnum_CreditState) EnumDescriptor() ([]byte, []int) {
	return file_enums_local_services_lead_credit_state_proto_rawDescGZIP(), []int{0, 0}
}

// Container for enum describing possible credit states of a lead.
type LocalServicesCreditStateEnum struct {
...
func (x *LocalServicesCreditStateEnum) Reset() {
	*x = LocalServicesCreditStateEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_local_services_lead_credit_state_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LocalServicesCreditStateEnum) String() string {
...
func (*LocalServicesCreditStateEnum) Descriptor() ([]byte, []int) {
	return file_enums_local_services_lead_credit_state_proto_rawDescGZIP(), []int{0}
}

var File_enums_local_services_lead_credit_state_proto protoreflect.FileDescriptor

var file_enums_local_services_lead_credit_state_proto_rawDesc = []byte{
...
var (
	file_enums_local_services_lead_credit_state_proto_rawDescOnce sync.Once
	file_enums_local_services_lead_credit_state_proto_rawDescData = file_enums_local_services_lead_credit_state_proto_rawDesc
)

func file_enums_local_services_lead_credit_state_proto_rawDescGZIP() []byte {
	file_enums_local_services_lead_credit_state_proto_rawDescOnce.Do(func() {
		file_enums_local_services_lead_credit_state_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_local_services_lead_credit_state_proto_rawDescData)
	})
	return file_enums_local_services_lead_credit_state_proto_rawDescData
}

var file_enums_local_services_lead_credit_state_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_local_services_lead_credit_state_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_local_services_lead_credit_state_proto_goTypes = []any{
...
var file_enums_local_services_lead_credit_state_proto_depIdxs = []int32{
...
func init() { file_enums_local_services_lead_credit_state_proto_init() }
func file_enums_local_services_lead_credit_state_proto_init() {
	if File_enums_local_services_lead_credit_state_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_local_services_lead_credit_state_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_local_services_lead_credit_state_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_local_services_lead_credit_state_proto_goTypes,
		DependencyIndexes: file_enums_local_services_lead_credit_state_proto_depIdxs,
		EnumInfos:         file_enums_local_services_lead_credit_state_proto_enumTypes,
		MessageInfos:      file_enums_local_services_lead_credit_state_proto_msgTypes,
	}.Build()
	File_enums_local_services_lead_credit_state_proto = out.File
	file_enums_local_services_lead_credit_state_proto_rawDesc = nil
	file_enums_local_services_lead_credit_state_proto_goTypes = nil
	file_enums_local_services_lead_credit_state_proto_depIdxs = nil
}
