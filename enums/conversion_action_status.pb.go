...
func (ConversionActionStatusEnum_ConversionActionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_conversion_action_status_proto_enumTypes[0].Descriptor()
}

func (ConversionActionStatusEnum_ConversionActionStatus) Type() protoreflect.EnumType {
	return &file_enums_conversion_action_status_proto_enumTypes[0]
}
...
func (ConversionActionStatusEnum_ConversionActionStatus) EnumDescriptor() ([]byte, []int) {
	return file_enums_conversion_action_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionActionStatusEnum) Reset() {
	*x = ConversionActionStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_conversion_action_status_proto_msgTypes[0]
...
func (*ConversionActionStatusEnum) Descriptor() ([]byte, []int) {
	return file_enums_conversion_action_status_proto_rawDescGZIP(), []int{0}
}

var File_enums_conversion_action_status_proto protoreflect.FileDescriptor

var file_enums_conversion_action_status_proto_rawDesc = []byte{
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1b, 0x43,
	0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53,
...
var (
	file_enums_conversion_action_status_proto_rawDescOnce sync.Once
	file_enums_conversion_action_status_proto_rawDescData = file_enums_conversion_action_status_proto_rawDesc
)

func file_enums_conversion_action_status_proto_rawDescGZIP() []byte {
	file_enums_conversion_action_status_proto_rawDescOnce.Do(func() {
		file_enums_conversion_action_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_conversion_action_status_proto_rawDescData)
	})
	return file_enums_conversion_action_status_proto_rawDescData
}

var file_enums_conversion_action_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_conversion_action_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_conversion_action_status_proto_goTypes = []interface{}{
	(ConversionActionStatusEnum_ConversionActionStatus)(0), // 0: google.ads.googleads.v9.enums.ConversionActionStatusEnum.ConversionActionStatus
	(*ConversionActionStatusEnum)(nil),                     // 1: google.ads.googleads.v9.enums.ConversionActionStatusEnum
}
var file_enums_conversion_action_status_proto_depIdxs = []int32{
...
func init() { file_enums_conversion_action_status_proto_init() }
func file_enums_conversion_action_status_proto_init() {
	if File_enums_conversion_action_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_conversion_action_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_conversion_action_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_conversion_action_status_proto_goTypes,
		DependencyIndexes: file_enums_conversion_action_status_proto_depIdxs,
		EnumInfos:         file_enums_conversion_action_status_proto_enumTypes,
		MessageInfos:      file_enums_conversion_action_status_proto_msgTypes,
	}.Build()
	File_enums_conversion_action_status_proto = out.File
	file_enums_conversion_action_status_proto_rawDesc = nil
	file_enums_conversion_action_status_proto_goTypes = nil
	file_enums_conversion_action_status_proto_depIdxs = nil
}
