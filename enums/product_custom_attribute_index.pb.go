...
var file_enums_product_custom_attribute_index_proto_goTypes = []any{
...
func file_enums_product_custom_attribute_index_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_product_custom_attribute_index_proto_msgTypes[0].Exporter = func(v any, i int) any {
