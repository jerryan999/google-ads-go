...
type LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType int32

const (
	// Not specified.
	LocalServicesEmployeeTypeEnum_UNSPECIFIED LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType = 0
	// Used for return value only. Represents value unknown in this version.
	LocalServicesEmployeeTypeEnum_UNKNOWN LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType = 1
	// Represents the owner of the business.
	LocalServicesEmployeeTypeEnum_BUSINESS_OWNER LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType = 2
	// Represents an employee of the business.
	LocalServicesEmployeeTypeEnum_EMPLOYEE LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType = 3
)

// Enum value maps for LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType.
var (
	LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "UNKNOWN",
		2: "BUSINESS_OWNER",
		3: "EMPLOYEE",
	}
	LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType_value = map[string]int32{
		"UNSPECIFIED":    0,
		"UNKNOWN":        1,
		"BUSINESS_OWNER": 2,
		"EMPLOYEE":       3,
...
func (x LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType) Enum() *LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType {
	p := new(LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType)
	*p = x
	return p
}

func (x LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_local_services_employee_type_proto_enumTypes[0].Descriptor()
}

func (LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType) Type() protoreflect.EnumType {
	return &file_enums_local_services_employee_type_proto_enumTypes[0]
}
...
func (LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType) EnumDescriptor() ([]byte, []int) {
	return file_enums_local_services_employee_type_proto_rawDescGZIP(), []int{0, 0}
}

// Container for enum describing the types of local services employee.
type LocalServicesEmployeeTypeEnum struct {
...
func (x *LocalServicesEmployeeTypeEnum) Reset() {
	*x = LocalServicesEmployeeTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_local_services_employee_type_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LocalServicesEmployeeTypeEnum) String() string {
...
func (*LocalServicesEmployeeTypeEnum) Descriptor() ([]byte, []int) {
	return file_enums_local_services_employee_type_proto_rawDescGZIP(), []int{0}
}

var File_enums_local_services_employee_type_proto protoreflect.FileDescriptor

var file_enums_local_services_employee_type_proto_rawDesc = []byte{
	...
	0x12, 0x0a, 0x0e, 0x42, 0x55, 0x53, 0x49, 0x4e, 0x45, 0x53, 0x53, 0x5f, 0x4f, 0x57, 0x4e, 0x45,
...
var (
	file_enums_local_services_employee_type_proto_rawDescOnce sync.Once
	file_enums_local_services_employee_type_proto_rawDescData = file_enums_local_services_employee_type_proto_rawDesc
)

func file_enums_local_services_employee_type_proto_rawDescGZIP() []byte {
	file_enums_local_services_employee_type_proto_rawDescOnce.Do(func() {
		file_enums_local_services_employee_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_local_services_employee_type_proto_rawDescData)
	})
	return file_enums_local_services_employee_type_proto_rawDescData
}

var file_enums_local_services_employee_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_local_services_employee_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_local_services_employee_type_proto_goTypes = []any{
...
var file_enums_local_services_employee_type_proto_depIdxs = []int32{
...
func init() { file_enums_local_services_employee_type_proto_init() }
func file_enums_local_services_employee_type_proto_init() {
	if File_enums_local_services_employee_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_local_services_employee_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_local_services_employee_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_local_services_employee_type_proto_goTypes,
		DependencyIndexes: file_enums_local_services_employee_type_proto_depIdxs,
		EnumInfos:         file_enums_local_services_employee_type_proto_enumTypes,
		MessageInfos:      file_enums_local_services_employee_type_proto_msgTypes,
	}.Build()
	File_enums_local_services_employee_type_proto = out.File
	file_enums_local_services_employee_type_proto_rawDesc = nil
	file_enums_local_services_employee_type_proto_goTypes = nil
	file_enums_local_services_employee_type_proto_depIdxs = nil
}
