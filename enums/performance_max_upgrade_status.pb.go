...
var file_enums_performance_max_upgrade_status_proto_goTypes = []any{
...
func file_enums_performance_max_upgrade_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_performance_max_upgrade_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
