...
func (AffiliateLocationPlaceholderFieldEnum_AffiliateLocationPlaceholderField) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_affiliate_location_placeholder_field_proto_enumTypes[0].Descriptor()
}

func (AffiliateLocationPlaceholderFieldEnum_AffiliateLocationPlaceholderField) Type() protoreflect.EnumType {
	return &file_enums_affiliate_location_placeholder_field_proto_enumTypes[0]
}
...
func (AffiliateLocationPlaceholderFieldEnum_AffiliateLocationPlaceholderField) EnumDescriptor() ([]byte, []int) {
	return file_enums_affiliate_location_placeholder_field_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AffiliateLocationPlaceholderFieldEnum) Reset() {
	*x = AffiliateLocationPlaceholderFieldEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_affiliate_location_placeholder_field_proto_msgTypes[0]
...
func (*AffiliateLocationPlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return file_enums_affiliate_location_placeholder_field_proto_rawDescGZIP(), []int{0}
}

var File_enums_affiliate_location_placeholder_field_proto protoreflect.FileDescriptor

var file_enums_affiliate_location_placeholder_field_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xa4, 0x02, 0x0a, 0x25,
	...
	0x09, 0x12, 0x11, 0x0a, 0x0d, 0x4c, 0x41, 0x4e, 0x47, 0x55, 0x41, 0x47, 0x45, 0x5f, 0x43, 0x4f,
	0x44, 0x45, 0x10, 0x0a, 0x12, 0x0c, 0x0a, 0x08, 0x43, 0x48, 0x41, 0x49, 0x4e, 0x5f, 0x49, 0x44,
	...
	0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x26, 0x41, 0x66, 0x66, 0x69, 0x6c,
...
var (
	file_enums_affiliate_location_placeholder_field_proto_rawDescOnce sync.Once
	file_enums_affiliate_location_placeholder_field_proto_rawDescData = file_enums_affiliate_location_placeholder_field_proto_rawDesc
)

func file_enums_affiliate_location_placeholder_field_proto_rawDescGZIP() []byte {
	file_enums_affiliate_location_placeholder_field_proto_rawDescOnce.Do(func() {
		file_enums_affiliate_location_placeholder_field_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_affiliate_location_placeholder_field_proto_rawDescData)
	})
	return file_enums_affiliate_location_placeholder_field_proto_rawDescData
}

var file_enums_affiliate_location_placeholder_field_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_affiliate_location_placeholder_field_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_affiliate_location_placeholder_field_proto_goTypes = []interface{}{
	(AffiliateLocationPlaceholderFieldEnum_AffiliateLocationPlaceholderField)(0), // 0: google.ads.googleads.v15.enums.AffiliateLocationPlaceholderFieldEnum.AffiliateLocationPlaceholderField
	(*AffiliateLocationPlaceholderFieldEnum)(nil),                                // 1: google.ads.googleads.v15.enums.AffiliateLocationPlaceholderFieldEnum
}
var file_enums_affiliate_location_placeholder_field_proto_depIdxs = []int32{
...
func init() { file_enums_affiliate_location_placeholder_field_proto_init() }
func file_enums_affiliate_location_placeholder_field_proto_init() {
	if File_enums_affiliate_location_placeholder_field_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_affiliate_location_placeholder_field_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_affiliate_location_placeholder_field_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_affiliate_location_placeholder_field_proto_goTypes,
		DependencyIndexes: file_enums_affiliate_location_placeholder_field_proto_depIdxs,
		EnumInfos:         file_enums_affiliate_location_placeholder_field_proto_enumTypes,
		MessageInfos:      file_enums_affiliate_location_placeholder_field_proto_msgTypes,
	}.Build()
	File_enums_affiliate_location_placeholder_field_proto = out.File
	file_enums_affiliate_location_placeholder_field_proto_rawDesc = nil
	file_enums_affiliate_location_placeholder_field_proto_goTypes = nil
	file_enums_affiliate_location_placeholder_field_proto_depIdxs = nil
}
