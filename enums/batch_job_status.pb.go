...
func (BatchJobStatusEnum_BatchJobStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_batch_job_status_proto_enumTypes[0].Descriptor()
}

func (BatchJobStatusEnum_BatchJobStatus) Type() protoreflect.EnumType {
	return &file_enums_batch_job_status_proto_enumTypes[0]
}
...
func (BatchJobStatusEnum_BatchJobStatus) EnumDescriptor() ([]byte, []int) {
	return file_enums_batch_job_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BatchJobStatusEnum) Reset() {
	*x = BatchJobStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_batch_job_status_proto_msgTypes[0]
...
func (*BatchJobStatusEnum) Descriptor() ([]byte, []int) {
	return file_enums_batch_job_status_proto_rawDescGZIP(), []int{0}
}

var File_enums_batch_job_status_proto protoreflect.FileDescriptor

var file_enums_batch_job_status_proto_rawDesc = []byte{
	...
	0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6a, 0x6f, 0x62, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x68, 0x0a, 0x12, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4a, 0x6f, 0x62, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x52, 0x0a, 0x0e, 0x42, 0x61, 0x74,
	0x63, 0x68, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0f, 0x0a, 0x0b, 0x55,
	...
	0x47, 0x10, 0x03, 0x12, 0x08, 0x0a, 0x04, 0x44, 0x4f, 0x4e, 0x45, 0x10, 0x04, 0x42, 0xe8, 0x01,
	...
	0x75, 0x6d, 0x73, 0x42, 0x13, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4a, 0x6f, 0x62, 0x53, 0x74, 0x61,
...
var (
	file_enums_batch_job_status_proto_rawDescOnce sync.Once
	file_enums_batch_job_status_proto_rawDescData = file_enums_batch_job_status_proto_rawDesc
)

func file_enums_batch_job_status_proto_rawDescGZIP() []byte {
	file_enums_batch_job_status_proto_rawDescOnce.Do(func() {
		file_enums_batch_job_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_batch_job_status_proto_rawDescData)
	})
	return file_enums_batch_job_status_proto_rawDescData
}

var file_enums_batch_job_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_batch_job_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_batch_job_status_proto_goTypes = []interface{}{
	(BatchJobStatusEnum_BatchJobStatus)(0), // 0: google.ads.googleads.v9.enums.BatchJobStatusEnum.BatchJobStatus
	(*BatchJobStatusEnum)(nil),             // 1: google.ads.googleads.v9.enums.BatchJobStatusEnum
}
var file_enums_batch_job_status_proto_depIdxs = []int32{
...
func init() { file_enums_batch_job_status_proto_init() }
func file_enums_batch_job_status_proto_init() {
	if File_enums_batch_job_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_batch_job_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_batch_job_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_batch_job_status_proto_goTypes,
		DependencyIndexes: file_enums_batch_job_status_proto_depIdxs,
		EnumInfos:         file_enums_batch_job_status_proto_enumTypes,
		MessageInfos:      file_enums_batch_job_status_proto_msgTypes,
	}.Build()
	File_enums_batch_job_status_proto = out.File
	file_enums_batch_job_status_proto_rawDesc = nil
	file_enums_batch_job_status_proto_goTypes = nil
	file_enums_batch_job_status_proto_depIdxs = nil
}
