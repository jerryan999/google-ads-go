...
var file_enums_offline_user_data_job_match_rate_range_proto_goTypes = []any{
...
func file_enums_offline_user_data_job_match_rate_range_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_offline_user_data_job_match_rate_range_proto_msgTypes[0].Exporter = func(v any, i int) any {
