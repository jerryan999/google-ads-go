...
var file_enums_local_services_insurance_rejection_reason_proto_goTypes = []any{
...
func file_enums_local_services_insurance_rejection_reason_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_local_services_insurance_rejection_reason_proto_msgTypes[0].Exporter = func(v any, i int) any {
