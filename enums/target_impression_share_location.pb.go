...
var file_enums_target_impression_share_location_proto_goTypes = []any{
...
func file_enums_target_impression_share_location_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_target_impression_share_location_proto_msgTypes[0].Exporter = func(v any, i int) any {
