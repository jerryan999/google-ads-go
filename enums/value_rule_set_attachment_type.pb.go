...
var file_enums_value_rule_set_attachment_type_proto_goTypes = []any{
...
func file_enums_value_rule_set_attachment_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_value_rule_set_attachment_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
