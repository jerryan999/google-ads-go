...
var file_enums_asset_offline_evaluation_error_reasons_proto_goTypes = []any{
...
func file_enums_asset_offline_evaluation_error_reasons_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_asset_offline_evaluation_error_reasons_proto_msgTypes[0].Exporter = func(v any, i int) any {
