...
var file_enums_conversion_value_rule_primary_dimension_proto_goTypes = []any{
...
func file_enums_conversion_value_rule_primary_dimension_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_conversion_value_rule_primary_dimension_proto_msgTypes[0].Exporter = func(v any, i int) any {
