...
type LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType int32

const (
	// Not specified.
	LocalServicesBusinessRegistrationTypeEnum_UNSPECIFIED LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType = 0
	// Used for return value only. Represents value unknown in this version.
	LocalServicesBusinessRegistrationTypeEnum_UNKNOWN LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType = 1
	// Registration number check type.
	LocalServicesBusinessRegistrationTypeEnum_NUMBER LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType = 2
	// Registration document check type.
	LocalServicesBusinessRegistrationTypeEnum_DOCUMENT LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType = 3
)

// Enum value maps for LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType.
var (
	LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "UNKNOWN",
		2: "NUMBER",
		3: "DOCUMENT",
	}
	LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType_value = map[string]int32{
		"UNSPECIFIED": 0,
		"UNKNOWN":     1,
		"NUMBER":      2,
		"DOCUMENT":    3,
...
func (x LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType) Enum() *LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType {
	p := new(LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType)
	*p = x
	return p
}

func (x LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType) String() string {
...
func (LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_local_services_business_registration_type_proto_enumTypes[0].Descriptor()
}

func (LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType) Type() protoreflect.EnumType {
	return &file_enums_local_services_business_registration_type_proto_enumTypes[0]
}
...
func (LocalServicesBusinessRegistrationTypeEnum_LocalServicesBusinessRegistrationType) EnumDescriptor() ([]byte, []int) {
	return file_enums_local_services_business_registration_type_proto_rawDescGZIP(), []int{0, 0}
}

// Container for enum describing the type of business registration check
// verification artifact.
type LocalServicesBusinessRegistrationTypeEnum struct {
...
func (x *LocalServicesBusinessRegistrationTypeEnum) Reset() {
	*x = LocalServicesBusinessRegistrationTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_local_services_business_registration_type_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *LocalServicesBusinessRegistrationTypeEnum) String() string {
...
func (*LocalServicesBusinessRegistrationTypeEnum) Descriptor() ([]byte, []int) {
	return file_enums_local_services_business_registration_type_proto_rawDescGZIP(), []int{0}
}

var File_enums_local_services_business_registration_type_proto protoreflect.FileDescriptor

var file_enums_local_services_business_registration_type_proto_rawDesc = []byte{
	...
	0x0a, 0x25, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42,
	0x75, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74,
...
var (
	file_enums_local_services_business_registration_type_proto_rawDescOnce sync.Once
	file_enums_local_services_business_registration_type_proto_rawDescData = file_enums_local_services_business_registration_type_proto_rawDesc
)

func file_enums_local_services_business_registration_type_proto_rawDescGZIP() []byte {
	file_enums_local_services_business_registration_type_proto_rawDescOnce.Do(func() {
		file_enums_local_services_business_registration_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_local_services_business_registration_type_proto_rawDescData)
	})
	return file_enums_local_services_business_registration_type_proto_rawDescData
}

var file_enums_local_services_business_registration_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_local_services_business_registration_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_local_services_business_registration_type_proto_goTypes = []any{
...
var file_enums_local_services_business_registration_type_proto_depIdxs = []int32{
...
func init() {
	file_enums_local_services_business_registration_type_proto_init()
}
func file_enums_local_services_business_registration_type_proto_init() {
	if File_enums_local_services_business_registration_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_local_services_business_registration_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_local_services_business_registration_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_local_services_business_registration_type_proto_goTypes,
		DependencyIndexes: file_enums_local_services_business_registration_type_proto_depIdxs,
		EnumInfos:         file_enums_local_services_business_registration_type_proto_enumTypes,
		MessageInfos:      file_enums_local_services_business_registration_type_proto_msgTypes,
	}.Build()
	File_enums_local_services_business_registration_type_proto = out.File
	file_enums_local_services_business_registration_type_proto_rawDesc = nil
	file_enums_local_services_business_registration_type_proto_goTypes = nil
	file_enums_local_services_business_registration_type_proto_depIdxs = nil
}
