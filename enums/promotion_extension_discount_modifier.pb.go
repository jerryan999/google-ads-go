...
var file_enums_promotion_extension_discount_modifier_proto_goTypes = []any{
...
func file_enums_promotion_extension_discount_modifier_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_promotion_extension_discount_modifier_proto_msgTypes[0].Exporter = func(v any, i int) any {
