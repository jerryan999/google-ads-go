...
func (x ImagePlaceholderFieldEnum_ImagePlaceholderField) Enum() *ImagePlaceholderFieldEnum_ImagePlaceholderField {
	p := new(ImagePlaceholderFieldEnum_ImagePlaceholderField)
	*p = x
	return p
}

func (x ImagePlaceholderFieldEnum_ImagePlaceholderField) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ImagePlaceholderFieldEnum_ImagePlaceholderField) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_image_placeholder_field_proto_enumTypes[0].Descriptor()
}

func (ImagePlaceholderFieldEnum_ImagePlaceholderField) Type() protoreflect.EnumType {
	return &file_enums_image_placeholder_field_proto_enumTypes[0]
}
...
func (ImagePlaceholderFieldEnum_ImagePlaceholderField) EnumDescriptor() ([]byte, []int) {
	return file_enums_image_placeholder_field_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ImagePlaceholderFieldEnum) Reset() {
	*x = ImagePlaceholderFieldEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_image_placeholder_field_proto_msgTypes[0]
...
func (*ImagePlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return file_enums_image_placeholder_field_proto_rawDescGZIP(), []int{0}
}

var File_enums_image_placeholder_field_proto protoreflect.FileDescriptor

var file_enums_image_placeholder_field_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f, 0x6c, 0x64, 0x65,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x60, 0x0a, 0x19, 0x49, 0x6d,
	0x61, 0x67, 0x65, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x46, 0x69,
	0x65, 0x6c, 0x64, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x43, 0x0a, 0x15, 0x49, 0x6d, 0x61, 0x67, 0x65,
	...
	0x0a, 0x08, 0x41, 0x53, 0x53, 0x45, 0x54, 0x5f, 0x49, 0x44, 0x10, 0x02, 0x42, 0xef, 0x01, 0x0a,
	...
	0x6d, 0x73, 0x42, 0x1a, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f,
...
var (
	file_enums_image_placeholder_field_proto_rawDescOnce sync.Once
	file_enums_image_placeholder_field_proto_rawDescData = file_enums_image_placeholder_field_proto_rawDesc
)

func file_enums_image_placeholder_field_proto_rawDescGZIP() []byte {
	file_enums_image_placeholder_field_proto_rawDescOnce.Do(func() {
		file_enums_image_placeholder_field_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_image_placeholder_field_proto_rawDescData)
	})
	return file_enums_image_placeholder_field_proto_rawDescData
}

var file_enums_image_placeholder_field_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_image_placeholder_field_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_image_placeholder_field_proto_goTypes = []interface{}{
	(ImagePlaceholderFieldEnum_ImagePlaceholderField)(0), // 0: google.ads.googleads.v9.enums.ImagePlaceholderFieldEnum.ImagePlaceholderField
	(*ImagePlaceholderFieldEnum)(nil),                    // 1: google.ads.googleads.v9.enums.ImagePlaceholderFieldEnum
}
var file_enums_image_placeholder_field_proto_depIdxs = []int32{
...
func init() { file_enums_image_placeholder_field_proto_init() }
func file_enums_image_placeholder_field_proto_init() {
	if File_enums_image_placeholder_field_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_image_placeholder_field_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_image_placeholder_field_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_image_placeholder_field_proto_goTypes,
		DependencyIndexes: file_enums_image_placeholder_field_proto_depIdxs,
		EnumInfos:         file_enums_image_placeholder_field_proto_enumTypes,
		MessageInfos:      file_enums_image_placeholder_field_proto_msgTypes,
	}.Build()
	File_enums_image_placeholder_field_proto = out.File
	file_enums_image_placeholder_field_proto_rawDesc = nil
	file_enums_image_placeholder_field_proto_goTypes = nil
	file_enums_image_placeholder_field_proto_depIdxs = nil
}
