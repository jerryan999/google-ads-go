...
func (x MatchingFunctionContextTypeEnum_MatchingFunctionContextType) Enum() *MatchingFunctionContextTypeEnum_MatchingFunctionContextType {
	p := new(MatchingFunctionContextTypeEnum_MatchingFunctionContextType)
	*p = x
	return p
}
...
func (MatchingFunctionContextTypeEnum_MatchingFunctionContextType) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_matching_function_context_type_proto_enumTypes[0].Descriptor()
}

func (MatchingFunctionContextTypeEnum_MatchingFunctionContextType) Type() protoreflect.EnumType {
	return &file_enums_matching_function_context_type_proto_enumTypes[0]
}
...
func (MatchingFunctionContextTypeEnum_MatchingFunctionContextType) EnumDescriptor() ([]byte, []int) {
	return file_enums_matching_function_context_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *MatchingFunctionContextTypeEnum) Reset() {
	*x = MatchingFunctionContextTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_matching_function_context_type_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MatchingFunctionContextTypeEnum) String() string {
...
func (*MatchingFunctionContextTypeEnum) Descriptor() ([]byte, []int) {
	return file_enums_matching_function_context_type_proto_rawDescGZIP(), []int{0}
}

var File_enums_matching_function_context_type_proto protoreflect.FileDescriptor

var file_enums_matching_function_context_type_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70,
	...
	0x6f, 0x22, 0x97, 0x01, 0x0a, 0x1f, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x46, 0x75,
	0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x54, 0x79, 0x70,
	0x65, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x74, 0x0a, 0x1b, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e,
	0x67, 0x46, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74,
	...
	0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x46, 0x45, 0x45, 0x44, 0x5f, 0x49, 0x54, 0x45, 0x4d, 0x5f,
	0x49, 0x44, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x44, 0x45, 0x56, 0x49, 0x43, 0x45, 0x5f, 0x4e,
	0x41, 0x4d, 0x45, 0x10, 0x03, 0x12, 0x14, 0x0a, 0x10, 0x46, 0x45, 0x45, 0x44, 0x5f, 0x49, 0x54,
	0x45, 0x4d, 0x5f, 0x53, 0x45, 0x54, 0x5f, 0x49, 0x44, 0x10, 0x04, 0x42, 0xf5, 0x01, 0x0a, 0x21,
	...
	0x73, 0x42, 0x20, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x46, 0x75, 0x6e, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x54, 0x79, 0x70, 0x65, 0x50, 0x72,
...
var (
	file_enums_matching_function_context_type_proto_rawDescOnce sync.Once
	file_enums_matching_function_context_type_proto_rawDescData = file_enums_matching_function_context_type_proto_rawDesc
)

func file_enums_matching_function_context_type_proto_rawDescGZIP() []byte {
	file_enums_matching_function_context_type_proto_rawDescOnce.Do(func() {
		file_enums_matching_function_context_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_matching_function_context_type_proto_rawDescData)
	})
	return file_enums_matching_function_context_type_proto_rawDescData
}

var file_enums_matching_function_context_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_matching_function_context_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_matching_function_context_type_proto_goTypes = []interface{}{
	(MatchingFunctionContextTypeEnum_MatchingFunctionContextType)(0), // 0: google.ads.googleads.v9.enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType
	(*MatchingFunctionContextTypeEnum)(nil),                          // 1: google.ads.googleads.v9.enums.MatchingFunctionContextTypeEnum
}
var file_enums_matching_function_context_type_proto_depIdxs = []int32{
...
func init() { file_enums_matching_function_context_type_proto_init() }
func file_enums_matching_function_context_type_proto_init() {
	if File_enums_matching_function_context_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_matching_function_context_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_matching_function_context_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_matching_function_context_type_proto_goTypes,
		DependencyIndexes: file_enums_matching_function_context_type_proto_depIdxs,
		EnumInfos:         file_enums_matching_function_context_type_proto_enumTypes,
		MessageInfos:      file_enums_matching_function_context_type_proto_msgTypes,
	}.Build()
	File_enums_matching_function_context_type_proto = out.File
	file_enums_matching_function_context_type_proto_rawDesc = nil
	file_enums_matching_function_context_type_proto_goTypes = nil
	file_enums_matching_function_context_type_proto_depIdxs = nil
}
