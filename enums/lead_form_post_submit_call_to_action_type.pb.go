...
var file_enums_lead_form_post_submit_call_to_action_type_proto_goTypes = []any{
...
func file_enums_lead_form_post_submit_call_to_action_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_lead_form_post_submit_call_to_action_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
