...
var file_enums_user_list_number_rule_item_operator_proto_goTypes = []any{
...
func file_enums_user_list_number_rule_item_operator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_user_list_number_rule_item_operator_proto_msgTypes[0].Exporter = func(v any, i int) any {
