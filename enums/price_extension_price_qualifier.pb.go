...
var file_enums_price_extension_price_qualifier_proto_goTypes = []any{
...
func file_enums_price_extension_price_qualifier_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_price_extension_price_qualifier_proto_msgTypes[0].Exporter = func(v any, i int) any {
