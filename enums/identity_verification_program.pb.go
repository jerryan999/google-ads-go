...
type IdentityVerificationProgramEnum_IdentityVerificationProgram int32

const (
	// Not specified.
	IdentityVerificationProgramEnum_UNSPECIFIED IdentityVerificationProgramEnum_IdentityVerificationProgram = 0
	// The value is unknown in this version.
	IdentityVerificationProgramEnum_UNKNOWN IdentityVerificationProgramEnum_IdentityVerificationProgram = 1
	// Advertiser submits documents to verify their identity.
	IdentityVerificationProgramEnum_ADVERTISER_IDENTITY_VERIFICATION IdentityVerificationProgramEnum_IdentityVerificationProgram = 2
)

// Enum value maps for IdentityVerificationProgramEnum_IdentityVerificationProgram.
var (
	IdentityVerificationProgramEnum_IdentityVerificationProgram_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "UNKNOWN",
		2: "ADVERTISER_IDENTITY_VERIFICATION",
	}
	IdentityVerificationProgramEnum_IdentityVerificationProgram_value = map[string]int32{
		"UNSPECIFIED":                      0,
		"UNKNOWN":                          1,
...
func (x IdentityVerificationProgramEnum_IdentityVerificationProgram) Enum() *IdentityVerificationProgramEnum_IdentityVerificationProgram {
	p := new(IdentityVerificationProgramEnum_IdentityVerificationProgram)
	*p = x
	return p
}

func (x IdentityVerificationProgramEnum_IdentityVerificationProgram) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (IdentityVerificationProgramEnum_IdentityVerificationProgram) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_identity_verification_program_proto_enumTypes[0].Descriptor()
}

func (IdentityVerificationProgramEnum_IdentityVerificationProgram) Type() protoreflect.EnumType {
	return &file_enums_identity_verification_program_proto_enumTypes[0]
}
...
func (IdentityVerificationProgramEnum_IdentityVerificationProgram) EnumDescriptor() ([]byte, []int) {
	return file_enums_identity_verification_program_proto_rawDescGZIP(), []int{0, 0}
}

// Container for IdentityVerificationProgram.
type IdentityVerificationProgramEnum struct {
...
func (x *IdentityVerificationProgramEnum) Reset() {
	*x = IdentityVerificationProgramEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_identity_verification_program_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *IdentityVerificationProgramEnum) String() string {
...
func (*IdentityVerificationProgramEnum) Descriptor() ([]byte, []int) {
	return file_enums_identity_verification_program_proto_rawDescGZIP(), []int{0}
}

var File_enums_identity_verification_program_proto protoreflect.FileDescriptor

var file_enums_identity_verification_program_proto_rawDesc = []byte{
	...
	0x50, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e, 0x53, 0x50, 0x45,
	0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e,
	0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x24, 0x0a, 0x20, 0x41, 0x44, 0x56, 0x45, 0x52, 0x54, 0x49,
...
var (
	file_enums_identity_verification_program_proto_rawDescOnce sync.Once
	file_enums_identity_verification_program_proto_rawDescData = file_enums_identity_verification_program_proto_rawDesc
)

func file_enums_identity_verification_program_proto_rawDescGZIP() []byte {
	file_enums_identity_verification_program_proto_rawDescOnce.Do(func() {
		file_enums_identity_verification_program_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_identity_verification_program_proto_rawDescData)
	})
	return file_enums_identity_verification_program_proto_rawDescData
}

var file_enums_identity_verification_program_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_identity_verification_program_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_identity_verification_program_proto_goTypes = []any{
...
var file_enums_identity_verification_program_proto_depIdxs = []int32{
...
func init() { file_enums_identity_verification_program_proto_init() }
func file_enums_identity_verification_program_proto_init() {
	if File_enums_identity_verification_program_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_identity_verification_program_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_identity_verification_program_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_identity_verification_program_proto_goTypes,
		DependencyIndexes: file_enums_identity_verification_program_proto_depIdxs,
		EnumInfos:         file_enums_identity_verification_program_proto_enumTypes,
		MessageInfos:      file_enums_identity_verification_program_proto_msgTypes,
	}.Build()
	File_enums_identity_verification_program_proto = out.File
	file_enums_identity_verification_program_proto_rawDesc = nil
	file_enums_identity_verification_program_proto_goTypes = nil
	file_enums_identity_verification_program_proto_depIdxs = nil
}
