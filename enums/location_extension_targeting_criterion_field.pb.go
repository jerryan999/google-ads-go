...
var file_enums_location_extension_targeting_criterion_field_proto_goTypes = []any{
...
func file_enums_location_extension_targeting_criterion_field_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_location_extension_targeting_criterion_field_proto_msgTypes[0].Exporter = func(v any, i int) any {
