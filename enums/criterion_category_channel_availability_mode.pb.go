...
// 	protoc        v4.23.4
// source: google/ads/googleads/v15/enums/criterion_category_channel_availability_mode.proto
...
func (CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_criterion_category_channel_availability_mode_proto_enumTypes[0].Descriptor()
}

func (CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode) Type() protoreflect.EnumType {
	return &file_enums_criterion_category_channel_availability_mode_proto_enumTypes[0]
}
...
func (CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode) EnumDescriptor() ([]byte, []int) {
	return file_enums_criterion_category_channel_availability_mode_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CriterionCategoryChannelAvailabilityModeEnum) Reset() {
	*x = CriterionCategoryChannelAvailabilityModeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_criterion_category_channel_availability_mode_proto_msgTypes[0]
...
func (*CriterionCategoryChannelAvailabilityModeEnum) Descriptor() ([]byte, []int) {
	return file_enums_criterion_category_channel_availability_mode_proto_rawDescGZIP(), []int{0}
}

var File_enums_criterion_category_channel_availability_mode_proto protoreflect.FileDescriptor

var file_enums_criterion_category_channel_availability_mode_proto_rawDesc = []byte{
	...
	0x45, 0x6e, 0x75, 0x6d, 0x22, 0xa3, 0x01, 0x0a, 0x28, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69,
	...
	0x10, 0x0a, 0x0c, 0x41, 0x4c, 0x4c, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x53, 0x10,
	0x02, 0x12, 0x21, 0x0a, 0x1d, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x5f, 0x54, 0x59, 0x50,
	0x45, 0x5f, 0x41, 0x4e, 0x44, 0x5f, 0x41, 0x4c, 0x4c, 0x5f, 0x53, 0x55, 0x42, 0x54, 0x59, 0x50,
	0x45, 0x53, 0x10, 0x03, 0x12, 0x24, 0x0a, 0x20, 0x43, 0x48, 0x41, 0x4e, 0x4e, 0x45, 0x4c, 0x5f,
	...
	0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x31, 0x35, 0x2e, 0x45, 0x6e, 0x75, 0x6d, 0x73, 0xca, 0x02,
	0x1e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x31, 0x35, 0x5c, 0x45, 0x6e, 0x75, 0x6d, 0x73, 0xea,
...
var (
	file_enums_criterion_category_channel_availability_mode_proto_rawDescOnce sync.Once
	file_enums_criterion_category_channel_availability_mode_proto_rawDescData = file_enums_criterion_category_channel_availability_mode_proto_rawDesc
)

func file_enums_criterion_category_channel_availability_mode_proto_rawDescGZIP() []byte {
	file_enums_criterion_category_channel_availability_mode_proto_rawDescOnce.Do(func() {
		file_enums_criterion_category_channel_availability_mode_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_criterion_category_channel_availability_mode_proto_rawDescData)
	})
	return file_enums_criterion_category_channel_availability_mode_proto_rawDescData
}

var file_enums_criterion_category_channel_availability_mode_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_criterion_category_channel_availability_mode_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_criterion_category_channel_availability_mode_proto_goTypes = []interface{}{
	(CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode)(0), // 0: google.ads.googleads.v15.enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode
	(*CriterionCategoryChannelAvailabilityModeEnum)(nil),                                       // 1: google.ads.googleads.v15.enums.CriterionCategoryChannelAvailabilityModeEnum
}
var file_enums_criterion_category_channel_availability_mode_proto_depIdxs = []int32{
...
func init() {
	file_enums_criterion_category_channel_availability_mode_proto_init()
}
func file_enums_criterion_category_channel_availability_mode_proto_init() {
	if File_enums_criterion_category_channel_availability_mode_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_criterion_category_channel_availability_mode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_criterion_category_channel_availability_mode_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_criterion_category_channel_availability_mode_proto_goTypes,
		DependencyIndexes: file_enums_criterion_category_channel_availability_mode_proto_depIdxs,
		EnumInfos:         file_enums_criterion_category_channel_availability_mode_proto_enumTypes,
		MessageInfos:      file_enums_criterion_category_channel_availability_mode_proto_msgTypes,
	}.Build()
	File_enums_criterion_category_channel_availability_mode_proto = out.File
	file_enums_criterion_category_channel_availability_mode_proto_rawDesc = nil
	file_enums_criterion_category_channel_availability_mode_proto_goTypes = nil
	file_enums_criterion_category_channel_availability_mode_proto_depIdxs = nil
}
