...
var file_enums_criterion_category_channel_availability_mode_proto_goTypes = []any{
...
func file_enums_criterion_category_channel_availability_mode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_criterion_category_channel_availability_mode_proto_msgTypes[0].Exporter = func(v any, i int) any {
