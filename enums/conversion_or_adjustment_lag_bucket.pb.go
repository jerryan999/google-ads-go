...
func (ConversionOrAdjustmentLagBucketEnum_ConversionOrAdjustmentLagBucket) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_conversion_or_adjustment_lag_bucket_proto_enumTypes[0].Descriptor()
}

func (ConversionOrAdjustmentLagBucketEnum_ConversionOrAdjustmentLagBucket) Type() protoreflect.EnumType {
	return &file_enums_conversion_or_adjustment_lag_bucket_proto_enumTypes[0]
}
...
func (ConversionOrAdjustmentLagBucketEnum_ConversionOrAdjustmentLagBucket) EnumDescriptor() ([]byte, []int) {
	return file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionOrAdjustmentLagBucketEnum) Reset() {
	*x = ConversionOrAdjustmentLagBucketEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_conversion_or_adjustment_lag_bucket_proto_msgTypes[0]
...
func (*ConversionOrAdjustmentLagBucketEnum) Descriptor() ([]byte, []int) {
	return file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescGZIP(), []int{0}
}

var File_enums_conversion_or_adjustment_lag_bucket_proto protoreflect.FileDescriptor

var file_enums_conversion_or_adjustment_lag_bucket_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xcb, 0x0c, 0x0a, 0x23, 0x43,
...
var (
	file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescOnce sync.Once
	file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescData = file_enums_conversion_or_adjustment_lag_bucket_proto_rawDesc
)

func file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescGZIP() []byte {
	file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescOnce.Do(func() {
		file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescData)
	})
	return file_enums_conversion_or_adjustment_lag_bucket_proto_rawDescData
}

var file_enums_conversion_or_adjustment_lag_bucket_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_conversion_or_adjustment_lag_bucket_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_conversion_or_adjustment_lag_bucket_proto_goTypes = []interface{}{
	(ConversionOrAdjustmentLagBucketEnum_ConversionOrAdjustmentLagBucket)(0), // 0: google.ads.googleads.v15.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket
	(*ConversionOrAdjustmentLagBucketEnum)(nil),                              // 1: google.ads.googleads.v15.enums.ConversionOrAdjustmentLagBucketEnum
}
var file_enums_conversion_or_adjustment_lag_bucket_proto_depIdxs = []int32{
...
func init() { file_enums_conversion_or_adjustment_lag_bucket_proto_init() }
func file_enums_conversion_or_adjustment_lag_bucket_proto_init() {
	if File_enums_conversion_or_adjustment_lag_bucket_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_conversion_or_adjustment_lag_bucket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_conversion_or_adjustment_lag_bucket_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_conversion_or_adjustment_lag_bucket_proto_goTypes,
		DependencyIndexes: file_enums_conversion_or_adjustment_lag_bucket_proto_depIdxs,
		EnumInfos:         file_enums_conversion_or_adjustment_lag_bucket_proto_enumTypes,
		MessageInfos:      file_enums_conversion_or_adjustment_lag_bucket_proto_msgTypes,
	}.Build()
	File_enums_conversion_or_adjustment_lag_bucket_proto = out.File
	file_enums_conversion_or_adjustment_lag_bucket_proto_rawDesc = nil
	file_enums_conversion_or_adjustment_lag_bucket_proto_goTypes = nil
	file_enums_conversion_or_adjustment_lag_bucket_proto_depIdxs = nil
}
