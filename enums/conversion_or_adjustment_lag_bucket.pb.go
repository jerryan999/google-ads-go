...
var file_enums_conversion_or_adjustment_lag_bucket_proto_goTypes = []any{
...
func file_enums_conversion_or_adjustment_lag_bucket_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_conversion_or_adjustment_lag_bucket_proto_msgTypes[0].Exporter = func(v any, i int) any {
