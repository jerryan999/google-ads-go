...
var file_enums_target_cpa_opt_in_recommendation_goal_proto_goTypes = []any{
...
func file_enums_target_cpa_opt_in_recommendation_goal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_target_cpa_opt_in_recommendation_goal_proto_msgTypes[0].Exporter = func(v any, i int) any {
