...
func (x FeedItemSetStatusEnum_FeedItemSetStatus) Enum() *FeedItemSetStatusEnum_FeedItemSetStatus {
	p := new(FeedItemSetStatusEnum_FeedItemSetStatus)
	*p = x
	return p
}

func (x FeedItemSetStatusEnum_FeedItemSetStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FeedItemSetStatusEnum_FeedItemSetStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_feed_item_set_status_proto_enumTypes[0].Descriptor()
}

func (FeedItemSetStatusEnum_FeedItemSetStatus) Type() protoreflect.EnumType {
	return &file_enums_feed_item_set_status_proto_enumTypes[0]
}
...
func (FeedItemSetStatusEnum_FeedItemSetStatus) EnumDescriptor() ([]byte, []int) {
	return file_enums_feed_item_set_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FeedItemSetStatusEnum) Reset() {
	*x = FeedItemSetStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_feed_item_set_status_proto_msgTypes[0]
...
func (*FeedItemSetStatusEnum) Descriptor() ([]byte, []int) {
	return file_enums_feed_item_set_status_proto_rawDescGZIP(), []int{0}
}

var File_enums_feed_item_set_status_proto protoreflect.FileDescriptor

var file_enums_feed_item_set_status_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x64, 0x0a, 0x15, 0x46, 0x65, 0x65, 0x64, 0x49,
	0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d,
	0x22, 0x4b, 0x0a, 0x11, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x53,
	...
	0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x03, 0x42, 0xeb, 0x01,
	...
	0x75, 0x6d, 0x73, 0x42, 0x16, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74,
...
var (
	file_enums_feed_item_set_status_proto_rawDescOnce sync.Once
	file_enums_feed_item_set_status_proto_rawDescData = file_enums_feed_item_set_status_proto_rawDesc
)

func file_enums_feed_item_set_status_proto_rawDescGZIP() []byte {
	file_enums_feed_item_set_status_proto_rawDescOnce.Do(func() {
		file_enums_feed_item_set_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_feed_item_set_status_proto_rawDescData)
	})
	return file_enums_feed_item_set_status_proto_rawDescData
}

var file_enums_feed_item_set_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_feed_item_set_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_feed_item_set_status_proto_goTypes = []interface{}{
	(FeedItemSetStatusEnum_FeedItemSetStatus)(0), // 0: google.ads.googleads.v9.enums.FeedItemSetStatusEnum.FeedItemSetStatus
	(*FeedItemSetStatusEnum)(nil),                // 1: google.ads.googleads.v9.enums.FeedItemSetStatusEnum
}
var file_enums_feed_item_set_status_proto_depIdxs = []int32{
...
func init() { file_enums_feed_item_set_status_proto_init() }
func file_enums_feed_item_set_status_proto_init() {
	if File_enums_feed_item_set_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_feed_item_set_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_feed_item_set_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_feed_item_set_status_proto_goTypes,
		DependencyIndexes: file_enums_feed_item_set_status_proto_depIdxs,
		EnumInfos:         file_enums_feed_item_set_status_proto_enumTypes,
		MessageInfos:      file_enums_feed_item_set_status_proto_msgTypes,
	}.Build()
	File_enums_feed_item_set_status_proto = out.File
	file_enums_feed_item_set_status_proto_rawDesc = nil
	file_enums_feed_item_set_status_proto_goTypes = nil
	file_enums_feed_item_set_status_proto_depIdxs = nil
}
