...
func (OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_offline_user_data_job_status_proto_enumTypes[0].Descriptor()
}

func (OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus) Type() protoreflect.EnumType {
	return &file_enums_offline_user_data_job_status_proto_enumTypes[0]
}
...
func (OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus) EnumDescriptor() ([]byte, []int) {
	return file_enums_offline_user_data_job_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *OfflineUserDataJobStatusEnum) Reset() {
	*x = OfflineUserDataJobStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_offline_user_data_job_status_proto_msgTypes[0]
...
func (*OfflineUserDataJobStatusEnum) Descriptor() ([]byte, []int) {
	return file_enums_offline_user_data_job_status_proto_rawDescGZIP(), []int{0}
}

var File_enums_offline_user_data_job_status_proto protoreflect.FileDescriptor

var file_enums_offline_user_data_job_status_proto_rawDesc = []byte{
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1d, 0x4f, 0x66, 0x66, 0x6c, 0x69, 0x6e,
...
var (
	file_enums_offline_user_data_job_status_proto_rawDescOnce sync.Once
	file_enums_offline_user_data_job_status_proto_rawDescData = file_enums_offline_user_data_job_status_proto_rawDesc
)

func file_enums_offline_user_data_job_status_proto_rawDescGZIP() []byte {
	file_enums_offline_user_data_job_status_proto_rawDescOnce.Do(func() {
		file_enums_offline_user_data_job_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_offline_user_data_job_status_proto_rawDescData)
	})
	return file_enums_offline_user_data_job_status_proto_rawDescData
}

var file_enums_offline_user_data_job_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_offline_user_data_job_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_offline_user_data_job_status_proto_goTypes = []interface{}{
	(OfflineUserDataJobStatusEnum_OfflineUserDataJobStatus)(0), // 0: google.ads.googleads.v15.enums.OfflineUserDataJobStatusEnum.OfflineUserDataJobStatus
	(*OfflineUserDataJobStatusEnum)(nil),                       // 1: google.ads.googleads.v15.enums.OfflineUserDataJobStatusEnum
}
var file_enums_offline_user_data_job_status_proto_depIdxs = []int32{
...
func init() { file_enums_offline_user_data_job_status_proto_init() }
func file_enums_offline_user_data_job_status_proto_init() {
	if File_enums_offline_user_data_job_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_offline_user_data_job_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_offline_user_data_job_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_offline_user_data_job_status_proto_goTypes,
		DependencyIndexes: file_enums_offline_user_data_job_status_proto_depIdxs,
		EnumInfos:         file_enums_offline_user_data_job_status_proto_enumTypes,
		MessageInfos:      file_enums_offline_user_data_job_status_proto_msgTypes,
	}.Build()
	File_enums_offline_user_data_job_status_proto = out.File
	file_enums_offline_user_data_job_status_proto_rawDesc = nil
	file_enums_offline_user_data_job_status_proto_goTypes = nil
	file_enums_offline_user_data_job_status_proto_depIdxs = nil
}
