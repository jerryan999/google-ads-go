...
func (x ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus) Enum() *ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus {
	p := new(ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus)
	*p = x
	return p
}

func (x ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_conversion_value_rule_set_status_proto_enumTypes[0].Descriptor()
}

func (ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus) Type() protoreflect.EnumType {
	return &file_enums_conversion_value_rule_set_status_proto_enumTypes[0]
}
...
func (ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus) EnumDescriptor() ([]byte, []int) {
	return file_enums_conversion_value_rule_set_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionValueRuleSetStatusEnum) Reset() {
	*x = ConversionValueRuleSetStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_conversion_value_rule_set_status_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ConversionValueRuleSetStatusEnum) String() string {
...
func (*ConversionValueRuleSetStatusEnum) Descriptor() ([]byte, []int) {
	return file_enums_conversion_value_rule_set_status_proto_rawDescGZIP(), []int{0}
}

var File_enums_conversion_value_rule_set_status_proto protoreflect.FileDescriptor

var file_enums_conversion_value_rule_set_status_proto_rawDesc = []byte{
	...
	0x5f, 0x72, 0x75, 0x6c, 0x65, 0x5f, 0x73, 0x65, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x6f, 0x74, 0x6f, 0x22, 0x86, 0x01, 0x0a, 0x20, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x75, 0x6c, 0x65, 0x53, 0x65, 0x74, 0x53, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x62, 0x0a, 0x1c, 0x43, 0x6f, 0x6e, 0x76,
	...
	0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x0b, 0x0a, 0x07, 0x45, 0x4e, 0x41, 0x42, 0x4c, 0x45,
	0x44, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x45, 0x4d, 0x4f, 0x56, 0x45, 0x44, 0x10, 0x03,
	0x12, 0x0a, 0x0a, 0x06, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x04, 0x42, 0xf6, 0x01, 0x0a,
	...
	0x6d, 0x73, 0x42, 0x21, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x52, 0x75, 0x6c, 0x65, 0x53, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
...
var (
	file_enums_conversion_value_rule_set_status_proto_rawDescOnce sync.Once
	file_enums_conversion_value_rule_set_status_proto_rawDescData = file_enums_conversion_value_rule_set_status_proto_rawDesc
)

func file_enums_conversion_value_rule_set_status_proto_rawDescGZIP() []byte {
	file_enums_conversion_value_rule_set_status_proto_rawDescOnce.Do(func() {
		file_enums_conversion_value_rule_set_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_conversion_value_rule_set_status_proto_rawDescData)
	})
	return file_enums_conversion_value_rule_set_status_proto_rawDescData
}

var file_enums_conversion_value_rule_set_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_conversion_value_rule_set_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_conversion_value_rule_set_status_proto_goTypes = []interface{}{
	(ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus)(0), // 0: google.ads.googleads.v9.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus
	(*ConversionValueRuleSetStatusEnum)(nil),                           // 1: google.ads.googleads.v9.enums.ConversionValueRuleSetStatusEnum
}
var file_enums_conversion_value_rule_set_status_proto_depIdxs = []int32{
...
func init() { file_enums_conversion_value_rule_set_status_proto_init() }
func file_enums_conversion_value_rule_set_status_proto_init() {
	if File_enums_conversion_value_rule_set_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_conversion_value_rule_set_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_conversion_value_rule_set_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_conversion_value_rule_set_status_proto_goTypes,
		DependencyIndexes: file_enums_conversion_value_rule_set_status_proto_depIdxs,
		EnumInfos:         file_enums_conversion_value_rule_set_status_proto_enumTypes,
		MessageInfos:      file_enums_conversion_value_rule_set_status_proto_msgTypes,
	}.Build()
	File_enums_conversion_value_rule_set_status_proto = out.File
	file_enums_conversion_value_rule_set_status_proto_rawDesc = nil
	file_enums_conversion_value_rule_set_status_proto_goTypes = nil
	file_enums_conversion_value_rule_set_status_proto_depIdxs = nil
}
