...
func (LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_legacy_app_install_ad_app_store_proto_enumTypes[0].Descriptor()
}

func (LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore) Type() protoreflect.EnumType {
	return &file_enums_legacy_app_install_ad_app_store_proto_enumTypes[0]
}
...
func (LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore) EnumDescriptor() ([]byte, []int) {
	return file_enums_legacy_app_install_ad_app_store_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *LegacyAppInstallAdAppStoreEnum) Reset() {
	*x = LegacyAppInstallAdAppStoreEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_legacy_app_install_ad_app_store_proto_msgTypes[0]
...
func (*LegacyAppInstallAdAppStoreEnum) Descriptor() ([]byte, []int) {
	return file_enums_legacy_app_install_ad_app_store_proto_rawDescGZIP(), []int{0}
}

var File_enums_legacy_app_install_ad_app_store_proto protoreflect.FileDescriptor

var file_enums_legacy_app_install_ad_app_store_proto_rawDesc = []byte{
	...
	0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x41, 0x50, 0x50, 0x4c, 0x45, 0x5f,
	0x41, 0x50, 0x50, 0x5f, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x47,
	0x4f, 0x4f, 0x47, 0x4c, 0x45, 0x5f, 0x50, 0x4c, 0x41, 0x59, 0x10, 0x03, 0x12, 0x11, 0x0a, 0x0d,
	0x57, 0x49, 0x4e, 0x44, 0x4f, 0x57, 0x53, 0x5f, 0x53, 0x54, 0x4f, 0x52, 0x45, 0x10, 0x04, 0x12,
	0x17, 0x0a, 0x13, 0x57, 0x49, 0x4e, 0x44, 0x4f, 0x57, 0x53, 0x5f, 0x50, 0x48, 0x4f, 0x4e, 0x45,
...
var (
	file_enums_legacy_app_install_ad_app_store_proto_rawDescOnce sync.Once
	file_enums_legacy_app_install_ad_app_store_proto_rawDescData = file_enums_legacy_app_install_ad_app_store_proto_rawDesc
)

func file_enums_legacy_app_install_ad_app_store_proto_rawDescGZIP() []byte {
	file_enums_legacy_app_install_ad_app_store_proto_rawDescOnce.Do(func() {
		file_enums_legacy_app_install_ad_app_store_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_legacy_app_install_ad_app_store_proto_rawDescData)
	})
	return file_enums_legacy_app_install_ad_app_store_proto_rawDescData
}

var file_enums_legacy_app_install_ad_app_store_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_legacy_app_install_ad_app_store_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_legacy_app_install_ad_app_store_proto_goTypes = []interface{}{
	(LegacyAppInstallAdAppStoreEnum_LegacyAppInstallAdAppStore)(0), // 0: google.ads.googleads.v15.enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore
	(*LegacyAppInstallAdAppStoreEnum)(nil),                         // 1: google.ads.googleads.v15.enums.LegacyAppInstallAdAppStoreEnum
}
var file_enums_legacy_app_install_ad_app_store_proto_depIdxs = []int32{
...
func init() { file_enums_legacy_app_install_ad_app_store_proto_init() }
func file_enums_legacy_app_install_ad_app_store_proto_init() {
	if File_enums_legacy_app_install_ad_app_store_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_legacy_app_install_ad_app_store_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_legacy_app_install_ad_app_store_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_legacy_app_install_ad_app_store_proto_goTypes,
		DependencyIndexes: file_enums_legacy_app_install_ad_app_store_proto_depIdxs,
		EnumInfos:         file_enums_legacy_app_install_ad_app_store_proto_enumTypes,
		MessageInfos:      file_enums_legacy_app_install_ad_app_store_proto_msgTypes,
	}.Build()
	File_enums_legacy_app_install_ad_app_store_proto = out.File
	file_enums_legacy_app_install_ad_app_store_proto_rawDesc = nil
	file_enums_legacy_app_install_ad_app_store_proto_goTypes = nil
	file_enums_legacy_app_install_ad_app_store_proto_depIdxs = nil
}
