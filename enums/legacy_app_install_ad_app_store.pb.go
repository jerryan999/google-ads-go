...
var file_enums_legacy_app_install_ad_app_store_proto_goTypes = []any{
...
func file_enums_legacy_app_install_ad_app_store_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_legacy_app_install_ad_app_store_proto_msgTypes[0].Exporter = func(v any, i int) any {
