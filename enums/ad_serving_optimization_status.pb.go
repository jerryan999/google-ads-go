...
var file_enums_ad_serving_optimization_status_proto_goTypes = []any{
...
func file_enums_ad_serving_optimization_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_ad_serving_optimization_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
