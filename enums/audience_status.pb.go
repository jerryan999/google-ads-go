...
var file_enums_audience_status_proto_rawDesc = []byte{
...
var (
	...
	file_enums_audience_status_proto_rawDescData = file_enums_audience_status_proto_rawDesc
)

func file_enums_audience_status_proto_rawDescGZIP() []byte {
	file_enums_audience_status_proto_rawDescOnce.Do(func() {
		file_enums_audience_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_audience_status_proto_rawDescData)
	})
...
var file_enums_audience_status_proto_goTypes = []interface{}{
...
func file_enums_audience_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_audience_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_audience_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_enums_audience_status_proto_rawDesc = nil
