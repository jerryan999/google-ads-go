...
var file_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_goTypes = []any{
...
func file_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_converting_user_prior_engagement_type_and_ltv_bucket_proto_msgTypes[0].Exporter = func(v any, i int) any {
