...
var file_enums_call_conversion_reporting_state_proto_goTypes = []any{
...
func file_enums_call_conversion_reporting_state_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_call_conversion_reporting_state_proto_msgTypes[0].Exporter = func(v any, i int) any {
