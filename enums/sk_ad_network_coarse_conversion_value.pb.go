...
var file_enums_sk_ad_network_coarse_conversion_value_proto_goTypes = []any{
...
func file_enums_sk_ad_network_coarse_conversion_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_sk_ad_network_coarse_conversion_value_proto_msgTypes[0].Exporter = func(v any, i int) any {
