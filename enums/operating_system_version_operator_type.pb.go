...
var file_enums_operating_system_version_operator_type_proto_goTypes = []any{
...
func file_enums_operating_system_version_operator_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_operating_system_version_operator_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
