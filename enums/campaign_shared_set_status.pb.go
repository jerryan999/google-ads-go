...
func (x CampaignSharedSetStatusEnum_CampaignSharedSetStatus) Enum() *CampaignSharedSetStatusEnum_CampaignSharedSetStatus {
	p := new(CampaignSharedSetStatusEnum_CampaignSharedSetStatus)
	*p = x
	return p
}
...
func (CampaignSharedSetStatusEnum_CampaignSharedSetStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_campaign_shared_set_status_proto_enumTypes[0].Descriptor()
}

func (CampaignSharedSetStatusEnum_CampaignSharedSetStatus) Type() protoreflect.EnumType {
	return &file_enums_campaign_shared_set_status_proto_enumTypes[0]
}
...
func (CampaignSharedSetStatusEnum_CampaignSharedSetStatus) EnumDescriptor() ([]byte, []int) {
	return file_enums_campaign_shared_set_status_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignSharedSetStatusEnum) Reset() {
	*x = CampaignSharedSetStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_campaign_shared_set_status_proto_msgTypes[0]
...
func (*CampaignSharedSetStatusEnum) Descriptor() ([]byte, []int) {
	return file_enums_campaign_shared_set_status_proto_rawDescGZIP(), []int{0}
}

var File_enums_campaign_shared_set_status_proto protoreflect.FileDescriptor

var file_enums_campaign_shared_set_status_proto_rawDesc = []byte{
	...
	0x1b, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x53, 0x68, 0x61, 0x72, 0x65, 0x64, 0x53,
	0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x51, 0x0a, 0x17,
	...
	0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1c, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x53,
	0x68, 0x61, 0x72, 0x65, 0x64, 0x53, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x50, 0x72,
...
var (
	file_enums_campaign_shared_set_status_proto_rawDescOnce sync.Once
	file_enums_campaign_shared_set_status_proto_rawDescData = file_enums_campaign_shared_set_status_proto_rawDesc
)

func file_enums_campaign_shared_set_status_proto_rawDescGZIP() []byte {
	file_enums_campaign_shared_set_status_proto_rawDescOnce.Do(func() {
		file_enums_campaign_shared_set_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_campaign_shared_set_status_proto_rawDescData)
	})
	return file_enums_campaign_shared_set_status_proto_rawDescData
}

var file_enums_campaign_shared_set_status_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_campaign_shared_set_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_campaign_shared_set_status_proto_goTypes = []interface{}{
	(CampaignSharedSetStatusEnum_CampaignSharedSetStatus)(0), // 0: google.ads.googleads.v9.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
	(*CampaignSharedSetStatusEnum)(nil),                      // 1: google.ads.googleads.v9.enums.CampaignSharedSetStatusEnum
}
var file_enums_campaign_shared_set_status_proto_depIdxs = []int32{
...
func init() { file_enums_campaign_shared_set_status_proto_init() }
func file_enums_campaign_shared_set_status_proto_init() {
	if File_enums_campaign_shared_set_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_campaign_shared_set_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_campaign_shared_set_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_campaign_shared_set_status_proto_goTypes,
		DependencyIndexes: file_enums_campaign_shared_set_status_proto_depIdxs,
		EnumInfos:         file_enums_campaign_shared_set_status_proto_enumTypes,
		MessageInfos:      file_enums_campaign_shared_set_status_proto_msgTypes,
	}.Build()
	File_enums_campaign_shared_set_status_proto = out.File
	file_enums_campaign_shared_set_status_proto_rawDesc = nil
	file_enums_campaign_shared_set_status_proto_goTypes = nil
	file_enums_campaign_shared_set_status_proto_depIdxs = nil
}
