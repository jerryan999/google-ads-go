...
func (AppStoreEnum_AppStore) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_app_store_proto_enumTypes[0].Descriptor()
}

func (AppStoreEnum_AppStore) Type() protoreflect.EnumType {
	return &file_enums_app_store_proto_enumTypes[0]
}
...
func (AppStoreEnum_AppStore) EnumDescriptor() ([]byte, []int) {
	return file_enums_app_store_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AppStoreEnum) Reset() {
	*x = AppStoreEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_app_store_proto_msgTypes[0]
...
func (*AppStoreEnum) Descriptor() ([]byte, []int) {
	return file_enums_app_store_proto_rawDescGZIP(), []int{0}
}

var File_enums_app_store_proto protoreflect.FileDescriptor

var file_enums_app_store_proto_rawDesc = []byte{
	...
	0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x41, 0x50,
...
var (
	file_enums_app_store_proto_rawDescOnce sync.Once
	file_enums_app_store_proto_rawDescData = file_enums_app_store_proto_rawDesc
)

func file_enums_app_store_proto_rawDescGZIP() []byte {
	file_enums_app_store_proto_rawDescOnce.Do(func() {
		file_enums_app_store_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_app_store_proto_rawDescData)
	})
	return file_enums_app_store_proto_rawDescData
}

var file_enums_app_store_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_app_store_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_app_store_proto_goTypes = []interface{}{
	(AppStoreEnum_AppStore)(0), // 0: google.ads.googleads.v15.enums.AppStoreEnum.AppStore
	(*AppStoreEnum)(nil),       // 1: google.ads.googleads.v15.enums.AppStoreEnum
}
var file_enums_app_store_proto_depIdxs = []int32{
...
func init() { file_enums_app_store_proto_init() }
func file_enums_app_store_proto_init() {
	if File_enums_app_store_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_app_store_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_app_store_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_app_store_proto_goTypes,
		DependencyIndexes: file_enums_app_store_proto_depIdxs,
		EnumInfos:         file_enums_app_store_proto_enumTypes,
		MessageInfos:      file_enums_app_store_proto_msgTypes,
	}.Build()
	File_enums_app_store_proto = out.File
	file_enums_app_store_proto_rawDesc = nil
	file_enums_app_store_proto_goTypes = nil
	file_enums_app_store_proto_depIdxs = nil
}
