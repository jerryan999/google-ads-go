...
func (ExperimentMetricDirectionEnum_ExperimentMetricDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_experiment_metric_direction_proto_enumTypes[0].Descriptor()
}

func (ExperimentMetricDirectionEnum_ExperimentMetricDirection) Type() protoreflect.EnumType {
	return &file_enums_experiment_metric_direction_proto_enumTypes[0]
}
...
func (ExperimentMetricDirectionEnum_ExperimentMetricDirection) EnumDescriptor() ([]byte, []int) {
	return file_enums_experiment_metric_direction_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ExperimentMetricDirectionEnum) Reset() {
	*x = ExperimentMetricDirectionEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_experiment_metric_direction_proto_msgTypes[0]
...
func (*ExperimentMetricDirectionEnum) Descriptor() ([]byte, []int) {
	return file_enums_experiment_metric_direction_proto_rawDescGZIP(), []int{0}
}

var File_enums_experiment_metric_direction_proto protoreflect.FileDescriptor

var file_enums_experiment_metric_direction_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69,
	...
	0x12, 0x0d, 0x0a, 0x09, 0x4e, 0x4f, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x10, 0x02, 0x12,
	0x0c, 0x0a, 0x08, 0x49, 0x4e, 0x43, 0x52, 0x45, 0x41, 0x53, 0x45, 0x10, 0x03, 0x12, 0x0c, 0x0a,
	0x08, 0x44, 0x45, 0x43, 0x52, 0x45, 0x41, 0x53, 0x45, 0x10, 0x04, 0x12, 0x19, 0x0a, 0x15, 0x4e,
	0x4f, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f, 0x4f, 0x52, 0x5f, 0x49, 0x4e, 0x43, 0x52,
	0x45, 0x41, 0x53, 0x45, 0x10, 0x05, 0x12, 0x19, 0x0a, 0x15, 0x4e, 0x4f, 0x5f, 0x43, 0x48, 0x41,
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1e, 0x45, 0x78, 0x70, 0x65, 0x72, 0x69,
...
var (
	file_enums_experiment_metric_direction_proto_rawDescOnce sync.Once
	file_enums_experiment_metric_direction_proto_rawDescData = file_enums_experiment_metric_direction_proto_rawDesc
)

func file_enums_experiment_metric_direction_proto_rawDescGZIP() []byte {
	file_enums_experiment_metric_direction_proto_rawDescOnce.Do(func() {
		file_enums_experiment_metric_direction_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_experiment_metric_direction_proto_rawDescData)
	})
	return file_enums_experiment_metric_direction_proto_rawDescData
}

var file_enums_experiment_metric_direction_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_experiment_metric_direction_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_experiment_metric_direction_proto_goTypes = []interface{}{
	(ExperimentMetricDirectionEnum_ExperimentMetricDirection)(0), // 0: google.ads.googleads.v15.enums.ExperimentMetricDirectionEnum.ExperimentMetricDirection
	(*ExperimentMetricDirectionEnum)(nil),                        // 1: google.ads.googleads.v15.enums.ExperimentMetricDirectionEnum
}
var file_enums_experiment_metric_direction_proto_depIdxs = []int32{
...
func init() { file_enums_experiment_metric_direction_proto_init() }
func file_enums_experiment_metric_direction_proto_init() {
	if File_enums_experiment_metric_direction_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_experiment_metric_direction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_experiment_metric_direction_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_experiment_metric_direction_proto_goTypes,
		DependencyIndexes: file_enums_experiment_metric_direction_proto_depIdxs,
		EnumInfos:         file_enums_experiment_metric_direction_proto_enumTypes,
		MessageInfos:      file_enums_experiment_metric_direction_proto_msgTypes,
	}.Build()
	File_enums_experiment_metric_direction_proto = out.File
	file_enums_experiment_metric_direction_proto_rawDesc = nil
	file_enums_experiment_metric_direction_proto_goTypes = nil
	file_enums_experiment_metric_direction_proto_depIdxs = nil
}
