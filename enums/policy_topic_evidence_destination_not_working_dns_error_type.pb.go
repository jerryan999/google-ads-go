...
var file_enums_policy_topic_evidence_destination_not_working_dns_error_type_proto_goTypes = []any{
...
func file_enums_policy_topic_evidence_destination_not_working_dns_error_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_policy_topic_evidence_destination_not_working_dns_error_type_proto_msgTypes[0].Exporter = func(v any, i int) any {
