...
func (UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_user_list_date_rule_item_operator_proto_enumTypes[0].Descriptor()
}

func (UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator) Type() protoreflect.EnumType {
	return &file_enums_user_list_date_rule_item_operator_proto_enumTypes[0]
}
...
func (UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator) EnumDescriptor() ([]byte, []int) {
	return file_enums_user_list_date_rule_item_operator_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *UserListDateRuleItemOperatorEnum) Reset() {
	*x = UserListDateRuleItemOperatorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_user_list_date_rule_item_operator_proto_msgTypes[0]
...
func (*UserListDateRuleItemOperatorEnum) Descriptor() ([]byte, []int) {
	return file_enums_user_list_date_rule_item_operator_proto_rawDescGZIP(), []int{0}
}

var File_enums_user_list_date_rule_item_operator_proto protoreflect.FileDescriptor

var file_enums_user_list_date_rule_item_operator_proto_rawDesc = []byte{
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x93, 0x01, 0x0a, 0x20, 0x55, 0x73, 0x65,
	...
	0x65, 0x49, 0x74, 0x65, 0x6d, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x0f, 0x0a,
	...
	0x51, 0x55, 0x41, 0x4c, 0x53, 0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x4e, 0x4f, 0x54, 0x5f, 0x45,
...
var (
	file_enums_user_list_date_rule_item_operator_proto_rawDescOnce sync.Once
	file_enums_user_list_date_rule_item_operator_proto_rawDescData = file_enums_user_list_date_rule_item_operator_proto_rawDesc
)

func file_enums_user_list_date_rule_item_operator_proto_rawDescGZIP() []byte {
	file_enums_user_list_date_rule_item_operator_proto_rawDescOnce.Do(func() {
		file_enums_user_list_date_rule_item_operator_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_user_list_date_rule_item_operator_proto_rawDescData)
	})
	return file_enums_user_list_date_rule_item_operator_proto_rawDescData
}

var file_enums_user_list_date_rule_item_operator_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_user_list_date_rule_item_operator_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_user_list_date_rule_item_operator_proto_goTypes = []interface{}{
	(UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator)(0), // 0: google.ads.googleads.v15.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator
	(*UserListDateRuleItemOperatorEnum)(nil),                           // 1: google.ads.googleads.v15.enums.UserListDateRuleItemOperatorEnum
}
var file_enums_user_list_date_rule_item_operator_proto_depIdxs = []int32{
...
func init() { file_enums_user_list_date_rule_item_operator_proto_init() }
func file_enums_user_list_date_rule_item_operator_proto_init() {
	if File_enums_user_list_date_rule_item_operator_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_user_list_date_rule_item_operator_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_user_list_date_rule_item_operator_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_user_list_date_rule_item_operator_proto_goTypes,
		DependencyIndexes: file_enums_user_list_date_rule_item_operator_proto_depIdxs,
		EnumInfos:         file_enums_user_list_date_rule_item_operator_proto_enumTypes,
		MessageInfos:      file_enums_user_list_date_rule_item_operator_proto_msgTypes,
	}.Build()
	File_enums_user_list_date_rule_item_operator_proto = out.File
	file_enums_user_list_date_rule_item_operator_proto_rawDesc = nil
	file_enums_user_list_date_rule_item_operator_proto_goTypes = nil
	file_enums_user_list_date_rule_item_operator_proto_depIdxs = nil
}
