...
func (CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_enumTypes[0].Descriptor()
}
...
func (CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason) Type() protoreflect.EnumType {
	return &file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_enumTypes[0]
}
...
func (CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason) EnumDescriptor() ([]byte, []int) {
	return file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CustomerPayPerConversionEligibilityFailureReasonEnum) Reset() {
	*x = CustomerPayPerConversionEligibilityFailureReasonEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_msgTypes[0]
...
func (*CustomerPayPerConversionEligibilityFailureReasonEnum) Descriptor() ([]byte, []int) {
	return file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescGZIP(), []int{0}
}

var File_enums_customer_pay_per_conversion_eligibility_failure_reason_proto protoreflect.FileDescriptor

var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xd1, 0x02,
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x35, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
...
var (
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescOnce sync.Once
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescData = file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc
)

func file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescGZIP() []byte {
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescOnce.Do(func() {
		file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescData)
	})
	return file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescData
}

var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_goTypes = []interface{}{
	(CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason)(0), // 0: google.ads.googleads.v15.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason
	(*CustomerPayPerConversionEligibilityFailureReasonEnum)(nil),                                               // 1: google.ads.googleads.v15.enums.CustomerPayPerConversionEligibilityFailureReasonEnum
}
var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_depIdxs = []int32{
...
func init() {
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_init()
}
func file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_init() {
	if File_enums_customer_pay_per_conversion_eligibility_failure_reason_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_goTypes,
		DependencyIndexes: file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_depIdxs,
		EnumInfos:         file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_enumTypes,
		MessageInfos:      file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_msgTypes,
	}.Build()
	File_enums_customer_pay_per_conversion_eligibility_failure_reason_proto = out.File
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc = nil
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_goTypes = nil
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_depIdxs = nil
}
