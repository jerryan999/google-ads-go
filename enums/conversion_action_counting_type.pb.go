...
func (ConversionActionCountingTypeEnum_ConversionActionCountingType) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_conversion_action_counting_type_proto_enumTypes[0].Descriptor()
}

func (ConversionActionCountingTypeEnum_ConversionActionCountingType) Type() protoreflect.EnumType {
	return &file_enums_conversion_action_counting_type_proto_enumTypes[0]
}
...
func (ConversionActionCountingTypeEnum_ConversionActionCountingType) EnumDescriptor() ([]byte, []int) {
	return file_enums_conversion_action_counting_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ConversionActionCountingTypeEnum) Reset() {
	*x = ConversionActionCountingTypeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_conversion_action_counting_type_proto_msgTypes[0]
...
func (*ConversionActionCountingTypeEnum) Descriptor() ([]byte, []int) {
	return file_enums_conversion_action_counting_type_proto_rawDescGZIP(), []int{0}
}

var File_enums_conversion_action_counting_type_proto protoreflect.FileDescriptor

var file_enums_conversion_action_counting_type_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x69, 0x6e, 0x67, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x55,
	0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07,
	0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d, 0x4f, 0x4e, 0x45,
	0x5f, 0x50, 0x45, 0x52, 0x5f, 0x43, 0x4c, 0x49, 0x43, 0x4b, 0x10, 0x02, 0x12, 0x12, 0x0a, 0x0e,
...
var (
	file_enums_conversion_action_counting_type_proto_rawDescOnce sync.Once
	file_enums_conversion_action_counting_type_proto_rawDescData = file_enums_conversion_action_counting_type_proto_rawDesc
)

func file_enums_conversion_action_counting_type_proto_rawDescGZIP() []byte {
	file_enums_conversion_action_counting_type_proto_rawDescOnce.Do(func() {
		file_enums_conversion_action_counting_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_conversion_action_counting_type_proto_rawDescData)
	})
	return file_enums_conversion_action_counting_type_proto_rawDescData
}

var file_enums_conversion_action_counting_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_conversion_action_counting_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_conversion_action_counting_type_proto_goTypes = []interface{}{
	(ConversionActionCountingTypeEnum_ConversionActionCountingType)(0), // 0: google.ads.googleads.v15.enums.ConversionActionCountingTypeEnum.ConversionActionCountingType
	(*ConversionActionCountingTypeEnum)(nil),                           // 1: google.ads.googleads.v15.enums.ConversionActionCountingTypeEnum
}
var file_enums_conversion_action_counting_type_proto_depIdxs = []int32{
...
func init() { file_enums_conversion_action_counting_type_proto_init() }
func file_enums_conversion_action_counting_type_proto_init() {
	if File_enums_conversion_action_counting_type_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_conversion_action_counting_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_conversion_action_counting_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_conversion_action_counting_type_proto_goTypes,
		DependencyIndexes: file_enums_conversion_action_counting_type_proto_depIdxs,
		EnumInfos:         file_enums_conversion_action_counting_type_proto_enumTypes,
		MessageInfos:      file_enums_conversion_action_counting_type_proto_msgTypes,
	}.Build()
	File_enums_conversion_action_counting_type_proto = out.File
	file_enums_conversion_action_counting_type_proto_rawDesc = nil
	file_enums_conversion_action_counting_type_proto_goTypes = nil
	file_enums_conversion_action_counting_type_proto_depIdxs = nil
}
