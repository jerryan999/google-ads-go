...
var file_enums_offline_user_data_job_failure_reason_proto_goTypes = []any{
...
func file_enums_offline_user_data_job_failure_reason_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_offline_user_data_job_failure_reason_proto_msgTypes[0].Exporter = func(v any, i int) any {
