...
func (ExperimentMetricEnum_ExperimentMetric) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_experiment_metric_proto_enumTypes[0].Descriptor()
}

func (ExperimentMetricEnum_ExperimentMetric) Type() protoreflect.EnumType {
	return &file_enums_experiment_metric_proto_enumTypes[0]
}
...
func (ExperimentMetricEnum_ExperimentMetric) EnumDescriptor() ([]byte, []int) {
	return file_enums_experiment_metric_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ExperimentMetricEnum) Reset() {
	*x = ExperimentMetricEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_experiment_metric_proto_msgTypes[0]
...
func (*ExperimentMetricEnum) Descriptor() ([]byte, []int) {
	return file_enums_experiment_metric_proto_rawDescGZIP(), []int{0}
}

var File_enums_experiment_metric_proto protoreflect.FileDescriptor

var file_enums_experiment_metric_proto_rawDesc = []byte{
...
var (
	file_enums_experiment_metric_proto_rawDescOnce sync.Once
	file_enums_experiment_metric_proto_rawDescData = file_enums_experiment_metric_proto_rawDesc
)

func file_enums_experiment_metric_proto_rawDescGZIP() []byte {
	file_enums_experiment_metric_proto_rawDescOnce.Do(func() {
		file_enums_experiment_metric_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_experiment_metric_proto_rawDescData)
	})
	return file_enums_experiment_metric_proto_rawDescData
}

var file_enums_experiment_metric_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_experiment_metric_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_experiment_metric_proto_goTypes = []interface{}{
...
var file_enums_experiment_metric_proto_depIdxs = []int32{
...
func init() { file_enums_experiment_metric_proto_init() }
func file_enums_experiment_metric_proto_init() {
	if File_enums_experiment_metric_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_experiment_metric_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_experiment_metric_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_experiment_metric_proto_goTypes,
		DependencyIndexes: file_enums_experiment_metric_proto_depIdxs,
		EnumInfos:         file_enums_experiment_metric_proto_enumTypes,
		MessageInfos:      file_enums_experiment_metric_proto_msgTypes,
	}.Build()
	File_enums_experiment_metric_proto = out.File
	file_enums_experiment_metric_proto_rawDesc = nil
	file_enums_experiment_metric_proto_goTypes = nil
	file_enums_experiment_metric_proto_depIdxs = nil
}
