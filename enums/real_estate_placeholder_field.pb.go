...
func (RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_real_estate_placeholder_field_proto_enumTypes[0].Descriptor()
}

func (RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField) Type() protoreflect.EnumType {
	return &file_enums_real_estate_placeholder_field_proto_enumTypes[0]
}
...
func (RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField) EnumDescriptor() ([]byte, []int) {
	return file_enums_real_estate_placeholder_field_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *RealEstatePlaceholderFieldEnum) Reset() {
	*x = RealEstatePlaceholderFieldEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_real_estate_placeholder_field_proto_msgTypes[0]
...
func (*RealEstatePlaceholderFieldEnum) Descriptor() ([]byte, []int) {
	return file_enums_real_estate_placeholder_field_proto_rawDescGZIP(), []int{0}
}

var File_enums_real_estate_placeholder_field_proto protoreflect.FileDescriptor

var file_enums_real_estate_placeholder_field_proto_rawDesc = []byte{
	...
	0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1f, 0x52, 0x65, 0x61, 0x6c, 0x45, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x50, 0x6c, 0x61, 0x63, 0x65, 0x68, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x46, 0x69,
...
var (
	file_enums_real_estate_placeholder_field_proto_rawDescOnce sync.Once
	file_enums_real_estate_placeholder_field_proto_rawDescData = file_enums_real_estate_placeholder_field_proto_rawDesc
)

func file_enums_real_estate_placeholder_field_proto_rawDescGZIP() []byte {
	file_enums_real_estate_placeholder_field_proto_rawDescOnce.Do(func() {
		file_enums_real_estate_placeholder_field_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_real_estate_placeholder_field_proto_rawDescData)
	})
	return file_enums_real_estate_placeholder_field_proto_rawDescData
}

var file_enums_real_estate_placeholder_field_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_real_estate_placeholder_field_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_real_estate_placeholder_field_proto_goTypes = []interface{}{
	(RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField)(0), // 0: google.ads.googleads.v15.enums.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField
	(*RealEstatePlaceholderFieldEnum)(nil),                         // 1: google.ads.googleads.v15.enums.RealEstatePlaceholderFieldEnum
}
var file_enums_real_estate_placeholder_field_proto_depIdxs = []int32{
...
func init() { file_enums_real_estate_placeholder_field_proto_init() }
func file_enums_real_estate_placeholder_field_proto_init() {
	if File_enums_real_estate_placeholder_field_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_real_estate_placeholder_field_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_real_estate_placeholder_field_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_real_estate_placeholder_field_proto_goTypes,
		DependencyIndexes: file_enums_real_estate_placeholder_field_proto_depIdxs,
		EnumInfos:         file_enums_real_estate_placeholder_field_proto_enumTypes,
		MessageInfos:      file_enums_real_estate_placeholder_field_proto_msgTypes,
	}.Build()
	File_enums_real_estate_placeholder_field_proto = out.File
	file_enums_real_estate_placeholder_field_proto_rawDesc = nil
	file_enums_real_estate_placeholder_field_proto_goTypes = nil
	file_enums_real_estate_placeholder_field_proto_depIdxs = nil
}
