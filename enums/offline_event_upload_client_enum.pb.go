...
var file_enums_offline_event_upload_client_enum_proto_goTypes = []any{
...
func file_enums_offline_event_upload_client_enum_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_offline_event_upload_client_enum_proto_msgTypes[0].Exporter = func(v any, i int) any {
