...
type AssetSourceEnum_AssetSource int32

const (
	// Not specified.
	AssetSourceEnum_UNSPECIFIED AssetSourceEnum_AssetSource = 0
	// Used for return value only. Represents value unknown in this version.
	AssetSourceEnum_UNKNOWN AssetSourceEnum_AssetSource = 1
	// The asset or asset link is provided by advertiser.
	AssetSourceEnum_ADVERTISER AssetSourceEnum_AssetSource = 2
	// The asset or asset link is generated by Google.
	AssetSourceEnum_AUTOMATICALLY_CREATED AssetSourceEnum_AssetSource = 3
)

// Enum value maps for AssetSourceEnum_AssetSource.
var (
	AssetSourceEnum_AssetSource_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "UNKNOWN",
		2: "ADVERTISER",
		3: "AUTOMATICALLY_CREATED",
	}
	AssetSourceEnum_AssetSource_value = map[string]int32{
		"UNSPECIFIED":           0,
		"UNKNOWN":               1,
		"ADVERTISER":            2,
...
func (x AssetSourceEnum_AssetSource) Enum() *AssetSourceEnum_AssetSource {
	p := new(AssetSourceEnum_AssetSource)
	*p = x
	return p
}

func (x AssetSourceEnum_AssetSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AssetSourceEnum_AssetSource) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_asset_source_proto_enumTypes[0].Descriptor()
}

func (AssetSourceEnum_AssetSource) Type() protoreflect.EnumType {
	return &file_enums_asset_source_proto_enumTypes[0]
}
...
func (x *AssetSourceEnum) Reset() {
	*x = AssetSourceEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_asset_source_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AssetSourceEnum) String() string {
...
func (*AssetSourceEnum) Descriptor() ([]byte, []int) {
	return file_enums_asset_source_proto_rawDescGZIP(), []int{0}
}

var File_enums_asset_source_proto protoreflect.FileDescriptor

var file_enums_asset_source_proto_rawDesc = []byte{
	...
	0x4e, 0x10, 0x01, 0x12, 0x0e, 0x0a, 0x0a, 0x41, 0x44, 0x56, 0x45, 0x52, 0x54, 0x49, 0x53, 0x45,
...
var (
	file_enums_asset_source_proto_rawDescOnce sync.Once
	file_enums_asset_source_proto_rawDescData = file_enums_asset_source_proto_rawDesc
)

func file_enums_asset_source_proto_rawDescGZIP() []byte {
	file_enums_asset_source_proto_rawDescOnce.Do(func() {
		file_enums_asset_source_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_asset_source_proto_rawDescData)
	})
	return file_enums_asset_source_proto_rawDescData
}

var file_enums_asset_source_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_asset_source_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_asset_source_proto_goTypes = []interface{}{
	(AssetSourceEnum_AssetSource)(0), // 0: google.ads.googleads.v15.enums.AssetSourceEnum.AssetSource
	(*AssetSourceEnum)(nil),          // 1: google.ads.googleads.v15.enums.AssetSourceEnum
}
var file_enums_asset_source_proto_depIdxs = []int32{
...
func init() { file_enums_asset_source_proto_init() }
func file_enums_asset_source_proto_init() {
	if File_enums_asset_source_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_asset_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_asset_source_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_asset_source_proto_goTypes,
		DependencyIndexes: file_enums_asset_source_proto_depIdxs,
		EnumInfos:         file_enums_asset_source_proto_enumTypes,
		MessageInfos:      file_enums_asset_source_proto_msgTypes,
	}.Build()
	File_enums_asset_source_proto = out.File
	file_enums_asset_source_proto_rawDesc = nil
	file_enums_asset_source_proto_goTypes = nil
	file_enums_asset_source_proto_depIdxs = nil
}
