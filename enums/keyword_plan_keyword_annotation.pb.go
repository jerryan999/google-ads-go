...
var file_enums_keyword_plan_keyword_annotation_proto_goTypes = []any{
...
func file_enums_keyword_plan_keyword_annotation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_keyword_plan_keyword_annotation_proto_msgTypes[0].Exporter = func(v any, i int) any {
