...
func (GeoTargetingRestrictionEnum_GeoTargetingRestriction) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_geo_targeting_restriction_proto_enumTypes[0].Descriptor()
}

func (GeoTargetingRestrictionEnum_GeoTargetingRestriction) Type() protoreflect.EnumType {
	return &file_enums_geo_targeting_restriction_proto_enumTypes[0]
}
...
func (GeoTargetingRestrictionEnum_GeoTargetingRestriction) EnumDescriptor() ([]byte, []int) {
	return file_enums_geo_targeting_restriction_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *GeoTargetingRestrictionEnum) Reset() {
	*x = GeoTargetingRestrictionEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_geo_targeting_restriction_proto_msgTypes[0]
...
func (*GeoTargetingRestrictionEnum) Descriptor() ([]byte, []int) {
	return file_enums_geo_targeting_restriction_proto_rawDescGZIP(), []int{0}
}

var File_enums_geo_targeting_restriction_proto protoreflect.FileDescriptor

var file_enums_geo_targeting_restriction_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e,
	0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0b, 0x0a, 0x07, 0x55,
	0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x4c, 0x4f, 0x43, 0x41,
	...
	0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1c, 0x47, 0x65, 0x6f, 0x54, 0x61,
...
var (
	file_enums_geo_targeting_restriction_proto_rawDescOnce sync.Once
	file_enums_geo_targeting_restriction_proto_rawDescData = file_enums_geo_targeting_restriction_proto_rawDesc
)

func file_enums_geo_targeting_restriction_proto_rawDescGZIP() []byte {
	file_enums_geo_targeting_restriction_proto_rawDescOnce.Do(func() {
		file_enums_geo_targeting_restriction_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_geo_targeting_restriction_proto_rawDescData)
	})
	return file_enums_geo_targeting_restriction_proto_rawDescData
}

var file_enums_geo_targeting_restriction_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_geo_targeting_restriction_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_geo_targeting_restriction_proto_goTypes = []interface{}{
	(GeoTargetingRestrictionEnum_GeoTargetingRestriction)(0), // 0: google.ads.googleads.v15.enums.GeoTargetingRestrictionEnum.GeoTargetingRestriction
	(*GeoTargetingRestrictionEnum)(nil),                      // 1: google.ads.googleads.v15.enums.GeoTargetingRestrictionEnum
}
var file_enums_geo_targeting_restriction_proto_depIdxs = []int32{
...
func init() { file_enums_geo_targeting_restriction_proto_init() }
func file_enums_geo_targeting_restriction_proto_init() {
	if File_enums_geo_targeting_restriction_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_geo_targeting_restriction_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_geo_targeting_restriction_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_geo_targeting_restriction_proto_goTypes,
		DependencyIndexes: file_enums_geo_targeting_restriction_proto_depIdxs,
		EnumInfos:         file_enums_geo_targeting_restriction_proto_enumTypes,
		MessageInfos:      file_enums_geo_targeting_restriction_proto_msgTypes,
	}.Build()
	File_enums_geo_targeting_restriction_proto = out.File
	file_enums_geo_targeting_restriction_proto_rawDesc = nil
	file_enums_geo_targeting_restriction_proto_goTypes = nil
	file_enums_geo_targeting_restriction_proto_depIdxs = nil
}
