...
var file_enums_vanity_pharma_display_url_mode_proto_goTypes = []any{
...
func file_enums_vanity_pharma_display_url_mode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_vanity_pharma_display_url_mode_proto_msgTypes[0].Exporter = func(v any, i int) any {
