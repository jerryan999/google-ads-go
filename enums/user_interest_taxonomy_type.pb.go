...
var file_enums_user_interest_taxonomy_type_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1d, 0x55, 0x73, 0x65,
...
var (
	...
	file_enums_user_interest_taxonomy_type_proto_rawDescData = file_enums_user_interest_taxonomy_type_proto_rawDesc
)
...
func file_enums_user_interest_taxonomy_type_proto_rawDescGZIP() []byte {
	file_enums_user_interest_taxonomy_type_proto_rawDescOnce.Do(func() {
		file_enums_user_interest_taxonomy_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_user_interest_taxonomy_type_proto_rawDescData)
	})
...
var file_enums_user_interest_taxonomy_type_proto_goTypes = []interface{}{
	(UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType)(0), // 0: google.ads.googleads.v15.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
	(*UserInterestTaxonomyTypeEnum)(nil),                       // 1: google.ads.googleads.v15.enums.UserInterestTaxonomyTypeEnum
}
...
func file_enums_user_interest_taxonomy_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_user_interest_taxonomy_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_user_interest_taxonomy_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_enums_user_interest_taxonomy_type_proto_rawDesc = nil
