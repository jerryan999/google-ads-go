...
func (BiddingSourceEnum_BiddingSource) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_bidding_source_proto_enumTypes[0].Descriptor()
}

func (BiddingSourceEnum_BiddingSource) Type() protoreflect.EnumType {
	return &file_enums_bidding_source_proto_enumTypes[0]
}
...
func (BiddingSourceEnum_BiddingSource) EnumDescriptor() ([]byte, []int) {
	return file_enums_bidding_source_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *BiddingSourceEnum) Reset() {
	*x = BiddingSourceEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_bidding_source_proto_msgTypes[0]
...
func (*BiddingSourceEnum) Descriptor() ([]byte, []int) {
	return file_enums_bidding_source_proto_rawDescGZIP(), []int{0}
}

var File_enums_bidding_source_proto protoreflect.FileDescriptor

var file_enums_bidding_source_proto_rawDesc = []byte{
	...
	0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x1d, 0x0a, 0x19, 0x43, 0x41,
	0x4d, 0x50, 0x41, 0x49, 0x47, 0x4e, 0x5f, 0x42, 0x49, 0x44, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x53,
	0x54, 0x52, 0x41, 0x54, 0x45, 0x47, 0x59, 0x10, 0x05, 0x12, 0x0c, 0x0a, 0x08, 0x41, 0x44, 0x5f,
...
var (
	file_enums_bidding_source_proto_rawDescOnce sync.Once
	file_enums_bidding_source_proto_rawDescData = file_enums_bidding_source_proto_rawDesc
)

func file_enums_bidding_source_proto_rawDescGZIP() []byte {
	file_enums_bidding_source_proto_rawDescOnce.Do(func() {
		file_enums_bidding_source_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_bidding_source_proto_rawDescData)
	})
	return file_enums_bidding_source_proto_rawDescData
}

var file_enums_bidding_source_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_bidding_source_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_bidding_source_proto_goTypes = []interface{}{
	(BiddingSourceEnum_BiddingSource)(0), // 0: google.ads.googleads.v15.enums.BiddingSourceEnum.BiddingSource
	(*BiddingSourceEnum)(nil),            // 1: google.ads.googleads.v15.enums.BiddingSourceEnum
}
var file_enums_bidding_source_proto_depIdxs = []int32{
...
func init() { file_enums_bidding_source_proto_init() }
func file_enums_bidding_source_proto_init() {
	if File_enums_bidding_source_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_bidding_source_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_bidding_source_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_bidding_source_proto_goTypes,
		DependencyIndexes: file_enums_bidding_source_proto_depIdxs,
		EnumInfos:         file_enums_bidding_source_proto_enumTypes,
		MessageInfos:      file_enums_bidding_source_proto_msgTypes,
	}.Build()
	File_enums_bidding_source_proto = out.File
	file_enums_bidding_source_proto_rawDesc = nil
	file_enums_bidding_source_proto_goTypes = nil
	file_enums_bidding_source_proto_depIdxs = nil
}
