...
func (PaymentModeEnum_PaymentMode) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_payment_mode_proto_enumTypes[0].Descriptor()
}

func (PaymentModeEnum_PaymentMode) Type() protoreflect.EnumType {
	return &file_enums_payment_mode_proto_enumTypes[0]
}
...
func (PaymentModeEnum_PaymentMode) EnumDescriptor() ([]byte, []int) {
	return file_enums_payment_mode_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *PaymentModeEnum) Reset() {
	*x = PaymentModeEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enums_payment_mode_proto_msgTypes[0]
...
func (*PaymentModeEnum) Descriptor() ([]byte, []int) {
	return file_enums_payment_mode_proto_rawDescGZIP(), []int{0}
}

var File_enums_payment_mode_proto protoreflect.FileDescriptor

var file_enums_payment_mode_proto_rawDesc = []byte{
	...
	0x57, 0x4e, 0x10, 0x01, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4c, 0x49, 0x43, 0x4b, 0x53, 0x10, 0x04,
	0x12, 0x14, 0x0a, 0x10, 0x43, 0x4f, 0x4e, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x56,
	0x41, 0x4c, 0x55, 0x45, 0x10, 0x05, 0x12, 0x0f, 0x0a, 0x0b, 0x43, 0x4f, 0x4e, 0x56, 0x45, 0x52,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x10,
...
var (
	file_enums_payment_mode_proto_rawDescOnce sync.Once
	file_enums_payment_mode_proto_rawDescData = file_enums_payment_mode_proto_rawDesc
)

func file_enums_payment_mode_proto_rawDescGZIP() []byte {
	file_enums_payment_mode_proto_rawDescOnce.Do(func() {
		file_enums_payment_mode_proto_rawDescData = protoimpl.X.CompressGZIP(file_enums_payment_mode_proto_rawDescData)
	})
	return file_enums_payment_mode_proto_rawDescData
}

var file_enums_payment_mode_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_payment_mode_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_payment_mode_proto_goTypes = []interface{}{
	(PaymentModeEnum_PaymentMode)(0), // 0: google.ads.googleads.v15.enums.PaymentModeEnum.PaymentMode
	(*PaymentModeEnum)(nil),          // 1: google.ads.googleads.v15.enums.PaymentModeEnum
}
var file_enums_payment_mode_proto_depIdxs = []int32{
...
func init() { file_enums_payment_mode_proto_init() }
func file_enums_payment_mode_proto_init() {
	if File_enums_payment_mode_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enums_payment_mode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enums_payment_mode_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_payment_mode_proto_goTypes,
		DependencyIndexes: file_enums_payment_mode_proto_depIdxs,
		EnumInfos:         file_enums_payment_mode_proto_enumTypes,
		MessageInfos:      file_enums_payment_mode_proto_msgTypes,
	}.Build()
	File_enums_payment_mode_proto = out.File
	file_enums_payment_mode_proto_rawDesc = nil
	file_enums_payment_mode_proto_goTypes = nil
	file_enums_payment_mode_proto_depIdxs = nil
}
