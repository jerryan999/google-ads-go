...
var file_errors_feed_item_target_error_proto_goTypes = []interface{}{
	(FeedItemTargetErrorEnum_FeedItemTargetError)(0), // 0: google.ads.googleads.v9.errors.FeedItemTargetErrorEnum.FeedItemTargetError
	(*FeedItemTargetErrorEnum)(nil),                  // 1: google.ads.googleads.v9.errors.FeedItemTargetErrorEnum
}
