...
func (CustomerLifecycleGoalErrorEnum_CustomerLifecycleGoalError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_customer_lifecycle_goal_error_proto_enumTypes[0].Descriptor()
}

func (CustomerLifecycleGoalErrorEnum_CustomerLifecycleGoalError) Type() protoreflect.EnumType {
	return &file_errors_customer_lifecycle_goal_error_proto_enumTypes[0]
}
...
func (CustomerLifecycleGoalErrorEnum_CustomerLifecycleGoalError) EnumDescriptor() ([]byte, []int) {
	return file_errors_customer_lifecycle_goal_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CustomerLifecycleGoalErrorEnum) Reset() {
	*x = CustomerLifecycleGoalErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_customer_lifecycle_goal_error_proto_msgTypes[0]
...
func (*CustomerLifecycleGoalErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_customer_lifecycle_goal_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_customer_lifecycle_goal_error_proto protoreflect.FileDescriptor

var file_errors_customer_lifecycle_goal_error_proto_rawDesc = []byte{
...
var (
	file_errors_customer_lifecycle_goal_error_proto_rawDescOnce sync.Once
	file_errors_customer_lifecycle_goal_error_proto_rawDescData = file_errors_customer_lifecycle_goal_error_proto_rawDesc
)

func file_errors_customer_lifecycle_goal_error_proto_rawDescGZIP() []byte {
	file_errors_customer_lifecycle_goal_error_proto_rawDescOnce.Do(func() {
		file_errors_customer_lifecycle_goal_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_customer_lifecycle_goal_error_proto_rawDescData)
	})
	return file_errors_customer_lifecycle_goal_error_proto_rawDescData
}

var file_errors_customer_lifecycle_goal_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_customer_lifecycle_goal_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_customer_lifecycle_goal_error_proto_goTypes = []interface{}{
...
var file_errors_customer_lifecycle_goal_error_proto_depIdxs = []int32{
...
func init() { file_errors_customer_lifecycle_goal_error_proto_init() }
func file_errors_customer_lifecycle_goal_error_proto_init() {
	if File_errors_customer_lifecycle_goal_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_customer_lifecycle_goal_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_customer_lifecycle_goal_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_customer_lifecycle_goal_error_proto_goTypes,
		DependencyIndexes: file_errors_customer_lifecycle_goal_error_proto_depIdxs,
		EnumInfos:         file_errors_customer_lifecycle_goal_error_proto_enumTypes,
		MessageInfos:      file_errors_customer_lifecycle_goal_error_proto_msgTypes,
	}.Build()
	File_errors_customer_lifecycle_goal_error_proto = out.File
	file_errors_customer_lifecycle_goal_error_proto_rawDesc = nil
	file_errors_customer_lifecycle_goal_error_proto_goTypes = nil
	file_errors_customer_lifecycle_goal_error_proto_depIdxs = nil
}
