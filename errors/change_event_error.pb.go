...
var file_errors_change_event_error_proto_goTypes = []interface{}{
	(ChangeEventErrorEnum_ChangeEventError)(0), // 0: google.ads.googleads.v9.errors.ChangeEventErrorEnum.ChangeEventError
	(*ChangeEventErrorEnum)(nil),               // 1: google.ads.googleads.v9.errors.ChangeEventErrorEnum
}
