...
// 	protoc        v4.23.4
// source: google/ads/googleads/v15/errors/change_event_error.proto
...
func (ChangeEventErrorEnum_ChangeEventError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_change_event_error_proto_enumTypes[0].Descriptor()
}

func (ChangeEventErrorEnum_ChangeEventError) Type() protoreflect.EnumType {
	return &file_errors_change_event_error_proto_enumTypes[0]
}
...
func (ChangeEventErrorEnum_ChangeEventError) EnumDescriptor() ([]byte, []int) {
	return file_errors_change_event_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ChangeEventErrorEnum) Reset() {
	*x = ChangeEventErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_change_event_error_proto_msgTypes[0]
...
func (*ChangeEventErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_change_event_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_change_event_error_proto protoreflect.FileDescriptor

var file_errors_change_event_error_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0xd4, 0x01, 0x0a, 0x14,
	...
	0x76, 0x31, 0x35, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x15, 0x43, 0x68, 0x61, 0x6e,
...
var (
	file_errors_change_event_error_proto_rawDescOnce sync.Once
	file_errors_change_event_error_proto_rawDescData = file_errors_change_event_error_proto_rawDesc
)

func file_errors_change_event_error_proto_rawDescGZIP() []byte {
	file_errors_change_event_error_proto_rawDescOnce.Do(func() {
		file_errors_change_event_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_change_event_error_proto_rawDescData)
	})
	return file_errors_change_event_error_proto_rawDescData
}

var file_errors_change_event_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_change_event_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_change_event_error_proto_goTypes = []interface{}{
	(ChangeEventErrorEnum_ChangeEventError)(0), // 0: google.ads.googleads.v15.errors.ChangeEventErrorEnum.ChangeEventError
	(*ChangeEventErrorEnum)(nil),               // 1: google.ads.googleads.v15.errors.ChangeEventErrorEnum
}
var file_errors_change_event_error_proto_depIdxs = []int32{
...
func init() { file_errors_change_event_error_proto_init() }
func file_errors_change_event_error_proto_init() {
	if File_errors_change_event_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_change_event_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_change_event_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_change_event_error_proto_goTypes,
		DependencyIndexes: file_errors_change_event_error_proto_depIdxs,
		EnumInfos:         file_errors_change_event_error_proto_enumTypes,
		MessageInfos:      file_errors_change_event_error_proto_msgTypes,
	}.Build()
	File_errors_change_event_error_proto = out.File
	file_errors_change_event_error_proto_rawDesc = nil
	file_errors_change_event_error_proto_goTypes = nil
	file_errors_change_event_error_proto_depIdxs = nil
}
