...
// 	protoc        v3.17.3
// source: google/ads/googleads/v9/errors/country_code_error.proto
...
func (x CountryCodeErrorEnum_CountryCodeError) Enum() *CountryCodeErrorEnum_CountryCodeError {
	p := new(CountryCodeErrorEnum_CountryCodeError)
	*p = x
	return p
}
...
func (CountryCodeErrorEnum_CountryCodeError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_country_code_error_proto_enumTypes[0].Descriptor()
}

func (CountryCodeErrorEnum_CountryCodeError) Type() protoreflect.EnumType {
	return &file_errors_country_code_error_proto_enumTypes[0]
}
...
func (CountryCodeErrorEnum_CountryCodeError) EnumDescriptor() ([]byte, []int) {
	return file_errors_country_code_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CountryCodeErrorEnum) Reset() {
	*x = CountryCodeErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_country_code_error_proto_msgTypes[0]
...
func (*CountryCodeErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_country_code_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_country_code_error_proto protoreflect.FileDescriptor

var file_errors_country_code_error_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x62, 0x0a, 0x14, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22,
	0x4a, 0x0a, 0x10, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x45, 0x72,
	...
	0x01, 0x12, 0x18, 0x0a, 0x14, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f, 0x43, 0x4f, 0x55,
	0x4e, 0x54, 0x52, 0x59, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x10, 0x02, 0x42, 0xf0, 0x01, 0x0a, 0x22,
	...
	0x72, 0x73, 0x42, 0x15, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x43, 0x6f, 0x64, 0x65, 0x45,
...
var (
	file_errors_country_code_error_proto_rawDescOnce sync.Once
	file_errors_country_code_error_proto_rawDescData = file_errors_country_code_error_proto_rawDesc
)

func file_errors_country_code_error_proto_rawDescGZIP() []byte {
	file_errors_country_code_error_proto_rawDescOnce.Do(func() {
		file_errors_country_code_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_country_code_error_proto_rawDescData)
	})
	return file_errors_country_code_error_proto_rawDescData
}

var file_errors_country_code_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_country_code_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_country_code_error_proto_goTypes = []interface{}{
	(CountryCodeErrorEnum_CountryCodeError)(0), // 0: google.ads.googleads.v9.errors.CountryCodeErrorEnum.CountryCodeError
	(*CountryCodeErrorEnum)(nil),               // 1: google.ads.googleads.v9.errors.CountryCodeErrorEnum
}
var file_errors_country_code_error_proto_depIdxs = []int32{
...
func init() { file_errors_country_code_error_proto_init() }
func file_errors_country_code_error_proto_init() {
	if File_errors_country_code_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_country_code_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_country_code_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_country_code_error_proto_goTypes,
		DependencyIndexes: file_errors_country_code_error_proto_depIdxs,
		EnumInfos:         file_errors_country_code_error_proto_enumTypes,
		MessageInfos:      file_errors_country_code_error_proto_msgTypes,
	}.Build()
	File_errors_country_code_error_proto = out.File
	file_errors_country_code_error_proto_rawDesc = nil
	file_errors_country_code_error_proto_goTypes = nil
	file_errors_country_code_error_proto_depIdxs = nil
}
