...
var file_errors_keyword_plan_ad_group_error_proto_goTypes = []interface{}{
	(KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError)(0), // 0: google.ads.googleads.v9.errors.KeywordPlanAdGroupErrorEnum.KeywordPlanAdGroupError
	(*KeywordPlanAdGroupErrorEnum)(nil),                      // 1: google.ads.googleads.v9.errors.KeywordPlanAdGroupErrorEnum
}
