...
var file_errors_ad_parameter_error_proto_goTypes = []interface{}{
	(AdParameterErrorEnum_AdParameterError)(0), // 0: google.ads.googleads.v9.errors.AdParameterErrorEnum.AdParameterError
	(*AdParameterErrorEnum)(nil),               // 1: google.ads.googleads.v9.errors.AdParameterErrorEnum
}
