...
var file_errors_conversion_value_rule_set_error_proto_goTypes = []any{
...
func file_errors_conversion_value_rule_set_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_errors_conversion_value_rule_set_error_proto_msgTypes[0].Exporter = func(v any, i int) any {
