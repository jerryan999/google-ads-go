...
var file_errors_custom_interest_error_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x39, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x18, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x45, 0x72, 0x72,
...
var (
	...
	file_errors_custom_interest_error_proto_rawDescData = file_errors_custom_interest_error_proto_rawDesc
)

func file_errors_custom_interest_error_proto_rawDescGZIP() []byte {
	file_errors_custom_interest_error_proto_rawDescOnce.Do(func() {
		file_errors_custom_interest_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_custom_interest_error_proto_rawDescData)
	})
...
var file_errors_custom_interest_error_proto_goTypes = []interface{}{
	(CustomInterestErrorEnum_CustomInterestError)(0), // 0: google.ads.googleads.v9.errors.CustomInterestErrorEnum.CustomInterestError
	(*CustomInterestErrorEnum)(nil),                  // 1: google.ads.googleads.v9.errors.CustomInterestErrorEnum
}
...
func file_errors_custom_interest_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_errors_custom_interest_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_custom_interest_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_errors_custom_interest_error_proto_rawDesc = nil
