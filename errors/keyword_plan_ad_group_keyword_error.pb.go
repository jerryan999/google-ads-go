...
var file_errors_keyword_plan_ad_group_keyword_error_proto_goTypes = []any{
...
func file_errors_keyword_plan_ad_group_keyword_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_errors_keyword_plan_ad_group_keyword_error_proto_msgTypes[0].Exporter = func(v any, i int) any {
