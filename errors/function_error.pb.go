...
var file_errors_function_error_proto_goTypes = []interface{}{
	(FunctionErrorEnum_FunctionError)(0), // 0: google.ads.googleads.v9.errors.FunctionErrorEnum.FunctionError
	(*FunctionErrorEnum)(nil),            // 1: google.ads.googleads.v9.errors.FunctionErrorEnum
}
