...
var file_errors_request_error_proto_goTypes = []interface{}{
	(RequestErrorEnum_RequestError)(0), // 0: google.ads.googleads.v9.errors.RequestErrorEnum.RequestError
	(*RequestErrorEnum)(nil),           // 1: google.ads.googleads.v9.errors.RequestErrorEnum
}
