...
var (
	AssetErrorEnum_AssetError_name = map[int32]string{
		...
		37: "LEAD_FORM_LOCATION_ANSWER_TYPE_DISALLOWED",
		38: "PAGE_FEED_INVALID_LABEL_TEXT",
	}
...
func (AssetErrorEnum_AssetError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_asset_error_proto_enumTypes[0].Descriptor()
}

func (AssetErrorEnum_AssetError) Type() protoreflect.EnumType {
	return &file_errors_asset_error_proto_enumTypes[0]
}
...
func (AssetErrorEnum_AssetError) EnumDescriptor() ([]byte, []int) {
	return file_errors_asset_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AssetErrorEnum) Reset() {
	*x = AssetErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_asset_error_proto_msgTypes[0]
...
func (*AssetErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_asset_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_asset_error_proto protoreflect.FileDescriptor

var file_errors_asset_error_proto_rawDesc = []byte{
	...
	0x45, 0x41, 0x54, 0x45, 0x44, 0x5f, 0x41, 0x53, 0x53, 0x45, 0x54, 0x10, 0x24, 0x12, 0x2d, 0x0a,
	0x29, 0x4c, 0x45, 0x41, 0x44, 0x5f, 0x46, 0x4f, 0x52, 0x4d, 0x5f, 0x4c, 0x4f, 0x43, 0x41, 0x54,
	0x49, 0x4f, 0x4e, 0x5f, 0x41, 0x4e, 0x53, 0x57, 0x45, 0x52, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f,
	0x44, 0x49, 0x53, 0x41, 0x4c, 0x4c, 0x4f, 0x57, 0x45, 0x44, 0x10, 0x25, 0x12, 0x20, 0x0a, 0x1c,
...
var (
	file_errors_asset_error_proto_rawDescOnce sync.Once
	file_errors_asset_error_proto_rawDescData = file_errors_asset_error_proto_rawDesc
)

func file_errors_asset_error_proto_rawDescGZIP() []byte {
	file_errors_asset_error_proto_rawDescOnce.Do(func() {
		file_errors_asset_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_asset_error_proto_rawDescData)
	})
	return file_errors_asset_error_proto_rawDescData
}

var file_errors_asset_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_asset_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_asset_error_proto_goTypes = []interface{}{
	(AssetErrorEnum_AssetError)(0), // 0: google.ads.googleads.v15.errors.AssetErrorEnum.AssetError
	(*AssetErrorEnum)(nil),         // 1: google.ads.googleads.v15.errors.AssetErrorEnum
}
var file_errors_asset_error_proto_depIdxs = []int32{
...
func init() { file_errors_asset_error_proto_init() }
func file_errors_asset_error_proto_init() {
	if File_errors_asset_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_asset_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_asset_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_asset_error_proto_goTypes,
		DependencyIndexes: file_errors_asset_error_proto_depIdxs,
		EnumInfos:         file_errors_asset_error_proto_enumTypes,
		MessageInfos:      file_errors_asset_error_proto_msgTypes,
	}.Build()
	File_errors_asset_error_proto = out.File
	file_errors_asset_error_proto_rawDesc = nil
	file_errors_asset_error_proto_goTypes = nil
	file_errors_asset_error_proto_depIdxs = nil
}
