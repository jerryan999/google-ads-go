...
var file_errors_media_upload_error_proto_goTypes = []interface{}{
	(MediaUploadErrorEnum_MediaUploadError)(0), // 0: google.ads.googleads.v9.errors.MediaUploadErrorEnum.MediaUploadError
	(*MediaUploadErrorEnum)(nil),               // 1: google.ads.googleads.v9.errors.MediaUploadErrorEnum
}
