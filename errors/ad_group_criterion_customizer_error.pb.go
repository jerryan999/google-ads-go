...
var file_errors_ad_group_criterion_customizer_error_proto_goTypes = []any{
...
func file_errors_ad_group_criterion_customizer_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_errors_ad_group_criterion_customizer_error_proto_msgTypes[0].Exporter = func(v any, i int) any {
