...
func (CampaignCustomizerErrorEnum_CampaignCustomizerError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_campaign_customizer_error_proto_enumTypes[0].Descriptor()
}

func (CampaignCustomizerErrorEnum_CampaignCustomizerError) Type() protoreflect.EnumType {
	return &file_errors_campaign_customizer_error_proto_enumTypes[0]
}
...
func (CampaignCustomizerErrorEnum_CampaignCustomizerError) EnumDescriptor() ([]byte, []int) {
	return file_errors_campaign_customizer_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *CampaignCustomizerErrorEnum) Reset() {
	*x = CampaignCustomizerErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_campaign_customizer_error_proto_msgTypes[0]
...
func (*CampaignCustomizerErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_campaign_customizer_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_campaign_customizer_error_proto protoreflect.FileDescriptor

var file_errors_campaign_customizer_error_proto_rawDesc = []byte{
	...
	0x2f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x17, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69,
...
var (
	file_errors_campaign_customizer_error_proto_rawDescOnce sync.Once
	file_errors_campaign_customizer_error_proto_rawDescData = file_errors_campaign_customizer_error_proto_rawDesc
)

func file_errors_campaign_customizer_error_proto_rawDescGZIP() []byte {
	file_errors_campaign_customizer_error_proto_rawDescOnce.Do(func() {
		file_errors_campaign_customizer_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_campaign_customizer_error_proto_rawDescData)
	})
	return file_errors_campaign_customizer_error_proto_rawDescData
}

var file_errors_campaign_customizer_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_campaign_customizer_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_campaign_customizer_error_proto_goTypes = []interface{}{
	(CampaignCustomizerErrorEnum_CampaignCustomizerError)(0), // 0: google.ads.googleads.v9.errors.CampaignCustomizerErrorEnum.CampaignCustomizerError
	(*CampaignCustomizerErrorEnum)(nil),                      // 1: google.ads.googleads.v9.errors.CampaignCustomizerErrorEnum
}
var file_errors_campaign_customizer_error_proto_depIdxs = []int32{
...
func init() { file_errors_campaign_customizer_error_proto_init() }
func file_errors_campaign_customizer_error_proto_init() {
	if File_errors_campaign_customizer_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_campaign_customizer_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_campaign_customizer_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_campaign_customizer_error_proto_goTypes,
		DependencyIndexes: file_errors_campaign_customizer_error_proto_depIdxs,
		EnumInfos:         file_errors_campaign_customizer_error_proto_enumTypes,
		MessageInfos:      file_errors_campaign_customizer_error_proto_msgTypes,
	}.Build()
	File_errors_campaign_customizer_error_proto = out.File
	file_errors_campaign_customizer_error_proto_rawDesc = nil
	file_errors_campaign_customizer_error_proto_goTypes = nil
	file_errors_campaign_customizer_error_proto_depIdxs = nil
}
