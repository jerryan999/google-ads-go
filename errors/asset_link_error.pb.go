...
var file_errors_asset_link_error_proto_goTypes = []interface{}{
	(AssetLinkErrorEnum_AssetLinkError)(0), // 0: google.ads.googleads.v9.errors.AssetLinkErrorEnum.AssetLinkError
	(*AssetLinkErrorEnum)(nil),             // 1: google.ads.googleads.v9.errors.AssetLinkErrorEnum
}
