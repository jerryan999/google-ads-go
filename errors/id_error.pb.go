...
func (x IdErrorEnum_IdError) Enum() *IdErrorEnum_IdError {
	p := new(IdErrorEnum_IdError)
	*p = x
	return p
}
...
func (IdErrorEnum_IdError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_id_error_proto_enumTypes[0].Descriptor()
}

func (IdErrorEnum_IdError) Type() protoreflect.EnumType {
	return &file_errors_id_error_proto_enumTypes[0]
}
...
func (IdErrorEnum_IdError) EnumDescriptor() ([]byte, []int) {
	return file_errors_id_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *IdErrorEnum) Reset() {
	*x = IdErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_id_error_proto_msgTypes[0]
...
func (*IdErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_id_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_id_error_proto protoreflect.FileDescriptor

var file_errors_id_error_proto_rawDesc = []byte{
	...
	0x2f, 0x69, 0x64, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x0b, 0x49, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x36, 0x0a, 0x07,
	0x49, 0x64, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x0f, 0x0a, 0x0b, 0x55, 0x4e, 0x53, 0x50, 0x45,
	...
	0x4e, 0x44, 0x10, 0x02, 0x42, 0xe7, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x39, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x0c, 0x49, 0x64, 0x45,
...
var (
	file_errors_id_error_proto_rawDescOnce sync.Once
	file_errors_id_error_proto_rawDescData = file_errors_id_error_proto_rawDesc
)

func file_errors_id_error_proto_rawDescGZIP() []byte {
	file_errors_id_error_proto_rawDescOnce.Do(func() {
		file_errors_id_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_id_error_proto_rawDescData)
	})
	return file_errors_id_error_proto_rawDescData
}

var file_errors_id_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_id_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_id_error_proto_goTypes = []interface{}{
	(IdErrorEnum_IdError)(0), // 0: google.ads.googleads.v9.errors.IdErrorEnum.IdError
	(*IdErrorEnum)(nil),      // 1: google.ads.googleads.v9.errors.IdErrorEnum
}
var file_errors_id_error_proto_depIdxs = []int32{
...
func init() { file_errors_id_error_proto_init() }
func file_errors_id_error_proto_init() {
	if File_errors_id_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_id_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_id_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_id_error_proto_goTypes,
		DependencyIndexes: file_errors_id_error_proto_depIdxs,
		EnumInfos:         file_errors_id_error_proto_enumTypes,
		MessageInfos:      file_errors_id_error_proto_msgTypes,
	}.Build()
	File_errors_id_error_proto = out.File
	file_errors_id_error_proto_rawDesc = nil
	file_errors_id_error_proto_goTypes = nil
	file_errors_id_error_proto_depIdxs = nil
}
