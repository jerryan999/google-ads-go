...
var file_errors_field_error_proto_goTypes = []interface{}{
	(FieldErrorEnum_FieldError)(0), // 0: google.ads.googleads.v15.errors.FieldErrorEnum.FieldError
	(*FieldErrorEnum)(nil),         // 1: google.ads.googleads.v15.errors.FieldErrorEnum
}
