...
var file_errors_header_error_proto_goTypes = []interface{}{
	(HeaderErrorEnum_HeaderError)(0), // 0: google.ads.googleads.v9.errors.HeaderErrorEnum.HeaderError
	(*HeaderErrorEnum)(nil),          // 1: google.ads.googleads.v9.errors.HeaderErrorEnum
}
