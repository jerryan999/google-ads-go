...
func (x *ErrorCode) GetVideoCampaignError() VideoCampaignErrorEnum_VideoCampaignError {
	if x, ok := x.GetErrorCode().(*ErrorCode_VideoCampaignError); ok {
		return x.VideoCampaignError
	}
	return VideoCampaignErrorEnum_UNSPECIFIED
}
...
func (x *ErrorCode) GetIdentityVerificationError() IdentityVerificationErrorEnum_IdentityVerificationError {
	if x, ok := x.GetErrorCode().(*ErrorCode_IdentityVerificationError); ok {
		return x.IdentityVerificationError
	}
...
func (*ErrorCode_VideoCampaignError) isErrorCode_ErrorCode() {}
...
func file_errors_errors_proto_init() {
	...
	file_errors_identity_verification_error_proto_init()
	...
	file_errors_shopping_product_error_proto_init()
	...
	file_errors_user_list_customer_type_error_proto_init()
	file_errors_user_list_error_proto_init()
	file_errors_video_campaign_error_proto_init()
	file_errors_youtube_video_registration_error_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_errors_errors_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_errors_errors_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_errors_errors_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*ErrorCode_VideoCampaignError)(nil),
	...
	file_errors_errors_proto_msgTypes[9].OneofWrappers = []any{}
	type x struct{}
