...
func (x KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError) Enum() *KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError {
	p := new(KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError)
	*p = x
	return p
}

func (x KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError) String() string {
...
func (KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_keyword_plan_campaign_keyword_error_proto_enumTypes[0].Descriptor()
}

func (KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError) Type() protoreflect.EnumType {
	return &file_errors_keyword_plan_campaign_keyword_error_proto_enumTypes[0]
}
...
func (KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError) EnumDescriptor() ([]byte, []int) {
	return file_errors_keyword_plan_campaign_keyword_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *KeywordPlanCampaignKeywordErrorEnum) Reset() {
	*x = KeywordPlanCampaignKeywordErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_keyword_plan_campaign_keyword_error_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *KeywordPlanCampaignKeywordErrorEnum) String() string {
...
func (*KeywordPlanCampaignKeywordErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_keyword_plan_campaign_keyword_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_keyword_plan_campaign_keyword_error_proto protoreflect.FileDescriptor

var file_errors_keyword_plan_campaign_keyword_error_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x5f, 0x65,
	...
	0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x01, 0x0a, 0x23, 0x4b, 0x65, 0x79,
	...
	0x22, 0x61, 0x0a, 0x1f, 0x4b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x50, 0x6c, 0x61, 0x6e, 0x43,
	0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x4b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64, 0x45, 0x72,
	...
	0x01, 0x12, 0x20, 0x0a, 0x1c, 0x43, 0x41, 0x4d, 0x50, 0x41, 0x49, 0x47, 0x4e, 0x5f, 0x4b, 0x45,
	0x59, 0x57, 0x4f, 0x52, 0x44, 0x5f, 0x49, 0x53, 0x5f, 0x50, 0x4f, 0x53, 0x49, 0x54, 0x49, 0x56,
	0x45, 0x10, 0x08, 0x42, 0xff, 0x01, 0x0a, 0x22, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x39, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x24, 0x4b, 0x65, 0x79, 0x77,
...
var (
	file_errors_keyword_plan_campaign_keyword_error_proto_rawDescOnce sync.Once
	file_errors_keyword_plan_campaign_keyword_error_proto_rawDescData = file_errors_keyword_plan_campaign_keyword_error_proto_rawDesc
)

func file_errors_keyword_plan_campaign_keyword_error_proto_rawDescGZIP() []byte {
	file_errors_keyword_plan_campaign_keyword_error_proto_rawDescOnce.Do(func() {
		file_errors_keyword_plan_campaign_keyword_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_keyword_plan_campaign_keyword_error_proto_rawDescData)
	})
	return file_errors_keyword_plan_campaign_keyword_error_proto_rawDescData
}

var file_errors_keyword_plan_campaign_keyword_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_keyword_plan_campaign_keyword_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_keyword_plan_campaign_keyword_error_proto_goTypes = []interface{}{
	(KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError)(0), // 0: google.ads.googleads.v9.errors.KeywordPlanCampaignKeywordErrorEnum.KeywordPlanCampaignKeywordError
	(*KeywordPlanCampaignKeywordErrorEnum)(nil),                              // 1: google.ads.googleads.v9.errors.KeywordPlanCampaignKeywordErrorEnum
}
var file_errors_keyword_plan_campaign_keyword_error_proto_depIdxs = []int32{
...
func init() { file_errors_keyword_plan_campaign_keyword_error_proto_init() }
func file_errors_keyword_plan_campaign_keyword_error_proto_init() {
	if File_errors_keyword_plan_campaign_keyword_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_keyword_plan_campaign_keyword_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_keyword_plan_campaign_keyword_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_keyword_plan_campaign_keyword_error_proto_goTypes,
		DependencyIndexes: file_errors_keyword_plan_campaign_keyword_error_proto_depIdxs,
		EnumInfos:         file_errors_keyword_plan_campaign_keyword_error_proto_enumTypes,
		MessageInfos:      file_errors_keyword_plan_campaign_keyword_error_proto_msgTypes,
	}.Build()
	File_errors_keyword_plan_campaign_keyword_error_proto = out.File
	file_errors_keyword_plan_campaign_keyword_error_proto_rawDesc = nil
	file_errors_keyword_plan_campaign_keyword_error_proto_goTypes = nil
	file_errors_keyword_plan_campaign_keyword_error_proto_depIdxs = nil
}
