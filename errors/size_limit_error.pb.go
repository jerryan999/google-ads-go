...
func (SizeLimitErrorEnum_SizeLimitError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_size_limit_error_proto_enumTypes[0].Descriptor()
}

func (SizeLimitErrorEnum_SizeLimitError) Type() protoreflect.EnumType {
	return &file_errors_size_limit_error_proto_enumTypes[0]
}
...
func (SizeLimitErrorEnum_SizeLimitError) EnumDescriptor() ([]byte, []int) {
	return file_errors_size_limit_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SizeLimitErrorEnum) Reset() {
	*x = SizeLimitErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_size_limit_error_proto_msgTypes[0]
...
func (*SizeLimitErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_size_limit_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_size_limit_error_proto protoreflect.FileDescriptor

var file_errors_size_limit_error_proto_rawDesc = []byte{
	...
	0x31, 0x35, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x87, 0x01, 0x0a, 0x12, 0x53, 0x69,
	...
	0x12, 0x1f, 0x0a, 0x1b, 0x52, 0x45, 0x51, 0x55, 0x45, 0x53, 0x54, 0x5f, 0x53, 0x49, 0x5a, 0x45,
	0x5f, 0x4c, 0x49, 0x4d, 0x49, 0x54, 0x5f, 0x45, 0x58, 0x43, 0x45, 0x45, 0x44, 0x45, 0x44, 0x10,
	0x02, 0x12, 0x20, 0x0a, 0x1c, 0x52, 0x45, 0x53, 0x50, 0x4f, 0x4e, 0x53, 0x45, 0x5f, 0x53, 0x49,
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x13, 0x53, 0x69, 0x7a,
...
var (
	file_errors_size_limit_error_proto_rawDescOnce sync.Once
	file_errors_size_limit_error_proto_rawDescData = file_errors_size_limit_error_proto_rawDesc
)

func file_errors_size_limit_error_proto_rawDescGZIP() []byte {
	file_errors_size_limit_error_proto_rawDescOnce.Do(func() {
		file_errors_size_limit_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_size_limit_error_proto_rawDescData)
	})
	return file_errors_size_limit_error_proto_rawDescData
}

var file_errors_size_limit_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_size_limit_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_size_limit_error_proto_goTypes = []interface{}{
	(SizeLimitErrorEnum_SizeLimitError)(0), // 0: google.ads.googleads.v15.errors.SizeLimitErrorEnum.SizeLimitError
	(*SizeLimitErrorEnum)(nil),             // 1: google.ads.googleads.v15.errors.SizeLimitErrorEnum
}
var file_errors_size_limit_error_proto_depIdxs = []int32{
...
func init() { file_errors_size_limit_error_proto_init() }
func file_errors_size_limit_error_proto_init() {
	if File_errors_size_limit_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_size_limit_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_size_limit_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_size_limit_error_proto_goTypes,
		DependencyIndexes: file_errors_size_limit_error_proto_depIdxs,
		EnumInfos:         file_errors_size_limit_error_proto_enumTypes,
		MessageInfos:      file_errors_size_limit_error_proto_msgTypes,
	}.Build()
	File_errors_size_limit_error_proto = out.File
	file_errors_size_limit_error_proto_rawDesc = nil
	file_errors_size_limit_error_proto_goTypes = nil
	file_errors_size_limit_error_proto_depIdxs = nil
}
