...
func (ProductLinkInvitationErrorEnum_ProductLinkInvitationError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_product_link_invitation_error_proto_enumTypes[0].Descriptor()
}

func (ProductLinkInvitationErrorEnum_ProductLinkInvitationError) Type() protoreflect.EnumType {
	return &file_errors_product_link_invitation_error_proto_enumTypes[0]
}
...
func (ProductLinkInvitationErrorEnum_ProductLinkInvitationError) EnumDescriptor() ([]byte, []int) {
	return file_errors_product_link_invitation_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *ProductLinkInvitationErrorEnum) Reset() {
	*x = ProductLinkInvitationErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_errors_product_link_invitation_error_proto_msgTypes[0]
...
func (*ProductLinkInvitationErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_product_link_invitation_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_product_link_invitation_error_proto protoreflect.FileDescriptor

var file_errors_product_link_invitation_error_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0xa4, 0x01, 0x0a, 0x1e, 0x50, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x4c, 0x69, 0x6e, 0x6b, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x81, 0x01, 0x0a, 0x1a, 0x50, 0x72,
	...
	0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49,
	0x44, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x10, 0x02, 0x12, 0x15, 0x0a, 0x11, 0x50, 0x45,
	0x52, 0x4d, 0x49, 0x53, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x44, 0x45, 0x4e, 0x49, 0x45, 0x44, 0x10,
	0x03, 0x12, 0x1a, 0x0a, 0x16, 0x4e, 0x4f, 0x5f, 0x49, 0x4e, 0x56, 0x49, 0x54, 0x41, 0x54, 0x49,
	0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x51, 0x55, 0x49, 0x52, 0x45, 0x44, 0x10, 0x04, 0x42, 0xff, 0x01,
	...
	0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x1f, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x4c, 0x69,
	0x6e, 0x6b, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f,
...
var (
	file_errors_product_link_invitation_error_proto_rawDescOnce sync.Once
	file_errors_product_link_invitation_error_proto_rawDescData = file_errors_product_link_invitation_error_proto_rawDesc
)

func file_errors_product_link_invitation_error_proto_rawDescGZIP() []byte {
	file_errors_product_link_invitation_error_proto_rawDescOnce.Do(func() {
		file_errors_product_link_invitation_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_errors_product_link_invitation_error_proto_rawDescData)
	})
	return file_errors_product_link_invitation_error_proto_rawDescData
}

var file_errors_product_link_invitation_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_product_link_invitation_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_product_link_invitation_error_proto_goTypes = []interface{}{
	(ProductLinkInvitationErrorEnum_ProductLinkInvitationError)(0), // 0: google.ads.googleads.v15.errors.ProductLinkInvitationErrorEnum.ProductLinkInvitationError
	(*ProductLinkInvitationErrorEnum)(nil),                         // 1: google.ads.googleads.v15.errors.ProductLinkInvitationErrorEnum
}
var file_errors_product_link_invitation_error_proto_depIdxs = []int32{
...
func init() { file_errors_product_link_invitation_error_proto_init() }
func file_errors_product_link_invitation_error_proto_init() {
	if File_errors_product_link_invitation_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_errors_product_link_invitation_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_errors_product_link_invitation_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_product_link_invitation_error_proto_goTypes,
		DependencyIndexes: file_errors_product_link_invitation_error_proto_depIdxs,
		EnumInfos:         file_errors_product_link_invitation_error_proto_enumTypes,
		MessageInfos:      file_errors_product_link_invitation_error_proto_msgTypes,
	}.Build()
	File_errors_product_link_invitation_error_proto = out.File
	file_errors_product_link_invitation_error_proto_rawDesc = nil
	file_errors_product_link_invitation_error_proto_goTypes = nil
	file_errors_product_link_invitation_error_proto_depIdxs = nil
}
