...
const (
	AssetService_MutateAssets_FullMethodName = "/google.ads.googleads.v17.services.AssetService/MutateAssets"
)
...
func (c *assetServiceClient) MutateAssets(ctx context.Context, in *MutateAssetsRequest, opts ...grpc.CallOption) (*MutateAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssetService_MutateAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AssetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.AssetService",
	...
	Metadata: "google/ads/googleads/v17/services/asset_service.proto",
}
