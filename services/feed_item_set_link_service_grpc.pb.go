...
const (
	FeedItemSetLinkService_MutateFeedItemSetLinks_FullMethodName = "/google.ads.googleads.v17.services.FeedItemSetLinkService/MutateFeedItemSetLinks"
)
...
func (c *feedItemSetLinkServiceClient) MutateFeedItemSetLinks(ctx context.Context, in *MutateFeedItemSetLinksRequest, opts ...grpc.CallOption) (*MutateFeedItemSetLinksResponse, error) {
	...
	err := c.cc.Invoke(ctx, FeedItemSetLinkService_MutateFeedItemSetLinks_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var FeedItemSetLinkService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.FeedItemSetLinkService",
	...
	Metadata: "google/ads/googleads/v17/services/feed_item_set_link_service.proto",
}
