...
const (
	TravelAssetSuggestionService_SuggestTravelAssets_FullMethodName = "/google.ads.googleads.v17.services.TravelAssetSuggestionService/SuggestTravelAssets"
)
...
func (c *travelAssetSuggestionServiceClient) SuggestTravelAssets(ctx context.Context, in *SuggestTravelAssetsRequest, opts ...grpc.CallOption) (*SuggestTravelAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TravelAssetSuggestionService_SuggestTravelAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
