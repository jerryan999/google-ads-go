...
const (
	CampaignBudgetService_MutateCampaignBudgets_FullMethodName = "/google.ads.googleads.v17.services.CampaignBudgetService/MutateCampaignBudgets"
)
...
func (c *campaignBudgetServiceClient) MutateCampaignBudgets(ctx context.Context, in *MutateCampaignBudgetsRequest, opts ...grpc.CallOption) (*MutateCampaignBudgetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampaignBudgetService_MutateCampaignBudgets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CampaignBudgetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CampaignBudgetService",
	...
	Metadata: "google/ads/googleads/v17/services/campaign_budget_service.proto",
}
