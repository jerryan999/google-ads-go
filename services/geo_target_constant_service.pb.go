...
func (*GeoTargetConstantSuggestion) Descriptor() ([]byte, []int) {
	return file_services_geo_target_constant_service_proto_rawDescGZIP(), []int{3}
}
...
func (*SuggestGeoTargetConstantsRequest_LocationNames) Descriptor() ([]byte, []int) {
	return file_services_geo_target_constant_service_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *SuggestGeoTargetConstantsRequest_GeoTargets) Reset() {
	*x = SuggestGeoTargetConstantsRequest_GeoTargets{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_geo_target_constant_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SuggestGeoTargetConstantsRequest_GeoTargets) Descriptor() ([]byte, []int) {
	return file_services_geo_target_constant_service_proto_rawDescGZIP(), []int{1, 1}
}
...
var file_services_geo_target_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
func file_services_geo_target_constant_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_geo_target_constant_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_geo_target_constant_service_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*SuggestGeoTargetConstantsRequest_LocationNames_)(nil),
		(*SuggestGeoTargetConstantsRequest_GeoTargets_)(nil),
	}
	file_services_geo_target_constant_service_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
