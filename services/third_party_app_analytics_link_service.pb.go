...
var file_services_third_party_app_analytics_link_service_proto_rawDesc = []byte{
	...
	0x31, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x67, 0x65,
...
var file_services_third_party_app_analytics_link_service_proto_goTypes = []any{
	(*RegenerateShareableLinkIdRequest)(nil),  // 0: google.ads.googleads.v17.services.RegenerateShareableLinkIdRequest
	(*RegenerateShareableLinkIdResponse)(nil), // 1: google.ads.googleads.v17.services.RegenerateShareableLinkIdResponse
}
var file_services_third_party_app_analytics_link_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v17.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId:input_type -> google.ads.googleads.v17.services.RegenerateShareableLinkIdRequest
	1, // 1: google.ads.googleads.v17.services.ThirdPartyAppAnalyticsLinkService.RegenerateShareableLinkId:output_type -> google.ads.googleads.v17.services.RegenerateShareableLinkIdResponse
...
func file_services_third_party_app_analytics_link_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_third_party_app_analytics_link_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_third_party_app_analytics_link_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
