...
const (
	GoogleAdsFieldService_GetGoogleAdsField_FullMethodName     = "/google.ads.googleads.v17.services.GoogleAdsFieldService/GetGoogleAdsField"
	GoogleAdsFieldService_SearchGoogleAdsFields_FullMethodName = "/google.ads.googleads.v17.services.GoogleAdsFieldService/SearchGoogleAdsFields"
)
...
func (c *googleAdsFieldServiceClient) GetGoogleAdsField(ctx context.Context, in *GetGoogleAdsFieldRequest, opts ...grpc.CallOption) (*resources.GoogleAdsField, error) {
	...
	err := c.cc.Invoke(ctx, GoogleAdsFieldService_GetGoogleAdsField_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *googleAdsFieldServiceClient) SearchGoogleAdsFields(ctx context.Context, in *SearchGoogleAdsFieldsRequest, opts ...grpc.CallOption) (*SearchGoogleAdsFieldsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoogleAdsFieldService_SearchGoogleAdsFields_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var GoogleAdsFieldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.GoogleAdsFieldService",
	...
	Metadata: "google/ads/googleads/v17/services/google_ads_field_service.proto",
}
