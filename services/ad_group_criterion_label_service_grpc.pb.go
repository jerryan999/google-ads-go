...
const (
	AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_FullMethodName = "/google.ads.googleads.v17.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels"
)
...
func (c *adGroupCriterionLabelServiceClient) MutateAdGroupCriterionLabels(ctx context.Context, in *MutateAdGroupCriterionLabelsRequest, opts ...grpc.CallOption) (*MutateAdGroupCriterionLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AdGroupCriterionLabelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.AdGroupCriterionLabelService",
	...
	Metadata: "google/ads/googleads/v17/services/ad_group_criterion_label_service.proto",
}
