...
func (c *customerUserAccessInvitationServiceClient) MutateCustomerUserAccessInvitation(ctx context.Context, in *MutateCustomerUserAccessInvitationRequest, opts ...grpc.CallOption) (*MutateCustomerUserAccessInvitationResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomerUserAccessInvitationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomerUserAccessInvitationService",
	...
	Metadata: "google/ads/googleads/v17/services/customer_user_access_invitation_service.proto",
}
