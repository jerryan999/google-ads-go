...
func file_services_smart_campaign_setting_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_smart_campaign_setting_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_smart_campaign_setting_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_smart_campaign_setting_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_smart_campaign_setting_service_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_smart_campaign_setting_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_smart_campaign_setting_service_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_smart_campaign_setting_service_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_services_smart_campaign_setting_service_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_services_smart_campaign_setting_service_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_services_smart_campaign_setting_service_proto_msgTypes[4].OneofWrappers = []interface{}{}
	file_services_smart_campaign_setting_service_proto_msgTypes[5].OneofWrappers = []interface{}{}
	file_services_smart_campaign_setting_service_proto_msgTypes[6].OneofWrappers = []interface{}{
