...
func (x *GetAdGroupAdLabelRequest) Reset() {
	*x = GetAdGroupAdLabelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_ad_label_service_proto_msgTypes[0]
...
func (*GetAdGroupAdLabelRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupAdLabelsRequest) Reset() {
	*x = MutateAdGroupAdLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_ad_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdLabelsRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupAdLabelOperation) Reset() {
	*x = AdGroupAdLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_ad_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAdLabelOperation) Descriptor() ([]byte, []int) {
	return file_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAdLabelsResponse) Reset() {
	*x = MutateAdGroupAdLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_ad_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdLabelsResponse) Descriptor() ([]byte, []int) {
	return file_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupAdLabelResult) Reset() {
	*x = MutateAdGroupAdLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_ad_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAdLabelResult) Descriptor() ([]byte, []int) {
	return file_services_ad_group_ad_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_ad_group_ad_label_service_proto_rawDesc = []byte{
...
var (
	file_services_ad_group_ad_label_service_proto_rawDescOnce sync.Once
	file_services_ad_group_ad_label_service_proto_rawDescData = file_services_ad_group_ad_label_service_proto_rawDesc
)

func file_services_ad_group_ad_label_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_ad_label_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_ad_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_ad_group_ad_label_service_proto_rawDescData)
	})
	return file_services_ad_group_ad_label_service_proto_rawDescData
}

var file_services_ad_group_ad_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_ad_group_ad_label_service_proto_goTypes = []interface{}{
	(*GetAdGroupAdLabelRequest)(nil),      // 0: google.ads.googleads.v9.services.GetAdGroupAdLabelRequest
	(*MutateAdGroupAdLabelsRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest
	(*AdGroupAdLabelOperation)(nil),       // 2: google.ads.googleads.v9.services.AdGroupAdLabelOperation
	(*MutateAdGroupAdLabelsResponse)(nil), // 3: google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse
	(*MutateAdGroupAdLabelResult)(nil),    // 4: google.ads.googleads.v9.services.MutateAdGroupAdLabelResult
	(*resources.AdGroupAdLabel)(nil),      // 5: google.ads.googleads.v9.resources.AdGroupAdLabel
	(*status.Status)(nil),                 // 6: google.rpc.Status
}
var file_services_ad_group_ad_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest.operations:type_name -> google.ads.googleads.v9.services.AdGroupAdLabelOperation
	5, // 1: google.ads.googleads.v9.services.AdGroupAdLabelOperation.create:type_name -> google.ads.googleads.v9.resources.AdGroupAdLabel
	6, // 2: google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse.results:type_name -> google.ads.googleads.v9.services.MutateAdGroupAdLabelResult
	0, // 4: google.ads.googleads.v9.services.AdGroupAdLabelService.GetAdGroupAdLabel:input_type -> google.ads.googleads.v9.services.GetAdGroupAdLabelRequest
	1, // 5: google.ads.googleads.v9.services.AdGroupAdLabelService.MutateAdGroupAdLabels:input_type -> google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest
	5, // 6: google.ads.googleads.v9.services.AdGroupAdLabelService.GetAdGroupAdLabel:output_type -> google.ads.googleads.v9.resources.AdGroupAdLabel
	3, // 7: google.ads.googleads.v9.services.AdGroupAdLabelService.MutateAdGroupAdLabels:output_type -> google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse
...
func init() { file_services_ad_group_ad_label_service_proto_init() }
func file_services_ad_group_ad_label_service_proto_init() {
	if File_services_ad_group_ad_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_ad_group_ad_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_ad_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_ad_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_ad_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_ad_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_ad_group_ad_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_ad_group_ad_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_ad_group_ad_label_service_proto_goTypes,
		DependencyIndexes: file_services_ad_group_ad_label_service_proto_depIdxs,
		MessageInfos:      file_services_ad_group_ad_label_service_proto_msgTypes,
	}.Build()
	File_services_ad_group_ad_label_service_proto = out.File
	file_services_ad_group_ad_label_service_proto_rawDesc = nil
	file_services_ad_group_ad_label_service_proto_goTypes = nil
	file_services_ad_group_ad_label_service_proto_depIdxs = nil
}
