...
const (
	AdGroupCriterionService_MutateAdGroupCriteria_FullMethodName = "/google.ads.googleads.v17.services.AdGroupCriterionService/MutateAdGroupCriteria"
)
...
func (c *adGroupCriterionServiceClient) MutateAdGroupCriteria(ctx context.Context, in *MutateAdGroupCriteriaRequest, opts ...grpc.CallOption) (*MutateAdGroupCriteriaResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdGroupCriterionService_MutateAdGroupCriteria_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AdGroupCriterionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.AdGroupCriterionService",
	...
	Metadata: "google/ads/googleads/v17/services/ad_group_criterion_service.proto",
}
