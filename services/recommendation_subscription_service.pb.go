...
var file_services_recommendation_subscription_service_proto_goTypes = []interface{}{
...
func file_services_recommendation_subscription_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_recommendation_subscription_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_recommendation_subscription_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_recommendation_subscription_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_recommendation_subscription_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_recommendation_subscription_service_proto_msgTypes[1].OneofWrappers = []interface{}{
