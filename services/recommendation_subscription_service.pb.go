...
func (x *MutateRecommendationSubscriptionRequest) Reset() {
	*x = MutateRecommendationSubscriptionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_recommendation_subscription_service_proto_msgTypes[0]
...
func (*MutateRecommendationSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RecommendationSubscriptionOperation) Reset() {
	*x = RecommendationSubscriptionOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_recommendation_subscription_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RecommendationSubscriptionOperation) Descriptor() ([]byte, []int) {
	return file_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateRecommendationSubscriptionResponse) Reset() {
	*x = MutateRecommendationSubscriptionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_recommendation_subscription_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRecommendationSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateRecommendationSubscriptionResult) Reset() {
	*x = MutateRecommendationSubscriptionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_recommendation_subscription_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRecommendationSubscriptionResult) Descriptor() ([]byte, []int) {
	return file_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{3}
}
...
var File_services_recommendation_subscription_service_proto protoreflect.FileDescriptor

var file_services_recommendation_subscription_service_proto_rawDesc = []byte{
	...
	0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
	...
	0x93, 0x02, 0x60, 0x3a, 0x01, 0x2a, 0x22, 0x5b, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73,
...
var (
	file_services_recommendation_subscription_service_proto_rawDescOnce sync.Once
	file_services_recommendation_subscription_service_proto_rawDescData = file_services_recommendation_subscription_service_proto_rawDesc
)

func file_services_recommendation_subscription_service_proto_rawDescGZIP() []byte {
	file_services_recommendation_subscription_service_proto_rawDescOnce.Do(func() {
		file_services_recommendation_subscription_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_recommendation_subscription_service_proto_rawDescData)
	})
	return file_services_recommendation_subscription_service_proto_rawDescData
}

var file_services_recommendation_subscription_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_recommendation_subscription_service_proto_goTypes = []any{
	(*MutateRecommendationSubscriptionRequest)(nil),        // 0: google.ads.googleads.v17.services.MutateRecommendationSubscriptionRequest
	(*RecommendationSubscriptionOperation)(nil),            // 1: google.ads.googleads.v17.services.RecommendationSubscriptionOperation
	(*MutateRecommendationSubscriptionResponse)(nil),       // 2: google.ads.googleads.v17.services.MutateRecommendationSubscriptionResponse
	(*MutateRecommendationSubscriptionResult)(nil),         // 3: google.ads.googleads.v17.services.MutateRecommendationSubscriptionResult
	...
	(*resources.RecommendationSubscription)(nil),           // 6: google.ads.googleads.v17.resources.RecommendationSubscription
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_services_recommendation_subscription_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateRecommendationSubscriptionRequest.operations:type_name -> google.ads.googleads.v17.services.RecommendationSubscriptionOperation
	4, // 1: google.ads.googleads.v17.services.MutateRecommendationSubscriptionRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.RecommendationSubscriptionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v17.services.RecommendationSubscriptionOperation.create:type_name -> google.ads.googleads.v17.resources.RecommendationSubscription
	...
	3, // 5: google.ads.googleads.v17.services.MutateRecommendationSubscriptionResponse.results:type_name -> google.ads.googleads.v17.services.MutateRecommendationSubscriptionResult
	7, // 6: google.ads.googleads.v17.services.MutateRecommendationSubscriptionResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v17.services.MutateRecommendationSubscriptionResult.recommendation_subscription:type_name -> google.ads.googleads.v17.resources.RecommendationSubscription
	0, // 8: google.ads.googleads.v17.services.RecommendationSubscriptionService.MutateRecommendationSubscription:input_type -> google.ads.googleads.v17.services.MutateRecommendationSubscriptionRequest
	2, // 9: google.ads.googleads.v17.services.RecommendationSubscriptionService.MutateRecommendationSubscription:output_type -> google.ads.googleads.v17.services.MutateRecommendationSubscriptionResponse
...
func init() { file_services_recommendation_subscription_service_proto_init() }
func file_services_recommendation_subscription_service_proto_init() {
	if File_services_recommendation_subscription_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_recommendation_subscription_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_recommendation_subscription_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_recommendation_subscription_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_recommendation_subscription_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_recommendation_subscription_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_recommendation_subscription_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_recommendation_subscription_service_proto_goTypes,
		DependencyIndexes: file_services_recommendation_subscription_service_proto_depIdxs,
		MessageInfos:      file_services_recommendation_subscription_service_proto_msgTypes,
	}.Build()
	File_services_recommendation_subscription_service_proto = out.File
	file_services_recommendation_subscription_service_proto_rawDesc = nil
	file_services_recommendation_subscription_service_proto_goTypes = nil
	file_services_recommendation_subscription_service_proto_depIdxs = nil
}
