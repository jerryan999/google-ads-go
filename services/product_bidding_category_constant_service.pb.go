...
func (x *GetProductBiddingCategoryConstantRequest) Reset() {
	*x = GetProductBiddingCategoryConstantRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_product_bidding_category_constant_service_proto_msgTypes[0]
...
func (*GetProductBiddingCategoryConstantRequest) Descriptor() ([]byte, []int) {
	return file_services_product_bidding_category_constant_service_proto_rawDescGZIP(), []int{0}
}
...
var File_services_product_bidding_category_constant_service_proto protoreflect.FileDescriptor

var file_services_product_bidding_category_constant_service_proto_rawDesc = []byte{
...
var (
	file_services_product_bidding_category_constant_service_proto_rawDescOnce sync.Once
	file_services_product_bidding_category_constant_service_proto_rawDescData = file_services_product_bidding_category_constant_service_proto_rawDesc
)

func file_services_product_bidding_category_constant_service_proto_rawDescGZIP() []byte {
	file_services_product_bidding_category_constant_service_proto_rawDescOnce.Do(func() {
		file_services_product_bidding_category_constant_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_product_bidding_category_constant_service_proto_rawDescData)
	})
	return file_services_product_bidding_category_constant_service_proto_rawDescData
}

var file_services_product_bidding_category_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_services_product_bidding_category_constant_service_proto_goTypes = []interface{}{
	(*GetProductBiddingCategoryConstantRequest)(nil), // 0: google.ads.googleads.v9.services.GetProductBiddingCategoryConstantRequest
	(*resources.ProductBiddingCategoryConstant)(nil), // 1: google.ads.googleads.v9.resources.ProductBiddingCategoryConstant
}
var file_services_product_bidding_category_constant_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v9.services.ProductBiddingCategoryConstantService.GetProductBiddingCategoryConstant:input_type -> google.ads.googleads.v9.services.GetProductBiddingCategoryConstantRequest
	1, // 1: google.ads.googleads.v9.services.ProductBiddingCategoryConstantService.GetProductBiddingCategoryConstant:output_type -> google.ads.googleads.v9.resources.ProductBiddingCategoryConstant
...
func init() {
	file_services_product_bidding_category_constant_service_proto_init()
}
func file_services_product_bidding_category_constant_service_proto_init() {
	if File_services_product_bidding_category_constant_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_product_bidding_category_constant_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_product_bidding_category_constant_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_product_bidding_category_constant_service_proto_goTypes,
		DependencyIndexes: file_services_product_bidding_category_constant_service_proto_depIdxs,
		MessageInfos:      file_services_product_bidding_category_constant_service_proto_msgTypes,
	}.Build()
	File_services_product_bidding_category_constant_service_proto = out.File
	file_services_product_bidding_category_constant_service_proto_rawDesc = nil
	file_services_product_bidding_category_constant_service_proto_goTypes = nil
	file_services_product_bidding_category_constant_service_proto_depIdxs = nil
}
