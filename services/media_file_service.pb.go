...
func (x *GetMediaFileRequest) Reset() {
	*x = GetMediaFileRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_media_file_service_proto_msgTypes[0]
...
func (*GetMediaFileRequest) Descriptor() ([]byte, []int) {
	return file_services_media_file_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateMediaFilesRequest) Reset() {
	*x = MutateMediaFilesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_media_file_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateMediaFilesRequest) Descriptor() ([]byte, []int) {
	return file_services_media_file_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MediaFileOperation) Reset() {
	*x = MediaFileOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_media_file_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MediaFileOperation) Descriptor() ([]byte, []int) {
	return file_services_media_file_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateMediaFilesResponse) Reset() {
	*x = MutateMediaFilesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_media_file_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateMediaFilesResponse) Descriptor() ([]byte, []int) {
	return file_services_media_file_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateMediaFileResult) Reset() {
	*x = MutateMediaFileResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_media_file_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateMediaFileResult) Descriptor() ([]byte, []int) {
	return file_services_media_file_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_media_file_service_proto_rawDesc = []byte{
	...
	0x39, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x6d, 0x65, 0x64, 0x69,
	...
	0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x65, 0x64, 0x69,
	...
	0x2f, 0x2f, 0x76, 0x39, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b,
	...
	0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x15, 0x4d, 0x65,
...
var (
	file_services_media_file_service_proto_rawDescOnce sync.Once
	file_services_media_file_service_proto_rawDescData = file_services_media_file_service_proto_rawDesc
)

func file_services_media_file_service_proto_rawDescGZIP() []byte {
	file_services_media_file_service_proto_rawDescOnce.Do(func() {
		file_services_media_file_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_media_file_service_proto_rawDescData)
	})
	return file_services_media_file_service_proto_rawDescData
}

var file_services_media_file_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_media_file_service_proto_goTypes = []interface{}{
	(*GetMediaFileRequest)(nil),                            // 0: google.ads.googleads.v9.services.GetMediaFileRequest
	(*MutateMediaFilesRequest)(nil),                        // 1: google.ads.googleads.v9.services.MutateMediaFilesRequest
	(*MediaFileOperation)(nil),                             // 2: google.ads.googleads.v9.services.MediaFileOperation
	(*MutateMediaFilesResponse)(nil),                       // 3: google.ads.googleads.v9.services.MutateMediaFilesResponse
	(*MutateMediaFileResult)(nil),                          // 4: google.ads.googleads.v9.services.MutateMediaFileResult
	...
	(*resources.MediaFile)(nil),                            // 6: google.ads.googleads.v9.resources.MediaFile
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_services_media_file_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateMediaFilesRequest.operations:type_name -> google.ads.googleads.v9.services.MediaFileOperation
	5, // 1: google.ads.googleads.v9.services.MutateMediaFilesRequest.response_content_type:type_name -> google.ads.googleads.v9.enums.ResponseContentTypeEnum.ResponseContentType
	6, // 2: google.ads.googleads.v9.services.MediaFileOperation.create:type_name -> google.ads.googleads.v9.resources.MediaFile
	7, // 3: google.ads.googleads.v9.services.MutateMediaFilesResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 4: google.ads.googleads.v9.services.MutateMediaFilesResponse.results:type_name -> google.ads.googleads.v9.services.MutateMediaFileResult
	6, // 5: google.ads.googleads.v9.services.MutateMediaFileResult.media_file:type_name -> google.ads.googleads.v9.resources.MediaFile
	0, // 6: google.ads.googleads.v9.services.MediaFileService.GetMediaFile:input_type -> google.ads.googleads.v9.services.GetMediaFileRequest
	1, // 7: google.ads.googleads.v9.services.MediaFileService.MutateMediaFiles:input_type -> google.ads.googleads.v9.services.MutateMediaFilesRequest
	6, // 8: google.ads.googleads.v9.services.MediaFileService.GetMediaFile:output_type -> google.ads.googleads.v9.resources.MediaFile
	3, // 9: google.ads.googleads.v9.services.MediaFileService.MutateMediaFiles:output_type -> google.ads.googleads.v9.services.MutateMediaFilesResponse
...
func init() { file_services_media_file_service_proto_init() }
func file_services_media_file_service_proto_init() {
	if File_services_media_file_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_media_file_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_media_file_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_media_file_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_media_file_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_media_file_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_media_file_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_media_file_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_media_file_service_proto_goTypes,
		DependencyIndexes: file_services_media_file_service_proto_depIdxs,
		MessageInfos:      file_services_media_file_service_proto_msgTypes,
	}.Build()
	File_services_media_file_service_proto = out.File
	file_services_media_file_service_proto_rawDesc = nil
	file_services_media_file_service_proto_goTypes = nil
	file_services_media_file_service_proto_depIdxs = nil
}
