...
const (
	RecommendationSubscriptionService_MutateRecommendationSubscription_FullMethodName = "/google.ads.googleads.v17.services.RecommendationSubscriptionService/MutateRecommendationSubscription"
)
...
func (c *recommendationSubscriptionServiceClient) MutateRecommendationSubscription(ctx context.Context, in *MutateRecommendationSubscriptionRequest, opts ...grpc.CallOption) (*MutateRecommendationSubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, RecommendationSubscriptionService_MutateRecommendationSubscription_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
