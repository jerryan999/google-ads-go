...
func (x *MutateConversionCustomVariableResult) Reset() {
	*x = MutateConversionCustomVariableResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_conversion_custom_variable_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateConversionCustomVariableResult) Descriptor() ([]byte, []int) {
	return file_services_conversion_custom_variable_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_conversion_custom_variable_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_conversion_custom_variable_service_proto_goTypes = []interface{}{
...
func file_services_conversion_custom_variable_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_conversion_custom_variable_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_conversion_custom_variable_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_conversion_custom_variable_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_conversion_custom_variable_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_conversion_custom_variable_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_conversion_custom_variable_service_proto_msgTypes[2].OneofWrappers = []interface{}{
