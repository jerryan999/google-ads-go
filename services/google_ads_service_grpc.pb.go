...
const (
	GoogleAdsService_Search_FullMethodName       = "/google.ads.googleads.v17.services.GoogleAdsService/Search"
	GoogleAdsService_SearchStream_FullMethodName = "/google.ads.googleads.v17.services.GoogleAdsService/SearchStream"
	GoogleAdsService_Mutate_FullMethodName       = "/google.ads.googleads.v17.services.GoogleAdsService/Mutate"
)
...
func (c *googleAdsServiceClient) SearchStream(ctx context.Context, in *SearchGoogleAdsStreamRequest, opts ...grpc.CallOption) (GoogleAdsService_SearchStreamClient, error) {
	...
	x := &googleAdsServiceSearchStreamClient{ClientStream: stream}
...
func _GoogleAdsService_SearchStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GoogleAdsServiceServer).SearchStream(m, &googleAdsServiceSearchStreamServer{ServerStream: stream})
}
...
var GoogleAdsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v17/services/google_ads_service.proto",
}
