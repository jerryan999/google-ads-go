...
const (
	GoogleAdsService_Search_FullMethodName       = "/google.ads.googleads.v15.services.GoogleAdsService/Search"
	GoogleAdsService_SearchStream_FullMethodName = "/google.ads.googleads.v15.services.GoogleAdsService/SearchStream"
	GoogleAdsService_Mutate_FullMethodName       = "/google.ads.googleads.v15.services.GoogleAdsService/Mutate"
)
...
func (c *googleAdsServiceClient) Search(ctx context.Context, in *SearchGoogleAdsRequest, opts ...grpc.CallOption) (*SearchGoogleAdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoogleAdsService_Search_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *googleAdsServiceClient) SearchStream(ctx context.Context, in *SearchGoogleAdsStreamRequest, opts ...grpc.CallOption) (GoogleAdsService_SearchStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GoogleAdsService_ServiceDesc.Streams[0], GoogleAdsService_SearchStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *googleAdsServiceClient) Mutate(ctx context.Context, in *MutateGoogleAdsRequest, opts ...grpc.CallOption) (*MutateGoogleAdsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GoogleAdsService_Mutate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var GoogleAdsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v15.services.GoogleAdsService",
	...
	Metadata: "google/ads/googleads/v15/services/google_ads_service.proto",
}
