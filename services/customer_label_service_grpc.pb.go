...
const (
	CustomerLabelService_MutateCustomerLabels_FullMethodName = "/google.ads.googleads.v17.services.CustomerLabelService/MutateCustomerLabels"
)
...
func (c *customerLabelServiceClient) MutateCustomerLabels(ctx context.Context, in *MutateCustomerLabelsRequest, opts ...grpc.CallOption) (*MutateCustomerLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerLabelService_MutateCustomerLabels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomerLabelService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v17/services/customer_label_service.proto",
}
