...
func file_services_brand_suggestion_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_brand_suggestion_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_brand_suggestion_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_brand_suggestion_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
