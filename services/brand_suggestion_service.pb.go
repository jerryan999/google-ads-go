...
var file_services_brand_suggestion_service_proto_rawDesc = []byte{
...
var (
	...
	file_services_brand_suggestion_service_proto_rawDescData = file_services_brand_suggestion_service_proto_rawDesc
)
...
func file_services_brand_suggestion_service_proto_rawDescGZIP() []byte {
	file_services_brand_suggestion_service_proto_rawDescOnce.Do(func() {
		file_services_brand_suggestion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_brand_suggestion_service_proto_rawDescData)
	})
...
var file_services_brand_suggestion_service_proto_goTypes = []interface{}{
...
func file_services_brand_suggestion_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_brand_suggestion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_brand_suggestion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_brand_suggestion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_brand_suggestion_service_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_services_brand_suggestion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_services_brand_suggestion_service_proto_rawDesc = nil
