...
func (x *MutateAudiencesRequest) Reset() {
	*x = MutateAudiencesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_audience_service_proto_msgTypes[0]
...
func (*MutateAudiencesRequest) Descriptor() ([]byte, []int) {
	return file_services_audience_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAudiencesResponse) Reset() {
	*x = MutateAudiencesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_audience_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAudiencesResponse) Descriptor() ([]byte, []int) {
	return file_services_audience_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AudienceOperation) Reset() {
	*x = AudienceOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_audience_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AudienceOperation) Descriptor() ([]byte, []int) {
	return file_services_audience_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAudienceResult) Reset() {
	*x = MutateAudienceResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_audience_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAudienceResult) Descriptor() ([]byte, []int) {
	return file_services_audience_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_audience_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x37, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x61, 0x75,
	...
	0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x75, 0x64,
	...
	0x2f, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f,
...
var (
	file_services_audience_service_proto_rawDescOnce sync.Once
	file_services_audience_service_proto_rawDescData = file_services_audience_service_proto_rawDesc
)

func file_services_audience_service_proto_rawDescGZIP() []byte {
	file_services_audience_service_proto_rawDescOnce.Do(func() {
		file_services_audience_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_audience_service_proto_rawDescData)
	})
	return file_services_audience_service_proto_rawDescData
}

var file_services_audience_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_audience_service_proto_goTypes = []any{
	(*MutateAudiencesRequest)(nil),                         // 0: google.ads.googleads.v17.services.MutateAudiencesRequest
	(*MutateAudiencesResponse)(nil),                        // 1: google.ads.googleads.v17.services.MutateAudiencesResponse
	(*AudienceOperation)(nil),                              // 2: google.ads.googleads.v17.services.AudienceOperation
	(*MutateAudienceResult)(nil),                           // 3: google.ads.googleads.v17.services.MutateAudienceResult
	...
	(*resources.Audience)(nil),                             // 7: google.ads.googleads.v17.resources.Audience
}
var file_services_audience_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v17.services.MutateAudiencesRequest.operations:type_name -> google.ads.googleads.v17.services.AudienceOperation
	4, // 1: google.ads.googleads.v17.services.MutateAudiencesRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	3, // 2: google.ads.googleads.v17.services.MutateAudiencesResponse.results:type_name -> google.ads.googleads.v17.services.MutateAudienceResult
	5, // 3: google.ads.googleads.v17.services.MutateAudiencesResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 4: google.ads.googleads.v17.services.AudienceOperation.update_mask:type_name -> google.protobuf.FieldMask
	7, // 5: google.ads.googleads.v17.services.AudienceOperation.create:type_name -> google.ads.googleads.v17.resources.Audience
	7, // 6: google.ads.googleads.v17.services.AudienceOperation.update:type_name -> google.ads.googleads.v17.resources.Audience
	7, // 7: google.ads.googleads.v17.services.MutateAudienceResult.audience:type_name -> google.ads.googleads.v17.resources.Audience
	0, // 8: google.ads.googleads.v17.services.AudienceService.MutateAudiences:input_type -> google.ads.googleads.v17.services.MutateAudiencesRequest
	1, // 9: google.ads.googleads.v17.services.AudienceService.MutateAudiences:output_type -> google.ads.googleads.v17.services.MutateAudiencesResponse
...
func init() { file_services_audience_service_proto_init() }
func file_services_audience_service_proto_init() {
	if File_services_audience_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_audience_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_audience_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_audience_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_audience_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_audience_service_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_audience_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_audience_service_proto_goTypes,
		DependencyIndexes: file_services_audience_service_proto_depIdxs,
		MessageInfos:      file_services_audience_service_proto_msgTypes,
	}.Build()
	File_services_audience_service_proto = out.File
	file_services_audience_service_proto_rawDesc = nil
	file_services_audience_service_proto_goTypes = nil
	file_services_audience_service_proto_depIdxs = nil
}
