...
func (x *GetCustomerAssetRequest) Reset() {
	*x = GetCustomerAssetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_service_proto_msgTypes[0]
...
func (*GetCustomerAssetRequest) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerAssetsRequest) Reset() {
	*x = MutateCustomerAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerAssetsRequest) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerAssetOperation) Reset() {
	*x = CustomerAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerAssetOperation) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerAssetsResponse) Reset() {
	*x = MutateCustomerAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerAssetsResponse) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerAssetResult) Reset() {
	*x = MutateCustomerAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerAssetResult) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_customer_asset_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x74, 0x22, 0x48, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x32, 0x12, 0x30, 0x2f, 0x76, 0x39,
	...
	0x64, 0x73, 0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x19,
...
var (
	file_services_customer_asset_service_proto_rawDescOnce sync.Once
	file_services_customer_asset_service_proto_rawDescData = file_services_customer_asset_service_proto_rawDesc
)

func file_services_customer_asset_service_proto_rawDescGZIP() []byte {
	file_services_customer_asset_service_proto_rawDescOnce.Do(func() {
		file_services_customer_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_customer_asset_service_proto_rawDescData)
	})
	return file_services_customer_asset_service_proto_rawDescData
}

var file_services_customer_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_customer_asset_service_proto_goTypes = []interface{}{
	(*GetCustomerAssetRequest)(nil),                        // 0: google.ads.googleads.v9.services.GetCustomerAssetRequest
	(*MutateCustomerAssetsRequest)(nil),                    // 1: google.ads.googleads.v9.services.MutateCustomerAssetsRequest
	(*CustomerAssetOperation)(nil),                         // 2: google.ads.googleads.v9.services.CustomerAssetOperation
	(*MutateCustomerAssetsResponse)(nil),                   // 3: google.ads.googleads.v9.services.MutateCustomerAssetsResponse
	(*MutateCustomerAssetResult)(nil),                      // 4: google.ads.googleads.v9.services.MutateCustomerAssetResult
	...
	(*resources.CustomerAsset)(nil),                        // 7: google.ads.googleads.v9.resources.CustomerAsset
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_services_customer_asset_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v9.services.MutateCustomerAssetsRequest.operations:type_name -> google.ads.googleads.v9.services.CustomerAssetOperation
	5,  // 1: google.ads.googleads.v9.services.MutateCustomerAssetsRequest.response_content_type:type_name -> google.ads.googleads.v9.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v9.services.CustomerAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v9.services.CustomerAssetOperation.create:type_name -> google.ads.googleads.v9.resources.CustomerAsset
	7,  // 4: google.ads.googleads.v9.services.CustomerAssetOperation.update:type_name -> google.ads.googleads.v9.resources.CustomerAsset
	8,  // 5: google.ads.googleads.v9.services.MutateCustomerAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v9.services.MutateCustomerAssetsResponse.results:type_name -> google.ads.googleads.v9.services.MutateCustomerAssetResult
	7,  // 7: google.ads.googleads.v9.services.MutateCustomerAssetResult.customer_asset:type_name -> google.ads.googleads.v9.resources.CustomerAsset
	0,  // 8: google.ads.googleads.v9.services.CustomerAssetService.GetCustomerAsset:input_type -> google.ads.googleads.v9.services.GetCustomerAssetRequest
	1,  // 9: google.ads.googleads.v9.services.CustomerAssetService.MutateCustomerAssets:input_type -> google.ads.googleads.v9.services.MutateCustomerAssetsRequest
	7,  // 10: google.ads.googleads.v9.services.CustomerAssetService.GetCustomerAsset:output_type -> google.ads.googleads.v9.resources.CustomerAsset
	3,  // 11: google.ads.googleads.v9.services.CustomerAssetService.MutateCustomerAssets:output_type -> google.ads.googleads.v9.services.MutateCustomerAssetsResponse
...
func init() { file_services_customer_asset_service_proto_init() }
func file_services_customer_asset_service_proto_init() {
	if File_services_customer_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_customer_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_customer_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_customer_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_customer_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_customer_asset_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_customer_asset_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_customer_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_customer_asset_service_proto_goTypes,
		DependencyIndexes: file_services_customer_asset_service_proto_depIdxs,
		MessageInfos:      file_services_customer_asset_service_proto_msgTypes,
	}.Build()
	File_services_customer_asset_service_proto = out.File
	file_services_customer_asset_service_proto_rawDesc = nil
	file_services_customer_asset_service_proto_goTypes = nil
	file_services_customer_asset_service_proto_depIdxs = nil
}
