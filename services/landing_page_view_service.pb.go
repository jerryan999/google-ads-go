...
func (x *GetLandingPageViewRequest) Reset() {
	*x = GetLandingPageViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_landing_page_view_service_proto_msgTypes[0]
...
func (*GetLandingPageViewRequest) Descriptor() ([]byte, []int) {
	return file_services_landing_page_view_service_proto_rawDescGZIP(), []int{0}
}
...
var File_services_landing_page_view_service_proto protoreflect.FileDescriptor

var file_services_landing_page_view_service_proto_rawDesc = []byte{
	...
	0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x4c,
...
var (
	file_services_landing_page_view_service_proto_rawDescOnce sync.Once
	file_services_landing_page_view_service_proto_rawDescData = file_services_landing_page_view_service_proto_rawDesc
)

func file_services_landing_page_view_service_proto_rawDescGZIP() []byte {
	file_services_landing_page_view_service_proto_rawDescOnce.Do(func() {
		file_services_landing_page_view_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_landing_page_view_service_proto_rawDescData)
	})
	return file_services_landing_page_view_service_proto_rawDescData
}

var file_services_landing_page_view_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_services_landing_page_view_service_proto_goTypes = []interface{}{
	(*GetLandingPageViewRequest)(nil), // 0: google.ads.googleads.v9.services.GetLandingPageViewRequest
	(*resources.LandingPageView)(nil), // 1: google.ads.googleads.v9.resources.LandingPageView
}
var file_services_landing_page_view_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v9.services.LandingPageViewService.GetLandingPageView:input_type -> google.ads.googleads.v9.services.GetLandingPageViewRequest
	1, // 1: google.ads.googleads.v9.services.LandingPageViewService.GetLandingPageView:output_type -> google.ads.googleads.v9.resources.LandingPageView
...
func init() { file_services_landing_page_view_service_proto_init() }
func file_services_landing_page_view_service_proto_init() {
	if File_services_landing_page_view_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_landing_page_view_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_landing_page_view_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_landing_page_view_service_proto_goTypes,
		DependencyIndexes: file_services_landing_page_view_service_proto_depIdxs,
		MessageInfos:      file_services_landing_page_view_service_proto_msgTypes,
	}.Build()
	File_services_landing_page_view_service_proto = out.File
	file_services_landing_page_view_service_proto_rawDesc = nil
	file_services_landing_page_view_service_proto_goTypes = nil
	file_services_landing_page_view_service_proto_depIdxs = nil
}
