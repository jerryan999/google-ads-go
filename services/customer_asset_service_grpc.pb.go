...
const (
	CustomerAssetService_MutateCustomerAssets_FullMethodName = "/google.ads.googleads.v17.services.CustomerAssetService/MutateCustomerAssets"
)
...
func (c *customerAssetServiceClient) MutateCustomerAssets(ctx context.Context, in *MutateCustomerAssetsRequest, opts ...grpc.CallOption) (*MutateCustomerAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerAssetService_MutateCustomerAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomerAssetService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomerAssetService",
	...
	Metadata: "google/ads/googleads/v17/services/customer_asset_service.proto",
}
