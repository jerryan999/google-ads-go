...
const (
	AssetGroupService_MutateAssetGroups_FullMethodName = "/google.ads.googleads.v17.services.AssetGroupService/MutateAssetGroups"
)
...
func (c *assetGroupServiceClient) MutateAssetGroups(ctx context.Context, in *MutateAssetGroupsRequest, opts ...grpc.CallOption) (*MutateAssetGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssetGroupService_MutateAssetGroups_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AssetGroupService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.AssetGroupService",
	...
	Metadata: "google/ads/googleads/v17/services/asset_group_service.proto",
}
