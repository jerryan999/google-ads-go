...
func (c *customerFeedServiceClient) MutateCustomerFeeds(ctx context.Context, in *MutateCustomerFeedsRequest, opts ...grpc.CallOption) (*MutateCustomerFeedsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerFeedService_MutateCustomerFeeds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomerFeedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomerFeedService",
	...
	Metadata: "google/ads/googleads/v17/services/customer_feed_service.proto",
}
