...
func (x *MutateCustomerUserAccessResult) Reset() {
	*x = MutateCustomerUserAccessResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_user_access_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessResult) Descriptor() ([]byte, []int) {
	return file_services_customer_user_access_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_customer_user_access_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
func file_services_customer_user_access_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_customer_user_access_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_customer_user_access_service_proto_msgTypes[2].OneofWrappers = []interface{}{
