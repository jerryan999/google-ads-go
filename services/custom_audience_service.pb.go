...
func (x *MutateCustomAudienceResult) Reset() {
	*x = MutateCustomAudienceResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_custom_audience_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomAudienceResult) Descriptor() ([]byte, []int) {
	return file_services_custom_audience_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_custom_audience_service_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x65, 0x22, 0x49, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x33, 0x12, 0x31, 0x2f, 0x76, 0x39,
	...
	0x39, 0x22, 0x34, 0x2f, 0x76, 0x39, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	...
	file_services_custom_audience_service_proto_rawDescData = file_services_custom_audience_service_proto_rawDesc
)
...
func file_services_custom_audience_service_proto_rawDescGZIP() []byte {
	file_services_custom_audience_service_proto_rawDescOnce.Do(func() {
		file_services_custom_audience_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_custom_audience_service_proto_rawDescData)
	})
	return file_services_custom_audience_service_proto_rawDescData
}

var file_services_custom_audience_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_custom_audience_service_proto_goTypes = []interface{}{
	(*GetCustomAudienceRequest)(nil),      // 0: google.ads.googleads.v9.services.GetCustomAudienceRequest
	(*MutateCustomAudiencesRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateCustomAudiencesRequest
	(*CustomAudienceOperation)(nil),       // 2: google.ads.googleads.v9.services.CustomAudienceOperation
	(*MutateCustomAudiencesResponse)(nil), // 3: google.ads.googleads.v9.services.MutateCustomAudiencesResponse
	(*MutateCustomAudienceResult)(nil),    // 4: google.ads.googleads.v9.services.MutateCustomAudienceResult
	(*fieldmaskpb.FieldMask)(nil),         // 5: google.protobuf.FieldMask
	(*resources.CustomAudience)(nil),      // 6: google.ads.googleads.v9.resources.CustomAudience
}
var file_services_custom_audience_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateCustomAudiencesRequest.operations:type_name -> google.ads.googleads.v9.services.CustomAudienceOperation
	5, // 1: google.ads.googleads.v9.services.CustomAudienceOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v9.services.CustomAudienceOperation.create:type_name -> google.ads.googleads.v9.resources.CustomAudience
	6, // 3: google.ads.googleads.v9.services.CustomAudienceOperation.update:type_name -> google.ads.googleads.v9.resources.CustomAudience
	4, // 4: google.ads.googleads.v9.services.MutateCustomAudiencesResponse.results:type_name -> google.ads.googleads.v9.services.MutateCustomAudienceResult
	0, // 5: google.ads.googleads.v9.services.CustomAudienceService.GetCustomAudience:input_type -> google.ads.googleads.v9.services.GetCustomAudienceRequest
	1, // 6: google.ads.googleads.v9.services.CustomAudienceService.MutateCustomAudiences:input_type -> google.ads.googleads.v9.services.MutateCustomAudiencesRequest
	6, // 7: google.ads.googleads.v9.services.CustomAudienceService.GetCustomAudience:output_type -> google.ads.googleads.v9.resources.CustomAudience
	3, // 8: google.ads.googleads.v9.services.CustomAudienceService.MutateCustomAudiences:output_type -> google.ads.googleads.v9.services.MutateCustomAudiencesResponse
...
func file_services_custom_audience_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_custom_audience_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_custom_audience_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_custom_audience_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_custom_audience_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_custom_audience_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_custom_audience_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_custom_audience_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_services_custom_audience_service_proto_rawDesc = nil
