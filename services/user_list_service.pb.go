...
func (x *GetUserListRequest) Reset() {
	*x = GetUserListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_list_service_proto_msgTypes[0]
...
func (*GetUserListRequest) Descriptor() ([]byte, []int) {
	return file_services_user_list_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateUserListsRequest) Reset() {
	*x = MutateUserListsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_list_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateUserListsRequest) Descriptor() ([]byte, []int) {
	return file_services_user_list_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *UserListOperation) Reset() {
	*x = UserListOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_list_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserListOperation) Descriptor() ([]byte, []int) {
	return file_services_user_list_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateUserListsResponse) Reset() {
	*x = MutateUserListsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_list_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateUserListsResponse) Descriptor() ([]byte, []int) {
	return file_services_user_list_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateUserListResult) Reset() {
	*x = MutateUserListResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_user_list_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateUserListResult) Descriptor() ([]byte, []int) {
	return file_services_user_list_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_user_list_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x31, 0x67, 0x6f,
	...
	0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72,
	...
	0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xed, 0x03, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72,
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2d, 0x12, 0x2b, 0x2f, 0x76, 0x39, 0x2f, 0x7b, 0x72, 0x65, 0x73,
	...
	0xe4, 0x93, 0x02, 0x33, 0x22, 0x2e, 0x2f, 0x76, 0x39, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x61, 0x64, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x42, 0xfb, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x42, 0x14, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var (
	file_services_user_list_service_proto_rawDescOnce sync.Once
	file_services_user_list_service_proto_rawDescData = file_services_user_list_service_proto_rawDesc
)

func file_services_user_list_service_proto_rawDescGZIP() []byte {
	file_services_user_list_service_proto_rawDescOnce.Do(func() {
		file_services_user_list_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_user_list_service_proto_rawDescData)
	})
	return file_services_user_list_service_proto_rawDescData
}

var file_services_user_list_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_user_list_service_proto_goTypes = []interface{}{
	(*GetUserListRequest)(nil),      // 0: google.ads.googleads.v9.services.GetUserListRequest
	(*MutateUserListsRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateUserListsRequest
	(*UserListOperation)(nil),       // 2: google.ads.googleads.v9.services.UserListOperation
	(*MutateUserListsResponse)(nil), // 3: google.ads.googleads.v9.services.MutateUserListsResponse
	(*MutateUserListResult)(nil),    // 4: google.ads.googleads.v9.services.MutateUserListResult
	(*fieldmaskpb.FieldMask)(nil),   // 5: google.protobuf.FieldMask
	(*resources.UserList)(nil),      // 6: google.ads.googleads.v9.resources.UserList
	(*status.Status)(nil),           // 7: google.rpc.Status
}
var file_services_user_list_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateUserListsRequest.operations:type_name -> google.ads.googleads.v9.services.UserListOperation
	5, // 1: google.ads.googleads.v9.services.UserListOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v9.services.UserListOperation.create:type_name -> google.ads.googleads.v9.resources.UserList
	6, // 3: google.ads.googleads.v9.services.UserListOperation.update:type_name -> google.ads.googleads.v9.resources.UserList
	7, // 4: google.ads.googleads.v9.services.MutateUserListsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v9.services.MutateUserListsResponse.results:type_name -> google.ads.googleads.v9.services.MutateUserListResult
	0, // 6: google.ads.googleads.v9.services.UserListService.GetUserList:input_type -> google.ads.googleads.v9.services.GetUserListRequest
	1, // 7: google.ads.googleads.v9.services.UserListService.MutateUserLists:input_type -> google.ads.googleads.v9.services.MutateUserListsRequest
	6, // 8: google.ads.googleads.v9.services.UserListService.GetUserList:output_type -> google.ads.googleads.v9.resources.UserList
	3, // 9: google.ads.googleads.v9.services.UserListService.MutateUserLists:output_type -> google.ads.googleads.v9.services.MutateUserListsResponse
...
func init() { file_services_user_list_service_proto_init() }
func file_services_user_list_service_proto_init() {
	if File_services_user_list_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_user_list_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_list_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_list_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_list_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_user_list_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_user_list_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_user_list_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_user_list_service_proto_goTypes,
		DependencyIndexes: file_services_user_list_service_proto_depIdxs,
		MessageInfos:      file_services_user_list_service_proto_msgTypes,
	}.Build()
	File_services_user_list_service_proto = out.File
	file_services_user_list_service_proto_rawDesc = nil
	file_services_user_list_service_proto_goTypes = nil
	file_services_user_list_service_proto_depIdxs = nil
}
