...
func (x *GetFeedItemSetRequest) Reset() {
	*x = GetFeedItemSetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_feed_item_set_service_proto_msgTypes[0]
...
func (*GetFeedItemSetRequest) Descriptor() ([]byte, []int) {
	return file_services_feed_item_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateFeedItemSetsRequest) Reset() {
	*x = MutateFeedItemSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_feed_item_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemSetsRequest) Descriptor() ([]byte, []int) {
	return file_services_feed_item_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedItemSetOperation) Reset() {
	*x = FeedItemSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_feed_item_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedItemSetOperation) Descriptor() ([]byte, []int) {
	return file_services_feed_item_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateFeedItemSetsResponse) Reset() {
	*x = MutateFeedItemSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_feed_item_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemSetsResponse) Descriptor() ([]byte, []int) {
	return file_services_feed_item_set_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateFeedItemSetResult) Reset() {
	*x = MutateFeedItemSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_feed_item_set_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedItemSetResult) Descriptor() ([]byte, []int) {
	return file_services_feed_item_set_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_feed_item_set_service_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6a, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x46, 0x65, 0x65, 0x64,
	0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x51,
	...
	0x65, 0x22, 0xec, 0x01, 0x0a, 0x19, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x46, 0x65, 0x65, 0x64,
	0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x22, 0x8e, 0x02, 0x0a, 0x14, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74,
	...
	0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x48, 0x00, 0x52, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65,
	...
	,
	...
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x2a, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65,
	0x6d, 0x53, 0x65, 0x74, 0x73, 0x2f, 0x2a, 0x7d, 0xda, 0x41, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0xe6, 0x01, 0x0a, 0x12, 0x4d, 0x75, 0x74,
	0x61, 0x74, 0x65, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x73, 0x12,
	...
	0x6d, 0x53, 0x65, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3c, 0x2e, 0x67,
	...
	0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x55, 0x82, 0xd3, 0xe4, 0x93,
	...
	0x73, 0x42, 0x17, 0x46, 0x65, 0x65, 0x64, 0x49, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x74, 0x53, 0x65,
...
var (
	file_services_feed_item_set_service_proto_rawDescOnce sync.Once
	file_services_feed_item_set_service_proto_rawDescData = file_services_feed_item_set_service_proto_rawDesc
)

func file_services_feed_item_set_service_proto_rawDescGZIP() []byte {
	file_services_feed_item_set_service_proto_rawDescOnce.Do(func() {
		file_services_feed_item_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_feed_item_set_service_proto_rawDescData)
	})
	return file_services_feed_item_set_service_proto_rawDescData
}

var file_services_feed_item_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_feed_item_set_service_proto_goTypes = []interface{}{
	(*GetFeedItemSetRequest)(nil),      // 0: google.ads.googleads.v9.services.GetFeedItemSetRequest
	(*MutateFeedItemSetsRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateFeedItemSetsRequest
	(*FeedItemSetOperation)(nil),       // 2: google.ads.googleads.v9.services.FeedItemSetOperation
	(*MutateFeedItemSetsResponse)(nil), // 3: google.ads.googleads.v9.services.MutateFeedItemSetsResponse
	(*MutateFeedItemSetResult)(nil),    // 4: google.ads.googleads.v9.services.MutateFeedItemSetResult
	(*fieldmaskpb.FieldMask)(nil),      // 5: google.protobuf.FieldMask
	(*resources.FeedItemSet)(nil),      // 6: google.ads.googleads.v9.resources.FeedItemSet
	(*status.Status)(nil),              // 7: google.rpc.Status
}
var file_services_feed_item_set_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateFeedItemSetsRequest.operations:type_name -> google.ads.googleads.v9.services.FeedItemSetOperation
	5, // 1: google.ads.googleads.v9.services.FeedItemSetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v9.services.FeedItemSetOperation.create:type_name -> google.ads.googleads.v9.resources.FeedItemSet
	6, // 3: google.ads.googleads.v9.services.FeedItemSetOperation.update:type_name -> google.ads.googleads.v9.resources.FeedItemSet
	4, // 4: google.ads.googleads.v9.services.MutateFeedItemSetsResponse.results:type_name -> google.ads.googleads.v9.services.MutateFeedItemSetResult
	7, // 5: google.ads.googleads.v9.services.MutateFeedItemSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v9.services.FeedItemSetService.GetFeedItemSet:input_type -> google.ads.googleads.v9.services.GetFeedItemSetRequest
	1, // 7: google.ads.googleads.v9.services.FeedItemSetService.MutateFeedItemSets:input_type -> google.ads.googleads.v9.services.MutateFeedItemSetsRequest
	6, // 8: google.ads.googleads.v9.services.FeedItemSetService.GetFeedItemSet:output_type -> google.ads.googleads.v9.resources.FeedItemSet
	3, // 9: google.ads.googleads.v9.services.FeedItemSetService.MutateFeedItemSets:output_type -> google.ads.googleads.v9.services.MutateFeedItemSetsResponse
...
func init() { file_services_feed_item_set_service_proto_init() }
func file_services_feed_item_set_service_proto_init() {
	if File_services_feed_item_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_feed_item_set_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetFeedItemSetRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_feed_item_set_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_feed_item_set_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_feed_item_set_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_feed_item_set_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_feed_item_set_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_feed_item_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_feed_item_set_service_proto_goTypes,
		DependencyIndexes: file_services_feed_item_set_service_proto_depIdxs,
		MessageInfos:      file_services_feed_item_set_service_proto_msgTypes,
	}.Build()
	File_services_feed_item_set_service_proto = out.File
	file_services_feed_item_set_service_proto_rawDesc = nil
	file_services_feed_item_set_service_proto_goTypes = nil
	file_services_feed_item_set_service_proto_depIdxs = nil
}
