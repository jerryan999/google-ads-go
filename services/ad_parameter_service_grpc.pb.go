...
func (c *adParameterServiceClient) MutateAdParameters(ctx context.Context, in *MutateAdParametersRequest, opts ...grpc.CallOption) (*MutateAdParametersResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdParameterService_MutateAdParameters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AdParameterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.AdParameterService",
	...
	Metadata: "google/ads/googleads/v17/services/ad_parameter_service.proto",
}
