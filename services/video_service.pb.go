...
func (x *GetVideoRequest) Reset() {
	*x = GetVideoRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_video_service_proto_msgTypes[0]
...
func (*GetVideoRequest) Descriptor() ([]byte, []int) {
	return file_services_video_service_proto_rawDescGZIP(), []int{0}
}
...
var File_services_video_service_proto protoreflect.FileDescriptor

var file_services_video_service_proto_rawDesc = []byte{
	...
	0x39, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x76, 0x69, 0x64, 0x65,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x81, 0x02, 0x0a, 0x0c, 0x56,
	...
	0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x56,
	...
	0x6d, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x61, 0x64, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x42, 0xf8,
	...
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x11, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65,
...
var (
	file_services_video_service_proto_rawDescOnce sync.Once
	file_services_video_service_proto_rawDescData = file_services_video_service_proto_rawDesc
)

func file_services_video_service_proto_rawDescGZIP() []byte {
	file_services_video_service_proto_rawDescOnce.Do(func() {
		file_services_video_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_video_service_proto_rawDescData)
	})
	return file_services_video_service_proto_rawDescData
}

var file_services_video_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_services_video_service_proto_goTypes = []interface{}{
	(*GetVideoRequest)(nil), // 0: google.ads.googleads.v9.services.GetVideoRequest
	(*resources.Video)(nil), // 1: google.ads.googleads.v9.resources.Video
}
var file_services_video_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v9.services.VideoService.GetVideo:input_type -> google.ads.googleads.v9.services.GetVideoRequest
	1, // 1: google.ads.googleads.v9.services.VideoService.GetVideo:output_type -> google.ads.googleads.v9.resources.Video
...
func init() { file_services_video_service_proto_init() }
func file_services_video_service_proto_init() {
	if File_services_video_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_video_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_video_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_video_service_proto_goTypes,
		DependencyIndexes: file_services_video_service_proto_depIdxs,
		MessageInfos:      file_services_video_service_proto_msgTypes,
	}.Build()
	File_services_video_service_proto = out.File
	file_services_video_service_proto_rawDesc = nil
	file_services_video_service_proto_goTypes = nil
	file_services_video_service_proto_depIdxs = nil
}
