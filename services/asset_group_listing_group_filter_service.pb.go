...
func (x *MutateAssetGroupListingGroupFiltersRequest) Reset() {
	*x = MutateAssetGroupListingGroupFiltersRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_listing_group_filter_service_proto_msgTypes[0]
...
func (*MutateAssetGroupListingGroupFiltersRequest) Descriptor() ([]byte, []int) {
	return file_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupListingGroupFilterOperation) Reset() {
	*x = AssetGroupListingGroupFilterOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_listing_group_filter_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetGroupListingGroupFilterOperation) Descriptor() ([]byte, []int) {
	return file_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetGroupListingGroupFiltersResponse) Reset() {
	*x = MutateAssetGroupListingGroupFiltersResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_listing_group_filter_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetGroupListingGroupFiltersResponse) Descriptor() ([]byte, []int) {
	return file_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetGroupListingGroupFilterResult) Reset() {
	*x = MutateAssetGroupListingGroupFilterResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_listing_group_filter_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetGroupListingGroupFilterResult) Descriptor() ([]byte, []int) {
	return file_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_asset_group_listing_group_filter_service_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x67, 0xda, 0x41,
	0x16, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x2c, 0x6f, 0x70, 0x65,
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x48, 0x3a, 0x01, 0x2a,
	0x22, 0x43, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
	0x2f, 0x7b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x3d, 0x2a, 0x7d,
	0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x69,
	0x6e, 0x67, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x3a, 0x6d,
...
var (
	file_services_asset_group_listing_group_filter_service_proto_rawDescOnce sync.Once
	file_services_asset_group_listing_group_filter_service_proto_rawDescData = file_services_asset_group_listing_group_filter_service_proto_rawDesc
)

func file_services_asset_group_listing_group_filter_service_proto_rawDescGZIP() []byte {
	file_services_asset_group_listing_group_filter_service_proto_rawDescOnce.Do(func() {
		file_services_asset_group_listing_group_filter_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_asset_group_listing_group_filter_service_proto_rawDescData)
	})
	return file_services_asset_group_listing_group_filter_service_proto_rawDescData
}

var file_services_asset_group_listing_group_filter_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_asset_group_listing_group_filter_service_proto_goTypes = []any{
	(*MutateAssetGroupListingGroupFiltersRequest)(nil),     // 0: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersRequest
	(*AssetGroupListingGroupFilterOperation)(nil),          // 1: google.ads.googleads.v17.services.AssetGroupListingGroupFilterOperation
	(*MutateAssetGroupListingGroupFiltersResponse)(nil),    // 2: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersResponse
	(*MutateAssetGroupListingGroupFilterResult)(nil),       // 3: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFilterResult
	...
	(*resources.AssetGroupListingGroupFilter)(nil),         // 6: google.ads.googleads.v17.resources.AssetGroupListingGroupFilter
}
var file_services_asset_group_listing_group_filter_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersRequest.operations:type_name -> google.ads.googleads.v17.services.AssetGroupListingGroupFilterOperation
	4, // 1: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.AssetGroupListingGroupFilterOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v17.services.AssetGroupListingGroupFilterOperation.create:type_name -> google.ads.googleads.v17.resources.AssetGroupListingGroupFilter
	...
	3, // 5: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersResponse.results:type_name -> google.ads.googleads.v17.services.MutateAssetGroupListingGroupFilterResult
	6, // 6: google.ads.googleads.v17.services.MutateAssetGroupListingGroupFilterResult.asset_group_listing_group_filter:type_name -> google.ads.googleads.v17.resources.AssetGroupListingGroupFilter
	0, // 7: google.ads.googleads.v17.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters:input_type -> google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersRequest
	2, // 8: google.ads.googleads.v17.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters:output_type -> google.ads.googleads.v17.services.MutateAssetGroupListingGroupFiltersResponse
...
func file_services_asset_group_listing_group_filter_service_proto_init() {
	if File_services_asset_group_listing_group_filter_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_asset_group_listing_group_filter_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_asset_group_listing_group_filter_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_asset_group_listing_group_filter_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_asset_group_listing_group_filter_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_asset_group_listing_group_filter_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_asset_group_listing_group_filter_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_asset_group_listing_group_filter_service_proto_goTypes,
		DependencyIndexes: file_services_asset_group_listing_group_filter_service_proto_depIdxs,
		MessageInfos:      file_services_asset_group_listing_group_filter_service_proto_msgTypes,
	}.Build()
	File_services_asset_group_listing_group_filter_service_proto = out.File
	file_services_asset_group_listing_group_filter_service_proto_rawDesc = nil
	file_services_asset_group_listing_group_filter_service_proto_goTypes = nil
	file_services_asset_group_listing_group_filter_service_proto_depIdxs = nil
}
