...
var file_services_campaign_conversion_goal_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x6d,
...
var file_services_campaign_conversion_goal_service_proto_goTypes = []any{
	(*MutateCampaignConversionGoalsRequest)(nil),  // 0: google.ads.googleads.v17.services.MutateCampaignConversionGoalsRequest
	(*CampaignConversionGoalOperation)(nil),       // 1: google.ads.googleads.v17.services.CampaignConversionGoalOperation
	(*MutateCampaignConversionGoalsResponse)(nil), // 2: google.ads.googleads.v17.services.MutateCampaignConversionGoalsResponse
	(*MutateCampaignConversionGoalResult)(nil),    // 3: google.ads.googleads.v17.services.MutateCampaignConversionGoalResult
	(*fieldmaskpb.FieldMask)(nil),                 // 4: google.protobuf.FieldMask
	(*resources.CampaignConversionGoal)(nil),      // 5: google.ads.googleads.v17.resources.CampaignConversionGoal
}
var file_services_campaign_conversion_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateCampaignConversionGoalsRequest.operations:type_name -> google.ads.googleads.v17.services.CampaignConversionGoalOperation
	4, // 1: google.ads.googleads.v17.services.CampaignConversionGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v17.services.CampaignConversionGoalOperation.update:type_name -> google.ads.googleads.v17.resources.CampaignConversionGoal
	3, // 3: google.ads.googleads.v17.services.MutateCampaignConversionGoalsResponse.results:type_name -> google.ads.googleads.v17.services.MutateCampaignConversionGoalResult
	0, // 4: google.ads.googleads.v17.services.CampaignConversionGoalService.MutateCampaignConversionGoals:input_type -> google.ads.googleads.v17.services.MutateCampaignConversionGoalsRequest
	2, // 5: google.ads.googleads.v17.services.CampaignConversionGoalService.MutateCampaignConversionGoals:output_type -> google.ads.googleads.v17.services.MutateCampaignConversionGoalsResponse
...
func file_services_campaign_conversion_goal_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_campaign_conversion_goal_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_campaign_conversion_goal_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_campaign_conversion_goal_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_campaign_conversion_goal_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_campaign_conversion_goal_service_proto_msgTypes[1].OneofWrappers = []any{
