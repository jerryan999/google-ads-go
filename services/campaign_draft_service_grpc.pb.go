...
const (
	CampaignDraftService_MutateCampaignDrafts_FullMethodName         = "/google.ads.googleads.v17.services.CampaignDraftService/MutateCampaignDrafts"
	CampaignDraftService_PromoteCampaignDraft_FullMethodName         = "/google.ads.googleads.v17.services.CampaignDraftService/PromoteCampaignDraft"
	CampaignDraftService_ListCampaignDraftAsyncErrors_FullMethodName = "/google.ads.googleads.v17.services.CampaignDraftService/ListCampaignDraftAsyncErrors"
)
...
func (c *campaignDraftServiceClient) MutateCampaignDrafts(ctx context.Context, in *MutateCampaignDraftsRequest, opts ...grpc.CallOption) (*MutateCampaignDraftsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampaignDraftService_MutateCampaignDrafts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignDraftServiceClient) PromoteCampaignDraft(ctx context.Context, in *PromoteCampaignDraftRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	...
	err := c.cc.Invoke(ctx, CampaignDraftService_PromoteCampaignDraft_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignDraftServiceClient) ListCampaignDraftAsyncErrors(ctx context.Context, in *ListCampaignDraftAsyncErrorsRequest, opts ...grpc.CallOption) (*ListCampaignDraftAsyncErrorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampaignDraftService_ListCampaignDraftAsyncErrors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CampaignDraftService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CampaignDraftService",
	...
	Metadata: "google/ads/googleads/v17/services/campaign_draft_service.proto",
}
