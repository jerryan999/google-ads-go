...
func (x *MutateAssetGroupsRequest) Reset() {
	*x = MutateAssetGroupsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_service_proto_msgTypes[0]
...
func (*MutateAssetGroupsRequest) Descriptor() ([]byte, []int) {
	return file_services_asset_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupOperation) Reset() {
	*x = AssetGroupOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetGroupOperation) Descriptor() ([]byte, []int) {
	return file_services_asset_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetGroupsResponse) Reset() {
	*x = MutateAssetGroupsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetGroupsResponse) Descriptor() ([]byte, []int) {
	return file_services_asset_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetGroupResult) Reset() {
	*x = MutateAssetGroupResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_asset_group_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetGroupResult) Descriptor() ([]byte, []int) {
	return file_services_asset_group_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_asset_group_service_proto_rawDesc = []byte{
	...
	0x01, 0x2a, 0x22, 0x31, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
...
var (
	file_services_asset_group_service_proto_rawDescOnce sync.Once
	file_services_asset_group_service_proto_rawDescData = file_services_asset_group_service_proto_rawDesc
)

func file_services_asset_group_service_proto_rawDescGZIP() []byte {
	file_services_asset_group_service_proto_rawDescOnce.Do(func() {
		file_services_asset_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_asset_group_service_proto_rawDescData)
	})
	return file_services_asset_group_service_proto_rawDescData
}

var file_services_asset_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_asset_group_service_proto_goTypes = []any{
	(*MutateAssetGroupsRequest)(nil),  // 0: google.ads.googleads.v17.services.MutateAssetGroupsRequest
	(*AssetGroupOperation)(nil),       // 1: google.ads.googleads.v17.services.AssetGroupOperation
	(*MutateAssetGroupsResponse)(nil), // 2: google.ads.googleads.v17.services.MutateAssetGroupsResponse
	(*MutateAssetGroupResult)(nil),    // 3: google.ads.googleads.v17.services.MutateAssetGroupResult
	(*fieldmaskpb.FieldMask)(nil),     // 4: google.protobuf.FieldMask
	(*resources.AssetGroup)(nil),      // 5: google.ads.googleads.v17.resources.AssetGroup
	(*status.Status)(nil),             // 6: google.rpc.Status
}
var file_services_asset_group_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateAssetGroupsRequest.operations:type_name -> google.ads.googleads.v17.services.AssetGroupOperation
	4, // 1: google.ads.googleads.v17.services.AssetGroupOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v17.services.AssetGroupOperation.create:type_name -> google.ads.googleads.v17.resources.AssetGroup
	5, // 3: google.ads.googleads.v17.services.AssetGroupOperation.update:type_name -> google.ads.googleads.v17.resources.AssetGroup
	3, // 4: google.ads.googleads.v17.services.MutateAssetGroupsResponse.results:type_name -> google.ads.googleads.v17.services.MutateAssetGroupResult
	6, // 5: google.ads.googleads.v17.services.MutateAssetGroupsResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v17.services.AssetGroupService.MutateAssetGroups:input_type -> google.ads.googleads.v17.services.MutateAssetGroupsRequest
	2, // 7: google.ads.googleads.v17.services.AssetGroupService.MutateAssetGroups:output_type -> google.ads.googleads.v17.services.MutateAssetGroupsResponse
...
func init() { file_services_asset_group_service_proto_init() }
func file_services_asset_group_service_proto_init() {
	if File_services_asset_group_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_asset_group_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_asset_group_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_asset_group_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_asset_group_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_asset_group_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_asset_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_asset_group_service_proto_goTypes,
		DependencyIndexes: file_services_asset_group_service_proto_depIdxs,
		MessageInfos:      file_services_asset_group_service_proto_msgTypes,
	}.Build()
	File_services_asset_group_service_proto = out.File
	file_services_asset_group_service_proto_rawDesc = nil
	file_services_asset_group_service_proto_goTypes = nil
	file_services_asset_group_service_proto_depIdxs = nil
}
