...
func (x *MutateCustomerAssetSetsRequest) Reset() {
	*x = MutateCustomerAssetSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_set_service_proto_msgTypes[0]
...
func (*MutateCustomerAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAssetSetOperation) Reset() {
	*x = CustomerAssetSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerAssetSetOperation) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_set_service_proto_rawDescGZIP(), []int{1}
}

func (m *CustomerAssetSetOperation) GetOperation() isCustomerAssetSetOperation_Operation {
	if m != nil {
		return m.Operation
	}
	return nil
...
func (x *CustomerAssetSetOperation) GetCreate() *resources.CustomerAssetSet {
	if x, ok := x.GetOperation().(*CustomerAssetSetOperation_Create); ok {
		return x.Create
	}
	return nil
}
...
func (x *CustomerAssetSetOperation) GetRemove() string {
	if x, ok := x.GetOperation().(*CustomerAssetSetOperation_Remove); ok {
		return x.Remove
	}
	return ""
}
...
func (x *MutateCustomerAssetSetsResponse) Reset() {
	*x = MutateCustomerAssetSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerAssetSetResult) Reset() {
	*x = MutateCustomerAssetSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_asset_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerAssetSetResult) Descriptor() ([]byte, []int) {
	return file_services_customer_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_services_customer_asset_set_service_proto protoreflect.FileDescriptor

var file_services_customer_asset_set_service_proto_rawDesc = []byte{
	...
	0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1c, 0x43, 0x75, 0x73, 0x74,
...
var (
	file_services_customer_asset_set_service_proto_rawDescOnce sync.Once
	file_services_customer_asset_set_service_proto_rawDescData = file_services_customer_asset_set_service_proto_rawDesc
)

func file_services_customer_asset_set_service_proto_rawDescGZIP() []byte {
	file_services_customer_asset_set_service_proto_rawDescOnce.Do(func() {
		file_services_customer_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_customer_asset_set_service_proto_rawDescData)
	})
	return file_services_customer_asset_set_service_proto_rawDescData
}

var file_services_customer_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_customer_asset_set_service_proto_goTypes = []any{
	(*MutateCustomerAssetSetsRequest)(nil),                 // 0: google.ads.googleads.v17.services.MutateCustomerAssetSetsRequest
	(*CustomerAssetSetOperation)(nil),                      // 1: google.ads.googleads.v17.services.CustomerAssetSetOperation
	(*MutateCustomerAssetSetsResponse)(nil),                // 2: google.ads.googleads.v17.services.MutateCustomerAssetSetsResponse
	(*MutateCustomerAssetSetResult)(nil),                   // 3: google.ads.googleads.v17.services.MutateCustomerAssetSetResult
	...
	(*resources.CustomerAssetSet)(nil),                     // 5: google.ads.googleads.v17.resources.CustomerAssetSet
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_services_customer_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateCustomerAssetSetsRequest.operations:type_name -> google.ads.googleads.v17.services.CustomerAssetSetOperation
	4, // 1: google.ads.googleads.v17.services.MutateCustomerAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.CustomerAssetSetOperation.create:type_name -> google.ads.googleads.v17.resources.CustomerAssetSet
	3, // 3: google.ads.googleads.v17.services.MutateCustomerAssetSetsResponse.results:type_name -> google.ads.googleads.v17.services.MutateCustomerAssetSetResult
	6, // 4: google.ads.googleads.v17.services.MutateCustomerAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v17.services.MutateCustomerAssetSetResult.customer_asset_set:type_name -> google.ads.googleads.v17.resources.CustomerAssetSet
	0, // 6: google.ads.googleads.v17.services.CustomerAssetSetService.MutateCustomerAssetSets:input_type -> google.ads.googleads.v17.services.MutateCustomerAssetSetsRequest
	2, // 7: google.ads.googleads.v17.services.CustomerAssetSetService.MutateCustomerAssetSets:output_type -> google.ads.googleads.v17.services.MutateCustomerAssetSetsResponse
...
func init() { file_services_customer_asset_set_service_proto_init() }
func file_services_customer_asset_set_service_proto_init() {
	if File_services_customer_asset_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_customer_asset_set_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*MutateCustomerAssetSetsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_customer_asset_set_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CustomerAssetSetOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_customer_asset_set_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*MutateCustomerAssetSetsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_customer_asset_set_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*MutateCustomerAssetSetResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_services_customer_asset_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_customer_asset_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_customer_asset_set_service_proto_goTypes,
		DependencyIndexes: file_services_customer_asset_set_service_proto_depIdxs,
		MessageInfos:      file_services_customer_asset_set_service_proto_msgTypes,
	}.Build()
	File_services_customer_asset_set_service_proto = out.File
	file_services_customer_asset_set_service_proto_rawDesc = nil
	file_services_customer_asset_set_service_proto_goTypes = nil
	file_services_customer_asset_set_service_proto_depIdxs = nil
}
