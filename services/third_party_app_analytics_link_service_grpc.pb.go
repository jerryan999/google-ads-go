...
const (
	ThirdPartyAppAnalyticsLinkService_RegenerateShareableLinkId_FullMethodName = "/google.ads.googleads.v17.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId"
)
...
func (c *thirdPartyAppAnalyticsLinkServiceClient) RegenerateShareableLinkId(ctx context.Context, in *RegenerateShareableLinkIdRequest, opts ...grpc.CallOption) (*RegenerateShareableLinkIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, ThirdPartyAppAnalyticsLinkService_RegenerateShareableLinkId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ThirdPartyAppAnalyticsLinkService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.ThirdPartyAppAnalyticsLinkService",
	...
	Metadata: "google/ads/googleads/v17/services/third_party_app_analytics_link_service.proto",
}
