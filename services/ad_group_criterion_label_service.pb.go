...
func (x *MutateAdGroupCriterionLabelsRequest) Reset() {
	*x = MutateAdGroupCriterionLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_criterion_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupCriterionLabelsRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupCriterionLabelOperation) Reset() {
	*x = AdGroupCriterionLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_criterion_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupCriterionLabelOperation) Descriptor() ([]byte, []int) {
	return file_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupCriterionLabelsResponse) Reset() {
	*x = MutateAdGroupCriterionLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_criterion_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelsResponse) Descriptor() ([]byte, []int) {
	return file_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionLabelResult) Reset() {
	*x = MutateAdGroupCriterionLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_criterion_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelResult) Descriptor() ([]byte, []int) {
	return file_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_ad_group_criterion_label_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x41, 0x67,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x60, 0xda, 0x41, 0x16, 0x63, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x2c, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x41, 0x3a, 0x01, 0x2a, 0x22, 0x3c, 0x2f, 0x76, 0x31,
	...
	0x6c, 0x73, 0x3a, 0x6d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x1a, 0x45, 0xca, 0x41, 0x18, 0x67, 0x6f,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x21, 0x41, 0x64, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e, 0x4c, 0x61, 0x62, 0x65,
...
var (
	file_services_ad_group_criterion_label_service_proto_rawDescOnce sync.Once
	file_services_ad_group_criterion_label_service_proto_rawDescData = file_services_ad_group_criterion_label_service_proto_rawDesc
)

func file_services_ad_group_criterion_label_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_criterion_label_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_criterion_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_ad_group_criterion_label_service_proto_rawDescData)
	})
	return file_services_ad_group_criterion_label_service_proto_rawDescData
}

var file_services_ad_group_criterion_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_ad_group_criterion_label_service_proto_goTypes = []any{
	(*MutateAdGroupCriterionLabelsRequest)(nil),  // 0: google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsRequest
	(*AdGroupCriterionLabelOperation)(nil),       // 1: google.ads.googleads.v17.services.AdGroupCriterionLabelOperation
	(*MutateAdGroupCriterionLabelsResponse)(nil), // 2: google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsResponse
	(*MutateAdGroupCriterionLabelResult)(nil),    // 3: google.ads.googleads.v17.services.MutateAdGroupCriterionLabelResult
	(*resources.AdGroupCriterionLabel)(nil),      // 4: google.ads.googleads.v17.resources.AdGroupCriterionLabel
	(*status.Status)(nil),                        // 5: google.rpc.Status
}
var file_services_ad_group_criterion_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsRequest.operations:type_name -> google.ads.googleads.v17.services.AdGroupCriterionLabelOperation
	4, // 1: google.ads.googleads.v17.services.AdGroupCriterionLabelOperation.create:type_name -> google.ads.googleads.v17.resources.AdGroupCriterionLabel
	5, // 2: google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsResponse.results:type_name -> google.ads.googleads.v17.services.MutateAdGroupCriterionLabelResult
	0, // 4: google.ads.googleads.v17.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:input_type -> google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsRequest
	2, // 5: google.ads.googleads.v17.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:output_type -> google.ads.googleads.v17.services.MutateAdGroupCriterionLabelsResponse
...
func init() { file_services_ad_group_criterion_label_service_proto_init() }
func file_services_ad_group_criterion_label_service_proto_init() {
	if File_services_ad_group_criterion_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_ad_group_criterion_label_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_criterion_label_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_criterion_label_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_criterion_label_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_ad_group_criterion_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_ad_group_criterion_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_ad_group_criterion_label_service_proto_goTypes,
		DependencyIndexes: file_services_ad_group_criterion_label_service_proto_depIdxs,
		MessageInfos:      file_services_ad_group_criterion_label_service_proto_msgTypes,
	}.Build()
	File_services_ad_group_criterion_label_service_proto = out.File
	file_services_ad_group_criterion_label_service_proto_rawDesc = nil
	file_services_ad_group_criterion_label_service_proto_goTypes = nil
	file_services_ad_group_criterion_label_service_proto_depIdxs = nil
}
