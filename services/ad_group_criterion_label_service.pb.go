...
func (x *MutateAdGroupCriterionLabelResult) Reset() {
	*x = MutateAdGroupCriterionLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_criterion_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupCriterionLabelResult) Descriptor() ([]byte, []int) {
	return file_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_ad_group_criterion_label_service_proto_rawDesc = []byte{
	...
	0x4e, 0x61, 0x6d, 0x65, 0x32, 0xe2, 0x04, 0x0a, 0x1c, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70,
...
var file_services_ad_group_criterion_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
func file_services_ad_group_criterion_label_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_ad_group_criterion_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_ad_group_criterion_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
