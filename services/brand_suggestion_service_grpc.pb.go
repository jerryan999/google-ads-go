...
const (
	BrandSuggestionService_SuggestBrands_FullMethodName = "/google.ads.googleads.v17.services.BrandSuggestionService/SuggestBrands"
)
...
func (c *brandSuggestionServiceClient) SuggestBrands(ctx context.Context, in *SuggestBrandsRequest, opts ...grpc.CallOption) (*SuggestBrandsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BrandSuggestionService_SuggestBrands_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
