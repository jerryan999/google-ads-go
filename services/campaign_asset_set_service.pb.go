...
func (x *MutateCampaignAssetSetsRequest) Reset() {
	*x = MutateCampaignAssetSetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_asset_set_service_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MutateCampaignAssetSetsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MutateCampaignAssetSetsRequest) ProtoMessage() {}

func (x *MutateCampaignAssetSetsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_services_campaign_asset_set_service_proto_msgTypes[0]
...
func (*MutateCampaignAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignAssetSetsRequest) GetOperations() []*CampaignAssetSetOperation {
	if x != nil {
		return x.Operations
	}
	return nil
...
func (x *MutateCampaignAssetSetsRequest) GetResponseContentType() enums.ResponseContentTypeEnum_ResponseContentType {
	if x != nil {
...
func (x *CampaignAssetSetOperation) Reset() {
	*x = CampaignAssetSetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_asset_set_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *CampaignAssetSetOperation) ProtoReflect() protoreflect.Message {
	mi := &file_services_campaign_asset_set_service_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*CampaignAssetSetOperation) Descriptor() ([]byte, []int) {
	return file_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignAssetSetOperation) GetCreate() *resources.CampaignAssetSet {
	if x, ok := x.GetOperation().(*CampaignAssetSetOperation_Create); ok {
		return x.Create
	}
	return nil
}
...
func (x *CampaignAssetSetOperation) GetRemove() string {
	if x, ok := x.GetOperation().(*CampaignAssetSetOperation_Remove); ok {
		return x.Remove
	}
	return ""
}

type isCampaignAssetSetOperation_Operation interface {
	isCampaignAssetSetOperation_Operation()
}
...
func (*CampaignAssetSetOperation_Create) isCampaignAssetSetOperation_Operation() {}

func (*CampaignAssetSetOperation_Remove) isCampaignAssetSetOperation_Operation() {}
...
func (x *MutateCampaignAssetSetsResponse) Reset() {
	*x = MutateCampaignAssetSetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_asset_set_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MutateCampaignAssetSetsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MutateCampaignAssetSetsResponse) ProtoMessage() {}

func (x *MutateCampaignAssetSetsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_services_campaign_asset_set_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*MutateCampaignAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{2}
}

func (x *MutateCampaignAssetSetsResponse) GetResults() []*MutateCampaignAssetSetResult {
	if x != nil {
		return x.Results
	}
	return nil
...
func (x *MutateCampaignAssetSetResult) Reset() {
	*x = MutateCampaignAssetSetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_asset_set_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MutateCampaignAssetSetResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MutateCampaignAssetSetResult) ProtoMessage() {}

func (x *MutateCampaignAssetSetResult) ProtoReflect() protoreflect.Message {
	mi := &file_services_campaign_asset_set_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (*MutateCampaignAssetSetResult) Descriptor() ([]byte, []int) {
	return file_services_campaign_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_campaign_asset_set_service_proto_rawDesc = []byte{
	...
	0x1e, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41,
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61,
	0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x74, 0x4f, 0x70,
	...
	0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xc2, 0x01, 0x0a, 0x19, 0x43, 0x61, 0x6d, 0x70,
	...
	0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x74, 0x48, 0x00, 0x52, 0x06, 0x63,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73,
	...
	0x1f, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41,
	...
	0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x75,
	...
	0x72, 0x6f, 0x72, 0x22, 0xd7, 0x01, 0x0a, 0x1c, 0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x43, 0x61,
	0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x74, 0x52, 0x65,
	...
	,
	...
	0x22, 0x37, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
	0x2f, 0x7b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x3d, 0x2a, 0x7d,
	0x2f, 0x63, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65,
	...
	0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1c, 0x43, 0x61, 0x6d, 0x70,
	0x61, 0x69, 0x67, 0x6e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76,
...
var (
	file_services_campaign_asset_set_service_proto_rawDescOnce sync.Once
	file_services_campaign_asset_set_service_proto_rawDescData = file_services_campaign_asset_set_service_proto_rawDesc
)

func file_services_campaign_asset_set_service_proto_rawDescGZIP() []byte {
	file_services_campaign_asset_set_service_proto_rawDescOnce.Do(func() {
		file_services_campaign_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_campaign_asset_set_service_proto_rawDescData)
	})
	return file_services_campaign_asset_set_service_proto_rawDescData
}

var file_services_campaign_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_campaign_asset_set_service_proto_goTypes = []any{
	(*MutateCampaignAssetSetsRequest)(nil),                 // 0: google.ads.googleads.v17.services.MutateCampaignAssetSetsRequest
	(*CampaignAssetSetOperation)(nil),                      // 1: google.ads.googleads.v17.services.CampaignAssetSetOperation
	(*MutateCampaignAssetSetsResponse)(nil),                // 2: google.ads.googleads.v17.services.MutateCampaignAssetSetsResponse
	(*MutateCampaignAssetSetResult)(nil),                   // 3: google.ads.googleads.v17.services.MutateCampaignAssetSetResult
	...
	(*resources.CampaignAssetSet)(nil),                     // 5: google.ads.googleads.v17.resources.CampaignAssetSet
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_services_campaign_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateCampaignAssetSetsRequest.operations:type_name -> google.ads.googleads.v17.services.CampaignAssetSetOperation
	4, // 1: google.ads.googleads.v17.services.MutateCampaignAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.CampaignAssetSetOperation.create:type_name -> google.ads.googleads.v17.resources.CampaignAssetSet
	3, // 3: google.ads.googleads.v17.services.MutateCampaignAssetSetsResponse.results:type_name -> google.ads.googleads.v17.services.MutateCampaignAssetSetResult
	6, // 4: google.ads.googleads.v17.services.MutateCampaignAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v17.services.MutateCampaignAssetSetResult.campaign_asset_set:type_name -> google.ads.googleads.v17.resources.CampaignAssetSet
	0, // 6: google.ads.googleads.v17.services.CampaignAssetSetService.MutateCampaignAssetSets:input_type -> google.ads.googleads.v17.services.MutateCampaignAssetSetsRequest
	2, // 7: google.ads.googleads.v17.services.CampaignAssetSetService.MutateCampaignAssetSets:output_type -> google.ads.googleads.v17.services.MutateCampaignAssetSetsResponse
...
func init() { file_services_campaign_asset_set_service_proto_init() }
func file_services_campaign_asset_set_service_proto_init() {
	if File_services_campaign_asset_set_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_campaign_asset_set_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*MutateCampaignAssetSetsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_campaign_asset_set_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*CampaignAssetSetOperation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_campaign_asset_set_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*MutateCampaignAssetSetsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_campaign_asset_set_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*MutateCampaignAssetSetResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_services_campaign_asset_set_service_proto_msgTypes[1].OneofWrappers = []any{
		(*CampaignAssetSetOperation_Create)(nil),
		(*CampaignAssetSetOperation_Remove)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_services_campaign_asset_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_campaign_asset_set_service_proto_goTypes,
		DependencyIndexes: file_services_campaign_asset_set_service_proto_depIdxs,
		MessageInfos:      file_services_campaign_asset_set_service_proto_msgTypes,
	}.Build()
	File_services_campaign_asset_set_service_proto = out.File
	file_services_campaign_asset_set_service_proto_rawDesc = nil
	file_services_campaign_asset_set_service_proto_goTypes = nil
	file_services_campaign_asset_set_service_proto_depIdxs = nil
}
