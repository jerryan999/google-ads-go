...
const (
	CustomAudienceService_MutateCustomAudiences_FullMethodName = "/google.ads.googleads.v17.services.CustomAudienceService/MutateCustomAudiences"
)
...
func (c *customAudienceServiceClient) MutateCustomAudiences(ctx context.Context, in *MutateCustomAudiencesRequest, opts ...grpc.CallOption) (*MutateCustomAudiencesResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomAudienceService_MutateCustomAudiences_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomAudienceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomAudienceService",
	...
	Metadata: "google/ads/googleads/v17/services/custom_audience_service.proto",
}
