...
const (
	SmartCampaignSettingService_GetSmartCampaignStatus_FullMethodName      = "/google.ads.googleads.v17.services.SmartCampaignSettingService/GetSmartCampaignStatus"
	SmartCampaignSettingService_MutateSmartCampaignSettings_FullMethodName = "/google.ads.googleads.v17.services.SmartCampaignSettingService/MutateSmartCampaignSettings"
)
...
func (c *smartCampaignSettingServiceClient) GetSmartCampaignStatus(ctx context.Context, in *GetSmartCampaignStatusRequest, opts ...grpc.CallOption) (*GetSmartCampaignStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmartCampaignSettingService_GetSmartCampaignStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smartCampaignSettingServiceClient) MutateSmartCampaignSettings(ctx context.Context, in *MutateSmartCampaignSettingsRequest, opts ...grpc.CallOption) (*MutateSmartCampaignSettingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, SmartCampaignSettingService_MutateSmartCampaignSettings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var SmartCampaignSettingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.SmartCampaignSettingService",
	...
	Metadata: "google/ads/googleads/v17/services/smart_campaign_setting_service.proto",
}
