...
const (
	ProductLinkService_CreateProductLink_FullMethodName = "/google.ads.googleads.v17.services.ProductLinkService/CreateProductLink"
	ProductLinkService_RemoveProductLink_FullMethodName = "/google.ads.googleads.v17.services.ProductLinkService/RemoveProductLink"
)
...
func (c *productLinkServiceClient) CreateProductLink(ctx context.Context, in *CreateProductLinkRequest, opts ...grpc.CallOption) (*CreateProductLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductLinkService_CreateProductLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productLinkServiceClient) RemoveProductLink(ctx context.Context, in *RemoveProductLinkRequest, opts ...grpc.CallOption) (*RemoveProductLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProductLinkService_RemoveProductLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
