...
type HotelAssetSuggestion struct {
	...
	// Call to action type.
	CallToAction enums.CallToActionTypeEnum_CallToActionType `protobuf:"varint,4,opt,name=call_to_action,json=callToAction,proto3,enum=google.ads.googleads.v15.enums.CallToActionTypeEnum_CallToActionType" json:"call_to_action,omitempty"`
	...
	Status enums.HotelAssetSuggestionStatusEnum_HotelAssetSuggestionStatus `protobuf:"varint,7,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.HotelAssetSuggestionStatusEnum_HotelAssetSuggestionStatus" json:"status,omitempty"`
}
...
type HotelTextAsset struct {
	...
	AssetFieldType enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,2,opt,name=asset_field_type,json=assetFieldType,proto3,enum=google.ads.googleads.v15.enums.AssetFieldTypeEnum_AssetFieldType" json:"asset_field_type,omitempty"`
}
...
var file_services_travel_asset_suggestion_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x35, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x35, 0x67, 0x6f,
	...
	0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x48,
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74,
...
var file_services_travel_asset_suggestion_service_proto_goTypes = []interface{}{
	(*SuggestTravelAssetsRequest)(nil),                                   // 0: google.ads.googleads.v15.services.SuggestTravelAssetsRequest
	(*SuggestTravelAssetsResponse)(nil),                                  // 1: google.ads.googleads.v15.services.SuggestTravelAssetsResponse
	(*HotelAssetSuggestion)(nil),                                         // 2: google.ads.googleads.v15.services.HotelAssetSuggestion
	(*HotelTextAsset)(nil),                                               // 3: google.ads.googleads.v15.services.HotelTextAsset
	(*HotelImageAsset)(nil),                                              // 4: google.ads.googleads.v15.services.HotelImageAsset
	(enums.CallToActionTypeEnum_CallToActionType)(0),                     // 5: google.ads.googleads.v15.enums.CallToActionTypeEnum.CallToActionType
	(enums.HotelAssetSuggestionStatusEnum_HotelAssetSuggestionStatus)(0), // 6: google.ads.googleads.v15.enums.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),                         // 7: google.ads.googleads.v15.enums.AssetFieldTypeEnum.AssetFieldType
}
var file_services_travel_asset_suggestion_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v15.services.SuggestTravelAssetsResponse.hotel_asset_suggestions:type_name -> google.ads.googleads.v15.services.HotelAssetSuggestion
	5, // 1: google.ads.googleads.v15.services.HotelAssetSuggestion.call_to_action:type_name -> google.ads.googleads.v15.enums.CallToActionTypeEnum.CallToActionType
	3, // 2: google.ads.googleads.v15.services.HotelAssetSuggestion.text_assets:type_name -> google.ads.googleads.v15.services.HotelTextAsset
	4, // 3: google.ads.googleads.v15.services.HotelAssetSuggestion.image_assets:type_name -> google.ads.googleads.v15.services.HotelImageAsset
	6, // 4: google.ads.googleads.v15.services.HotelAssetSuggestion.status:type_name -> google.ads.googleads.v15.enums.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus
	7, // 5: google.ads.googleads.v15.services.HotelTextAsset.asset_field_type:type_name -> google.ads.googleads.v15.enums.AssetFieldTypeEnum.AssetFieldType
	7, // 6: google.ads.googleads.v15.services.HotelImageAsset.asset_field_type:type_name -> google.ads.googleads.v15.enums.AssetFieldTypeEnum.AssetFieldType
	0, // 7: google.ads.googleads.v15.services.TravelAssetSuggestionService.SuggestTravelAssets:input_type -> google.ads.googleads.v15.services.SuggestTravelAssetsRequest
	1, // 8: google.ads.googleads.v15.services.TravelAssetSuggestionService.SuggestTravelAssets:output_type -> google.ads.googleads.v15.services.SuggestTravelAssetsResponse
...
func file_services_travel_asset_suggestion_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_travel_asset_suggestion_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_travel_asset_suggestion_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_travel_asset_suggestion_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_travel_asset_suggestion_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_travel_asset_suggestion_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
