...
func (x *MutateFeedResult) Reset() {
	*x = MutateFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_feed_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateFeedResult) Descriptor() ([]byte, []int) {
	return file_services_feed_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_feed_service_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x4e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2f, 0x22, 0x2a, 0x2f, 0x76, 0x39, 0x2f,
...
var file_services_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_feed_service_proto_goTypes = []interface{}{
	(*GetFeedRequest)(nil),                                 // 0: google.ads.googleads.v9.services.GetFeedRequest
	(*MutateFeedsRequest)(nil),                             // 1: google.ads.googleads.v9.services.MutateFeedsRequest
	(*FeedOperation)(nil),                                  // 2: google.ads.googleads.v9.services.FeedOperation
	(*MutateFeedsResponse)(nil),                            // 3: google.ads.googleads.v9.services.MutateFeedsResponse
	(*MutateFeedResult)(nil),                               // 4: google.ads.googleads.v9.services.MutateFeedResult
	...
	(*resources.Feed)(nil),                                 // 7: google.ads.googleads.v9.resources.Feed
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_services_feed_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v9.services.MutateFeedsRequest.operations:type_name -> google.ads.googleads.v9.services.FeedOperation
	5,  // 1: google.ads.googleads.v9.services.MutateFeedsRequest.response_content_type:type_name -> google.ads.googleads.v9.enums.ResponseContentTypeEnum.ResponseContentType
	6,  // 2: google.ads.googleads.v9.services.FeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	7,  // 3: google.ads.googleads.v9.services.FeedOperation.create:type_name -> google.ads.googleads.v9.resources.Feed
	7,  // 4: google.ads.googleads.v9.services.FeedOperation.update:type_name -> google.ads.googleads.v9.resources.Feed
	8,  // 5: google.ads.googleads.v9.services.MutateFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	4,  // 6: google.ads.googleads.v9.services.MutateFeedsResponse.results:type_name -> google.ads.googleads.v9.services.MutateFeedResult
	7,  // 7: google.ads.googleads.v9.services.MutateFeedResult.feed:type_name -> google.ads.googleads.v9.resources.Feed
	0,  // 8: google.ads.googleads.v9.services.FeedService.GetFeed:input_type -> google.ads.googleads.v9.services.GetFeedRequest
	1,  // 9: google.ads.googleads.v9.services.FeedService.MutateFeeds:input_type -> google.ads.googleads.v9.services.MutateFeedsRequest
	7,  // 10: google.ads.googleads.v9.services.FeedService.GetFeed:output_type -> google.ads.googleads.v9.resources.Feed
	3,  // 11: google.ads.googleads.v9.services.FeedService.MutateFeeds:output_type -> google.ads.googleads.v9.services.MutateFeedsResponse
...
func file_services_feed_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_feed_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_feed_service_proto_msgTypes[2].OneofWrappers = []interface{}{
