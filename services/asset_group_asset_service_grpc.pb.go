...
const (
	AssetGroupAssetService_MutateAssetGroupAssets_FullMethodName = "/google.ads.googleads.v17.services.AssetGroupAssetService/MutateAssetGroupAssets"
)
...
func (c *assetGroupAssetServiceClient) MutateAssetGroupAssets(ctx context.Context, in *MutateAssetGroupAssetsRequest, opts ...grpc.CallOption) (*MutateAssetGroupAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AssetGroupAssetService_MutateAssetGroupAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
