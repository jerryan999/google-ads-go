...
const (
	CampaignGroupService_MutateCampaignGroups_FullMethodName = "/google.ads.googleads.v17.services.CampaignGroupService/MutateCampaignGroups"
)
...
func (c *campaignGroupServiceClient) MutateCampaignGroups(ctx context.Context, in *MutateCampaignGroupsRequest, opts ...grpc.CallOption) (*MutateCampaignGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CampaignGroupService_MutateCampaignGroups_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
