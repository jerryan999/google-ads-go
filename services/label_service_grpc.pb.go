...
const (
	LabelService_MutateLabels_FullMethodName = "/google.ads.googleads.v17.services.LabelService/MutateLabels"
)
...
func (c *labelServiceClient) MutateLabels(ctx context.Context, in *MutateLabelsRequest, opts ...grpc.CallOption) (*MutateLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, LabelService_MutateLabels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var LabelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.LabelService",
	...
	Metadata: "google/ads/googleads/v17/services/label_service.proto",
}
