...
func (x *MutateAdGroupAssetsRequest) Reset() {
	*x = MutateAdGroupAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_asset_service_proto_msgTypes[0]
...
func (*MutateAdGroupAssetsRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAssetOperation) Reset() {
	*x = AdGroupAssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupAssetOperation) Descriptor() ([]byte, []int) {
	return file_services_ad_group_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupAssetsResponse) Reset() {
	*x = MutateAdGroupAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAssetsResponse) Descriptor() ([]byte, []int) {
	return file_services_ad_group_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAssetResult) Reset() {
	*x = MutateAdGroupAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupAssetResult) Descriptor() ([]byte, []int) {
	return file_services_ad_group_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_ad_group_asset_service_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf0, 0x02, 0x0a, 0x1a, 0x4d, 0x75, 0x74, 0x61, 0x74,
	0x65, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x73, 0x73, 0x65, 0x74, 0x73, 0x52, 0x65,
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x22, 0xbf, 0x02, 0x0a, 0x15, 0x41, 0x64,
	...
	0x12, 0x4a, 0x0a, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	...
	0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x48, 0x00, 0x52, 0x06, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x4a, 0x0a, 0x06,
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x67,
	...
	0x52, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x44, 0x0a, 0x06, 0x72, 0x65, 0x6d, 0x6f,
	0x76, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2a, 0xfa, 0x41, 0x27, 0x0a, 0x25, 0x67,
	...
	0x73, 0x73, 0x65, 0x74, 0x48, 0x00, 0x52, 0x06, 0x72, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x42, 0x0b,
	0x0a, 0x09, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xbc, 0x01, 0x0a, 0x1b,
	0x4d, 0x75, 0x74, 0x61, 0x74, 0x65, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x46, 0x0a, 0x15, 0x70,
	...
	0x72, 0x6f, 0x72, 0x12, 0x55, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x3b, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64,
	...
	0x74, 0x52, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0xc3, 0x01, 0x0a, 0x18, 0x4d,
	0x75, 0x74, 0x61, 0x74, 0x65, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x73, 0x73, 0x65,
	0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x4f, 0x0a, 0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x2a,
	...
	,
	...
	0x70, 0x41, 0x73, 0x73, 0x65, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x57, 0xda, 0x41, 0x16, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x2c,
	0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38,
	...
	0x3d, 0x2a, 0x7d, 0x2f, 0x61, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x41, 0x73, 0x73, 0x65, 0x74,
...
var (
	file_services_ad_group_asset_service_proto_rawDescOnce sync.Once
	file_services_ad_group_asset_service_proto_rawDescData = file_services_ad_group_asset_service_proto_rawDesc
)

func file_services_ad_group_asset_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_asset_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_ad_group_asset_service_proto_rawDescData)
	})
	return file_services_ad_group_asset_service_proto_rawDescData
}

var file_services_ad_group_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_ad_group_asset_service_proto_goTypes = []any{
	(*MutateAdGroupAssetsRequest)(nil),                     // 0: google.ads.googleads.v17.services.MutateAdGroupAssetsRequest
	(*AdGroupAssetOperation)(nil),                          // 1: google.ads.googleads.v17.services.AdGroupAssetOperation
	(*MutateAdGroupAssetsResponse)(nil),                    // 2: google.ads.googleads.v17.services.MutateAdGroupAssetsResponse
	(*MutateAdGroupAssetResult)(nil),                       // 3: google.ads.googleads.v17.services.MutateAdGroupAssetResult
	...
	(*resources.AdGroupAsset)(nil),                         // 6: google.ads.googleads.v17.resources.AdGroupAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_services_ad_group_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateAdGroupAssetsRequest.operations:type_name -> google.ads.googleads.v17.services.AdGroupAssetOperation
	4, // 1: google.ads.googleads.v17.services.MutateAdGroupAssetsRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.AdGroupAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v17.services.AdGroupAssetOperation.create:type_name -> google.ads.googleads.v17.resources.AdGroupAsset
	6, // 4: google.ads.googleads.v17.services.AdGroupAssetOperation.update:type_name -> google.ads.googleads.v17.resources.AdGroupAsset
	7, // 5: google.ads.googleads.v17.services.MutateAdGroupAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v17.services.MutateAdGroupAssetsResponse.results:type_name -> google.ads.googleads.v17.services.MutateAdGroupAssetResult
	6, // 7: google.ads.googleads.v17.services.MutateAdGroupAssetResult.ad_group_asset:type_name -> google.ads.googleads.v17.resources.AdGroupAsset
	0, // 8: google.ads.googleads.v17.services.AdGroupAssetService.MutateAdGroupAssets:input_type -> google.ads.googleads.v17.services.MutateAdGroupAssetsRequest
	2, // 9: google.ads.googleads.v17.services.AdGroupAssetService.MutateAdGroupAssets:output_type -> google.ads.googleads.v17.services.MutateAdGroupAssetsResponse
...
func init() { file_services_ad_group_asset_service_proto_init() }
func file_services_ad_group_asset_service_proto_init() {
	if File_services_ad_group_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_ad_group_asset_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_asset_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_asset_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_asset_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_ad_group_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_ad_group_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_ad_group_asset_service_proto_goTypes,
		DependencyIndexes: file_services_ad_group_asset_service_proto_depIdxs,
		MessageInfos:      file_services_ad_group_asset_service_proto_msgTypes,
	}.Build()
	File_services_ad_group_asset_service_proto = out.File
	file_services_ad_group_asset_service_proto_rawDesc = nil
	file_services_ad_group_asset_service_proto_goTypes = nil
	file_services_ad_group_asset_service_proto_depIdxs = nil
}
