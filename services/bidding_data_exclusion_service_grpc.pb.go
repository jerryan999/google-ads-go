...
const (
	BiddingDataExclusionService_MutateBiddingDataExclusions_FullMethodName = "/google.ads.googleads.v17.services.BiddingDataExclusionService/MutateBiddingDataExclusions"
)
...
func (c *biddingDataExclusionServiceClient) MutateBiddingDataExclusions(ctx context.Context, in *MutateBiddingDataExclusionsRequest, opts ...grpc.CallOption) (*MutateBiddingDataExclusionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BiddingDataExclusionService_MutateBiddingDataExclusions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var BiddingDataExclusionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.BiddingDataExclusionService",
	...
	Metadata: "google/ads/googleads/v17/services/bidding_data_exclusion_service.proto",
}
