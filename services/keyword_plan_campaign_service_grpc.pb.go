...
const (
	KeywordPlanCampaignService_MutateKeywordPlanCampaigns_FullMethodName = "/google.ads.googleads.v17.services.KeywordPlanCampaignService/MutateKeywordPlanCampaigns"
)
...
func (c *keywordPlanCampaignServiceClient) MutateKeywordPlanCampaigns(ctx context.Context, in *MutateKeywordPlanCampaignsRequest, opts ...grpc.CallOption) (*MutateKeywordPlanCampaignsResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeywordPlanCampaignService_MutateKeywordPlanCampaigns_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var KeywordPlanCampaignService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.KeywordPlanCampaignService",
	...
	Metadata: "google/ads/googleads/v17/services/keyword_plan_campaign_service.proto",
}
