...
func (x *SuggestKeywordThemeConstantsResponse) Reset() {
	*x = SuggestKeywordThemeConstantsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_keyword_theme_constant_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SuggestKeywordThemeConstantsResponse) Descriptor() ([]byte, []int) {
	return file_services_keyword_theme_constant_service_proto_rawDescGZIP(), []int{2}
}
...
var file_services_keyword_theme_constant_service_proto_rawDesc = []byte{
	...
	0x02, 0x2d, 0x12, 0x2b, 0x2f, 0x76, 0x39, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	...
	0x2c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x26, 0x22, 0x21, 0x2f, 0x76, 0x39, 0x2f, 0x6b, 0x65, 0x79,
	...
	0x73, 0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x20, 0x4b,
...
var file_services_keyword_theme_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_services_keyword_theme_constant_service_proto_goTypes = []interface{}{
	(*GetKeywordThemeConstantRequest)(nil),       // 0: google.ads.googleads.v9.services.GetKeywordThemeConstantRequest
	(*SuggestKeywordThemeConstantsRequest)(nil),  // 1: google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest
	(*SuggestKeywordThemeConstantsResponse)(nil), // 2: google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse
	(*resources.KeywordThemeConstant)(nil),       // 3: google.ads.googleads.v9.resources.KeywordThemeConstant
}
var file_services_keyword_theme_constant_service_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse.keyword_theme_constants:type_name -> google.ads.googleads.v9.resources.KeywordThemeConstant
	0, // 1: google.ads.googleads.v9.services.KeywordThemeConstantService.GetKeywordThemeConstant:input_type -> google.ads.googleads.v9.services.GetKeywordThemeConstantRequest
	1, // 2: google.ads.googleads.v9.services.KeywordThemeConstantService.SuggestKeywordThemeConstants:input_type -> google.ads.googleads.v9.services.SuggestKeywordThemeConstantsRequest
	3, // 3: google.ads.googleads.v9.services.KeywordThemeConstantService.GetKeywordThemeConstant:output_type -> google.ads.googleads.v9.resources.KeywordThemeConstant
	2, // 4: google.ads.googleads.v9.services.KeywordThemeConstantService.SuggestKeywordThemeConstants:output_type -> google.ads.googleads.v9.services.SuggestKeywordThemeConstantsResponse
...
func file_services_keyword_theme_constant_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_keyword_theme_constant_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
