...
var file_services_product_link_invitation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_services_product_link_invitation_service_proto_goTypes = []interface{}{
...
func file_services_product_link_invitation_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_product_link_invitation_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_product_link_invitation_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
