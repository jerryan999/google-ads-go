...
const (
	AdGroupAssetService_MutateAdGroupAssets_FullMethodName = "/google.ads.googleads.v17.services.AdGroupAssetService/MutateAdGroupAssets"
)
...
func (c *adGroupAssetServiceClient) MutateAdGroupAssets(ctx context.Context, in *MutateAdGroupAssetsRequest, opts ...grpc.CallOption) (*MutateAdGroupAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdGroupAssetService_MutateAdGroupAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AdGroupAssetService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v17/services/ad_group_asset_service.proto",
}
