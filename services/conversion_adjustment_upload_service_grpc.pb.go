...
const (
	ConversionAdjustmentUploadService_UploadConversionAdjustments_FullMethodName = "/google.ads.googleads.v17.services.ConversionAdjustmentUploadService/UploadConversionAdjustments"
)
...
func (c *conversionAdjustmentUploadServiceClient) UploadConversionAdjustments(ctx context.Context, in *UploadConversionAdjustmentsRequest, opts ...grpc.CallOption) (*UploadConversionAdjustmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConversionAdjustmentUploadService_UploadConversionAdjustments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ConversionAdjustmentUploadService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v17/services/conversion_adjustment_upload_service.proto",
}
