...
const (
	CustomizerAttributeService_MutateCustomizerAttributes_FullMethodName = "/google.ads.googleads.v17.services.CustomizerAttributeService/MutateCustomizerAttributes"
)
...
func (c *customizerAttributeServiceClient) MutateCustomizerAttributes(ctx context.Context, in *MutateCustomizerAttributesRequest, opts ...grpc.CallOption) (*MutateCustomizerAttributesResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomizerAttributeService_MutateCustomizerAttributes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomizerAttributeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomizerAttributeService",
	...
	Metadata: "google/ads/googleads/v17/services/customizer_attribute_service.proto",
}
