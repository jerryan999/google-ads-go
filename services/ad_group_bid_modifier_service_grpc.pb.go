...
const (
	AdGroupBidModifierService_MutateAdGroupBidModifiers_FullMethodName = "/google.ads.googleads.v17.services.AdGroupBidModifierService/MutateAdGroupBidModifiers"
)
...
func (c *adGroupBidModifierServiceClient) MutateAdGroupBidModifiers(ctx context.Context, in *MutateAdGroupBidModifiersRequest, opts ...grpc.CallOption) (*MutateAdGroupBidModifiersResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdGroupBidModifierService_MutateAdGroupBidModifiers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AdGroupBidModifierService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.AdGroupBidModifierService",
	...
	Metadata: "google/ads/googleads/v17/services/ad_group_bid_modifier_service.proto",
}
