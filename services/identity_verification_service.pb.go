...
var file_services_identity_verification_service_proto_rawDesc = []byte{
...
var (
	...
	file_services_identity_verification_service_proto_rawDescData = file_services_identity_verification_service_proto_rawDesc
)
...
func file_services_identity_verification_service_proto_rawDescGZIP() []byte {
	file_services_identity_verification_service_proto_rawDescOnce.Do(func() {
		file_services_identity_verification_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_identity_verification_service_proto_rawDescData)
	})
...
func file_services_identity_verification_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_identity_verification_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_identity_verification_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_identity_verification_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_identity_verification_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_services_identity_verification_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_services_identity_verification_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_identity_verification_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_services_identity_verification_service_proto_rawDesc = nil
