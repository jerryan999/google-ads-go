...
const (
	CustomerManagerLinkService_MutateCustomerManagerLink_FullMethodName = "/google.ads.googleads.v17.services.CustomerManagerLinkService/MutateCustomerManagerLink"
	CustomerManagerLinkService_MoveManagerLink_FullMethodName           = "/google.ads.googleads.v17.services.CustomerManagerLinkService/MoveManagerLink"
)
...
func (c *customerManagerLinkServiceClient) MutateCustomerManagerLink(ctx context.Context, in *MutateCustomerManagerLinkRequest, opts ...grpc.CallOption) (*MutateCustomerManagerLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerManagerLinkService_MutateCustomerManagerLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerManagerLinkServiceClient) MoveManagerLink(ctx context.Context, in *MoveManagerLinkRequest, opts ...grpc.CallOption) (*MoveManagerLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomerManagerLinkService_MoveManagerLink_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomerManagerLinkService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomerManagerLinkService",
	...
	Metadata: "google/ads/googleads/v17/services/customer_manager_link_service.proto",
}
