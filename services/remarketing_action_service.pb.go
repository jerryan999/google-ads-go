...
func (x *MutateRemarketingActionResult) Reset() {
	*x = MutateRemarketingActionResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_remarketing_action_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateRemarketingActionResult) Descriptor() ([]byte, []int) {
	return file_services_remarketing_action_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_remarketing_action_service_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0xbe, 0x04, 0x0a, 0x18, 0x52, 0x65,
	...
	0x63, 0x65, 0x73, 0x42, 0x1d, 0x52, 0x65, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x69, 0x6e, 0x67,
	0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f,
...
var file_services_remarketing_action_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_remarketing_action_service_proto_goTypes = []interface{}{
	(*GetRemarketingActionRequest)(nil),      // 0: google.ads.googleads.v9.services.GetRemarketingActionRequest
	(*MutateRemarketingActionsRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateRemarketingActionsRequest
	(*RemarketingActionOperation)(nil),       // 2: google.ads.googleads.v9.services.RemarketingActionOperation
	(*MutateRemarketingActionsResponse)(nil), // 3: google.ads.googleads.v9.services.MutateRemarketingActionsResponse
	(*MutateRemarketingActionResult)(nil),    // 4: google.ads.googleads.v9.services.MutateRemarketingActionResult
	(*fieldmaskpb.FieldMask)(nil),            // 5: google.protobuf.FieldMask
	(*resources.RemarketingAction)(nil),      // 6: google.ads.googleads.v9.resources.RemarketingAction
	(*status.Status)(nil),                    // 7: google.rpc.Status
}
var file_services_remarketing_action_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateRemarketingActionsRequest.operations:type_name -> google.ads.googleads.v9.services.RemarketingActionOperation
	5, // 1: google.ads.googleads.v9.services.RemarketingActionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v9.services.RemarketingActionOperation.create:type_name -> google.ads.googleads.v9.resources.RemarketingAction
	6, // 3: google.ads.googleads.v9.services.RemarketingActionOperation.update:type_name -> google.ads.googleads.v9.resources.RemarketingAction
	7, // 4: google.ads.googleads.v9.services.MutateRemarketingActionsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v9.services.MutateRemarketingActionsResponse.results:type_name -> google.ads.googleads.v9.services.MutateRemarketingActionResult
	0, // 6: google.ads.googleads.v9.services.RemarketingActionService.GetRemarketingAction:input_type -> google.ads.googleads.v9.services.GetRemarketingActionRequest
	1, // 7: google.ads.googleads.v9.services.RemarketingActionService.MutateRemarketingActions:input_type -> google.ads.googleads.v9.services.MutateRemarketingActionsRequest
	6, // 8: google.ads.googleads.v9.services.RemarketingActionService.GetRemarketingAction:output_type -> google.ads.googleads.v9.resources.RemarketingAction
	3, // 9: google.ads.googleads.v9.services.RemarketingActionService.MutateRemarketingActions:output_type -> google.ads.googleads.v9.services.MutateRemarketingActionsResponse
...
func file_services_remarketing_action_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_remarketing_action_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_remarketing_action_service_proto_msgTypes[2].OneofWrappers = []interface{}{
