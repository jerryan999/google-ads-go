...
const (
	AdGroupFeedService_MutateAdGroupFeeds_FullMethodName = "/google.ads.googleads.v17.services.AdGroupFeedService/MutateAdGroupFeeds"
)
...
func (c *adGroupFeedServiceClient) MutateAdGroupFeeds(ctx context.Context, in *MutateAdGroupFeedsRequest, opts ...grpc.CallOption) (*MutateAdGroupFeedsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdGroupFeedService_MutateAdGroupFeeds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var AdGroupFeedService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v17/services/ad_group_feed_service.proto",
}
