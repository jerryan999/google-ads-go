...
const (
	AdGroupFeedService_MutateAdGroupFeeds_FullMethodName = "/google.ads.googleads.v15.services.AdGroupFeedService/MutateAdGroupFeeds"
)
...
func (c *adGroupFeedServiceClient) MutateAdGroupFeeds(ctx context.Context, in *MutateAdGroupFeedsRequest, opts ...grpc.CallOption) (*MutateAdGroupFeedsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdGroupFeedService_MutateAdGroupFeeds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupFeedService_MutateAdGroupFeeds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdGroupFeedService_MutateAdGroupFeeds_FullMethodName,
	}
...
var AdGroupFeedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v15.services.AdGroupFeedService",
	...
	Metadata: "google/ads/googleads/v15/services/ad_group_feed_service.proto",
}
