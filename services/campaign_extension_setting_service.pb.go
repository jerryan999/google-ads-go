...
func (x *MutateCampaignExtensionSettingsRequest) Reset() {
	*x = MutateCampaignExtensionSettingsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_extension_setting_service_proto_msgTypes[0]
...
func (*MutateCampaignExtensionSettingsRequest) Descriptor() ([]byte, []int) {
	return file_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignExtensionSettingOperation) Reset() {
	*x = CampaignExtensionSettingOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_extension_setting_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignExtensionSettingOperation) Descriptor() ([]byte, []int) {
	return file_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignExtensionSettingsResponse) Reset() {
	*x = MutateCampaignExtensionSettingsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_extension_setting_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignExtensionSettingsResponse) Descriptor() ([]byte, []int) {
	return file_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignExtensionSettingResult) Reset() {
	*x = MutateCampaignExtensionSettingResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_campaign_extension_setting_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignExtensionSettingResult) Descriptor() ([]byte, []int) {
	return file_services_campaign_extension_setting_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_campaign_extension_setting_service_proto_rawDesc = []byte{
...
var (
	file_services_campaign_extension_setting_service_proto_rawDescOnce sync.Once
	file_services_campaign_extension_setting_service_proto_rawDescData = file_services_campaign_extension_setting_service_proto_rawDesc
)

func file_services_campaign_extension_setting_service_proto_rawDescGZIP() []byte {
	file_services_campaign_extension_setting_service_proto_rawDescOnce.Do(func() {
		file_services_campaign_extension_setting_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_campaign_extension_setting_service_proto_rawDescData)
	})
	return file_services_campaign_extension_setting_service_proto_rawDescData
}

var file_services_campaign_extension_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_campaign_extension_setting_service_proto_goTypes = []any{
	(*MutateCampaignExtensionSettingsRequest)(nil),         // 0: google.ads.googleads.v17.services.MutateCampaignExtensionSettingsRequest
	(*CampaignExtensionSettingOperation)(nil),              // 1: google.ads.googleads.v17.services.CampaignExtensionSettingOperation
	(*MutateCampaignExtensionSettingsResponse)(nil),        // 2: google.ads.googleads.v17.services.MutateCampaignExtensionSettingsResponse
	...
	(*resources.CampaignExtensionSetting)(nil),             // 6: google.ads.googleads.v17.resources.CampaignExtensionSetting
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_services_campaign_extension_setting_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateCampaignExtensionSettingsRequest.operations:type_name -> google.ads.googleads.v17.services.CampaignExtensionSettingOperation
	4, // 1: google.ads.googleads.v17.services.MutateCampaignExtensionSettingsRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.CampaignExtensionSettingOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v17.services.CampaignExtensionSettingOperation.create:type_name -> google.ads.googleads.v17.resources.CampaignExtensionSetting
	...
	7, // 5: google.ads.googleads.v17.services.MutateCampaignExtensionSettingsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v17.services.MutateCampaignExtensionSettingsResponse.results:type_name -> google.ads.googleads.v17.services.MutateCampaignExtensionSettingResult
	6, // 7: google.ads.googleads.v17.services.MutateCampaignExtensionSettingResult.campaign_extension_setting:type_name -> google.ads.googleads.v17.resources.CampaignExtensionSetting
	0, // 8: google.ads.googleads.v17.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings:input_type -> google.ads.googleads.v17.services.MutateCampaignExtensionSettingsRequest
	2, // 9: google.ads.googleads.v17.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings:output_type -> google.ads.googleads.v17.services.MutateCampaignExtensionSettingsResponse
...
func init() { file_services_campaign_extension_setting_service_proto_init() }
func file_services_campaign_extension_setting_service_proto_init() {
	if File_services_campaign_extension_setting_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_campaign_extension_setting_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_campaign_extension_setting_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_campaign_extension_setting_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_campaign_extension_setting_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_campaign_extension_setting_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_campaign_extension_setting_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_campaign_extension_setting_service_proto_goTypes,
		DependencyIndexes: file_services_campaign_extension_setting_service_proto_depIdxs,
		MessageInfos:      file_services_campaign_extension_setting_service_proto_msgTypes,
	}.Build()
	File_services_campaign_extension_setting_service_proto = out.File
	file_services_campaign_extension_setting_service_proto_rawDesc = nil
	file_services_campaign_extension_setting_service_proto_goTypes = nil
	file_services_campaign_extension_setting_service_proto_depIdxs = nil
}
