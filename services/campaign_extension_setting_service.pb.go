...
// Request message for
// [CampaignExtensionSettingService.MutateCampaignExtensionSettings][google.ads.googleads.v15.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings].
...
var file_services_campaign_extension_setting_service_proto_goTypes = []interface{}{
	(*MutateCampaignExtensionSettingsRequest)(nil),         // 0: google.ads.googleads.v15.services.MutateCampaignExtensionSettingsRequest
	(*CampaignExtensionSettingOperation)(nil),              // 1: google.ads.googleads.v15.services.CampaignExtensionSettingOperation
	(*MutateCampaignExtensionSettingsResponse)(nil),        // 2: google.ads.googleads.v15.services.MutateCampaignExtensionSettingsResponse
	(*MutateCampaignExtensionSettingResult)(nil),           // 3: google.ads.googleads.v15.services.MutateCampaignExtensionSettingResult
	...
	(*resources.CampaignExtensionSetting)(nil),             // 6: google.ads.googleads.v15.resources.CampaignExtensionSetting
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_services_campaign_extension_setting_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.services.MutateCampaignExtensionSettingsRequest.operations:type_name -> google.ads.googleads.v15.services.CampaignExtensionSettingOperation
	4, // 1: google.ads.googleads.v15.services.MutateCampaignExtensionSettingsRequest.response_content_type:type_name -> google.ads.googleads.v15.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v15.services.CampaignExtensionSettingOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v15.services.CampaignExtensionSettingOperation.create:type_name -> google.ads.googleads.v15.resources.CampaignExtensionSetting
	6, // 4: google.ads.googleads.v15.services.CampaignExtensionSettingOperation.update:type_name -> google.ads.googleads.v15.resources.CampaignExtensionSetting
	7, // 5: google.ads.googleads.v15.services.MutateCampaignExtensionSettingsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v15.services.MutateCampaignExtensionSettingsResponse.results:type_name -> google.ads.googleads.v15.services.MutateCampaignExtensionSettingResult
	6, // 7: google.ads.googleads.v15.services.MutateCampaignExtensionSettingResult.campaign_extension_setting:type_name -> google.ads.googleads.v15.resources.CampaignExtensionSetting
	0, // 8: google.ads.googleads.v15.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings:input_type -> google.ads.googleads.v15.services.MutateCampaignExtensionSettingsRequest
	2, // 9: google.ads.googleads.v15.services.CampaignExtensionSettingService.MutateCampaignExtensionSettings:output_type -> google.ads.googleads.v15.services.MutateCampaignExtensionSettingsResponse
...
func file_services_campaign_extension_setting_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_campaign_extension_setting_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_campaign_extension_setting_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_campaign_extension_setting_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_campaign_extension_setting_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_campaign_extension_setting_service_proto_msgTypes[1].OneofWrappers = []interface{}{
