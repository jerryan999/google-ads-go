...
const (
	CustomConversionGoalService_MutateCustomConversionGoals_FullMethodName = "/google.ads.googleads.v17.services.CustomConversionGoalService/MutateCustomConversionGoals"
)
...
func (c *customConversionGoalServiceClient) MutateCustomConversionGoals(ctx context.Context, in *MutateCustomConversionGoalsRequest, opts ...grpc.CallOption) (*MutateCustomConversionGoalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, CustomConversionGoalService_MutateCustomConversionGoals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var CustomConversionGoalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.CustomConversionGoalService",
	...
	Metadata: "google/ads/googleads/v17/services/custom_conversion_goal_service.proto",
}
