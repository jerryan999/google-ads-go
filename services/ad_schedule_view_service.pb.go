...
func (x *GetAdScheduleViewRequest) Reset() {
	*x = GetAdScheduleViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_schedule_view_service_proto_msgTypes[0]
...
func (*GetAdScheduleViewRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_schedule_view_service_proto_rawDescGZIP(), []int{0}
}
...
var File_services_ad_schedule_view_service_proto protoreflect.FileDescriptor

var file_services_ad_schedule_view_service_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x32, 0xae, 0x02, 0x0a, 0x15, 0x41, 0x64, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c,
	...
	0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1a, 0x41, 0x64,
	0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x56, 0x69, 0x65, 0x77, 0x53, 0x65, 0x72, 0x76,
...
var (
	file_services_ad_schedule_view_service_proto_rawDescOnce sync.Once
	file_services_ad_schedule_view_service_proto_rawDescData = file_services_ad_schedule_view_service_proto_rawDesc
)

func file_services_ad_schedule_view_service_proto_rawDescGZIP() []byte {
	file_services_ad_schedule_view_service_proto_rawDescOnce.Do(func() {
		file_services_ad_schedule_view_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_ad_schedule_view_service_proto_rawDescData)
	})
	return file_services_ad_schedule_view_service_proto_rawDescData
}

var file_services_ad_schedule_view_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_services_ad_schedule_view_service_proto_goTypes = []interface{}{
	(*GetAdScheduleViewRequest)(nil), // 0: google.ads.googleads.v9.services.GetAdScheduleViewRequest
	(*resources.AdScheduleView)(nil), // 1: google.ads.googleads.v9.resources.AdScheduleView
}
var file_services_ad_schedule_view_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v9.services.AdScheduleViewService.GetAdScheduleView:input_type -> google.ads.googleads.v9.services.GetAdScheduleViewRequest
	1, // 1: google.ads.googleads.v9.services.AdScheduleViewService.GetAdScheduleView:output_type -> google.ads.googleads.v9.resources.AdScheduleView
...
func init() { file_services_ad_schedule_view_service_proto_init() }
func file_services_ad_schedule_view_service_proto_init() {
	if File_services_ad_schedule_view_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_ad_schedule_view_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_ad_schedule_view_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_ad_schedule_view_service_proto_goTypes,
		DependencyIndexes: file_services_ad_schedule_view_service_proto_depIdxs,
		MessageInfos:      file_services_ad_schedule_view_service_proto_msgTypes,
	}.Build()
	File_services_ad_schedule_view_service_proto = out.File
	file_services_ad_schedule_view_service_proto_rawDesc = nil
	file_services_ad_schedule_view_service_proto_goTypes = nil
	file_services_ad_schedule_view_service_proto_depIdxs = nil
}
