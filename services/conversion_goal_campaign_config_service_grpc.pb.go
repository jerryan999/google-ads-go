...
const (
	ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_FullMethodName = "/google.ads.googleads.v15.services.ConversionGoalCampaignConfigService/MutateConversionGoalCampaignConfigs"
)
...
func (c *conversionGoalCampaignConfigServiceClient) MutateConversionGoalCampaignConfigs(ctx context.Context, in *MutateConversionGoalCampaignConfigsRequest, opts ...grpc.CallOption) (*MutateConversionGoalCampaignConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_FullMethodName,
	}
...
var ConversionGoalCampaignConfigService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v15.services.ConversionGoalCampaignConfigService",
	...
	Metadata: "google/ads/googleads/v15/services/conversion_goal_campaign_config_service.proto",
}
