...
func (x *CampaignLifecycleGoalOperation) GetUpdate() *resources.CampaignLifecycleGoal {
	if x, ok := x.GetOperation().(*CampaignLifecycleGoalOperation_Update); ok {
		return x.Update
	}
	return nil
}
...
var file_services_campaign_lifecycle_goal_service_proto_rawDesc = []byte{
	...
	0x31, 0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x6d, 0x70,
...
var (
	...
	file_services_campaign_lifecycle_goal_service_proto_rawDescData = file_services_campaign_lifecycle_goal_service_proto_rawDesc
)
...
func file_services_campaign_lifecycle_goal_service_proto_rawDescGZIP() []byte {
	file_services_campaign_lifecycle_goal_service_proto_rawDescOnce.Do(func() {
		file_services_campaign_lifecycle_goal_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_campaign_lifecycle_goal_service_proto_rawDescData)
	})
...
var file_services_campaign_lifecycle_goal_service_proto_goTypes = []any{
	(*ConfigureCampaignLifecycleGoalsRequest)(nil),  // 0: google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsRequest
	(*CampaignLifecycleGoalOperation)(nil),          // 1: google.ads.googleads.v17.services.CampaignLifecycleGoalOperation
	(*ConfigureCampaignLifecycleGoalsResponse)(nil), // 2: google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsResponse
	(*ConfigureCampaignLifecycleGoalsResult)(nil),   // 3: google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsResult
	(*fieldmaskpb.FieldMask)(nil),                   // 4: google.protobuf.FieldMask
	(*resources.CampaignLifecycleGoal)(nil),         // 5: google.ads.googleads.v17.resources.CampaignLifecycleGoal
}
var file_services_campaign_lifecycle_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsRequest.operation:type_name -> google.ads.googleads.v17.services.CampaignLifecycleGoalOperation
	4, // 1: google.ads.googleads.v17.services.CampaignLifecycleGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v17.services.CampaignLifecycleGoalOperation.create:type_name -> google.ads.googleads.v17.resources.CampaignLifecycleGoal
	5, // 3: google.ads.googleads.v17.services.CampaignLifecycleGoalOperation.update:type_name -> google.ads.googleads.v17.resources.CampaignLifecycleGoal
	3, // 4: google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsResponse.result:type_name -> google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsResult
	0, // 5: google.ads.googleads.v17.services.CampaignLifecycleGoalService.ConfigureCampaignLifecycleGoals:input_type -> google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsRequest
	2, // 6: google.ads.googleads.v17.services.CampaignLifecycleGoalService.ConfigureCampaignLifecycleGoals:output_type -> google.ads.googleads.v17.services.ConfigureCampaignLifecycleGoalsResponse
...
func file_services_campaign_lifecycle_goal_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_campaign_lifecycle_goal_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_campaign_lifecycle_goal_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_campaign_lifecycle_goal_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_campaign_lifecycle_goal_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_campaign_lifecycle_goal_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_services_campaign_lifecycle_goal_service_proto_rawDesc = nil
