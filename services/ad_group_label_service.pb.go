...
func (x *GetAdGroupLabelRequest) Reset() {
	*x = GetAdGroupLabelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_label_service_proto_msgTypes[0]
...
func (*GetAdGroupLabelRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAdGroupLabelsRequest) Reset() {
	*x = MutateAdGroupLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupLabelsRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AdGroupLabelOperation) Reset() {
	*x = AdGroupLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupLabelOperation) Descriptor() ([]byte, []int) {
	return file_services_ad_group_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupLabelsResponse) Reset() {
	*x = MutateAdGroupLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupLabelsResponse) Descriptor() ([]byte, []int) {
	return file_services_ad_group_label_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAdGroupLabelResult) Reset() {
	*x = MutateAdGroupLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupLabelResult) Descriptor() ([]byte, []int) {
	return file_services_ad_group_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_ad_group_label_service_proto_rawDesc = []byte{
	...
	0x91, 0x04, 0x0a, 0x13, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x4c, 0x61, 0x62, 0x65, 0x6c,
	...
	0x72, 0x64, 0x73, 0x42, 0xff, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x39, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x18, 0x41, 0x64,
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var (
	file_services_ad_group_label_service_proto_rawDescOnce sync.Once
	file_services_ad_group_label_service_proto_rawDescData = file_services_ad_group_label_service_proto_rawDesc
)

func file_services_ad_group_label_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_label_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_ad_group_label_service_proto_rawDescData)
	})
	return file_services_ad_group_label_service_proto_rawDescData
}

var file_services_ad_group_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_ad_group_label_service_proto_goTypes = []interface{}{
	(*GetAdGroupLabelRequest)(nil),      // 0: google.ads.googleads.v9.services.GetAdGroupLabelRequest
	(*MutateAdGroupLabelsRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateAdGroupLabelsRequest
	(*AdGroupLabelOperation)(nil),       // 2: google.ads.googleads.v9.services.AdGroupLabelOperation
	(*MutateAdGroupLabelsResponse)(nil), // 3: google.ads.googleads.v9.services.MutateAdGroupLabelsResponse
	(*MutateAdGroupLabelResult)(nil),    // 4: google.ads.googleads.v9.services.MutateAdGroupLabelResult
	(*resources.AdGroupLabel)(nil),      // 5: google.ads.googleads.v9.resources.AdGroupLabel
	(*status.Status)(nil),               // 6: google.rpc.Status
}
var file_services_ad_group_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateAdGroupLabelsRequest.operations:type_name -> google.ads.googleads.v9.services.AdGroupLabelOperation
	5, // 1: google.ads.googleads.v9.services.AdGroupLabelOperation.create:type_name -> google.ads.googleads.v9.resources.AdGroupLabel
	6, // 2: google.ads.googleads.v9.services.MutateAdGroupLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v9.services.MutateAdGroupLabelsResponse.results:type_name -> google.ads.googleads.v9.services.MutateAdGroupLabelResult
	0, // 4: google.ads.googleads.v9.services.AdGroupLabelService.GetAdGroupLabel:input_type -> google.ads.googleads.v9.services.GetAdGroupLabelRequest
	1, // 5: google.ads.googleads.v9.services.AdGroupLabelService.MutateAdGroupLabels:input_type -> google.ads.googleads.v9.services.MutateAdGroupLabelsRequest
	5, // 6: google.ads.googleads.v9.services.AdGroupLabelService.GetAdGroupLabel:output_type -> google.ads.googleads.v9.resources.AdGroupLabel
	3, // 7: google.ads.googleads.v9.services.AdGroupLabelService.MutateAdGroupLabels:output_type -> google.ads.googleads.v9.services.MutateAdGroupLabelsResponse
...
func init() { file_services_ad_group_label_service_proto_init() }
func file_services_ad_group_label_service_proto_init() {
	if File_services_ad_group_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_ad_group_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_services_ad_group_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_ad_group_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_ad_group_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_ad_group_label_service_proto_goTypes,
		DependencyIndexes: file_services_ad_group_label_service_proto_depIdxs,
		MessageInfos:      file_services_ad_group_label_service_proto_msgTypes,
	}.Build()
	File_services_ad_group_label_service_proto = out.File
	file_services_ad_group_label_service_proto_rawDesc = nil
	file_services_ad_group_label_service_proto_goTypes = nil
	file_services_ad_group_label_service_proto_depIdxs = nil
}
