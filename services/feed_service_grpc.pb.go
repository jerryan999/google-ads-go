...
const (
	FeedService_MutateFeeds_FullMethodName = "/google.ads.googleads.v17.services.FeedService/MutateFeeds"
)
...
func (c *feedServiceClient) MutateFeeds(ctx context.Context, in *MutateFeedsRequest, opts ...grpc.CallOption) (*MutateFeedsResponse, error) {
	...
	err := c.cc.Invoke(ctx, FeedService_MutateFeeds_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var FeedService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.FeedService",
	...
	Metadata: "google/ads/googleads/v17/services/feed_service.proto",
}
