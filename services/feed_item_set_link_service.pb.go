...
var file_services_feed_item_set_link_service_proto_rawDesc = []byte{
	...
	0x37, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1b, 0x46, 0x65, 0x65, 0x64,
...
var file_services_feed_item_set_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_feed_item_set_link_service_proto_goTypes = []any{
	(*MutateFeedItemSetLinksRequest)(nil),  // 0: google.ads.googleads.v17.services.MutateFeedItemSetLinksRequest
	(*FeedItemSetLinkOperation)(nil),       // 1: google.ads.googleads.v17.services.FeedItemSetLinkOperation
	(*MutateFeedItemSetLinksResponse)(nil), // 2: google.ads.googleads.v17.services.MutateFeedItemSetLinksResponse
	(*MutateFeedItemSetLinkResult)(nil),    // 3: google.ads.googleads.v17.services.MutateFeedItemSetLinkResult
	(*resources.FeedItemSetLink)(nil),      // 4: google.ads.googleads.v17.resources.FeedItemSetLink
	(*status.Status)(nil),                  // 5: google.rpc.Status
}
var file_services_feed_item_set_link_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateFeedItemSetLinksRequest.operations:type_name -> google.ads.googleads.v17.services.FeedItemSetLinkOperation
	4, // 1: google.ads.googleads.v17.services.FeedItemSetLinkOperation.create:type_name -> google.ads.googleads.v17.resources.FeedItemSetLink
	3, // 2: google.ads.googleads.v17.services.MutateFeedItemSetLinksResponse.results:type_name -> google.ads.googleads.v17.services.MutateFeedItemSetLinkResult
	5, // 3: google.ads.googleads.v17.services.MutateFeedItemSetLinksResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 4: google.ads.googleads.v17.services.FeedItemSetLinkService.MutateFeedItemSetLinks:input_type -> google.ads.googleads.v17.services.MutateFeedItemSetLinksRequest
	2, // 5: google.ads.googleads.v17.services.FeedItemSetLinkService.MutateFeedItemSetLinks:output_type -> google.ads.googleads.v17.services.MutateFeedItemSetLinksResponse
...
func file_services_feed_item_set_link_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_feed_item_set_link_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_feed_item_set_link_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_feed_item_set_link_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_feed_item_set_link_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_feed_item_set_link_service_proto_msgTypes[1].OneofWrappers = []any{
