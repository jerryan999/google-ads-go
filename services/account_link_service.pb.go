...
func (x *CreateAccountLinkRequest) Reset() {
	*x = CreateAccountLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[0]
...
func (*CreateAccountLinkRequest) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateAccountLinkResponse) Reset() {
	*x = CreateAccountLinkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CreateAccountLinkResponse) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAccountLinkRequest) Reset() {
	*x = MutateAccountLinkRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAccountLinkRequest) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *AccountLinkOperation) Reset() {
	*x = AccountLinkOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AccountLinkOperation) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAccountLinkResponse) Reset() {
	*x = MutateAccountLinkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAccountLinkResponse) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *MutateAccountLinkResult) Reset() {
	*x = MutateAccountLinkResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAccountLinkResult) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{5}
}
...
var file_services_account_link_service_proto_rawDesc = []byte{
	...
	0x01, 0x2a, 0x22, 0x32, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
	...
	0x6e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x37, 0x3a, 0x01, 0x2a, 0x22, 0x32, 0x2f, 0x76, 0x31, 0x37,
...
var (
	file_services_account_link_service_proto_rawDescOnce sync.Once
	file_services_account_link_service_proto_rawDescData = file_services_account_link_service_proto_rawDesc
)

func file_services_account_link_service_proto_rawDescGZIP() []byte {
	file_services_account_link_service_proto_rawDescOnce.Do(func() {
		file_services_account_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_account_link_service_proto_rawDescData)
	})
	return file_services_account_link_service_proto_rawDescData
}

var file_services_account_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_services_account_link_service_proto_goTypes = []any{
	(*CreateAccountLinkRequest)(nil),  // 0: google.ads.googleads.v17.services.CreateAccountLinkRequest
	(*CreateAccountLinkResponse)(nil), // 1: google.ads.googleads.v17.services.CreateAccountLinkResponse
	(*MutateAccountLinkRequest)(nil),  // 2: google.ads.googleads.v17.services.MutateAccountLinkRequest
	(*AccountLinkOperation)(nil),      // 3: google.ads.googleads.v17.services.AccountLinkOperation
	(*MutateAccountLinkResponse)(nil), // 4: google.ads.googleads.v17.services.MutateAccountLinkResponse
	(*MutateAccountLinkResult)(nil),   // 5: google.ads.googleads.v17.services.MutateAccountLinkResult
	(*resources.AccountLink)(nil),     // 6: google.ads.googleads.v17.resources.AccountLink
	(*fieldmaskpb.FieldMask)(nil),     // 7: google.protobuf.FieldMask
	(*status.Status)(nil),             // 8: google.rpc.Status
}
var file_services_account_link_service_proto_depIdxs = []int32{
	6, // 0: google.ads.googleads.v17.services.CreateAccountLinkRequest.account_link:type_name -> google.ads.googleads.v17.resources.AccountLink
	3, // 1: google.ads.googleads.v17.services.MutateAccountLinkRequest.operation:type_name -> google.ads.googleads.v17.services.AccountLinkOperation
	7, // 2: google.ads.googleads.v17.services.AccountLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v17.services.AccountLinkOperation.update:type_name -> google.ads.googleads.v17.resources.AccountLink
	5, // 4: google.ads.googleads.v17.services.MutateAccountLinkResponse.result:type_name -> google.ads.googleads.v17.services.MutateAccountLinkResult
	8, // 5: google.ads.googleads.v17.services.MutateAccountLinkResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v17.services.AccountLinkService.CreateAccountLink:input_type -> google.ads.googleads.v17.services.CreateAccountLinkRequest
	2, // 7: google.ads.googleads.v17.services.AccountLinkService.MutateAccountLink:input_type -> google.ads.googleads.v17.services.MutateAccountLinkRequest
	1, // 8: google.ads.googleads.v17.services.AccountLinkService.CreateAccountLink:output_type -> google.ads.googleads.v17.services.CreateAccountLinkResponse
	4, // 9: google.ads.googleads.v17.services.AccountLinkService.MutateAccountLink:output_type -> google.ads.googleads.v17.services.MutateAccountLinkResponse
...
func init() { file_services_account_link_service_proto_init() }
func file_services_account_link_service_proto_init() {
	if File_services_account_link_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_account_link_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_account_link_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_account_link_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_account_link_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_services_account_link_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_services_account_link_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_services_account_link_service_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_account_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_account_link_service_proto_goTypes,
		DependencyIndexes: file_services_account_link_service_proto_depIdxs,
		MessageInfos:      file_services_account_link_service_proto_msgTypes,
	}.Build()
	File_services_account_link_service_proto = out.File
	file_services_account_link_service_proto_rawDesc = nil
	file_services_account_link_service_proto_goTypes = nil
	file_services_account_link_service_proto_depIdxs = nil
}
