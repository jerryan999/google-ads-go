...
func (x *MutateAccountLinkResult) Reset() {
	*x = MutateAccountLinkResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_account_link_service_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAccountLinkResult) Descriptor() ([]byte, []int) {
	return file_services_account_link_service_proto_rawDescGZIP(), []int{6}
}
...
var file_services_account_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
func file_services_account_link_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_account_link_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_account_link_service_proto_msgTypes[4].OneofWrappers = []interface{}{
