...
func file_services_smart_campaign_suggest_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_smart_campaign_suggest_service_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_smart_campaign_suggest_service_proto_msgTypes[11].OneofWrappers = []interface{}{
