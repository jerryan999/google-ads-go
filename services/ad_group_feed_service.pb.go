...
func (x *MutateAdGroupFeedsRequest) Reset() {
	*x = MutateAdGroupFeedsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_feed_service_proto_msgTypes[0]
...
func (*MutateAdGroupFeedsRequest) Descriptor() ([]byte, []int) {
	return file_services_ad_group_feed_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupFeedOperation) Reset() {
	*x = AdGroupFeedOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_feed_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdGroupFeedOperation) Descriptor() ([]byte, []int) {
	return file_services_ad_group_feed_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupFeedsResponse) Reset() {
	*x = MutateAdGroupFeedsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_feed_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupFeedsResponse) Descriptor() ([]byte, []int) {
	return file_services_ad_group_feed_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupFeedResult) Reset() {
	*x = MutateAdGroupFeedResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_ad_group_feed_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAdGroupFeedResult) Descriptor() ([]byte, []int) {
	return file_services_ad_group_feed_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_ad_group_feed_service_proto_rawDesc = []byte{
	...
	0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x64, 0x47, 0x72,
	...
	0x22, 0x32, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_services_ad_group_feed_service_proto_rawDescOnce sync.Once
	file_services_ad_group_feed_service_proto_rawDescData = file_services_ad_group_feed_service_proto_rawDesc
)

func file_services_ad_group_feed_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_feed_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_feed_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_ad_group_feed_service_proto_rawDescData)
	})
	return file_services_ad_group_feed_service_proto_rawDescData
}

var file_services_ad_group_feed_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_ad_group_feed_service_proto_goTypes = []any{
	(*MutateAdGroupFeedsRequest)(nil),                      // 0: google.ads.googleads.v17.services.MutateAdGroupFeedsRequest
	(*AdGroupFeedOperation)(nil),                           // 1: google.ads.googleads.v17.services.AdGroupFeedOperation
	(*MutateAdGroupFeedsResponse)(nil),                     // 2: google.ads.googleads.v17.services.MutateAdGroupFeedsResponse
	(*MutateAdGroupFeedResult)(nil),                        // 3: google.ads.googleads.v17.services.MutateAdGroupFeedResult
	...
	(*resources.AdGroupFeed)(nil),                          // 6: google.ads.googleads.v17.resources.AdGroupFeed
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_services_ad_group_feed_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateAdGroupFeedsRequest.operations:type_name -> google.ads.googleads.v17.services.AdGroupFeedOperation
	4, // 1: google.ads.googleads.v17.services.MutateAdGroupFeedsRequest.response_content_type:type_name -> google.ads.googleads.v17.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v17.services.AdGroupFeedOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v17.services.AdGroupFeedOperation.create:type_name -> google.ads.googleads.v17.resources.AdGroupFeed
	6, // 4: google.ads.googleads.v17.services.AdGroupFeedOperation.update:type_name -> google.ads.googleads.v17.resources.AdGroupFeed
	7, // 5: google.ads.googleads.v17.services.MutateAdGroupFeedsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v17.services.MutateAdGroupFeedsResponse.results:type_name -> google.ads.googleads.v17.services.MutateAdGroupFeedResult
	6, // 7: google.ads.googleads.v17.services.MutateAdGroupFeedResult.ad_group_feed:type_name -> google.ads.googleads.v17.resources.AdGroupFeed
	0, // 8: google.ads.googleads.v17.services.AdGroupFeedService.MutateAdGroupFeeds:input_type -> google.ads.googleads.v17.services.MutateAdGroupFeedsRequest
	2, // 9: google.ads.googleads.v17.services.AdGroupFeedService.MutateAdGroupFeeds:output_type -> google.ads.googleads.v17.services.MutateAdGroupFeedsResponse
...
func init() { file_services_ad_group_feed_service_proto_init() }
func file_services_ad_group_feed_service_proto_init() {
	if File_services_ad_group_feed_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_ad_group_feed_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_feed_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_feed_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_ad_group_feed_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_ad_group_feed_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_ad_group_feed_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_ad_group_feed_service_proto_goTypes,
		DependencyIndexes: file_services_ad_group_feed_service_proto_depIdxs,
		MessageInfos:      file_services_ad_group_feed_service_proto_msgTypes,
	}.Build()
	File_services_ad_group_feed_service_proto = out.File
	file_services_ad_group_feed_service_proto_rawDesc = nil
	file_services_ad_group_feed_service_proto_goTypes = nil
	file_services_ad_group_feed_service_proto_depIdxs = nil
}
