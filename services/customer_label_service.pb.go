...
func (x *MutateCustomerLabelResult) Reset() {
	*x = MutateCustomerLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerLabelResult) Descriptor() ([]byte, []int) {
	return file_services_customer_label_service_proto_rawDescGZIP(), []int{4}
}
...
var file_services_customer_label_service_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x32, 0x9a, 0x04, 0x0a, 0x14, 0x43, 0x75, 0x73,
	...
	0x62, 0x65, 0x6c, 0x22, 0x48, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x32, 0x12, 0x30, 0x2f, 0x76, 0x39,
	...
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x53, 0x65, 0x72,
...
var file_services_customer_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_services_customer_label_service_proto_goTypes = []interface{}{
	(*GetCustomerLabelRequest)(nil),      // 0: google.ads.googleads.v9.services.GetCustomerLabelRequest
	(*MutateCustomerLabelsRequest)(nil),  // 1: google.ads.googleads.v9.services.MutateCustomerLabelsRequest
	(*CustomerLabelOperation)(nil),       // 2: google.ads.googleads.v9.services.CustomerLabelOperation
	(*MutateCustomerLabelsResponse)(nil), // 3: google.ads.googleads.v9.services.MutateCustomerLabelsResponse
	(*MutateCustomerLabelResult)(nil),    // 4: google.ads.googleads.v9.services.MutateCustomerLabelResult
	(*resources.CustomerLabel)(nil),      // 5: google.ads.googleads.v9.resources.CustomerLabel
	(*status.Status)(nil),                // 6: google.rpc.Status
}
var file_services_customer_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.services.MutateCustomerLabelsRequest.operations:type_name -> google.ads.googleads.v9.services.CustomerLabelOperation
	5, // 1: google.ads.googleads.v9.services.CustomerLabelOperation.create:type_name -> google.ads.googleads.v9.resources.CustomerLabel
	6, // 2: google.ads.googleads.v9.services.MutateCustomerLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v9.services.MutateCustomerLabelsResponse.results:type_name -> google.ads.googleads.v9.services.MutateCustomerLabelResult
	0, // 4: google.ads.googleads.v9.services.CustomerLabelService.GetCustomerLabel:input_type -> google.ads.googleads.v9.services.GetCustomerLabelRequest
	1, // 5: google.ads.googleads.v9.services.CustomerLabelService.MutateCustomerLabels:input_type -> google.ads.googleads.v9.services.MutateCustomerLabelsRequest
	5, // 6: google.ads.googleads.v9.services.CustomerLabelService.GetCustomerLabel:output_type -> google.ads.googleads.v9.resources.CustomerLabel
	3, // 7: google.ads.googleads.v9.services.CustomerLabelService.MutateCustomerLabels:output_type -> google.ads.googleads.v9.services.MutateCustomerLabelsResponse
...
func file_services_customer_label_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_services_customer_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_services_customer_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
