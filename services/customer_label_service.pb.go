...
func (x *MutateCustomerLabelsRequest) Reset() {
	*x = MutateCustomerLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_label_service_proto_msgTypes[0]
...
func (*MutateCustomerLabelsRequest) Descriptor() ([]byte, []int) {
	return file_services_customer_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerLabelOperation) Reset() {
	*x = CustomerLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerLabelOperation) Descriptor() ([]byte, []int) {
	return file_services_customer_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerLabelsResponse) Reset() {
	*x = MutateCustomerLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerLabelsResponse) Descriptor() ([]byte, []int) {
	return file_services_customer_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerLabelResult) Reset() {
	*x = MutateCustomerLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_services_customer_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerLabelResult) Descriptor() ([]byte, []int) {
	return file_services_customer_label_service_proto_rawDescGZIP(), []int{3}
}
...
var file_services_customer_label_service_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x61, 0x62, 0x65, 0x6c,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c,
	...
	0x16, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x4f, 0x70,
	...
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x48, 0x00, 0x52, 0x06, 0x63, 0x72,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x61, 0x62, 0x65,
	...
	,
	...
	0x34, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f,
	0x7b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x3d, 0x2a, 0x7d, 0x2f,
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x3a, 0x6d,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x19, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_services_customer_label_service_proto_rawDescOnce sync.Once
	file_services_customer_label_service_proto_rawDescData = file_services_customer_label_service_proto_rawDesc
)

func file_services_customer_label_service_proto_rawDescGZIP() []byte {
	file_services_customer_label_service_proto_rawDescOnce.Do(func() {
		file_services_customer_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_customer_label_service_proto_rawDescData)
	})
	return file_services_customer_label_service_proto_rawDescData
}

var file_services_customer_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_services_customer_label_service_proto_goTypes = []any{
	(*MutateCustomerLabelsRequest)(nil),  // 0: google.ads.googleads.v17.services.MutateCustomerLabelsRequest
	(*CustomerLabelOperation)(nil),       // 1: google.ads.googleads.v17.services.CustomerLabelOperation
	(*MutateCustomerLabelsResponse)(nil), // 2: google.ads.googleads.v17.services.MutateCustomerLabelsResponse
	(*MutateCustomerLabelResult)(nil),    // 3: google.ads.googleads.v17.services.MutateCustomerLabelResult
	(*resources.CustomerLabel)(nil),      // 4: google.ads.googleads.v17.resources.CustomerLabel
	(*status.Status)(nil),                // 5: google.rpc.Status
}
var file_services_customer_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.services.MutateCustomerLabelsRequest.operations:type_name -> google.ads.googleads.v17.services.CustomerLabelOperation
	4, // 1: google.ads.googleads.v17.services.CustomerLabelOperation.create:type_name -> google.ads.googleads.v17.resources.CustomerLabel
	5, // 2: google.ads.googleads.v17.services.MutateCustomerLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v17.services.MutateCustomerLabelsResponse.results:type_name -> google.ads.googleads.v17.services.MutateCustomerLabelResult
	0, // 4: google.ads.googleads.v17.services.CustomerLabelService.MutateCustomerLabels:input_type -> google.ads.googleads.v17.services.MutateCustomerLabelsRequest
	2, // 5: google.ads.googleads.v17.services.CustomerLabelService.MutateCustomerLabels:output_type -> google.ads.googleads.v17.services.MutateCustomerLabelsResponse
...
func init() { file_services_customer_label_service_proto_init() }
func file_services_customer_label_service_proto_init() {
	if File_services_customer_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_services_customer_label_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_services_customer_label_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_services_customer_label_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_services_customer_label_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_services_customer_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_customer_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_services_customer_label_service_proto_goTypes,
		DependencyIndexes: file_services_customer_label_service_proto_depIdxs,
		MessageInfos:      file_services_customer_label_service_proto_msgTypes,
	}.Build()
	File_services_customer_label_service_proto = out.File
	file_services_customer_label_service_proto_rawDesc = nil
	file_services_customer_label_service_proto_goTypes = nil
	file_services_customer_label_service_proto_depIdxs = nil
}
