...
const (
	PaymentsAccountService_ListPaymentsAccounts_FullMethodName = "/google.ads.googleads.v17.services.PaymentsAccountService/ListPaymentsAccounts"
)
...
func (c *paymentsAccountServiceClient) ListPaymentsAccounts(ctx context.Context, in *ListPaymentsAccountsRequest, opts ...grpc.CallOption) (*ListPaymentsAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, PaymentsAccountService_ListPaymentsAccounts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var PaymentsAccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v17.services.PaymentsAccountService",
	...
	Metadata: "google/ads/googleads/v17/services/payments_account_service.proto",
}
