...
var file_resources_customer_client_link_proto_goTypes = []interface{}{
	(*CustomerClientLink)(nil),                         // 0: google.ads.googleads.v9.resources.CustomerClientLink
...
var file_resources_customer_client_link_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.resources.CustomerClientLink.status:type_name -> google.ads.googleads.v9.enums.ManagerLinkStatusEnum.ManagerLinkStatus
