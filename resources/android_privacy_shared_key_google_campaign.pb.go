...
var file_resources_android_privacy_shared_key_google_campaign_proto_goTypes = []any{
	(*AndroidPrivacySharedKeyGoogleCampaign)(nil),                              // 0: google.ads.googleads.v17.resources.AndroidPrivacySharedKeyGoogleCampaign
...
var file_resources_android_privacy_shared_key_google_campaign_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AndroidPrivacySharedKeyGoogleCampaign.android_privacy_interaction_type:type_name -> google.ads.googleads.v17.enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType
...
func file_resources_android_privacy_shared_key_google_campaign_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_android_privacy_shared_key_google_campaign_proto_msgTypes[0].Exporter = func(v any, i int) any {
