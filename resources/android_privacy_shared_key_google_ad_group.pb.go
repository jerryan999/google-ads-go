...
func (x *AndroidPrivacySharedKeyGoogleAdGroup) Reset() {
	*x = AndroidPrivacySharedKeyGoogleAdGroup{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes[0]
...
func (*AndroidPrivacySharedKeyGoogleAdGroup) Descriptor() ([]byte, []int) {
	return file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_android_privacy_shared_key_google_ad_group_proto protoreflect.FileDescriptor

var file_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x6e, 0x64, 0x72, 0x6f, 0x69,
	...
	0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x31, 0x37, 0x2e, 0x52,
	...
	0x56, 0x31, 0x37, 0x5c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0xea, 0x02, 0x26,
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x37, 0x3a, 0x3a, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescOnce sync.Once
	file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData = file_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc
)

func file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescGZIP() []byte {
	file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescOnce.Do(func() {
		file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData)
	})
	return file_resources_android_privacy_shared_key_google_ad_group_proto_rawDescData
}

var file_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_android_privacy_shared_key_google_ad_group_proto_goTypes = []any{
	(*AndroidPrivacySharedKeyGoogleAdGroup)(nil),                               // 0: google.ads.googleads.v17.resources.AndroidPrivacySharedKeyGoogleAdGroup
	(enums.AndroidPrivacyInteractionTypeEnum_AndroidPrivacyInteractionType)(0), // 1: google.ads.googleads.v17.enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType
	(enums.AndroidPrivacyNetworkTypeEnum_AndroidPrivacyNetworkType)(0),         // 2: google.ads.googleads.v17.enums.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType
}
var file_resources_android_privacy_shared_key_google_ad_group_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AndroidPrivacySharedKeyGoogleAdGroup.android_privacy_interaction_type:type_name -> google.ads.googleads.v17.enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType
	2, // 1: google.ads.googleads.v17.resources.AndroidPrivacySharedKeyGoogleAdGroup.android_privacy_network_type:type_name -> google.ads.googleads.v17.enums.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType
...
func init() {
	file_resources_android_privacy_shared_key_google_ad_group_proto_init()
}
func file_resources_android_privacy_shared_key_google_ad_group_proto_init() {
	if File_resources_android_privacy_shared_key_google_ad_group_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*AndroidPrivacySharedKeyGoogleAdGroup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_android_privacy_shared_key_google_ad_group_proto_goTypes,
		DependencyIndexes: file_resources_android_privacy_shared_key_google_ad_group_proto_depIdxs,
		MessageInfos:      file_resources_android_privacy_shared_key_google_ad_group_proto_msgTypes,
	}.Build()
	File_resources_android_privacy_shared_key_google_ad_group_proto = out.File
	file_resources_android_privacy_shared_key_google_ad_group_proto_rawDesc = nil
	file_resources_android_privacy_shared_key_google_ad_group_proto_goTypes = nil
	file_resources_android_privacy_shared_key_google_ad_group_proto_depIdxs = nil
}
