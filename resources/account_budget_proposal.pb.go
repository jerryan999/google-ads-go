...
type AccountBudgetProposal struct {
	...
	// proposal.
	ProposalType enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType `protobuf:"varint,4,opt,name=proposal_type,json=proposalType,proto3,enum=google.ads.googleads.v9.enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType" json:"proposal_type,omitempty"`
	// Output only. The status of this proposal.
	// When a new proposal is created, the status defaults to PENDING.
	Status enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus `protobuf:"varint,15,opt,name=status,proto3,enum=google.ads.googleads.v9.enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus" json:"status,omitempty"`
...
type AccountBudgetProposal_ProposedStartTimeType struct {
	...
	ProposedStartTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,7,opt,name=proposed_start_time_type,json=proposedStartTimeType,proto3,enum=google.ads.googleads.v9.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudgetProposal_ApprovedEndTimeType struct {
	...
	ApprovedEndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,22,opt,name=approved_end_time_type,json=approvedEndTimeType,proto3,enum=google.ads.googleads.v9.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudgetProposal_ProposedSpendingLimitType struct {
	...
	ProposedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,11,opt,name=proposed_spending_limit_type,json=proposedSpendingLimitType,proto3,enum=google.ads.googleads.v9.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudgetProposal_ApprovedSpendingLimitType struct {
	...
	ApprovedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,24,opt,name=approved_spending_limit_type,json=approvedSpendingLimitType,proto3,enum=google.ads.googleads.v9.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
var file_resources_account_budget_proposal_proto_rawDesc = []byte{
	...
	0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f,
	...
	0x2f, 0x76, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x73, 0x70, 0x65, 0x6e, 0x64, 0x69,
	...
	0x73, 0x2e, 0x76, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75,
...
var file_resources_account_budget_proposal_proto_goTypes = []interface{}{
	(*AccountBudgetProposal)(nil),                                          // 0: google.ads.googleads.v9.resources.AccountBudgetProposal
	(enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType)(0),     // 1: google.ads.googleads.v9.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	(enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus)(0), // 2: google.ads.googleads.v9.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
...
var file_resources_account_budget_proposal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.resources.AccountBudgetProposal.proposal_type:type_name -> google.ads.googleads.v9.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	2, // 1: google.ads.googleads.v9.resources.AccountBudgetProposal.status:type_name -> google.ads.googleads.v9.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
	3, // 2: google.ads.googleads.v9.resources.AccountBudgetProposal.proposed_start_time_type:type_name -> google.ads.googleads.v9.enums.TimeTypeEnum.TimeType
	3, // 3: google.ads.googleads.v9.resources.AccountBudgetProposal.proposed_end_time_type:type_name -> google.ads.googleads.v9.enums.TimeTypeEnum.TimeType
	3, // 4: google.ads.googleads.v9.resources.AccountBudgetProposal.approved_end_time_type:type_name -> google.ads.googleads.v9.enums.TimeTypeEnum.TimeType
	4, // 5: google.ads.googleads.v9.resources.AccountBudgetProposal.proposed_spending_limit_type:type_name -> google.ads.googleads.v9.enums.SpendingLimitTypeEnum.SpendingLimitType
	4, // 6: google.ads.googleads.v9.resources.AccountBudgetProposal.approved_spending_limit_type:type_name -> google.ads.googleads.v9.enums.SpendingLimitTypeEnum.SpendingLimitType
