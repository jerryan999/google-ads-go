...
var file_resources_local_services_verification_artifact_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_resources_local_services_verification_artifact_proto_goTypes = []interface{}{
...
func file_resources_local_services_verification_artifact_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_local_services_verification_artifact_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_local_services_verification_artifact_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_local_services_verification_artifact_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_local_services_verification_artifact_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_local_services_verification_artifact_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_resources_local_services_verification_artifact_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_resources_local_services_verification_artifact_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_resources_local_services_verification_artifact_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
