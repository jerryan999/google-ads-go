...
var file_resources_dynamic_search_ads_search_term_view_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x23,
...
var (
	...
	file_resources_dynamic_search_ads_search_term_view_proto_rawDescData = file_resources_dynamic_search_ads_search_term_view_proto_rawDesc
)
...
func file_resources_dynamic_search_ads_search_term_view_proto_rawDescGZIP() []byte {
	file_resources_dynamic_search_ads_search_term_view_proto_rawDescOnce.Do(func() {
		file_resources_dynamic_search_ads_search_term_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_dynamic_search_ads_search_term_view_proto_rawDescData)
	})
...
var file_resources_dynamic_search_ads_search_term_view_proto_goTypes = []interface{}{
	(*DynamicSearchAdsSearchTermView)(nil), // 0: google.ads.googleads.v15.resources.DynamicSearchAdsSearchTermView
}
...
func file_resources_dynamic_search_ads_search_term_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_dynamic_search_ads_search_term_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_dynamic_search_ads_search_term_view_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_resources_dynamic_search_ads_search_term_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_resources_dynamic_search_ads_search_term_view_proto_rawDesc = nil
