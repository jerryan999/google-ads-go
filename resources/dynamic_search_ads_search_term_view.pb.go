...
var file_resources_dynamic_search_ads_search_term_view_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x23,
...
var file_resources_dynamic_search_ads_search_term_view_proto_goTypes = []any{
	(*DynamicSearchAdsSearchTermView)(nil), // 0: google.ads.googleads.v17.resources.DynamicSearchAdsSearchTermView
}
...
func file_resources_dynamic_search_ads_search_term_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_dynamic_search_ads_search_term_view_proto_msgTypes[0].Exporter = func(v any, i int) any {
