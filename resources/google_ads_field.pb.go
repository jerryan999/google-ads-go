...
type GoogleAdsField struct {
	...
	Category enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory `protobuf:"varint,3,opt,name=category,proto3,enum=google.ads.googleads.v9.enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory" json:"category,omitempty"`
	...
	// in WHERE clauses.
	DataType enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType `protobuf:"varint,12,opt,name=data_type,json=dataType,proto3,enum=google.ads.googleads.v9.enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType" json:"data_type,omitempty"`
...
func (x *GoogleAdsField) Reset() {
	*x = GoogleAdsField{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_google_ads_field_proto_msgTypes[0]
...
func (*GoogleAdsField) Descriptor() ([]byte, []int) {
	return file_resources_google_ads_field_proto_rawDescGZIP(), []int{0}
}
...
var file_resources_google_ads_field_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x39, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x3d, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x67, 0x6f, 0x6f,
	...
	0x64, 0x73, 0x2f, 0x76, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64,
...
var (
	file_resources_google_ads_field_proto_rawDescOnce sync.Once
	file_resources_google_ads_field_proto_rawDescData = file_resources_google_ads_field_proto_rawDesc
)

func file_resources_google_ads_field_proto_rawDescGZIP() []byte {
	file_resources_google_ads_field_proto_rawDescOnce.Do(func() {
		file_resources_google_ads_field_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_google_ads_field_proto_rawDescData)
	})
	return file_resources_google_ads_field_proto_rawDescData
}

var file_resources_google_ads_field_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_google_ads_field_proto_goTypes = []interface{}{
	(*GoogleAdsField)(nil), // 0: google.ads.googleads.v9.resources.GoogleAdsField
	(enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory)(0), // 1: google.ads.googleads.v9.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	(enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType)(0), // 2: google.ads.googleads.v9.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
}
var file_resources_google_ads_field_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.resources.GoogleAdsField.category:type_name -> google.ads.googleads.v9.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	2, // 1: google.ads.googleads.v9.resources.GoogleAdsField.data_type:type_name -> google.ads.googleads.v9.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
...
func init() { file_resources_google_ads_field_proto_init() }
func file_resources_google_ads_field_proto_init() {
	if File_resources_google_ads_field_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_google_ads_field_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_google_ads_field_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_resources_google_ads_field_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_google_ads_field_proto_goTypes,
		DependencyIndexes: file_resources_google_ads_field_proto_depIdxs,
		MessageInfos:      file_resources_google_ads_field_proto_msgTypes,
	}.Build()
	File_resources_google_ads_field_proto = out.File
	file_resources_google_ads_field_proto_rawDesc = nil
	file_resources_google_ads_field_proto_goTypes = nil
	file_resources_google_ads_field_proto_depIdxs = nil
}
