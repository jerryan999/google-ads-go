...
type GoogleAdsField struct {
	...
	Category enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory `protobuf:"varint,3,opt,name=category,proto3,enum=google.ads.googleads.v17.enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory" json:"category,omitempty"`
	...
	DataType enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType `protobuf:"varint,12,opt,name=data_type,json=dataType,proto3,enum=google.ads.googleads.v17.enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType" json:"data_type,omitempty"`
...
var file_resources_google_ads_field_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var file_resources_google_ads_field_proto_goTypes = []any{
	(*GoogleAdsField)(nil), // 0: google.ads.googleads.v17.resources.GoogleAdsField
	(enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory)(0), // 1: google.ads.googleads.v17.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	(enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType)(0), // 2: google.ads.googleads.v17.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
}
var file_resources_google_ads_field_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.GoogleAdsField.category:type_name -> google.ads.googleads.v17.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	2, // 1: google.ads.googleads.v17.resources.GoogleAdsField.data_type:type_name -> google.ads.googleads.v17.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
...
func file_resources_google_ads_field_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_google_ads_field_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_google_ads_field_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
