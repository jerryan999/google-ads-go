...
var file_resources_topic_constant_proto_goTypes = []any{
	(*TopicConstant)(nil), // 0: google.ads.googleads.v17.resources.TopicConstant
}
...
func file_resources_topic_constant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_topic_constant_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_topic_constant_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
