...
type AssetSetAsset struct {
	...
	Status enums.AssetSetAssetStatusEnum_AssetSetAssetStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.AssetSetAssetStatusEnum_AssetSetAssetStatus" json:"status,omitempty"`
}
...
var file_resources_asset_set_asset_proto_goTypes = []any{
	(*AssetSetAsset)(nil), // 0: google.ads.googleads.v17.resources.AssetSetAsset
	(enums.AssetSetAssetStatusEnum_AssetSetAssetStatus)(0), // 1: google.ads.googleads.v17.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus
}
var file_resources_asset_set_asset_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AssetSetAsset.status:type_name -> google.ads.googleads.v17.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus
...
func file_resources_asset_set_asset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_set_asset_proto_msgTypes[0].Exporter = func(v any, i int) any {
