...
type MobileDeviceConstant struct {
	...
	Type enums.MobileDeviceTypeEnum_MobileDeviceType `protobuf:"varint,6,opt,name=type,proto3,enum=google.ads.googleads.v17.enums.MobileDeviceTypeEnum_MobileDeviceType" json:"type,omitempty"`
}
...
var file_resources_mobile_device_constant_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x6f, 0x62, 0x69,
...
var file_resources_mobile_device_constant_proto_goTypes = []any{
	(*MobileDeviceConstant)(nil),                     // 0: google.ads.googleads.v17.resources.MobileDeviceConstant
	(enums.MobileDeviceTypeEnum_MobileDeviceType)(0), // 1: google.ads.googleads.v17.enums.MobileDeviceTypeEnum.MobileDeviceType
}
var file_resources_mobile_device_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.MobileDeviceConstant.type:type_name -> google.ads.googleads.v17.enums.MobileDeviceTypeEnum.MobileDeviceType
...
func file_resources_mobile_device_constant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_mobile_device_constant_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_mobile_device_constant_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
