...
func (x *Ad) GetDemandGenProductAd() *common.DemandGenProductAdInfo {
	if x, ok := x.GetAdData().(*Ad_DemandGenProductAd); ok {
...
var file_resources_ad_proto_goTypes = []any{
...
func file_resources_ad_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_ad_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Ad); i {
			case 0:
				return &v.state
			case 1:
	...
	file_resources_ad_proto_msgTypes[0].OneofWrappers = []any{
		(*Ad_TextAd)(nil),
