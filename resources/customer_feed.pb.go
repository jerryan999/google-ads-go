...
type CustomerFeed struct {
	...
	// customer. Required.
	PlaceholderTypes []enums.PlaceholderTypeEnum_PlaceholderType `protobuf:"varint,3,rep,packed,name=placeholder_types,json=placeholderTypes,proto3,enum=google.ads.googleads.v15.enums.PlaceholderTypeEnum_PlaceholderType" json:"placeholder_types,omitempty"`
	...
	Status enums.FeedLinkStatusEnum_FeedLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.FeedLinkStatusEnum_FeedLinkStatus" json:"status,omitempty"`
}
...
var file_resources_customer_feed_proto_rawDesc = []byte{
	...
	0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x4c, 0x69, 0x6e, 0x6b,
...
var file_resources_customer_feed_proto_goTypes = []interface{}{
	(*CustomerFeed)(nil),                           // 0: google.ads.googleads.v15.resources.CustomerFeed
...
var file_resources_customer_feed_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.CustomerFeed.placeholder_types:type_name -> google.ads.googleads.v15.enums.PlaceholderTypeEnum.PlaceholderType
	2, // 1: google.ads.googleads.v15.resources.CustomerFeed.matching_function:type_name -> google.ads.googleads.v15.common.MatchingFunction
	3, // 2: google.ads.googleads.v15.resources.CustomerFeed.status:type_name -> google.ads.googleads.v15.enums.FeedLinkStatusEnum.FeedLinkStatus
