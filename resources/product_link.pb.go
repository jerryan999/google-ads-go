...
type ProductLink struct {
	...
	Type enums.LinkedProductTypeEnum_LinkedProductType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v17.enums.LinkedProductTypeEnum_LinkedProductType" json:"type,omitempty"`
...
func (x *ProductLink) Reset() {
	*x = ProductLink{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_product_link_proto_msgTypes[0]
...
func (*ProductLink) Descriptor() ([]byte, []int) {
	return file_resources_product_link_proto_rawDescGZIP(), []int{0}
}
...
func (x *DataPartnerIdentifier) Reset() {
	*x = DataPartnerIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_product_link_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DataPartnerIdentifier) Descriptor() ([]byte, []int) {
	return file_resources_product_link_proto_rawDescGZIP(), []int{1}
}
...
func (x *GoogleAdsIdentifier) Reset() {
	*x = GoogleAdsIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_product_link_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GoogleAdsIdentifier) Descriptor() ([]byte, []int) {
	return file_resources_product_link_proto_rawDescGZIP(), []int{2}
}
...
func (x *MerchantCenterIdentifier) Reset() {
	*x = MerchantCenterIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_product_link_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MerchantCenterIdentifier) Descriptor() ([]byte, []int) {
	return file_resources_product_link_proto_rawDescGZIP(), []int{3}
}
...
func (x *AdvertisingPartnerIdentifier) Reset() {
	*x = AdvertisingPartnerIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_product_link_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdvertisingPartnerIdentifier) Descriptor() ([]byte, []int) {
	return file_resources_product_link_proto_rawDescGZIP(), []int{4}
}
...
var File_resources_product_link_proto protoreflect.FileDescriptor

var file_resources_product_link_proto_rawDesc = []byte{
	...
	0x73, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x69, 0x6e, 0x6b,
	...
	0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x64, 0x76,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x10, 0x50, 0x72, 0x6f,
...
var (
	file_resources_product_link_proto_rawDescOnce sync.Once
	file_resources_product_link_proto_rawDescData = file_resources_product_link_proto_rawDesc
)

func file_resources_product_link_proto_rawDescGZIP() []byte {
	file_resources_product_link_proto_rawDescOnce.Do(func() {
		file_resources_product_link_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_product_link_proto_rawDescData)
	})
	return file_resources_product_link_proto_rawDescData
}

var file_resources_product_link_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_resources_product_link_proto_goTypes = []any{
	(*ProductLink)(nil),                                // 0: google.ads.googleads.v17.resources.ProductLink
	(*DataPartnerIdentifier)(nil),                      // 1: google.ads.googleads.v17.resources.DataPartnerIdentifier
	(*GoogleAdsIdentifier)(nil),                        // 2: google.ads.googleads.v17.resources.GoogleAdsIdentifier
	(*MerchantCenterIdentifier)(nil),                   // 3: google.ads.googleads.v17.resources.MerchantCenterIdentifier
	(*AdvertisingPartnerIdentifier)(nil),               // 4: google.ads.googleads.v17.resources.AdvertisingPartnerIdentifier
	(enums.LinkedProductTypeEnum_LinkedProductType)(0), // 5: google.ads.googleads.v17.enums.LinkedProductTypeEnum.LinkedProductType
}
var file_resources_product_link_proto_depIdxs = []int32{
	5, // 0: google.ads.googleads.v17.resources.ProductLink.type:type_name -> google.ads.googleads.v17.enums.LinkedProductTypeEnum.LinkedProductType
	1, // 1: google.ads.googleads.v17.resources.ProductLink.data_partner:type_name -> google.ads.googleads.v17.resources.DataPartnerIdentifier
	2, // 2: google.ads.googleads.v17.resources.ProductLink.google_ads:type_name -> google.ads.googleads.v17.resources.GoogleAdsIdentifier
	3, // 3: google.ads.googleads.v17.resources.ProductLink.merchant_center:type_name -> google.ads.googleads.v17.resources.MerchantCenterIdentifier
	4, // 4: google.ads.googleads.v17.resources.ProductLink.advertising_partner:type_name -> google.ads.googleads.v17.resources.AdvertisingPartnerIdentifier
...
func init() { file_resources_product_link_proto_init() }
func file_resources_product_link_proto_init() {
	if File_resources_product_link_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_product_link_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_resources_product_link_proto_msgTypes[0].OneofWrappers = []any{
		(*ProductLink_DataPartner)(nil),
		(*ProductLink_GoogleAds)(nil),
		(*ProductLink_MerchantCenter)(nil),
		(*ProductLink_AdvertisingPartner)(nil),
	}
	file_resources_product_link_proto_msgTypes[1].OneofWrappers = []any{}
	file_resources_product_link_proto_msgTypes[2].OneofWrappers = []any{}
	file_resources_product_link_proto_msgTypes[3].OneofWrappers = []any{}
	file_resources_product_link_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_resources_product_link_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_product_link_proto_goTypes,
		DependencyIndexes: file_resources_product_link_proto_depIdxs,
		MessageInfos:      file_resources_product_link_proto_msgTypes,
	}.Build()
	File_resources_product_link_proto = out.File
	file_resources_product_link_proto_rawDesc = nil
	file_resources_product_link_proto_goTypes = nil
	file_resources_product_link_proto_depIdxs = nil
}
