...
var file_resources_product_link_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_resources_product_link_proto_goTypes = []interface{}{
...
func file_resources_product_link_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_product_link_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_product_link_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_product_link_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_product_link_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_product_link_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ProductLink_DataPartner)(nil),
		(*ProductLink_GoogleAds)(nil),
		(*ProductLink_MerchantCenter)(nil),
	}
	file_resources_product_link_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_resources_product_link_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_resources_product_link_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
