...
var file_resources_shopping_product_proto_rawDesc = []byte{
...
var (
	...
	file_resources_shopping_product_proto_rawDescData = file_resources_shopping_product_proto_rawDesc
)

func file_resources_shopping_product_proto_rawDescGZIP() []byte {
	file_resources_shopping_product_proto_rawDescOnce.Do(func() {
		file_resources_shopping_product_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_shopping_product_proto_rawDescData)
	})
...
func file_resources_shopping_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_shopping_product_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_shopping_product_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_shopping_product_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_resources_shopping_product_proto_rawDesc = nil
