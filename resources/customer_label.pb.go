...
var file_resources_customer_label_proto_goTypes = []any{
	(*CustomerLabel)(nil), // 0: google.ads.googleads.v17.resources.CustomerLabel
}
...
func file_resources_customer_label_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_customer_label_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_customer_label_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
