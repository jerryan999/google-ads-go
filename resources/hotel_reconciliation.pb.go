...
type HotelReconciliation struct {
	...
	Status enums.HotelReconciliationStatusEnum_HotelReconciliationStatus `protobuf:"varint,10,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.HotelReconciliationStatusEnum_HotelReconciliationStatus" json:"status,omitempty"`
}
...
var file_resources_hotel_reconciliation_proto_rawDesc = []byte{
	...
	0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x48, 0x6f, 0x74, 0x65, 0x6c, 0x52, 0x65, 0x63,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x18, 0x48, 0x6f, 0x74,
...
var file_resources_hotel_reconciliation_proto_goTypes = []any{
	(*HotelReconciliation)(nil),                                        // 0: google.ads.googleads.v17.resources.HotelReconciliation
	(enums.HotelReconciliationStatusEnum_HotelReconciliationStatus)(0), // 1: google.ads.googleads.v17.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus
}
var file_resources_hotel_reconciliation_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.HotelReconciliation.status:type_name -> google.ads.googleads.v17.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus
...
func file_resources_hotel_reconciliation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_hotel_reconciliation_proto_msgTypes[0].Exporter = func(v any, i int) any {
