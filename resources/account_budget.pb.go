...
var file_resources_account_budget_proto_goTypes = []any{
...
func file_resources_account_budget_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_account_budget_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_account_budget_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_resources_account_budget_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_resources_account_budget_proto_msgTypes[1].OneofWrappers = []any{
