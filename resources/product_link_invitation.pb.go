...
type ProductLinkInvitation struct {
	...
	// This field is read only.
	Status enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus" json:"status,omitempty"`
	...
	Type enums.LinkedProductTypeEnum_LinkedProductType `protobuf:"varint,6,opt,name=type,proto3,enum=google.ads.googleads.v17.enums.LinkedProductTypeEnum_LinkedProductType" json:"type,omitempty"`
...
var file_resources_product_link_invitation_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64,
...
var file_resources_product_link_invitation_proto_goTypes = []any{
	(*ProductLinkInvitation)(nil),                                          // 0: google.ads.googleads.v17.resources.ProductLinkInvitation
	(*HotelCenterLinkInvitationIdentifier)(nil),                            // 1: google.ads.googleads.v17.resources.HotelCenterLinkInvitationIdentifier
	...
	(enums.ProductLinkInvitationStatusEnum_ProductLinkInvitationStatus)(0), // 4: google.ads.googleads.v17.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus
...
var file_resources_product_link_invitation_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v17.resources.ProductLinkInvitation.status:type_name -> google.ads.googleads.v17.enums.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus
	5, // 1: google.ads.googleads.v17.resources.ProductLinkInvitation.type:type_name -> google.ads.googleads.v17.enums.LinkedProductTypeEnum.LinkedProductType
	1, // 2: google.ads.googleads.v17.resources.ProductLinkInvitation.hotel_center:type_name -> google.ads.googleads.v17.resources.HotelCenterLinkInvitationIdentifier
	...
	3, // 4: google.ads.googleads.v17.resources.ProductLinkInvitation.advertising_partner:type_name -> google.ads.googleads.v17.resources.AdvertisingPartnerLinkInvitationIdentifier
...
func file_resources_product_link_invitation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_product_link_invitation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_invitation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_invitation_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_resources_product_link_invitation_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_resources_product_link_invitation_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_resources_product_link_invitation_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
