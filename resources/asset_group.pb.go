...
type AssetGroup struct {
	...
	Status enums.AssetGroupStatusEnum_AssetGroupStatus `protobuf:"varint,6,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.AssetGroupStatusEnum_AssetGroupStatus" json:"status,omitempty"`
	...
	PrimaryStatus enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus `protobuf:"varint,11,opt,name=primary_status,json=primaryStatus,proto3,enum=google.ads.googleads.v17.enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus" json:"primary_status,omitempty"`
	...
	// issues.
	PrimaryStatusReasons []enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason `protobuf:"varint,12,rep,packed,name=primary_status_reasons,json=primaryStatusReasons,proto3,enum=google.ads.googleads.v17.enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason" json:"primary_status_reasons,omitempty"`
	...
	AdStrength enums.AdStrengthEnum_AdStrength `protobuf:"varint,10,opt,name=ad_strength,json=adStrength,proto3,enum=google.ads.googleads.v17.enums.AdStrengthEnum_AdStrength" json:"ad_strength,omitempty"`
}
...
var file_resources_asset_group_proto_goTypes = []any{
	(*AssetGroup)(nil), // 0: google.ads.googleads.v17.resources.AssetGroup
	(enums.AssetGroupStatusEnum_AssetGroupStatus)(0),                           // 1: google.ads.googleads.v17.enums.AssetGroupStatusEnum.AssetGroupStatus
	(enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus)(0),             // 2: google.ads.googleads.v17.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	(enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason)(0), // 3: google.ads.googleads.v17.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
...
var file_resources_asset_group_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AssetGroup.status:type_name -> google.ads.googleads.v17.enums.AssetGroupStatusEnum.AssetGroupStatus
	2, // 1: google.ads.googleads.v17.resources.AssetGroup.primary_status:type_name -> google.ads.googleads.v17.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	3, // 2: google.ads.googleads.v17.resources.AssetGroup.primary_status_reasons:type_name -> google.ads.googleads.v17.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	4, // 3: google.ads.googleads.v17.resources.AssetGroup.ad_strength:type_name -> google.ads.googleads.v17.enums.AdStrengthEnum.AdStrength
...
func file_resources_asset_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
