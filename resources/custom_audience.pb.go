...
type CustomAudience struct {
	...
	Status enums.CustomAudienceStatusEnum_CustomAudienceStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.CustomAudienceStatusEnum_CustomAudienceStatus" json:"status,omitempty"`
	...
	Type enums.CustomAudienceTypeEnum_CustomAudienceType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v15.enums.CustomAudienceTypeEnum_CustomAudienceType" json:"type,omitempty"`
...
func (x *CustomAudience) Reset() {
	*x = CustomAudience{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_custom_audience_proto_msgTypes[0]
...
func (*CustomAudience) Descriptor() ([]byte, []int) {
	return file_resources_custom_audience_proto_rawDescGZIP(), []int{0}
}
...
type CustomAudienceMember struct {
	...
	MemberType enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType `protobuf:"varint,1,opt,name=member_type,json=memberType,proto3,enum=google.ads.googleads.v15.enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType" json:"member_type,omitempty"`
...
func (x *CustomAudienceMember) Reset() {
	*x = CustomAudienceMember{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_custom_audience_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomAudienceMember) Descriptor() ([]byte, []int) {
	return file_resources_custom_audience_proto_rawDescGZIP(), []int{1}
}
...
var file_resources_custom_audience_proto_rawDesc = []byte{
...
var (
	file_resources_custom_audience_proto_rawDescOnce sync.Once
	file_resources_custom_audience_proto_rawDescData = file_resources_custom_audience_proto_rawDesc
)

func file_resources_custom_audience_proto_rawDescGZIP() []byte {
	file_resources_custom_audience_proto_rawDescOnce.Do(func() {
		file_resources_custom_audience_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_custom_audience_proto_rawDescData)
	})
	return file_resources_custom_audience_proto_rawDescData
}

var file_resources_custom_audience_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_resources_custom_audience_proto_goTypes = []interface{}{
	(*CustomAudience)(nil),                                           // 0: google.ads.googleads.v15.resources.CustomAudience
	(*CustomAudienceMember)(nil),                                     // 1: google.ads.googleads.v15.resources.CustomAudienceMember
	(enums.CustomAudienceStatusEnum_CustomAudienceStatus)(0),         // 2: google.ads.googleads.v15.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	(enums.CustomAudienceTypeEnum_CustomAudienceType)(0),             // 3: google.ads.googleads.v15.enums.CustomAudienceTypeEnum.CustomAudienceType
	(enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType)(0), // 4: google.ads.googleads.v15.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
}
var file_resources_custom_audience_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v15.resources.CustomAudience.status:type_name -> google.ads.googleads.v15.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	3, // 1: google.ads.googleads.v15.resources.CustomAudience.type:type_name -> google.ads.googleads.v15.enums.CustomAudienceTypeEnum.CustomAudienceType
	1, // 2: google.ads.googleads.v15.resources.CustomAudience.members:type_name -> google.ads.googleads.v15.resources.CustomAudienceMember
	4, // 3: google.ads.googleads.v15.resources.CustomAudienceMember.member_type:type_name -> google.ads.googleads.v15.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
...
func init() { file_resources_custom_audience_proto_init() }
func file_resources_custom_audience_proto_init() {
	if File_resources_custom_audience_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_custom_audience_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_custom_audience_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_custom_audience_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_custom_audience_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_custom_audience_proto_goTypes,
		DependencyIndexes: file_resources_custom_audience_proto_depIdxs,
		MessageInfos:      file_resources_custom_audience_proto_msgTypes,
	}.Build()
	File_resources_custom_audience_proto = out.File
	file_resources_custom_audience_proto_rawDesc = nil
	file_resources_custom_audience_proto_goTypes = nil
	file_resources_custom_audience_proto_depIdxs = nil
}
