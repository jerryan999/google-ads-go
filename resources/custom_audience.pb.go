...
type CustomAudience struct {
	...
	Status enums.CustomAudienceStatusEnum_CustomAudienceStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.CustomAudienceStatusEnum_CustomAudienceStatus" json:"status,omitempty"`
	...
	Type enums.CustomAudienceTypeEnum_CustomAudienceType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v17.enums.CustomAudienceTypeEnum_CustomAudienceType" json:"type,omitempty"`
...
var file_resources_custom_audience_proto_goTypes = []any{
	(*CustomAudience)(nil),                                           // 0: google.ads.googleads.v17.resources.CustomAudience
	(*CustomAudienceMember)(nil),                                     // 1: google.ads.googleads.v17.resources.CustomAudienceMember
	(enums.CustomAudienceStatusEnum_CustomAudienceStatus)(0),         // 2: google.ads.googleads.v17.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	(enums.CustomAudienceTypeEnum_CustomAudienceType)(0),             // 3: google.ads.googleads.v17.enums.CustomAudienceTypeEnum.CustomAudienceType
	(enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType)(0), // 4: google.ads.googleads.v17.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
}
var file_resources_custom_audience_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v17.resources.CustomAudience.status:type_name -> google.ads.googleads.v17.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	3, // 1: google.ads.googleads.v17.resources.CustomAudience.type:type_name -> google.ads.googleads.v17.enums.CustomAudienceTypeEnum.CustomAudienceType
	1, // 2: google.ads.googleads.v17.resources.CustomAudience.members:type_name -> google.ads.googleads.v17.resources.CustomAudienceMember
	4, // 3: google.ads.googleads.v17.resources.CustomAudienceMember.member_type:type_name -> google.ads.googleads.v17.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
...
func file_resources_custom_audience_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_custom_audience_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_custom_audience_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_resources_custom_audience_proto_msgTypes[1].OneofWrappers = []any{
