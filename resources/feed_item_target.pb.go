...
type FeedItemTarget struct {
	...
	// read-only.
	FeedItemTargetType enums.FeedItemTargetTypeEnum_FeedItemTargetType `protobuf:"varint,3,opt,name=feed_item_target_type,json=feedItemTargetType,proto3,enum=google.ads.googleads.v15.enums.FeedItemTargetTypeEnum_FeedItemTargetType" json:"feed_item_target_type,omitempty"`
	...
	Status enums.FeedItemTargetStatusEnum_FeedItemTargetStatus `protobuf:"varint,11,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.FeedItemTargetStatusEnum_FeedItemTargetStatus" json:"status,omitempty"`
...
type FeedItemTarget_Device struct {
	...
	Device enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice `protobuf:"varint,9,opt,name=device,proto3,enum=google.ads.googleads.v15.enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice,oneof"`
}
...
var file_resources_feed_item_target_proto_goTypes = []interface{}{
	(*FeedItemTarget)(nil),                                   // 0: google.ads.googleads.v15.resources.FeedItemTarget
	(enums.FeedItemTargetTypeEnum_FeedItemTargetType)(0),     // 1: google.ads.googleads.v15.enums.FeedItemTargetTypeEnum.FeedItemTargetType
	(enums.FeedItemTargetStatusEnum_FeedItemTargetStatus)(0), // 2: google.ads.googleads.v15.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus
	(*common.KeywordInfo)(nil),                               // 3: google.ads.googleads.v15.common.KeywordInfo
	(enums.FeedItemTargetDeviceEnum_FeedItemTargetDevice)(0), // 4: google.ads.googleads.v15.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice
	(*common.AdScheduleInfo)(nil),                            // 5: google.ads.googleads.v15.common.AdScheduleInfo
}
var file_resources_feed_item_target_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.FeedItemTarget.feed_item_target_type:type_name -> google.ads.googleads.v15.enums.FeedItemTargetTypeEnum.FeedItemTargetType
	2, // 1: google.ads.googleads.v15.resources.FeedItemTarget.status:type_name -> google.ads.googleads.v15.enums.FeedItemTargetStatusEnum.FeedItemTargetStatus
	3, // 2: google.ads.googleads.v15.resources.FeedItemTarget.keyword:type_name -> google.ads.googleads.v15.common.KeywordInfo
	4, // 3: google.ads.googleads.v15.resources.FeedItemTarget.device:type_name -> google.ads.googleads.v15.enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice
	5, // 4: google.ads.googleads.v15.resources.FeedItemTarget.ad_schedule:type_name -> google.ads.googleads.v15.common.AdScheduleInfo
