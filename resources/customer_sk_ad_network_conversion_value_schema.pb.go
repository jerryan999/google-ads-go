...
func (*CustomerSkAdNetworkConversionValueSchema_SkAdNetworkConversionValueSchema_Event_RevenueRange) Descriptor() ([]byte, []int) {
	return file_resources_customer_sk_ad_network_conversion_value_schema_proto_rawDescGZIP(), []int{0, 0, 2, 0}
}
...
func (*CustomerSkAdNetworkConversionValueSchema_SkAdNetworkConversionValueSchema_Event_EventOccurrenceRange) Descriptor() ([]byte, []int) {
	return file_resources_customer_sk_ad_network_conversion_value_schema_proto_rawDescGZIP(), []int{0, 0, 2, 1}
}
...
var file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_resources_customer_sk_ad_network_conversion_value_schema_proto_goTypes = []interface{}{
...
func file_resources_customer_sk_ad_network_conversion_value_schema_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_customer_sk_ad_network_conversion_value_schema_proto_msgTypes[4].OneofWrappers = []interface{}{
