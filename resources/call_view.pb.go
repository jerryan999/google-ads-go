...
type CallView struct {
	...
	CallTrackingDisplayLocation enums.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation `protobuf:"varint,7,opt,name=call_tracking_display_location,json=callTrackingDisplayLocation,proto3,enum=google.ads.googleads.v15.enums.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation" json:"call_tracking_display_location,omitempty"`
	// Output only. The type of the call.
	Type enums.CallTypeEnum_CallType `protobuf:"varint,8,opt,name=type,proto3,enum=google.ads.googleads.v15.enums.CallTypeEnum_CallType" json:"type,omitempty"`
	// Output only. The status of the call.
	CallStatus enums.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus `protobuf:"varint,9,opt,name=call_status,json=callStatus,proto3,enum=google.ads.googleads.v15.enums.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus" json:"call_status,omitempty"`
}

func (x *CallView) Reset() {
	*x = CallView{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_call_view_proto_msgTypes[0]
...
func (*CallView) Descriptor() ([]byte, []int) {
	return file_resources_call_view_proto_rawDescGZIP(), []int{0}
}
...
var file_resources_call_view_proto_rawDesc = []byte{
	...
	0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x61, 0x6c, 0x6c, 0x5f, 0x74, 0x72,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x67, 0x6f,
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x56,
...
var (
	file_resources_call_view_proto_rawDescOnce sync.Once
	file_resources_call_view_proto_rawDescData = file_resources_call_view_proto_rawDesc
)

func file_resources_call_view_proto_rawDescGZIP() []byte {
	file_resources_call_view_proto_rawDescOnce.Do(func() {
		file_resources_call_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_call_view_proto_rawDescData)
	})
	return file_resources_call_view_proto_rawDescData
}

var file_resources_call_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_call_view_proto_goTypes = []interface{}{
	(*CallView)(nil), // 0: google.ads.googleads.v15.resources.CallView
	(enums.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation)(0), // 1: google.ads.googleads.v15.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation
	(enums.CallTypeEnum_CallType)(0),                                       // 2: google.ads.googleads.v15.enums.CallTypeEnum.CallType
	(enums.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus)(0),             // 3: google.ads.googleads.v15.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus
}
var file_resources_call_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.CallView.call_tracking_display_location:type_name -> google.ads.googleads.v15.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation
	2, // 1: google.ads.googleads.v15.resources.CallView.type:type_name -> google.ads.googleads.v15.enums.CallTypeEnum.CallType
	3, // 2: google.ads.googleads.v15.resources.CallView.call_status:type_name -> google.ads.googleads.v15.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus
...
func init() { file_resources_call_view_proto_init() }
func file_resources_call_view_proto_init() {
	if File_resources_call_view_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_call_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_call_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_call_view_proto_goTypes,
		DependencyIndexes: file_resources_call_view_proto_depIdxs,
		MessageInfos:      file_resources_call_view_proto_msgTypes,
	}.Build()
	File_resources_call_view_proto = out.File
	file_resources_call_view_proto_rawDesc = nil
	file_resources_call_view_proto_goTypes = nil
	file_resources_call_view_proto_depIdxs = nil
}
