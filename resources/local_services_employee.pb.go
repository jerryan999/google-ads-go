...
var file_resources_local_services_employee_proto_goTypes = []any{
...
func file_resources_local_services_employee_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_local_services_employee_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_local_services_employee_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_local_services_employee_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_resources_local_services_employee_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_resources_local_services_employee_proto_msgTypes[0].OneofWrappers = []any{}
	file_resources_local_services_employee_proto_msgTypes[1].OneofWrappers = []any{}
	file_resources_local_services_employee_proto_msgTypes[2].OneofWrappers = []any{}
	file_resources_local_services_employee_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
