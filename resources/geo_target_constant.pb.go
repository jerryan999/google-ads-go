...
type GeoTargetConstant struct {
	...
	Status enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus `protobuf:"varint,7,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus" json:"status,omitempty"`
...
var file_resources_geo_target_constant_proto_goTypes = []any{
	(*GeoTargetConstant)(nil),                                      // 0: google.ads.googleads.v17.resources.GeoTargetConstant
	(enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus)(0), // 1: google.ads.googleads.v17.enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus
}
var file_resources_geo_target_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.GeoTargetConstant.status:type_name -> google.ads.googleads.v17.enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus
...
func file_resources_geo_target_constant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_geo_target_constant_proto_msgTypes[0].Exporter = func(v any, i int) any {
