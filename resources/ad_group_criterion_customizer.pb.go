...
func (x *AdGroupCriterionCustomizer) Reset() {
	*x = AdGroupCriterionCustomizer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_ad_group_criterion_customizer_proto_msgTypes[0]
...
func (*AdGroupCriterionCustomizer) Descriptor() ([]byte, []int) {
	return file_resources_ad_group_criterion_customizer_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_ad_group_criterion_customizer_proto protoreflect.FileDescriptor

var file_resources_ad_group_criterion_customizer_proto_rawDesc = []byte{
	...
	0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x36, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x75,
...
var (
	file_resources_ad_group_criterion_customizer_proto_rawDescOnce sync.Once
	file_resources_ad_group_criterion_customizer_proto_rawDescData = file_resources_ad_group_criterion_customizer_proto_rawDesc
)

func file_resources_ad_group_criterion_customizer_proto_rawDescGZIP() []byte {
	file_resources_ad_group_criterion_customizer_proto_rawDescOnce.Do(func() {
		file_resources_ad_group_criterion_customizer_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_ad_group_criterion_customizer_proto_rawDescData)
	})
	return file_resources_ad_group_criterion_customizer_proto_rawDescData
}

var file_resources_ad_group_criterion_customizer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_ad_group_criterion_customizer_proto_goTypes = []any{
	(*AdGroupCriterionCustomizer)(nil),                         // 0: google.ads.googleads.v17.resources.AdGroupCriterionCustomizer
...
var file_resources_ad_group_criterion_customizer_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AdGroupCriterionCustomizer.status:type_name -> google.ads.googleads.v17.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	2, // 1: google.ads.googleads.v17.resources.AdGroupCriterionCustomizer.value:type_name -> google.ads.googleads.v17.common.CustomizerValue
...
func init() { file_resources_ad_group_criterion_customizer_proto_init() }
func file_resources_ad_group_criterion_customizer_proto_init() {
	if File_resources_ad_group_criterion_customizer_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_ad_group_criterion_customizer_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_ad_group_criterion_customizer_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_resources_ad_group_criterion_customizer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_ad_group_criterion_customizer_proto_goTypes,
		DependencyIndexes: file_resources_ad_group_criterion_customizer_proto_depIdxs,
		MessageInfos:      file_resources_ad_group_criterion_customizer_proto_msgTypes,
	}.Build()
	File_resources_ad_group_criterion_customizer_proto = out.File
	file_resources_ad_group_criterion_customizer_proto_rawDesc = nil
	file_resources_ad_group_criterion_customizer_proto_goTypes = nil
	file_resources_ad_group_criterion_customizer_proto_depIdxs = nil
}
