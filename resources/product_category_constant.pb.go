...
type ProductCategoryConstant struct {
	...
	Level enums.ProductCategoryLevelEnum_ProductCategoryLevel `protobuf:"varint,4,opt,name=level,proto3,enum=google.ads.googleads.v17.enums.ProductCategoryLevelEnum_ProductCategoryLevel" json:"level,omitempty"`
	// Output only. State of the product category.
	State enums.ProductCategoryStateEnum_ProductCategoryState `protobuf:"varint,5,opt,name=state,proto3,enum=google.ads.googleads.v17.enums.ProductCategoryStateEnum_ProductCategoryState" json:"state,omitempty"`
...
var file_resources_product_category_constant_proto_rawDesc = []byte{
	...
	0x31, 0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
...
var file_resources_product_category_constant_proto_goTypes = []any{
	(*ProductCategoryConstant)(nil),                             // 0: google.ads.googleads.v17.resources.ProductCategoryConstant
	(*ProductCategoryConstant_ProductCategoryLocalization)(nil), // 1: google.ads.googleads.v17.resources.ProductCategoryConstant.ProductCategoryLocalization
	(enums.ProductCategoryLevelEnum_ProductCategoryLevel)(0),    // 2: google.ads.googleads.v17.enums.ProductCategoryLevelEnum.ProductCategoryLevel
	(enums.ProductCategoryStateEnum_ProductCategoryState)(0),    // 3: google.ads.googleads.v17.enums.ProductCategoryStateEnum.ProductCategoryState
}
var file_resources_product_category_constant_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v17.resources.ProductCategoryConstant.level:type_name -> google.ads.googleads.v17.enums.ProductCategoryLevelEnum.ProductCategoryLevel
	3, // 1: google.ads.googleads.v17.resources.ProductCategoryConstant.state:type_name -> google.ads.googleads.v17.enums.ProductCategoryStateEnum.ProductCategoryState
	1, // 2: google.ads.googleads.v17.resources.ProductCategoryConstant.localizations:type_name -> google.ads.googleads.v17.resources.ProductCategoryConstant.ProductCategoryLocalization
...
func file_resources_product_category_constant_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_product_category_constant_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_product_category_constant_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_resources_product_category_constant_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
