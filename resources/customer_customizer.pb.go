...
type CustomerCustomizer struct {
	...
	Status enums.CustomizerValueStatusEnum_CustomizerValueStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.CustomizerValueStatusEnum_CustomizerValueStatus" json:"status,omitempty"`
...
var file_resources_customer_customizer_proto_goTypes = []interface{}{
	(*CustomerCustomizer)(nil),                                 // 0: google.ads.googleads.v15.resources.CustomerCustomizer
...
var file_resources_customer_customizer_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.CustomerCustomizer.status:type_name -> google.ads.googleads.v15.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	2, // 1: google.ads.googleads.v15.resources.CustomerCustomizer.value:type_name -> google.ads.googleads.v15.common.CustomizerValue
...
func file_resources_customer_customizer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_customer_customizer_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
