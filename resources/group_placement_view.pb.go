...
type GroupPlacementView struct {
	...
	PlacementType enums.PlacementTypeEnum_PlacementType `protobuf:"varint,5,opt,name=placement_type,json=placementType,proto3,enum=google.ads.googleads.v9.enums.PlacementTypeEnum_PlacementType" json:"placement_type,omitempty"`
}
...
var file_resources_group_placement_view_proto_goTypes = []interface{}{
	(*GroupPlacementView)(nil),                 // 0: google.ads.googleads.v9.resources.GroupPlacementView
...
var file_resources_group_placement_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.resources.GroupPlacementView.placement_type:type_name -> google.ads.googleads.v9.enums.PlacementTypeEnum.PlacementType
