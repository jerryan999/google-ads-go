...
var file_resources_campaign_bid_modifier_proto_goTypes = []any{
	(*CampaignBidModifier)(nil),        // 0: google.ads.googleads.v17.resources.CampaignBidModifier
	(*common.InteractionTypeInfo)(nil), // 1: google.ads.googleads.v17.common.InteractionTypeInfo
}
var file_resources_campaign_bid_modifier_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.CampaignBidModifier.interaction_type:type_name -> google.ads.googleads.v17.common.InteractionTypeInfo
...
func file_resources_campaign_bid_modifier_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_campaign_bid_modifier_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_campaign_bid_modifier_proto_msgTypes[0].OneofWrappers = []any{
