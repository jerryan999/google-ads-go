...
var file_resources_asset_group_signal_proto_goTypes = []interface{}{
...
func file_resources_asset_group_signal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_group_signal_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_asset_group_signal_proto_msgTypes[0].OneofWrappers = []interface{}{
