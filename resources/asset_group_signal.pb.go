...
type AssetGroupSignal struct {
	...
	ApprovalStatus enums.AssetGroupSignalApprovalStatusEnum_AssetGroupSignalApprovalStatus `protobuf:"varint,6,opt,name=approval_status,json=approvalStatus,proto3,enum=google.ads.googleads.v17.enums.AssetGroupSignalApprovalStatusEnum_AssetGroupSignalApprovalStatus" json:"approval_status,omitempty"`
...
func (x *AssetGroupSignal) Reset() {
	*x = AssetGroupSignal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_asset_group_signal_proto_msgTypes[0]
...
func (*AssetGroupSignal) Descriptor() ([]byte, []int) {
	return file_resources_asset_group_signal_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_asset_group_signal_proto protoreflect.FileDescriptor

var file_resources_asset_group_signal_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x41, 0x75,
...
var (
	file_resources_asset_group_signal_proto_rawDescOnce sync.Once
	file_resources_asset_group_signal_proto_rawDescData = file_resources_asset_group_signal_proto_rawDesc
)

func file_resources_asset_group_signal_proto_rawDescGZIP() []byte {
	file_resources_asset_group_signal_proto_rawDescOnce.Do(func() {
		file_resources_asset_group_signal_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_asset_group_signal_proto_rawDescData)
	})
	return file_resources_asset_group_signal_proto_rawDescData
}

var file_resources_asset_group_signal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_asset_group_signal_proto_goTypes = []any{
	(*AssetGroupSignal)(nil), // 0: google.ads.googleads.v17.resources.AssetGroupSignal
	(enums.AssetGroupSignalApprovalStatusEnum_AssetGroupSignalApprovalStatus)(0), // 1: google.ads.googleads.v17.enums.AssetGroupSignalApprovalStatusEnum.AssetGroupSignalApprovalStatus
	(*common.AudienceInfo)(nil),    // 2: google.ads.googleads.v17.common.AudienceInfo
	(*common.SearchThemeInfo)(nil), // 3: google.ads.googleads.v17.common.SearchThemeInfo
}
var file_resources_asset_group_signal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AssetGroupSignal.approval_status:type_name -> google.ads.googleads.v17.enums.AssetGroupSignalApprovalStatusEnum.AssetGroupSignalApprovalStatus
	2, // 1: google.ads.googleads.v17.resources.AssetGroupSignal.audience:type_name -> google.ads.googleads.v17.common.AudienceInfo
	3, // 2: google.ads.googleads.v17.resources.AssetGroupSignal.search_theme:type_name -> google.ads.googleads.v17.common.SearchThemeInfo
...
func init() { file_resources_asset_group_signal_proto_init() }
func file_resources_asset_group_signal_proto_init() {
	if File_resources_asset_group_signal_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_group_signal_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_asset_group_signal_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_asset_group_signal_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_asset_group_signal_proto_goTypes,
		DependencyIndexes: file_resources_asset_group_signal_proto_depIdxs,
		MessageInfos:      file_resources_asset_group_signal_proto_msgTypes,
	}.Build()
	File_resources_asset_group_signal_proto = out.File
	file_resources_asset_group_signal_proto_rawDesc = nil
	file_resources_asset_group_signal_proto_goTypes = nil
	file_resources_asset_group_signal_proto_depIdxs = nil
}
