...
type AccountLink struct {
	...
	Status enums.AccountLinkStatusEnum_AccountLinkStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v9.enums.AccountLinkStatusEnum_AccountLinkStatus" json:"status,omitempty"`
	// Output only. The type of the linked account.
	Type enums.LinkedAccountTypeEnum_LinkedAccountType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v9.enums.LinkedAccountTypeEnum_LinkedAccountType" json:"type,omitempty"`
...
type ThirdPartyAppAnalyticsLinkIdentifier struct {
	...
	// party app analytics link. It is unable to be modified after the creation of
	// the link.
	AppVendor enums.MobileAppVendorEnum_MobileAppVendor `protobuf:"varint,3,opt,name=app_vendor,json=appVendor,proto3,enum=google.ads.googleads.v9.enums.MobileAppVendorEnum_MobileAppVendor" json:"app_vendor,omitempty"`
}
...
var file_resources_account_link_proto_rawDesc = []byte{
	...
	0x76, 0x39, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
...
var file_resources_account_link_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_resources_account_link_proto_goTypes = []interface{}{
	(*AccountLink)(nil),                                // 0: google.ads.googleads.v9.resources.AccountLink
	(*ThirdPartyAppAnalyticsLinkIdentifier)(nil),       // 1: google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLinkIdentifier
	(*DataPartnerLinkIdentifier)(nil),                  // 2: google.ads.googleads.v9.resources.DataPartnerLinkIdentifier
	(*GoogleAdsLinkIdentifier)(nil),                    // 3: google.ads.googleads.v9.resources.GoogleAdsLinkIdentifier
	(enums.AccountLinkStatusEnum_AccountLinkStatus)(0), // 4: google.ads.googleads.v9.enums.AccountLinkStatusEnum.AccountLinkStatus
	(enums.LinkedAccountTypeEnum_LinkedAccountType)(0), // 5: google.ads.googleads.v9.enums.LinkedAccountTypeEnum.LinkedAccountType
	(enums.MobileAppVendorEnum_MobileAppVendor)(0),     // 6: google.ads.googleads.v9.enums.MobileAppVendorEnum.MobileAppVendor
}
var file_resources_account_link_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v9.resources.AccountLink.status:type_name -> google.ads.googleads.v9.enums.AccountLinkStatusEnum.AccountLinkStatus
	5, // 1: google.ads.googleads.v9.resources.AccountLink.type:type_name -> google.ads.googleads.v9.enums.LinkedAccountTypeEnum.LinkedAccountType
	1, // 2: google.ads.googleads.v9.resources.AccountLink.third_party_app_analytics:type_name -> google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLinkIdentifier
	2, // 3: google.ads.googleads.v9.resources.AccountLink.data_partner:type_name -> google.ads.googleads.v9.resources.DataPartnerLinkIdentifier
	3, // 4: google.ads.googleads.v9.resources.AccountLink.google_ads:type_name -> google.ads.googleads.v9.resources.GoogleAdsLinkIdentifier
	6, // 5: google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLinkIdentifier.app_vendor:type_name -> google.ads.googleads.v9.enums.MobileAppVendorEnum.MobileAppVendor
