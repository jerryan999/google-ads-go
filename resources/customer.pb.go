...
func file_resources_customer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resources_customer_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_customer_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_resources_customer_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
