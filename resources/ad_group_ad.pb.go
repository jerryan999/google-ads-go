...
var file_resources_ad_group_ad_proto_goTypes = []any{
...
func file_resources_ad_group_ad_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_ad_group_ad_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_ad_group_ad_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_resources_ad_group_ad_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
