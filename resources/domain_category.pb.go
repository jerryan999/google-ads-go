...
var file_resources_domain_category_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x1f,
...
var file_resources_domain_category_proto_goTypes = []any{
	(*DomainCategory)(nil), // 0: google.ads.googleads.v17.resources.DomainCategory
}
...
func file_resources_domain_category_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_domain_category_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_domain_category_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
