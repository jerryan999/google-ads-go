...
type Feed struct {
	...
	Origin enums.FeedOriginEnum_FeedOrigin `protobuf:"varint,5,opt,name=origin,proto3,enum=google.ads.googleads.v15.enums.FeedOriginEnum_FeedOrigin" json:"origin,omitempty"`
	// Output only. Status of the feed.
	// This field is read-only.
	Status enums.FeedStatusEnum_FeedStatus `protobuf:"varint,8,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.FeedStatusEnum_FeedStatus" json:"status,omitempty"`
...
type FeedAttribute struct {
	...
	Type enums.FeedAttributeTypeEnum_FeedAttributeType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v15.enums.FeedAttributeTypeEnum_FeedAttributeType" json:"type,omitempty"`
...
type FeedAttributeOperation struct {
	...
	Operator FeedAttributeOperation_Operator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v15.resources.FeedAttributeOperation_Operator" json:"operator,omitempty"`
...
var file_resources_feed_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65,
	...
	0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x66, 0x66, 0x69, 0x6c, 0x69, 0x61, 0x74,
	...
	0x31, 0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x09, 0x46, 0x65,
...
var file_resources_feed_proto_goTypes = []interface{}{
	(FeedAttributeOperation_Operator)(0),               // 0: google.ads.googleads.v15.resources.FeedAttributeOperation.Operator
	(*Feed)(nil),                                       // 1: google.ads.googleads.v15.resources.Feed
	(*FeedAttribute)(nil),                              // 2: google.ads.googleads.v15.resources.FeedAttribute
	(*FeedAttributeOperation)(nil),                     // 3: google.ads.googleads.v15.resources.FeedAttributeOperation
	(*Feed_PlacesLocationFeedData)(nil),                // 4: google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData
	(*Feed_AffiliateLocationFeedData)(nil),             // 5: google.ads.googleads.v15.resources.Feed.AffiliateLocationFeedData
	(*Feed_PlacesLocationFeedData_OAuthInfo)(nil),      // 6: google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData.OAuthInfo
	(enums.FeedOriginEnum_FeedOrigin)(0),               // 7: google.ads.googleads.v15.enums.FeedOriginEnum.FeedOrigin
	(enums.FeedStatusEnum_FeedStatus)(0),               // 8: google.ads.googleads.v15.enums.FeedStatusEnum.FeedStatus
	(enums.FeedAttributeTypeEnum_FeedAttributeType)(0), // 9: google.ads.googleads.v15.enums.FeedAttributeTypeEnum.FeedAttributeType
	(enums.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType)(0), // 10: google.ads.googleads.v15.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
}
var file_resources_feed_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v15.resources.Feed.attributes:type_name -> google.ads.googleads.v15.resources.FeedAttribute
	3,  // 1: google.ads.googleads.v15.resources.Feed.attribute_operations:type_name -> google.ads.googleads.v15.resources.FeedAttributeOperation
	7,  // 2: google.ads.googleads.v15.resources.Feed.origin:type_name -> google.ads.googleads.v15.enums.FeedOriginEnum.FeedOrigin
	8,  // 3: google.ads.googleads.v15.resources.Feed.status:type_name -> google.ads.googleads.v15.enums.FeedStatusEnum.FeedStatus
	4,  // 4: google.ads.googleads.v15.resources.Feed.places_location_feed_data:type_name -> google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData
	5,  // 5: google.ads.googleads.v15.resources.Feed.affiliate_location_feed_data:type_name -> google.ads.googleads.v15.resources.Feed.AffiliateLocationFeedData
	9,  // 6: google.ads.googleads.v15.resources.FeedAttribute.type:type_name -> google.ads.googleads.v15.enums.FeedAttributeTypeEnum.FeedAttributeType
	0,  // 7: google.ads.googleads.v15.resources.FeedAttributeOperation.operator:type_name -> google.ads.googleads.v15.resources.FeedAttributeOperation.Operator
	2,  // 8: google.ads.googleads.v15.resources.FeedAttributeOperation.value:type_name -> google.ads.googleads.v15.resources.FeedAttribute
	6,  // 9: google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData.oauth_info:type_name -> google.ads.googleads.v15.resources.Feed.PlacesLocationFeedData.OAuthInfo
	10, // 10: google.ads.googleads.v15.resources.Feed.AffiliateLocationFeedData.relationship_type:type_name -> google.ads.googleads.v15.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
...
func file_resources_feed_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Feed); i {
			case 0:
				return &v.state
			case 1:
		...
		file_resources_feed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_feed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_feed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_feed_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_feed_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_feed_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Feed_PlacesLocationFeedData_)(nil),
		(*Feed_AffiliateLocationFeedData_)(nil),
	}
	file_resources_feed_proto_msgTypes[1].OneofWrappers = []interface{}{}
	file_resources_feed_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_resources_feed_proto_msgTypes[5].OneofWrappers = []interface{}{}
	type x struct{}
