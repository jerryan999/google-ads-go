...
type KeywordPlanCampaign struct {
	...
	// This field is required and should not be empty when creating Keyword Plan
	// campaigns.
	KeywordPlanNetwork enums.KeywordPlanNetworkEnum_KeywordPlanNetwork `protobuf:"varint,6,opt,name=keyword_plan_network,json=keywordPlanNetwork,proto3,enum=google.ads.googleads.v9.enums.KeywordPlanNetworkEnum_KeywordPlanNetwork" json:"keyword_plan_network,omitempty"`
...
var file_resources_keyword_plan_campaign_proto_goTypes = []interface{}{
	(*KeywordPlanCampaign)(nil),                          // 0: google.ads.googleads.v9.resources.KeywordPlanCampaign
	(*KeywordPlanGeoTarget)(nil),                         // 1: google.ads.googleads.v9.resources.KeywordPlanGeoTarget
	(enums.KeywordPlanNetworkEnum_KeywordPlanNetwork)(0), // 2: google.ads.googleads.v9.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
}
var file_resources_keyword_plan_campaign_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v9.resources.KeywordPlanCampaign.keyword_plan_network:type_name -> google.ads.googleads.v9.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	1, // 1: google.ads.googleads.v9.resources.KeywordPlanCampaign.geo_targets:type_name -> google.ads.googleads.v9.resources.KeywordPlanGeoTarget
