...
func file_resources_asset_set_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_resources_asset_set_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_asset_set_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_resources_asset_set_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
