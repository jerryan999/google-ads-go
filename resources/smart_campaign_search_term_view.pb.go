...
var file_resources_smart_campaign_search_term_view_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x20,
...
var file_resources_smart_campaign_search_term_view_proto_goTypes = []any{
	(*SmartCampaignSearchTermView)(nil), // 0: google.ads.googleads.v17.resources.SmartCampaignSearchTermView
}
...
func file_resources_smart_campaign_search_term_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_smart_campaign_search_term_view_proto_msgTypes[0].Exporter = func(v any, i int) any {
