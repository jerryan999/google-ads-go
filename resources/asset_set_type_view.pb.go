...
type AssetSetTypeView struct {
	...
	AssetSetType enums.AssetSetTypeEnum_AssetSetType `protobuf:"varint,3,opt,name=asset_set_type,json=assetSetType,proto3,enum=google.ads.googleads.v17.enums.AssetSetTypeEnum_AssetSetType" json:"asset_set_type,omitempty"`
}
...
var file_resources_asset_set_type_view_proto_goTypes = []any{
	(*AssetSetTypeView)(nil),                 // 0: google.ads.googleads.v17.resources.AssetSetTypeView
	(enums.AssetSetTypeEnum_AssetSetType)(0), // 1: google.ads.googleads.v17.enums.AssetSetTypeEnum.AssetSetType
}
var file_resources_asset_set_type_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AssetSetTypeView.asset_set_type:type_name -> google.ads.googleads.v17.enums.AssetSetTypeEnum.AssetSetType
...
func file_resources_asset_set_type_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_set_type_view_proto_msgTypes[0].Exporter = func(v any, i int) any {
