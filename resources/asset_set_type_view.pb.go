...
type AssetSetTypeView struct {
	...
	AssetSetType enums.AssetSetTypeEnum_AssetSetType `protobuf:"varint,3,opt,name=asset_set_type,json=assetSetType,proto3,enum=google.ads.googleads.v15.enums.AssetSetTypeEnum_AssetSetType" json:"asset_set_type,omitempty"`
}

func (x *AssetSetTypeView) Reset() {
	*x = AssetSetTypeView{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_asset_set_type_view_proto_msgTypes[0]
...
func (*AssetSetTypeView) Descriptor() ([]byte, []int) {
	return file_resources_asset_set_type_view_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_asset_set_type_view_proto protoreflect.FileDescriptor

var file_resources_asset_set_type_view_proto_rawDesc = []byte{
...
var (
	file_resources_asset_set_type_view_proto_rawDescOnce sync.Once
	file_resources_asset_set_type_view_proto_rawDescData = file_resources_asset_set_type_view_proto_rawDesc
)

func file_resources_asset_set_type_view_proto_rawDescGZIP() []byte {
	file_resources_asset_set_type_view_proto_rawDescOnce.Do(func() {
		file_resources_asset_set_type_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_asset_set_type_view_proto_rawDescData)
	})
	return file_resources_asset_set_type_view_proto_rawDescData
}

var file_resources_asset_set_type_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_asset_set_type_view_proto_goTypes = []interface{}{
	(*AssetSetTypeView)(nil),                 // 0: google.ads.googleads.v15.resources.AssetSetTypeView
	(enums.AssetSetTypeEnum_AssetSetType)(0), // 1: google.ads.googleads.v15.enums.AssetSetTypeEnum.AssetSetType
}
var file_resources_asset_set_type_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.AssetSetTypeView.asset_set_type:type_name -> google.ads.googleads.v15.enums.AssetSetTypeEnum.AssetSetType
...
func init() { file_resources_asset_set_type_view_proto_init() }
func file_resources_asset_set_type_view_proto_init() {
	if File_resources_asset_set_type_view_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_set_type_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssetSetTypeView); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_asset_set_type_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_asset_set_type_view_proto_goTypes,
		DependencyIndexes: file_resources_asset_set_type_view_proto_depIdxs,
		MessageInfos:      file_resources_asset_set_type_view_proto_msgTypes,
	}.Build()
	File_resources_asset_set_type_view_proto = out.File
	file_resources_asset_set_type_view_proto_rawDesc = nil
	file_resources_asset_set_type_view_proto_goTypes = nil
	file_resources_asset_set_type_view_proto_depIdxs = nil
}
