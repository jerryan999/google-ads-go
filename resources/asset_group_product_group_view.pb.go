...
var file_resources_asset_group_product_group_view_proto_goTypes = []any{
	(*AssetGroupProductGroupView)(nil), // 0: google.ads.googleads.v17.resources.AssetGroupProductGroupView
}
...
func file_resources_asset_group_product_group_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_group_product_group_view_proto_msgTypes[0].Exporter = func(v any, i int) any {
