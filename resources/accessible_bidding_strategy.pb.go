...
var file_resources_accessible_bidding_strategy_proto_goTypes = []any{
...
func file_resources_accessible_bidding_strategy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_accessible_bidding_strategy_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_accessible_bidding_strategy_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_accessible_bidding_strategy_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_resources_accessible_bidding_strategy_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_resources_accessible_bidding_strategy_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_resources_accessible_bidding_strategy_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_resources_accessible_bidding_strategy_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_resources_accessible_bidding_strategy_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_resources_accessible_bidding_strategy_proto_msgTypes[3].OneofWrappers = []any{}
	file_resources_accessible_bidding_strategy_proto_msgTypes[4].OneofWrappers = []any{}
	file_resources_accessible_bidding_strategy_proto_msgTypes[5].OneofWrappers = []any{}
	file_resources_accessible_bidding_strategy_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
