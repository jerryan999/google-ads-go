...
type ConversionValueRuleSet struct {
	...
	Dimensions []enums.ValueRuleSetDimensionEnum_ValueRuleSetDimension `protobuf:"varint,4,rep,packed,name=dimensions,proto3,enum=google.ads.googleads.v15.enums.ValueRuleSetDimensionEnum_ValueRuleSetDimension" json:"dimensions,omitempty"`
	...
	// attached.
	AttachmentType enums.ValueRuleSetAttachmentTypeEnum_ValueRuleSetAttachmentType `protobuf:"varint,6,opt,name=attachment_type,json=attachmentType,proto3,enum=google.ads.googleads.v15.enums.ValueRuleSetAttachmentTypeEnum_ValueRuleSetAttachmentType" json:"attachment_type,omitempty"`
	...
	// ** Read-only **
	Status enums.ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus `protobuf:"varint,8,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus" json:"status,omitempty"`
	// Immutable. The conversion action categories of the conversion value rule
	// set.
	ConversionActionCategories []enums.ConversionActionCategoryEnum_ConversionActionCategory `protobuf:"varint,9,rep,packed,name=conversion_action_categories,json=conversionActionCategories,proto3,enum=google.ads.googleads.v15.enums.ConversionActionCategoryEnum_ConversionActionCategory" json:"conversion_action_categories,omitempty"`
}

func (x *ConversionValueRuleSet) Reset() {
	*x = ConversionValueRuleSet{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_conversion_value_rule_set_proto_msgTypes[0]
...
func (*ConversionValueRuleSet) Descriptor() ([]byte, []int) {
	return file_resources_conversion_value_rule_set_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_conversion_value_rule_set_proto protoreflect.FileDescriptor

var file_resources_conversion_value_rule_set_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x6f, 0x6e, 0x76, 0x65, 0x72,
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x56, 0x61, 0x6c,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x6f, 0x6e,
...
var (
	file_resources_conversion_value_rule_set_proto_rawDescOnce sync.Once
	file_resources_conversion_value_rule_set_proto_rawDescData = file_resources_conversion_value_rule_set_proto_rawDesc
)

func file_resources_conversion_value_rule_set_proto_rawDescGZIP() []byte {
	file_resources_conversion_value_rule_set_proto_rawDescOnce.Do(func() {
		file_resources_conversion_value_rule_set_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_conversion_value_rule_set_proto_rawDescData)
	})
	return file_resources_conversion_value_rule_set_proto_rawDescData
}

var file_resources_conversion_value_rule_set_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_conversion_value_rule_set_proto_goTypes = []interface{}{
	(*ConversionValueRuleSet)(nil),                                           // 0: google.ads.googleads.v15.resources.ConversionValueRuleSet
	(enums.ValueRuleSetDimensionEnum_ValueRuleSetDimension)(0),               // 1: google.ads.googleads.v15.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension
	(enums.ValueRuleSetAttachmentTypeEnum_ValueRuleSetAttachmentType)(0),     // 2: google.ads.googleads.v15.enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType
	(enums.ConversionValueRuleSetStatusEnum_ConversionValueRuleSetStatus)(0), // 3: google.ads.googleads.v15.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus
	(enums.ConversionActionCategoryEnum_ConversionActionCategory)(0),         // 4: google.ads.googleads.v15.enums.ConversionActionCategoryEnum.ConversionActionCategory
}
var file_resources_conversion_value_rule_set_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.ConversionValueRuleSet.dimensions:type_name -> google.ads.googleads.v15.enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension
	2, // 1: google.ads.googleads.v15.resources.ConversionValueRuleSet.attachment_type:type_name -> google.ads.googleads.v15.enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType
	3, // 2: google.ads.googleads.v15.resources.ConversionValueRuleSet.status:type_name -> google.ads.googleads.v15.enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus
	4, // 3: google.ads.googleads.v15.resources.ConversionValueRuleSet.conversion_action_categories:type_name -> google.ads.googleads.v15.enums.ConversionActionCategoryEnum.ConversionActionCategory
...
func init() { file_resources_conversion_value_rule_set_proto_init() }
func file_resources_conversion_value_rule_set_proto_init() {
	if File_resources_conversion_value_rule_set_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_conversion_value_rule_set_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_conversion_value_rule_set_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_conversion_value_rule_set_proto_goTypes,
		DependencyIndexes: file_resources_conversion_value_rule_set_proto_depIdxs,
		MessageInfos:      file_resources_conversion_value_rule_set_proto_msgTypes,
	}.Build()
	File_resources_conversion_value_rule_set_proto = out.File
	file_resources_conversion_value_rule_set_proto_rawDesc = nil
	file_resources_conversion_value_rule_set_proto_goTypes = nil
	file_resources_conversion_value_rule_set_proto_depIdxs = nil
}
