...
type OfflineConversionUploadClientSummary struct {
	...
	Status enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus" json:"status,omitempty"`
...
func (x *OfflineConversionUploadClientSummary) Reset() {
	*x = OfflineConversionUploadClientSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_offline_conversion_upload_client_summary_proto_msgTypes[0]
...
func (*OfflineConversionUploadClientSummary) Descriptor() ([]byte, []int) {
	return file_resources_offline_conversion_upload_client_summary_proto_rawDescGZIP(), []int{0}
}
...
func (x *OfflineConversionSummary) Reset() {
	*x = OfflineConversionSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_offline_conversion_upload_client_summary_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OfflineConversionSummary) Descriptor() ([]byte, []int) {
	return file_resources_offline_conversion_upload_client_summary_proto_rawDescGZIP(), []int{1}
}
...
func (x *OfflineConversionAlert) Reset() {
	*x = OfflineConversionAlert{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_offline_conversion_upload_client_summary_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OfflineConversionAlert) Descriptor() ([]byte, []int) {
	return file_resources_offline_conversion_upload_client_summary_proto_rawDescGZIP(), []int{2}
}
...
func (x *OfflineConversionError) Reset() {
	*x = OfflineConversionError{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_offline_conversion_upload_client_summary_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OfflineConversionError) Descriptor() ([]byte, []int) {
	return file_resources_offline_conversion_upload_client_summary_proto_rawDescGZIP(), []int{3}
}
...
type OfflineConversionError_CollectionSizeError struct {
	...
	CollectionSizeError errors.CollectionSizeErrorEnum_CollectionSizeError `protobuf:"varint,1,opt,name=collection_size_error,json=collectionSizeError,proto3,enum=google.ads.googleads.v17.errors.CollectionSizeErrorEnum_CollectionSizeError,oneof"`
}

type OfflineConversionError_ConversionAdjustmentUploadError struct {
	// Output only. Conversion adjustment upload error.
	ConversionAdjustmentUploadError errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError `protobuf:"varint,2,opt,name=conversion_adjustment_upload_error,json=conversionAdjustmentUploadError,proto3,enum=google.ads.googleads.v17.errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError,oneof"`
}

type OfflineConversionError_ConversionUploadError struct {
	// Output only. Conversion upload error.
	ConversionUploadError errors.ConversionUploadErrorEnum_ConversionUploadError `protobuf:"varint,3,opt,name=conversion_upload_error,json=conversionUploadError,proto3,enum=google.ads.googleads.v17.errors.ConversionUploadErrorEnum_ConversionUploadError,oneof"`
}

type OfflineConversionError_DateError struct {
	// Output only. Date error.
	DateError errors.DateErrorEnum_DateError `protobuf:"varint,4,opt,name=date_error,json=dateError,proto3,enum=google.ads.googleads.v17.errors.DateErrorEnum_DateError,oneof"`
}

type OfflineConversionError_DistinctError struct {
	// Output only. Distinct error.
	DistinctError errors.DistinctErrorEnum_DistinctError `protobuf:"varint,5,opt,name=distinct_error,json=distinctError,proto3,enum=google.ads.googleads.v17.errors.DistinctErrorEnum_DistinctError,oneof"`
}

type OfflineConversionError_FieldError struct {
	// Output only. Field error.
	FieldError errors.FieldErrorEnum_FieldError `protobuf:"varint,6,opt,name=field_error,json=fieldError,proto3,enum=google.ads.googleads.v17.errors.FieldErrorEnum_FieldError,oneof"`
}

type OfflineConversionError_MutateError struct {
	// Output only. Mutate error.
	MutateError errors.MutateErrorEnum_MutateError `protobuf:"varint,7,opt,name=mutate_error,json=mutateError,proto3,enum=google.ads.googleads.v17.errors.MutateErrorEnum_MutateError,oneof"`
}

type OfflineConversionError_NotAllowlistedError struct {
	// Output only. Not allowlisted error.
	NotAllowlistedError errors.NotAllowlistedErrorEnum_NotAllowlistedError `protobuf:"varint,8,opt,name=not_allowlisted_error,json=notAllowlistedError,proto3,enum=google.ads.googleads.v17.errors.NotAllowlistedErrorEnum_NotAllowlistedError,oneof"`
}

type OfflineConversionError_StringFormatError struct {
	// Output only. String format error.
	StringFormatError errors.StringFormatErrorEnum_StringFormatError `protobuf:"varint,9,opt,name=string_format_error,json=stringFormatError,proto3,enum=google.ads.googleads.v17.errors.StringFormatErrorEnum_StringFormatError,oneof"`
}

type OfflineConversionError_StringLengthError struct {
	// Output only. String length error.
	StringLengthError errors.StringLengthErrorEnum_StringLengthError `protobuf:"varint,10,opt,name=string_length_error,json=stringLengthError,proto3,enum=google.ads.googleads.v17.errors.StringLengthErrorEnum_StringLengthError,oneof"`
}
...
var File_resources_offline_conversion_upload_client_summary_proto protoreflect.FileDescriptor

var file_resources_offline_conversion_upload_client_summary_proto_rawDesc = []byte{
	...
	0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x5f,
	...
	0x64, 0x73, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2f, 0x66, 0x69,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4f, 0x66, 0x66,
	...
	0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x29, 0x4f, 0x66, 0x66,
	0x6c, 0x69, 0x6e, 0x65, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x55, 0x70,
	0x6c, 0x6f, 0x61, 0x64, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72,
...
var (
	file_resources_offline_conversion_upload_client_summary_proto_rawDescOnce sync.Once
	file_resources_offline_conversion_upload_client_summary_proto_rawDescData = file_resources_offline_conversion_upload_client_summary_proto_rawDesc
)

func file_resources_offline_conversion_upload_client_summary_proto_rawDescGZIP() []byte {
	file_resources_offline_conversion_upload_client_summary_proto_rawDescOnce.Do(func() {
		file_resources_offline_conversion_upload_client_summary_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_offline_conversion_upload_client_summary_proto_rawDescData)
	})
	return file_resources_offline_conversion_upload_client_summary_proto_rawDescData
}

var file_resources_offline_conversion_upload_client_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_resources_offline_conversion_upload_client_summary_proto_goTypes = []any{
	(*OfflineConversionUploadClientSummary)(nil),                                       // 0: google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary
	(*OfflineConversionSummary)(nil),                                                   // 1: google.ads.googleads.v17.resources.OfflineConversionSummary
	(*OfflineConversionAlert)(nil),                                                     // 2: google.ads.googleads.v17.resources.OfflineConversionAlert
	(*OfflineConversionError)(nil),                                                     // 3: google.ads.googleads.v17.resources.OfflineConversionError
	(enums.OfflineEventUploadClientEnum_OfflineEventUploadClient)(0),                   // 4: google.ads.googleads.v17.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	(enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus)(0), // 5: google.ads.googleads.v17.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	(errors.CollectionSizeErrorEnum_CollectionSizeError)(0),                            // 6: google.ads.googleads.v17.errors.CollectionSizeErrorEnum.CollectionSizeError
	(errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError)(0),    // 7: google.ads.googleads.v17.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError
	(errors.ConversionUploadErrorEnum_ConversionUploadError)(0),                        // 8: google.ads.googleads.v17.errors.ConversionUploadErrorEnum.ConversionUploadError
	(errors.DateErrorEnum_DateError)(0),                                                // 9: google.ads.googleads.v17.errors.DateErrorEnum.DateError
	(errors.DistinctErrorEnum_DistinctError)(0),                                        // 10: google.ads.googleads.v17.errors.DistinctErrorEnum.DistinctError
	(errors.FieldErrorEnum_FieldError)(0),                                              // 11: google.ads.googleads.v17.errors.FieldErrorEnum.FieldError
	(errors.MutateErrorEnum_MutateError)(0),                                            // 12: google.ads.googleads.v17.errors.MutateErrorEnum.MutateError
	(errors.NotAllowlistedErrorEnum_NotAllowlistedError)(0),                            // 13: google.ads.googleads.v17.errors.NotAllowlistedErrorEnum.NotAllowlistedError
	(errors.StringFormatErrorEnum_StringFormatError)(0),                                // 14: google.ads.googleads.v17.errors.StringFormatErrorEnum.StringFormatError
	(errors.StringLengthErrorEnum_StringLengthError)(0),                                // 15: google.ads.googleads.v17.errors.StringLengthErrorEnum.StringLengthError
}
var file_resources_offline_conversion_upload_client_summary_proto_depIdxs = []int32{
	4,  // 0: google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary.client:type_name -> google.ads.googleads.v17.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	5,  // 1: google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary.status:type_name -> google.ads.googleads.v17.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	1,  // 2: google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary.daily_summaries:type_name -> google.ads.googleads.v17.resources.OfflineConversionSummary
	1,  // 3: google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary.job_summaries:type_name -> google.ads.googleads.v17.resources.OfflineConversionSummary
	2,  // 4: google.ads.googleads.v17.resources.OfflineConversionUploadClientSummary.alerts:type_name -> google.ads.googleads.v17.resources.OfflineConversionAlert
	3,  // 5: google.ads.googleads.v17.resources.OfflineConversionAlert.error:type_name -> google.ads.googleads.v17.resources.OfflineConversionError
	6,  // 6: google.ads.googleads.v17.resources.OfflineConversionError.collection_size_error:type_name -> google.ads.googleads.v17.errors.CollectionSizeErrorEnum.CollectionSizeError
	7,  // 7: google.ads.googleads.v17.resources.OfflineConversionError.conversion_adjustment_upload_error:type_name -> google.ads.googleads.v17.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError
	8,  // 8: google.ads.googleads.v17.resources.OfflineConversionError.conversion_upload_error:type_name -> google.ads.googleads.v17.errors.ConversionUploadErrorEnum.ConversionUploadError
	9,  // 9: google.ads.googleads.v17.resources.OfflineConversionError.date_error:type_name -> google.ads.googleads.v17.errors.DateErrorEnum.DateError
	10, // 10: google.ads.googleads.v17.resources.OfflineConversionError.distinct_error:type_name -> google.ads.googleads.v17.errors.DistinctErrorEnum.DistinctError
	11, // 11: google.ads.googleads.v17.resources.OfflineConversionError.field_error:type_name -> google.ads.googleads.v17.errors.FieldErrorEnum.FieldError
	12, // 12: google.ads.googleads.v17.resources.OfflineConversionError.mutate_error:type_name -> google.ads.googleads.v17.errors.MutateErrorEnum.MutateError
	13, // 13: google.ads.googleads.v17.resources.OfflineConversionError.not_allowlisted_error:type_name -> google.ads.googleads.v17.errors.NotAllowlistedErrorEnum.NotAllowlistedError
	14, // 14: google.ads.googleads.v17.resources.OfflineConversionError.string_format_error:type_name -> google.ads.googleads.v17.errors.StringFormatErrorEnum.StringFormatError
	15, // 15: google.ads.googleads.v17.resources.OfflineConversionError.string_length_error:type_name -> google.ads.googleads.v17.errors.StringLengthErrorEnum.StringLengthError
...
func file_resources_offline_conversion_upload_client_summary_proto_init() {
	if File_resources_offline_conversion_upload_client_summary_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[3].Exporter = func(v any, i int) any {
	...
	file_resources_offline_conversion_upload_client_summary_proto_msgTypes[1].OneofWrappers = []any{
		(*OfflineConversionSummary_JobId)(nil),
		(*OfflineConversionSummary_UploadDate)(nil),
	}
	file_resources_offline_conversion_upload_client_summary_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_offline_conversion_upload_client_summary_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_offline_conversion_upload_client_summary_proto_goTypes,
		DependencyIndexes: file_resources_offline_conversion_upload_client_summary_proto_depIdxs,
		MessageInfos:      file_resources_offline_conversion_upload_client_summary_proto_msgTypes,
	}.Build()
	File_resources_offline_conversion_upload_client_summary_proto = out.File
	file_resources_offline_conversion_upload_client_summary_proto_rawDesc = nil
	file_resources_offline_conversion_upload_client_summary_proto_goTypes = nil
	file_resources_offline_conversion_upload_client_summary_proto_depIdxs = nil
}
