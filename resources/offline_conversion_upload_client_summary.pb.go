...
var file_resources_offline_conversion_upload_client_summary_proto_goTypes = []interface{}{
...
func file_resources_offline_conversion_upload_client_summary_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_offline_conversion_upload_client_summary_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_offline_conversion_upload_client_summary_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*OfflineConversionSummary_JobId)(nil),
		(*OfflineConversionSummary_UploadDate)(nil),
	}
	file_resources_offline_conversion_upload_client_summary_proto_msgTypes[3].OneofWrappers = []interface{}{
