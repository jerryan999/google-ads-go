...
// 	protoc        v4.23.4
// source: google/ads/googleads/v15/resources/bidding_data_exclusion.proto
...
type BiddingDataExclusion struct {
	...
	Scope enums.SeasonalityEventScopeEnum_SeasonalityEventScope `protobuf:"varint,3,opt,name=scope,proto3,enum=google.ads.googleads.v15.enums.SeasonalityEventScopeEnum_SeasonalityEventScope" json:"scope,omitempty"`
	// Output only. The status of the data exclusion.
	Status enums.SeasonalityEventStatusEnum_SeasonalityEventStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.SeasonalityEventStatusEnum_SeasonalityEventStatus" json:"status,omitempty"`
	...
	// exclusion.
	Devices []enums.DeviceEnum_Device `protobuf:"varint,9,rep,packed,name=devices,proto3,enum=google.ads.googleads.v15.enums.DeviceEnum_Device" json:"devices,omitempty"`
...
var file_resources_bidding_data_exclusion_proto_rawDesc = []byte{
	...
	0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x61,
	...
	0x73, 0x2e, 0x76, 0x31, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x64, 0x76, 0x65,
	...
	0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x19, 0x42, 0x69, 0x64,
	0x64, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x73, 0x69, 0x6f,
...
var file_resources_bidding_data_exclusion_proto_goTypes = []interface{}{
	(*BiddingDataExclusion)(nil),                                 // 0: google.ads.googleads.v15.resources.BiddingDataExclusion
	(enums.SeasonalityEventScopeEnum_SeasonalityEventScope)(0),   // 1: google.ads.googleads.v15.enums.SeasonalityEventScopeEnum.SeasonalityEventScope
	(enums.SeasonalityEventStatusEnum_SeasonalityEventStatus)(0), // 2: google.ads.googleads.v15.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus
	(enums.DeviceEnum_Device)(0),                                 // 3: google.ads.googleads.v15.enums.DeviceEnum.Device
...
var file_resources_bidding_data_exclusion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.BiddingDataExclusion.scope:type_name -> google.ads.googleads.v15.enums.SeasonalityEventScopeEnum.SeasonalityEventScope
	2, // 1: google.ads.googleads.v15.resources.BiddingDataExclusion.status:type_name -> google.ads.googleads.v15.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus
	3, // 2: google.ads.googleads.v15.resources.BiddingDataExclusion.devices:type_name -> google.ads.googleads.v15.enums.DeviceEnum.Device
	4, // 3: google.ads.googleads.v15.resources.BiddingDataExclusion.advertising_channel_types:type_name -> google.ads.googleads.v15.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
