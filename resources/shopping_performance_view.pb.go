...
var file_resources_shopping_performance_view_proto_goTypes = []any{
	(*ShoppingPerformanceView)(nil), // 0: google.ads.googleads.v17.resources.ShoppingPerformanceView
}
...
func file_resources_shopping_performance_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_shopping_performance_view_proto_msgTypes[0].Exporter = func(v any, i int) any {
