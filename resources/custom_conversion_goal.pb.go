...
type CustomConversionGoal struct {
	...
	Status enums.CustomConversionGoalStatusEnum_CustomConversionGoalStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.CustomConversionGoalStatusEnum_CustomConversionGoalStatus" json:"status,omitempty"`
}
...
var file_resources_custom_conversion_goal_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x19, 0x43,
...
var file_resources_custom_conversion_goal_proto_goTypes = []any{
	(*CustomConversionGoal)(nil),                                         // 0: google.ads.googleads.v17.resources.CustomConversionGoal
	(enums.CustomConversionGoalStatusEnum_CustomConversionGoalStatus)(0), // 1: google.ads.googleads.v17.enums.CustomConversionGoalStatusEnum.CustomConversionGoalStatus
}
var file_resources_custom_conversion_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.CustomConversionGoal.status:type_name -> google.ads.googleads.v17.enums.CustomConversionGoalStatusEnum.CustomConversionGoalStatus
...
func file_resources_custom_conversion_goal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_custom_conversion_goal_proto_msgTypes[0].Exporter = func(v any, i int) any {
