...
type UserInterest struct {
	...
	TaxonomyType enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType `protobuf:"varint,2,opt,name=taxonomy_type,json=taxonomyType,proto3,enum=google.ads.googleads.v17.enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType" json:"taxonomy_type,omitempty"`
...
func (x *UserInterest) Reset() {
	*x = UserInterest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_user_interest_proto_msgTypes[0]
...
func (*UserInterest) Descriptor() ([]byte, []int) {
	return file_resources_user_interest_proto_rawDescGZIP(), []int{0}
}
...
var file_resources_user_interest_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2f, 0x76, 0x31, 0x37, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x72,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55,
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x69, 0x74,
...
var (
	file_resources_user_interest_proto_rawDescOnce sync.Once
	file_resources_user_interest_proto_rawDescData = file_resources_user_interest_proto_rawDesc
)

func file_resources_user_interest_proto_rawDescGZIP() []byte {
	file_resources_user_interest_proto_rawDescOnce.Do(func() {
		file_resources_user_interest_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_user_interest_proto_rawDescData)
	})
	return file_resources_user_interest_proto_rawDescData
}

var file_resources_user_interest_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_user_interest_proto_goTypes = []any{
	(*UserInterest)(nil), // 0: google.ads.googleads.v17.resources.UserInterest
	(enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType)(0), // 1: google.ads.googleads.v17.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
	(*common.CriterionCategoryAvailability)(nil),                     // 2: google.ads.googleads.v17.common.CriterionCategoryAvailability
}
var file_resources_user_interest_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.UserInterest.taxonomy_type:type_name -> google.ads.googleads.v17.enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
	2, // 1: google.ads.googleads.v17.resources.UserInterest.availabilities:type_name -> google.ads.googleads.v17.common.CriterionCategoryAvailability
...
func init() { file_resources_user_interest_proto_init() }
func file_resources_user_interest_proto_init() {
	if File_resources_user_interest_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_user_interest_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_user_interest_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_resources_user_interest_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_user_interest_proto_goTypes,
		DependencyIndexes: file_resources_user_interest_proto_depIdxs,
		MessageInfos:      file_resources_user_interest_proto_msgTypes,
	}.Build()
	File_resources_user_interest_proto = out.File
	file_resources_user_interest_proto_rawDesc = nil
	file_resources_user_interest_proto_goTypes = nil
	file_resources_user_interest_proto_depIdxs = nil
}
