...
func (x *CampaignCriterionSimulation) Reset() {
	*x = CampaignCriterionSimulation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_campaign_criterion_simulation_proto_msgTypes[0]
...
func (*CampaignCriterionSimulation) Descriptor() ([]byte, []int) {
	return file_resources_campaign_criterion_simulation_proto_rawDescGZIP(), []int{0}
}
...
var file_resources_campaign_criterion_simulation_proto_rawDesc = []byte{
	...
	0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74, 0x69,
	...
	0x76, 0x39, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x42, 0x69, 0x64, 0x4d, 0x6f, 0x64,
...
var (
	file_resources_campaign_criterion_simulation_proto_rawDescOnce sync.Once
	file_resources_campaign_criterion_simulation_proto_rawDescData = file_resources_campaign_criterion_simulation_proto_rawDesc
)

func file_resources_campaign_criterion_simulation_proto_rawDescGZIP() []byte {
	file_resources_campaign_criterion_simulation_proto_rawDescOnce.Do(func() {
		file_resources_campaign_criterion_simulation_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_campaign_criterion_simulation_proto_rawDescData)
	})
	return file_resources_campaign_criterion_simulation_proto_rawDescData
}

var file_resources_campaign_criterion_simulation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_campaign_criterion_simulation_proto_goTypes = []interface{}{
	(*CampaignCriterionSimulation)(nil),                                      // 0: google.ads.googleads.v9.resources.CampaignCriterionSimulation
	...
	(*common.BidModifierSimulationPointList)(nil),                            // 3: google.ads.googleads.v9.common.BidModifierSimulationPointList
}
var file_resources_campaign_criterion_simulation_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.resources.CampaignCriterionSimulation.type:type_name -> google.ads.googleads.v9.enums.SimulationTypeEnum.SimulationType
	2, // 1: google.ads.googleads.v9.resources.CampaignCriterionSimulation.modification_method:type_name -> google.ads.googleads.v9.enums.SimulationModificationMethodEnum.SimulationModificationMethod
	3, // 2: google.ads.googleads.v9.resources.CampaignCriterionSimulation.bid_modifier_point_list:type_name -> google.ads.googleads.v9.common.BidModifierSimulationPointList
...
func init() { file_resources_campaign_criterion_simulation_proto_init() }
func file_resources_campaign_criterion_simulation_proto_init() {
	if File_resources_campaign_criterion_simulation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_campaign_criterion_simulation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_resources_campaign_criterion_simulation_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_campaign_criterion_simulation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_campaign_criterion_simulation_proto_goTypes,
		DependencyIndexes: file_resources_campaign_criterion_simulation_proto_depIdxs,
		MessageInfos:      file_resources_campaign_criterion_simulation_proto_msgTypes,
	}.Build()
	File_resources_campaign_criterion_simulation_proto = out.File
	file_resources_campaign_criterion_simulation_proto_rawDesc = nil
	file_resources_campaign_criterion_simulation_proto_goTypes = nil
	file_resources_campaign_criterion_simulation_proto_depIdxs = nil
}
