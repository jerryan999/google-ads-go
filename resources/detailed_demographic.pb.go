...
var file_resources_detailed_demographic_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x37, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x72, 0x69,
...
var file_resources_detailed_demographic_proto_goTypes = []any{
	(*DetailedDemographic)(nil),                  // 0: google.ads.googleads.v17.resources.DetailedDemographic
...
var file_resources_detailed_demographic_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.DetailedDemographic.availabilities:type_name -> google.ads.googleads.v17.common.CriterionCategoryAvailability
...
func file_resources_detailed_demographic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_detailed_demographic_proto_msgTypes[0].Exporter = func(v any, i int) any {
