...
func (x *AssetGroupTopCombinationView) Reset() {
	*x = AssetGroupTopCombinationView{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_asset_group_top_combination_view_proto_msgTypes[0]
...
func (*AssetGroupTopCombinationView) Descriptor() ([]byte, []int) {
	return file_resources_asset_group_top_combination_view_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupAssetCombinationData) Reset() {
	*x = AssetGroupAssetCombinationData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_asset_group_top_combination_view_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetGroupAssetCombinationData) Descriptor() ([]byte, []int) {
	return file_resources_asset_group_top_combination_view_proto_rawDescGZIP(), []int{1}
}
...
var File_resources_asset_group_top_combination_view_proto protoreflect.FileDescriptor

var file_resources_asset_group_top_combination_view_proto_rawDesc = []byte{
...
var (
	file_resources_asset_group_top_combination_view_proto_rawDescOnce sync.Once
	file_resources_asset_group_top_combination_view_proto_rawDescData = file_resources_asset_group_top_combination_view_proto_rawDesc
)

func file_resources_asset_group_top_combination_view_proto_rawDescGZIP() []byte {
	file_resources_asset_group_top_combination_view_proto_rawDescOnce.Do(func() {
		file_resources_asset_group_top_combination_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_asset_group_top_combination_view_proto_rawDescData)
	})
	return file_resources_asset_group_top_combination_view_proto_rawDescData
}

var file_resources_asset_group_top_combination_view_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_resources_asset_group_top_combination_view_proto_goTypes = []any{
	(*AssetGroupTopCombinationView)(nil),   // 0: google.ads.googleads.v17.resources.AssetGroupTopCombinationView
	(*AssetGroupAssetCombinationData)(nil), // 1: google.ads.googleads.v17.resources.AssetGroupAssetCombinationData
	(*common.AssetUsage)(nil),              // 2: google.ads.googleads.v17.common.AssetUsage
}
var file_resources_asset_group_top_combination_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.AssetGroupTopCombinationView.asset_group_top_combinations:type_name -> google.ads.googleads.v17.resources.AssetGroupAssetCombinationData
	2, // 1: google.ads.googleads.v17.resources.AssetGroupAssetCombinationData.asset_combination_served_assets:type_name -> google.ads.googleads.v17.common.AssetUsage
...
func init() { file_resources_asset_group_top_combination_view_proto_init() }
func file_resources_asset_group_top_combination_view_proto_init() {
	if File_resources_asset_group_top_combination_view_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_group_top_combination_view_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_asset_group_top_combination_view_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_asset_group_top_combination_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_asset_group_top_combination_view_proto_goTypes,
		DependencyIndexes: file_resources_asset_group_top_combination_view_proto_depIdxs,
		MessageInfos:      file_resources_asset_group_top_combination_view_proto_msgTypes,
	}.Build()
	File_resources_asset_group_top_combination_view_proto = out.File
	file_resources_asset_group_top_combination_view_proto_rawDesc = nil
	file_resources_asset_group_top_combination_view_proto_goTypes = nil
	file_resources_asset_group_top_combination_view_proto_depIdxs = nil
}
