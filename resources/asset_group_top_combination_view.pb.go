...
var file_resources_asset_group_top_combination_view_proto_goTypes = []interface{}{
...
func file_resources_asset_group_top_combination_view_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_asset_group_top_combination_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_asset_group_top_combination_view_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
