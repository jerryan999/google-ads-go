...
func (x *CustomerLifecycleGoal_LifecycleGoalCustomerDefinitionSettings) Reset() {
	*x = CustomerLifecycleGoal_LifecycleGoalCustomerDefinitionSettings{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_customer_lifecycle_goal_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerLifecycleGoal_LifecycleGoalCustomerDefinitionSettings) Descriptor() ([]byte, []int) {
	return file_resources_customer_lifecycle_goal_proto_rawDescGZIP(), []int{0, 0}
}
...
var file_resources_customer_lifecycle_goal_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_resources_customer_lifecycle_goal_proto_goTypes = []interface{}{
...
func file_resources_customer_lifecycle_goal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_customer_lifecycle_goal_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_customer_lifecycle_goal_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
