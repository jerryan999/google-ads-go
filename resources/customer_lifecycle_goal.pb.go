...
func (x *CustomerLifecycleGoal) Reset() {
	*x = CustomerLifecycleGoal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_customer_lifecycle_goal_proto_msgTypes[0]
...
func (*CustomerLifecycleGoal) Descriptor() ([]byte, []int) {
	return file_resources_customer_lifecycle_goal_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_customer_lifecycle_goal_proto protoreflect.FileDescriptor

var file_resources_customer_lifecycle_goal_proto_rawDesc = []byte{
	...
	0x72, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf4, 0x02, 0x0a, 0x15, 0x43, 0x75,
	...
	0x6c, 0x75, 0x65, 0x53, 0x65, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x73, 0x3a, 0x63, 0xea, 0x41, 0x60,
	...
	0x12, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x63, 0x75, 0x73,
	...
	0x42, 0x8c, 0x02, 0x0a, 0x26, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31,
	0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x1a, 0x43, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4c, 0x69, 0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x47, 0x6f,
	0x61, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4b, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
...
var (
	file_resources_customer_lifecycle_goal_proto_rawDescOnce sync.Once
	file_resources_customer_lifecycle_goal_proto_rawDescData = file_resources_customer_lifecycle_goal_proto_rawDesc
)

func file_resources_customer_lifecycle_goal_proto_rawDescGZIP() []byte {
	file_resources_customer_lifecycle_goal_proto_rawDescOnce.Do(func() {
		file_resources_customer_lifecycle_goal_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_customer_lifecycle_goal_proto_rawDescData)
	})
	return file_resources_customer_lifecycle_goal_proto_rawDescData
}

var file_resources_customer_lifecycle_goal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_customer_lifecycle_goal_proto_goTypes = []any{
	(*CustomerLifecycleGoal)(nil),             // 0: google.ads.googleads.v17.resources.CustomerLifecycleGoal
	(*common.LifecycleGoalValueSettings)(nil), // 1: google.ads.googleads.v17.common.LifecycleGoalValueSettings
}
var file_resources_customer_lifecycle_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.CustomerLifecycleGoal.customer_acquisition_goal_value_settings:type_name -> google.ads.googleads.v17.common.LifecycleGoalValueSettings
...
func init() { file_resources_customer_lifecycle_goal_proto_init() }
func file_resources_customer_lifecycle_goal_proto_init() {
	if File_resources_customer_lifecycle_goal_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_customer_lifecycle_goal_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_customer_lifecycle_goal_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_customer_lifecycle_goal_proto_goTypes,
		DependencyIndexes: file_resources_customer_lifecycle_goal_proto_depIdxs,
		MessageInfos:      file_resources_customer_lifecycle_goal_proto_msgTypes,
	}.Build()
	File_resources_customer_lifecycle_goal_proto = out.File
	file_resources_customer_lifecycle_goal_proto_rawDesc = nil
	file_resources_customer_lifecycle_goal_proto_goTypes = nil
	file_resources_customer_lifecycle_goal_proto_depIdxs = nil
}
