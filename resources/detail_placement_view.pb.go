...
type DetailPlacementView struct {
	...
	PlacementType enums.PlacementTypeEnum_PlacementType `protobuf:"varint,6,opt,name=placement_type,json=placementType,proto3,enum=google.ads.googleads.v9.enums.PlacementTypeEnum_PlacementType" json:"placement_type,omitempty"`
}
...
var file_resources_detail_placement_view_proto_goTypes = []interface{}{
	(*DetailPlacementView)(nil),                // 0: google.ads.googleads.v9.resources.DetailPlacementView
	(enums.PlacementTypeEnum_PlacementType)(0), // 1: google.ads.googleads.v9.enums.PlacementTypeEnum.PlacementType
}
var file_resources_detail_placement_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v9.resources.DetailPlacementView.placement_type:type_name -> google.ads.googleads.v9.enums.PlacementTypeEnum.PlacementType
