...
var file_resources_lead_form_submission_data_proto_goTypes = []interface{}{
...
func file_resources_lead_form_submission_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_lead_form_submission_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_lead_form_submission_data_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_lead_form_submission_data_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
