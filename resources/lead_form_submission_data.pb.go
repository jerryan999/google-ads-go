...
func (x *LeadFormSubmissionData) Reset() {
	*x = LeadFormSubmissionData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_lead_form_submission_data_proto_msgTypes[0]
...
func (*LeadFormSubmissionData) Descriptor() ([]byte, []int) {
	return file_resources_lead_form_submission_data_proto_rawDescGZIP(), []int{0}
}
...
type LeadFormSubmissionField struct {
	...
	FieldType enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType `protobuf:"varint,1,opt,name=field_type,json=fieldType,proto3,enum=google.ads.googleads.v17.enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType" json:"field_type,omitempty"`
...
func (x *LeadFormSubmissionField) Reset() {
	*x = LeadFormSubmissionField{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_lead_form_submission_data_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LeadFormSubmissionField) Descriptor() ([]byte, []int) {
	return file_resources_lead_form_submission_data_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomLeadFormSubmissionField) Reset() {
	*x = CustomLeadFormSubmissionField{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_lead_form_submission_data_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomLeadFormSubmissionField) Descriptor() ([]byte, []int) {
	return file_resources_lead_form_submission_data_proto_rawDescGZIP(), []int{2}
}
...
var File_resources_lead_form_submission_data_proto protoreflect.FileDescriptor

var file_resources_lead_form_submission_data_proto_rawDesc = []byte{
	...
	0x31, 0x37, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x65, 0x61, 0x64, 0x5f, 0x66, 0x6f,
...
var (
	file_resources_lead_form_submission_data_proto_rawDescOnce sync.Once
	file_resources_lead_form_submission_data_proto_rawDescData = file_resources_lead_form_submission_data_proto_rawDesc
)

func file_resources_lead_form_submission_data_proto_rawDescGZIP() []byte {
	file_resources_lead_form_submission_data_proto_rawDescOnce.Do(func() {
		file_resources_lead_form_submission_data_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_lead_form_submission_data_proto_rawDescData)
	})
	return file_resources_lead_form_submission_data_proto_rawDescData
}

var file_resources_lead_form_submission_data_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_resources_lead_form_submission_data_proto_goTypes = []any{
	(*LeadFormSubmissionData)(nil),                                       // 0: google.ads.googleads.v17.resources.LeadFormSubmissionData
	(*LeadFormSubmissionField)(nil),                                      // 1: google.ads.googleads.v17.resources.LeadFormSubmissionField
	(*CustomLeadFormSubmissionField)(nil),                                // 2: google.ads.googleads.v17.resources.CustomLeadFormSubmissionField
	(enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType)(0), // 3: google.ads.googleads.v17.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType
}
var file_resources_lead_form_submission_data_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.LeadFormSubmissionData.lead_form_submission_fields:type_name -> google.ads.googleads.v17.resources.LeadFormSubmissionField
	2, // 1: google.ads.googleads.v17.resources.LeadFormSubmissionData.custom_lead_form_submission_fields:type_name -> google.ads.googleads.v17.resources.CustomLeadFormSubmissionField
	3, // 2: google.ads.googleads.v17.resources.LeadFormSubmissionField.field_type:type_name -> google.ads.googleads.v17.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType
...
func init() { file_resources_lead_form_submission_data_proto_init() }
func file_resources_lead_form_submission_data_proto_init() {
	if File_resources_lead_form_submission_data_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_lead_form_submission_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_resources_lead_form_submission_data_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_resources_lead_form_submission_data_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_lead_form_submission_data_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_lead_form_submission_data_proto_goTypes,
		DependencyIndexes: file_resources_lead_form_submission_data_proto_depIdxs,
		MessageInfos:      file_resources_lead_form_submission_data_proto_msgTypes,
	}.Build()
	File_resources_lead_form_submission_data_proto = out.File
	file_resources_lead_form_submission_data_proto_rawDesc = nil
	file_resources_lead_form_submission_data_proto_goTypes = nil
	file_resources_lead_form_submission_data_proto_depIdxs = nil
}
