...
type ConversionCustomVariable struct {
	...
	Status enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus" json:"status,omitempty"`
...
var file_resources_conversion_custom_variable_proto_goTypes = []any{
	(*ConversionCustomVariable)(nil),                                             // 0: google.ads.googleads.v17.resources.ConversionCustomVariable
	(enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus)(0), // 1: google.ads.googleads.v17.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
}
var file_resources_conversion_custom_variable_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.ConversionCustomVariable.status:type_name -> google.ads.googleads.v17.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
...
func file_resources_conversion_custom_variable_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_conversion_custom_variable_proto_msgTypes[0].Exporter = func(v any, i int) any {
