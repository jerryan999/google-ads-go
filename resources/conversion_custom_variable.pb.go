...
type ConversionCustomVariable struct {
	...
	Status enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v15.enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus" json:"status,omitempty"`
...
func (x *ConversionCustomVariable) Reset() {
	*x = ConversionCustomVariable{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_conversion_custom_variable_proto_msgTypes[0]
...
func (*ConversionCustomVariable) Descriptor() ([]byte, []int) {
	return file_resources_conversion_custom_variable_proto_rawDescGZIP(), []int{0}
}
...
var file_resources_conversion_custom_variable_proto_rawDesc = []byte{
...
var (
	file_resources_conversion_custom_variable_proto_rawDescOnce sync.Once
	file_resources_conversion_custom_variable_proto_rawDescData = file_resources_conversion_custom_variable_proto_rawDesc
)

func file_resources_conversion_custom_variable_proto_rawDescGZIP() []byte {
	file_resources_conversion_custom_variable_proto_rawDescOnce.Do(func() {
		file_resources_conversion_custom_variable_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_conversion_custom_variable_proto_rawDescData)
	})
	return file_resources_conversion_custom_variable_proto_rawDescData
}

var file_resources_conversion_custom_variable_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_conversion_custom_variable_proto_goTypes = []interface{}{
	(*ConversionCustomVariable)(nil),                                             // 0: google.ads.googleads.v15.resources.ConversionCustomVariable
	(enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus)(0), // 1: google.ads.googleads.v15.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
}
var file_resources_conversion_custom_variable_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v15.resources.ConversionCustomVariable.status:type_name -> google.ads.googleads.v15.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
...
func init() { file_resources_conversion_custom_variable_proto_init() }
func file_resources_conversion_custom_variable_proto_init() {
	if File_resources_conversion_custom_variable_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_conversion_custom_variable_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_conversion_custom_variable_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_conversion_custom_variable_proto_goTypes,
		DependencyIndexes: file_resources_conversion_custom_variable_proto_depIdxs,
		MessageInfos:      file_resources_conversion_custom_variable_proto_msgTypes,
	}.Build()
	File_resources_conversion_custom_variable_proto = out.File
	file_resources_conversion_custom_variable_proto_rawDesc = nil
	file_resources_conversion_custom_variable_proto_goTypes = nil
	file_resources_conversion_custom_variable_proto_depIdxs = nil
}
