...
var file_resources_android_privacy_shared_key_google_network_type_proto_goTypes = []interface{}{
...
func file_resources_android_privacy_shared_key_google_network_type_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_android_privacy_shared_key_google_network_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
