...
type CampaignSharedSet struct {
	...
	Status enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus `protobuf:"varint,2,opt,name=status,proto3,enum=google.ads.googleads.v17.enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus" json:"status,omitempty"`
}
...
var file_resources_campaign_shared_set_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x37, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x16,
...
var file_resources_campaign_shared_set_proto_goTypes = []any{
	(*CampaignSharedSet)(nil),                                      // 0: google.ads.googleads.v17.resources.CampaignSharedSet
	(enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus)(0), // 1: google.ads.googleads.v17.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
}
var file_resources_campaign_shared_set_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v17.resources.CampaignSharedSet.status:type_name -> google.ads.googleads.v17.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
...
func file_resources_campaign_shared_set_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_campaign_shared_set_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_resources_campaign_shared_set_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
