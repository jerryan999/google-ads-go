...
func (x *ExperimentArm) Reset() {
	*x = ExperimentArm{}
	if protoimpl.UnsafeEnabled {
		mi := &file_resources_experiment_arm_proto_msgTypes[0]
...
func (*ExperimentArm) Descriptor() ([]byte, []int) {
	return file_resources_experiment_arm_proto_rawDescGZIP(), []int{0}
}
...
var File_resources_experiment_arm_proto protoreflect.FileDescriptor

var file_resources_experiment_arm_proto_rawDesc = []byte{
...
var (
	file_resources_experiment_arm_proto_rawDescOnce sync.Once
	file_resources_experiment_arm_proto_rawDescData = file_resources_experiment_arm_proto_rawDesc
)

func file_resources_experiment_arm_proto_rawDescGZIP() []byte {
	file_resources_experiment_arm_proto_rawDescOnce.Do(func() {
		file_resources_experiment_arm_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_experiment_arm_proto_rawDescData)
	})
	return file_resources_experiment_arm_proto_rawDescData
}

var file_resources_experiment_arm_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_resources_experiment_arm_proto_goTypes = []interface{}{
	(*ExperimentArm)(nil), // 0: google.ads.googleads.v15.resources.ExperimentArm
}
var file_resources_experiment_arm_proto_depIdxs = []int32{
...
func init() { file_resources_experiment_arm_proto_init() }
func file_resources_experiment_arm_proto_init() {
	if File_resources_experiment_arm_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_resources_experiment_arm_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_resources_experiment_arm_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_resources_experiment_arm_proto_goTypes,
		DependencyIndexes: file_resources_experiment_arm_proto_depIdxs,
		MessageInfos:      file_resources_experiment_arm_proto_msgTypes,
	}.Build()
	File_resources_experiment_arm_proto = out.File
	file_resources_experiment_arm_proto_rawDesc = nil
	file_resources_experiment_arm_proto_goTypes = nil
	file_resources_experiment_arm_proto_depIdxs = nil
}
